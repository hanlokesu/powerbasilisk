...
> Summary:
> - **811** official PowerBASIC statement/function keywords currently available for use
>   - **663** implemented or completed by this fork
...
> - **44** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 176 (v0.2.033). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 811 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DEC | GRAPHIC SET WRAP | MKD$ | TCP OPEN |
| ACCEL ATTACH | DEC$ | GRAPHIC STYLE | MKDIR | TCP PRINT |
| ACODE | DECLARE | GRAPHIC TEXT SIZE | MKDWD | TCP RECV |
| ACODE$ | DECR | GRAPHIC WIDTH | MKDWD$ | TCP SEND |
| ACOS | DEF | HEADER GET COUNT | MKE | THREAD CLOSE |
| ACOSH | DESKTOP GET CLIENT | HEADER GET ITEM | MKE$ | THREAD CREATE |
| AND | DESKTOP GET LOC | HEADER SEND | MKI$ | THREAD GET PRIORITY |
| ARRAY ADD | DESKTOP GET PPI | HEADER SET ITEM | MKL$ | THREAD RESUME |
| ARRAY ARRAYIX | DESKTOP GET SIZE | HEX | MKQ$ | THREAD SET PRIORITY |
| ARRAY ASSIGN | DIALOG DEFAULT FONT | HEX$ | MKS | THREAD STATUS |
| ARRAY COPY | DIALOG DISABLE | HI | MKS$ | THREAD SUSPEND |
| ARRAY DELETE | DIALOG DOEVENTS | HIWRD | MKWRD | THREADCOUNT |
| ARRAY INSERT | DIALOG ENABLE | HOST ADDR | MKWRD$ | THREADED |
| ARRAY REDIM DECR | DIALOG END | HOST NAME | MOD | THREADID |
| ARRAY REDIM INCR | DIALOG GET CLIENT | HYPOT | MONTHNAME | TIMER |
| ARRAY REVERSE | DIALOG GET LOC | IF | MONTHNAME$ | TIX |
| ARRAY SCAN | DIALOG GET SIZE | IF/END IF | MOUSEPTR | TOOLBAR ADD BUTTON |
| ARRAY SHUFFLE | DIALOG GET TEXT | IIF | MSGBOX | TOOLBAR ADD SEPARATOR |
| ARRAY SORT | DIALOG GET USER | IMAGELIST ADD BITMAP | NAME | TOOLBAR DELETE BUTTON |
| ARRAY SWAP | DIALOG HIDE | IMAGELIST ADD ICON | NOT | TOOLBAR GET COUNT |
| ARRAY TAGARRAY | DIALOG MAXIMIZE | IMAGELIST ADD MASKED | NUL | TOOLBAR GET STATE |
| ARRAY TAGARRAY ERASE | DIALOG MINIMIZE | IMAGELIST COUNT | NUL$ | TOOLBAR SET IMAGELIST |
| ARRAY UNIQUE | DIALOG NEW | IMAGELIST GET COUNT | OBJECT | TOOLBAR SET STATE |
| ASC | DIALOG NONSTABLE | IMAGELIST KILL | OCT | TRACE |
| ASIN | DIALOG NORMALIZE | IMAGELIST NEW | OCT$ | TREEVIEW DELETE |
| ASINH | DIALOG PIXELS | IMAGELIST NEW BITMAP | OEMTOCHR | TREEVIEW GET BOLD |
| ASM | DIALOG POST | IMAGELIST NEW ICON | OEMTOCHR$ | TREEVIEW GET CHECK |
| ASMDATA / END ASMDATA | DIALOG REDRAW | IMAGELIST SET OVERLAY | ON CALL | TREEVIEW GET CHILD |
| ATANH | DIALOG SEND | IMP | ON ERROR | TREEVIEW GET COUNT |
| ATN | DIALOG SET CLIENT | IMPORT | ON GOSUB | TREEVIEW GET EXPANDED |
| ATN2 | DIALOG SET COLOR | INCR | ON GOTO | TREEVIEW GET NEXT |
| BEEP | DIALOG SET ICON | INPUT FLUSH | OPEN | TREEVIEW GET PARENT |
| BGR | DIALOG SET LOC | INPUT# | OPTION EXPLICIT | TREEVIEW GET PREVIOUS |
| BIN | DIALOG SET SIZE | INSTANCE | OR | TREEVIEW GET ROOT |
| BIN$ | DIALOG SET TEXT | INSTR | PARSE | TREEVIEW GET SELECT |
| BIT | DIALOG SET USER | INT | PARSE$ | TREEVIEW GET TEXT |
| BIT CALC | DIALOG SHOW MODAL | INTEGER | PARSECOUNT | TREEVIEW GET USER |
| BITS | DIALOG SHOW MODELESS | INTERFACE / END INTERFACE (DIRECT) | PATHNAME | TREEVIEW INSERT ITEM |
| BITS$ | DIALOG SHOW STATE | INTERFACE/END INTERFACE (IDBIND) | PATHNAME$ | TREEVIEW RESET |
| BITSE | DIALOG STABILIZE | ISEVEN | PATHSCAN | TREEVIEW SELECT |
| BUILD | DIALOG UNITS | ISFALSE | PATHSCAN$ | TREEVIEW SET BOLD |
| BUILD$ | DIM | ISFILE | PEEK | TREEVIEW SET CHECK |
| BYTE | DIR | ISFOLDER | PLAY | TREEVIEW SET EXPANDED |
| CALL | DIR CLOSE | ISINFINITE | PLAY SOUND | TREEVIEW SET IMAGELIST |
| CALL DWORD | DIR$ | ISNORMAL | PLAY WAVE | TREEVIEW SET TEXT |
| CALLSTK | DISKFREE | ISODD | POKE | TREEVIEW SET USER |
| CALLSTK$ | DISKSIZE | ISTRUE | PREFIX | TREEVIEW UNSELECT |
| CALLSTKCOUNT | DISPLAY BROWSE | ISWIN | PRINT# | TRIM |
| CBOOL | DISPLAY COLOR | ITERATE | PRINTER$ | TRIM$ |
| CBRT | DISPLAY FONT | JOIN$ | PRINTERCOUNT | TRUNC |
| CBYTE | DISPLAY OPENFILE | KILL | PROCESS GET PRIORITY | TRY/END TRY |
| CDBL | DISPLAY SAVEFILE | LCASE | PROCESS SET PRIORITY | TYPE SET |
| CDWORD | DOUBLE | LCASE$ | PROFILE | TYPE/END TYPE |
| CEIL | END | LEFT | PROGRESSBAR GET POS | UCASE |
| CFLT | ENVIRON | LEFT$ | PROGRESSBAR GET RANGE | UCASE$ |
| CHDIR | ENVIRON$ | LEN | PROGRESSBAR SET POS | UCODE$ |
| CHDRIVE | EOF | LET | PROGRESSBAR SET RANGE | UCODEPAGE |
| CHOOSE | EQV | LET *(WITH OBJECTS)* | PROGRESSBAR SET STEP | UDP CLOSE |
| CHR | ERASE | LET *(WITH TYPES)* | PROGRESSBAR STEP | UDP NOTIFY |
| CHR$ | ERF | LET *(WITH VARIANTS)* | PUT | UDP OPEN |
| CHRBYTES | ERL | LINE INPUT# | PUT STR | UDP RECV |
| CHRTOOEM | ERL$ | LISTBOX ADD | PUT WSTR | UDP SEND |
| CHRTOOEM$ | ERR | LISTBOX DELETE | PUT$ | UNLOCK |
| CHRTOUTF8 | ERRCLEAR | LISTBOX FIND | PUT$$ | UNWRAP |
| CHRTOUTF8$ | ERROR | LISTBOX FIND EXACT | QUAD | UNWRAP$ |
| CLASS/END CLASS | ERROR$ | LISTBOX GET COUNT | RAISEEVENT | USING |
| CLIP | EVENT SOURCE | LISTBOX GET SELCOUNT | RANDOMIZE | USING$ |
| CLIP$ | EVENTS | LISTBOX GET SELECT | READ | UTF8TOCHR |
| CLIPBOARD | EXE | LISTBOX GET STATE | READ$ | UTF8TOCHR$ |
| CLOSE | EXIST | LISTBOX GET TEXT | REDIM | VAL |
| CLS | EXIT | LISTBOX GET USER | REGEXPR | VARPTR |
| CODEPTR | EXP | LISTBOX INSERT | REGISTER | VERIFY |
| COLOR | EXP10 | LISTBOX RESET | REGREPL | WAITKEY |
| COMBOBOX ADD | EXP2 | LISTBOX SELECT | REM | WAITKEY$ |
| COMBOBOX DELETE | EXPM1 | LISTBOX SET TEXT | REMAIN | WINDOW GET |
| COMBOBOX FIND | EXTRACT | LISTBOX SET USER | REMAIN$ | WINDOW SET |
| COMBOBOX FIND EXACT | EXTRACT$ | LISTBOX UNSELECT | REMOVE | WORD |
| COMBOBOX GET COUNT | FIELD | LISTVIEW DELETE COLUMN | REMOVE$ | WRAP |
| COMBOBOX GET SELCOUNT | FILEATTR | LISTVIEW DELETE ITEM | REPEAT | WRAP$ |
| COMBOBOX GET SELECT | FILECOPY | LISTVIEW FIND | REPEAT$ | WRITE |
| COMBOBOX GET STATE | FILENAME | LISTVIEW FIND EXACT | REPLACE | WRITE# |
| COMBOBOX GET TEXT | FILENAME$ | LISTVIEW FIT CONTENT | RESET | XOR |
| COMBOBOX GET USER | FILESCAN | LISTVIEW FIT HEADER | RESOURCE SAVE FILE | XPRINT ARC |
| COMBOBOX INSERT | FIX | LISTVIEW GET COLUMN | RESOURCE$ | XPRINT ATTACH |
| COMBOBOX RESET | FLOOR | LISTVIEW GET COUNT | RESUME | XPRINT BOX |
| COMBOBOX SELECT | FLUSH | LISTVIEW GET HEADER | RETAIN | XPRINT CANCEL |
| COMBOBOX SET TEXT | FONT END | LISTVIEW GET HEADERID | RETAIN$ | XPRINT CELL |
| COMBOBOX SET USER | FONT NEW | LISTVIEW GET MODE | RETURN | XPRINT CELL SIZE |
| COMBOBOX UNSELECT | FOR / NEXT | LISTVIEW GET SELCOUNT | RGB | XPRINT CHR SIZE |
| COMM CLOSE | FORMAT | LISTVIEW GET SELECT | RIGHT | XPRINT CLOSE |
| COMM LINE | FORMAT$ | LISTVIEW GET STATE | RIGHT$ | XPRINT COLOR |
| COMM LINE INPUT | FRAC | LISTVIEW GET STYLEXX | RMDIR | XPRINT COPY |
| COMM OPEN | FRE | LISTVIEW GET TEXT | RND | XPRINT ELLIPSE |
| COMM PRINT | FREEFILE | LISTVIEW GET USER | ROTATE | XPRINT FORMFEED |
| COMM RECV | FUNCNAME | LISTVIEW INSERT COLUMN | ROUND | XPRINT GET ATTACH |
| COMM RESET | FUNCNAME$ | LISTVIEW INSERT ITEM | RSET | XPRINT GET CANVAS |
| COMM SEND | FUNCTION / END FUNCTION | LISTVIEW RESET | RSET$ | XPRINT GET CLIENT |
| COMM SET | GET | LISTVIEW SELECT | RTRIM | XPRINT GET CLIP |
| COMM TIMEOUT | GET STR | LISTVIEW SET COLUMN | RTRIM$ | XPRINT GET COLLATE |
| COMMAND | GET WSTR | LISTVIEW SET HEADER | SCROLLBAR GET PAGESIZE | XPRINT GET COLOR |
| COMMAND$ | GET$ | LISTVIEW SET IMAGE | SCROLLBAR GET POS | XPRINT GET COLORMODE |
| CONTROL ADD | GET$$ | LISTVIEW SET IMAGE2 | SCROLLBAR GET RANGE | XPRINT GET COPIES |
| CONTROL ADD BUTTON | GETATTR | LISTVIEW SET IMAGELIST | SCROLLBAR GET TRACKPOS | XPRINT GET DC |
| CONTROL ADD CHECKBOX | GLOBAL | LISTVIEW SET MODE | SCROLLBAR SET PAGESIZE | XPRINT GET DUPLEX |
| CONTROL ADD COMBOBOX | GLOBALMEM | LISTVIEW SET OVERLAY | SCROLLBAR SET POS | XPRINT GET LINES |
| CONTROL ADD LABEL | GRAPHIC ARC | LISTVIEW SET STYLEXX | SCROLLBAR SET RANGE | XPRINT GET MARGIN |
| CONTROL ADD LISTBOX | GRAPHIC ATTACH | LISTVIEW SET TEXT | SEC | XPRINT GET MIX |
| CONTROL ADD LISTVIEW | GRAPHIC BITMAP END | LISTVIEW SET USER | SECH | XPRINT GET ORIENTATION |
| CONTROL ADD PROGRESSBAR | GRAPHIC BITMAP LOAD | LISTVIEW SORT | SEEK | XPRINT GET OVERLAP |
| CONTROL ADD SCROLLBAR | GRAPHIC BITMAP NEW | LISTVIEW UNSELECT | SELECT CASE/END SELECT | XPRINT GET PAGES |
| CONTROL ADD STATUSBAR | GRAPHIC BOX | LISTVIEW VISIBLE | SETATTR | XPRINT GET PAPER |
| CONTROL ADD TAB | GRAPHIC CELL | LO | SETEOF | XPRINT GET PAPERS |
| CONTROL ADD TOOLBAR | GRAPHIC CELL SIZE | LOC | SGN | XPRINT GET PIXEL |
| CONTROL ADD TREEVIEW | GRAPHIC CHR SIZE | LOCAL | SHELL | XPRINT GET POS |
| CONTROL DISABLE | GRAPHIC CIRCLE | LOCK | SHIFT | XPRINT GET PPI |
| CONTROL ENABLE | GRAPHIC CLEAR | LOF | SHRINK | XPRINT GET QUALITY |
| CONTROL GET CHECK | GRAPHIC COLOR | LOG | SHRINK$ | XPRINT GET SCALE |
| CONTROL GET CLIENT | GRAPHIC COPY | LOG10 | SIN | XPRINT GET SELECTION |
| CONTROL GET LOC | GRAPHIC DETACH | LOG1P | SINGLE | XPRINT GET SIZE |
| CONTROL GET SIZE | GRAPHIC ELLIPSE | LOG2 | SINH | XPRINT GET STRETCHMODE |
| CONTROL GET TEXT | GRAPHIC GET BITS | LONG | SIZEOF | XPRINT GET TEXTALIGN |
| CONTROL GET USER | GRAPHIC GET CANVAS | LOWRD | SLEEP | XPRINT GET TRAY |
| CONTROL HANDLE | GRAPHIC GET CAPTION | LPRINT | SPACE | XPRINT GET TRAYS |
| CONTROL HIDE | GRAPHIC GET CLIENT | LPRINT ATTACH | SPACE$ | XPRINT GET WORDWRAP |
| CONTROL KILL | GRAPHIC GET CLIP | LPRINT CLOSE | SPLIT | XPRINT GET WRAP |
| CONTROL NORMALIZE | GRAPHIC GET DC | LPRINT FLUSH | SQR | XPRINT IMAGELIST |
| CONTROL POST | GRAPHIC GET LINES | LPRINT FORMFEED | STATIC | XPRINT LINE |
| CONTROL REDRAW | GRAPHIC GET LOC | LPRINT$ | STATUSBAR SET PARTS | XPRINT PIE |
| CONTROL SEND | GRAPHIC GET MIX | LSET | STATUSBAR SET TEXT | XPRINT POLYGON |
| CONTROL SET CHECK | GRAPHIC GET PIXEL | LSET$ | STR | XPRINT POLYLINE |
| CONTROL SET CLIENT | GRAPHIC GET POS | LTRIM | STR$ | XPRINT PREVIEW |
| CONTROL SET FOCUS | GRAPHIC GET PPI | LTRIM$ | STRDELETE | XPRINT PRINT |
| CONTROL SET FONT | GRAPHIC GET SCALE | MACRO/END MACRO | STRDELETE$ | XPRINT RENDER |
| CONTROL SET LOC | GRAPHIC GET SIZE | MAK | STRING | XPRINT SCALE |
| CONTROL SET SIZE | GRAPHIC GET STRETCHMODE | MAT | STRINSERT | XPRINT SET CLIP |
| CONTROL SET TEXT | GRAPHIC GET TEXTALIGN | MAX | STRINSERT$ | XPRINT SET COLLATE |
| CONTROL SET USER | GRAPHIC GET VIEW | MCASE | STRPTR | XPRINT SET COLOR |
| CONTROL SHOW STATE | GRAPHIC GET WORDWRAP | MCASE$ | STRREVERSE | XPRINT SET COLORMODE |
| COS | GRAPHIC GET WRAP | MEMORY | STRREVERSE$ | XPRINT SET COPIES |
| COSH | GRAPHIC LINE | MEMORY FILL | SWAP | XPRINT SET DUPLEX |
| COT | GRAPHIC PAINT | MEMORY FILLS | SWITCH | XPRINT SET FONT |
| COTH | GRAPHIC PIE | MENU ADD POPUP | SWITCH$ | XPRINT SET MIX |
| CQUAD | GRAPHIC POLYGON | MENU ADD STRING | TAB DELETE | XPRINT SET ORIENTATION |
| CSC | GRAPHIC POLYLINE | MENU ATTACH | TAB GET COUNT | XPRINT SET OVERLAP |
| CSCH | GRAPHIC PRINT | MENU CONTEXT | TAB GET DIALOG | XPRINT SET PAGES |
| CSET | GRAPHIC SAVE | MENU DELETE | TAB GET IMAGE | XPRINT SET PAPER |
| CSET$ | GRAPHIC SCALE | MENU DRAW BAR | TAB GET PAGE | XPRINT SET PIXEL |
| CSNG | GRAPHIC SCALE PIXELS | MENU GET STATE | TAB GET SELECT | XPRINT SET POS |
| CSTR | GRAPHIC SET AUTOSIZE | MENU GET TEXT | TAB GET TEXT | XPRINT SET QUALITY |
| CULNG | GRAPHIC SET BITS | MENU NEW BAR | TAB INSERT PAGE | XPRINT SET STRETCHMODE |
| CURDIR | GRAPHIC SET CAPTION | MENU NEW POPUP | TAB RESET | XPRINT SET TEXTALIGN |
| CURDIR$ | GRAPHIC SET CLIP | MENU SET STATE | TAB SELECT | XPRINT SET TRAY |
| CVBYT | GRAPHIC SET FIXED | MENU SET TEXT | TAB SET IMAGE | XPRINT SET WORDWRAP |
| CVCUX | GRAPHIC SET FONT | METHOD / END METHOD | TAB SET IMAGELIST | XPRINT SET WRAP |
| CVDWD | GRAPHIC SET MIX | METRICS | TAB SET TEXT | XPRINT SPLIT |
| CVL | GRAPHIC SET PIXEL | MID | TAB$ | XPRINT STRETCH |
| CVQ | GRAPHIC SET POS | MID$ | TALLY | XPRINT STYLE |
| CVW | GRAPHIC SET SIZE | MIN | TAN | XPRINT TEXT SIZE |
| CWORD | GRAPHIC SET STRETCHMODE | MKBYT | TANH | XPRINT WIDTH |
| DATA | GRAPHIC SET TEXTALIGN | MKBYT$ | TCP ACCEPT |  |
| DATACOUNT | GRAPHIC SET VIEW | MKCUR$ | TCP CLOSE |  |
| DAYNAME | GRAPHIC SET VIRTUAL | MKCUX | TCP LINE INPUT |  |
| DAYNAME$ | GRAPHIC SET WORDWRAP | MKCUX$ | TCP NOTIFY |  |

## **Newly** implemented by this branch

> **663 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG SET USER | LISTBOX FIND EXACT | STATUSBAR SET PARTS |
| ACCEL ATTACH | DIALOG SHOW MODAL | LISTBOX GET COUNT | STATUSBAR SET TEXT |
| ACODE | DIALOG SHOW MODELESS | LISTBOX GET SELCOUNT | STR |
| ACODE$ | DIALOG SHOW STATE | LISTBOX GET SELECT | STR$ |
| ACOS | DIALOG STABILIZE | LISTBOX GET STATE | STRDELETE |
| ACOSH | DIALOG UNITS | LISTBOX GET TEXT | STRDELETE$ |
| ARRAY ADD | DIM | LISTBOX GET USER | STRING |
| ARRAY ARRAYIX | DIR | LISTBOX INSERT | STRINSERT |
| ARRAY ASSIGN | DIR CLOSE | LISTBOX RESET | STRINSERT$ |
| ARRAY COPY | DIR$ | LISTBOX SELECT | STRPTR |
| ARRAY DELETE | DISKFREE | LISTBOX SET TEXT | STRREVERSE |
| ARRAY INSERT | DISKSIZE | LISTBOX SET USER | STRREVERSE$ |
| ARRAY REDIM DECR | DISPLAY BROWSE | LISTBOX UNSELECT | SWITCH |
| ARRAY REDIM INCR | DISPLAY COLOR | LISTVIEW DELETE COLUMN | SWITCH$ |
| ARRAY REVERSE | DISPLAY FONT | LISTVIEW DELETE ITEM | TAB DELETE |
| ARRAY SCAN | DISPLAY OPENFILE | LISTVIEW FIND | TAB GET COUNT |
| ARRAY SHUFFLE | DISPLAY SAVEFILE | LISTVIEW FIND EXACT | TAB GET DIALOG |
| ARRAY SWAP | DOUBLE | LISTVIEW FIT CONTENT | TAB GET IMAGE |
| ARRAY TAGARRAY | ENVIRON$ | LISTVIEW FIT HEADER | TAB GET PAGE |
| ARRAY TAGARRAY ERASE | EOF | LISTVIEW GET COLUMN | TAB GET SELECT |
| ARRAY UNIQUE | EQV | LISTVIEW GET COUNT | TAB GET TEXT |
| ASIN | ERF | LISTVIEW GET HEADER | TAB INSERT PAGE |
| ASINH | ERL | LISTVIEW GET HEADERID | TAB RESET |
| ATANH | ERL$ | LISTVIEW GET MODE | TAB SELECT |
| ATN | ERR | LISTVIEW GET SELCOUNT | TAB SET IMAGE |
| ATN2 | ERRCLEAR | LISTVIEW GET SELECT | TAB SET IMAGELIST |
| BGR | ERROR$ | LISTVIEW GET STATE | TAB SET TEXT |
| BIN | EVENT SOURCE | LISTVIEW GET STYLEXX | TAB$ |
| BIN$ | EVENTS | LISTVIEW GET TEXT | TALLY |
| BITS | EXE | LISTVIEW GET USER | TAN |
| BITS$ | EXIST | LISTVIEW INSERT COLUMN | TANH |
| BITSE | EXP | LISTVIEW INSERT ITEM | TCP NOTIFY |
| BUILD | EXP10 | LISTVIEW RESET | THREADCOUNT |
| BUILD$ | EXP2 | LISTVIEW SELECT | THREADID |
| BYTE | EXPM1 | LISTVIEW SET COLUMN | TIMER |
| CALLSTK$ | EXTRACT | LISTVIEW SET HEADER | TOOLBAR ADD BUTTON |
| CALLSTKCOUNT | EXTRACT$ | LISTVIEW SET IMAGE | TOOLBAR ADD SEPARATOR |
| CBOOL | FILEATTR | LISTVIEW SET IMAGE2 | TOOLBAR DELETE BUTTON |
| CBRT | FILENAME | LISTVIEW SET IMAGELIST | TOOLBAR GET COUNT |
| CBYTE | FILENAME$ | LISTVIEW SET MODE | TOOLBAR GET STATE |
| CDBL | FIX | LISTVIEW SET OVERLAY | TOOLBAR SET IMAGELIST |
| CDWORD | FLOOR | LISTVIEW SET STYLEXX | TOOLBAR SET STATE |
| CEIL | FONT END | LISTVIEW SET TEXT | TREEVIEW DELETE |
| CFLT | FONT NEW | LISTVIEW SET USER | TREEVIEW GET BOLD |
| CHOOSE | FORMAT | LISTVIEW SORT | TREEVIEW GET CHECK |
| CHR | FORMAT$ | LISTVIEW UNSELECT | TREEVIEW GET CHILD |
| CHR$ | FRAC | LISTVIEW VISIBLE | TREEVIEW GET COUNT |
| CHRBYTES | FRE | LO | TREEVIEW GET EXPANDED |
| CHRTOOEM | FREEFILE | LOC | TREEVIEW GET NEXT |
| CHRTOOEM$ | FUNCNAME | LOF | TREEVIEW GET PARENT |
| CHRTOUTF8 | FUNCNAME$ | LOG | TREEVIEW GET PREVIOUS |
| CHRTOUTF8$ | GET | LOG10 | TREEVIEW GET ROOT |
| CLIP | GET STR | LOG1P | TREEVIEW GET SELECT |
| CLIP$ | GET WSTR | LOG2 | TREEVIEW GET TEXT |
| CLOSE | GET$ | LONG | TREEVIEW GET USER |
| CODEPTR | GET$$ | LOWRD | TREEVIEW INSERT ITEM |
| COMBOBOX ADD | GETATTR | LPRINT$ | TREEVIEW RESET |
| COMBOBOX DELETE | GRAPHIC ARC | LSET$ | TREEVIEW SELECT |
| COMBOBOX FIND | GRAPHIC ATTACH | LTRIM | TREEVIEW SET BOLD |
| COMBOBOX FIND EXACT | GRAPHIC BITMAP END | LTRIM$ | TREEVIEW SET CHECK |
| COMBOBOX GET COUNT | GRAPHIC BITMAP LOAD | MAK | TREEVIEW SET EXPANDED |
| COMBOBOX GET SELCOUNT | GRAPHIC BITMAP NEW | MAX | TREEVIEW SET IMAGELIST |
| COMBOBOX GET SELECT | GRAPHIC BOX | MCASE | TREEVIEW SET TEXT |
| COMBOBOX GET STATE | GRAPHIC CELL | MCASE$ | TREEVIEW SET USER |
| COMBOBOX GET TEXT | GRAPHIC CELL SIZE | MEMORY FILL | TREEVIEW UNSELECT |
| COMBOBOX GET USER | GRAPHIC CHR SIZE | MEMORY FILLS | TRIM |
| COMBOBOX INSERT | GRAPHIC CIRCLE | MENU ADD POPUP | TRIM$ |
| COMBOBOX RESET | GRAPHIC CLEAR | MENU ADD STRING | TRUNC |
| COMBOBOX SELECT | GRAPHIC COLOR | MENU ATTACH | UCASE |
| COMBOBOX SET TEXT | GRAPHIC COPY | MENU CONTEXT | UCASE$ |
| COMBOBOX SET USER | GRAPHIC DETACH | MENU DELETE | UCODE$ |
| COMBOBOX UNSELECT | GRAPHIC ELLIPSE | MENU DRAW BAR | UCODEPAGE |
| COMM LINE INPUT | GRAPHIC GET BITS | MENU GET STATE | UDP NOTIFY |
| COMMAND | GRAPHIC GET CANVAS | MENU GET TEXT | UNWRAP |
| COMMAND$ | GRAPHIC GET CAPTION | MENU NEW BAR | UNWRAP$ |
| CONTROL ADD | GRAPHIC GET CLIENT | MENU NEW POPUP | USING |
| CONTROL ADD BUTTON | GRAPHIC GET CLIP | MENU SET STATE | USING$ |
| CONTROL ADD CHECKBOX | GRAPHIC GET DC | MENU SET TEXT | UTF8TOCHR |
| CONTROL ADD COMBOBOX | GRAPHIC GET LINES | METRICS | UTF8TOCHR$ |
| CONTROL ADD LABEL | GRAPHIC GET LOC | MID | VARPTR |
| CONTROL ADD LISTBOX | GRAPHIC GET MIX | MIN | VERIFY |
| CONTROL ADD LISTVIEW | GRAPHIC GET PIXEL | MKBYT | WAITKEY |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET POS | MKCUX | WAITKEY$ |
| CONTROL ADD SCROLLBAR | GRAPHIC GET PPI | MKDWD | WORD |
| CONTROL ADD STATUSBAR | GRAPHIC GET SCALE | MKE | WRAP |
| CONTROL ADD TAB | GRAPHIC GET SIZE | MKS | WRAP$ |
| CONTROL ADD TOOLBAR | GRAPHIC GET STRETCHMODE | MKWRD | WRITE |
| CONTROL ADD TREEVIEW | GRAPHIC GET TEXTALIGN | MOD | WRITE# |
| CONTROL DISABLE | GRAPHIC GET VIEW | MONTHNAME | XPRINT ARC |
| CONTROL ENABLE | GRAPHIC GET WORDWRAP | MONTHNAME$ | XPRINT ATTACH |
| CONTROL GET CHECK | GRAPHIC GET WRAP | NUL$ | XPRINT BOX |
| CONTROL GET CLIENT | GRAPHIC LINE | OCT | XPRINT CANCEL |
| CONTROL GET LOC | GRAPHIC PAINT | OCT$ | XPRINT CELL |
| CONTROL GET SIZE | GRAPHIC PIE | OEMTOCHR | XPRINT CELL SIZE |
| CONTROL GET TEXT | GRAPHIC POLYGON | OEMTOCHR$ | XPRINT CHR SIZE |
| CONTROL GET USER | GRAPHIC POLYLINE | ON CALL | XPRINT CLOSE |
| CONTROL HANDLE | GRAPHIC PRINT | ON GOSUB | XPRINT COLOR |
| CONTROL HIDE | GRAPHIC SAVE | ON GOTO | XPRINT COPY |
| CONTROL KILL | GRAPHIC SCALE | OPEN | XPRINT ELLIPSE |
| CONTROL NORMALIZE | GRAPHIC SCALE PIXELS | PARSE$ | XPRINT FORMFEED |
| CONTROL POST | GRAPHIC SET AUTOSIZE | PARSECOUNT | XPRINT GET ATTACH |
| CONTROL REDRAW | GRAPHIC SET BITS | PATHNAME | XPRINT GET CANVAS |
| CONTROL SEND | GRAPHIC SET CAPTION | PATHNAME$ | XPRINT GET CLIENT |
| CONTROL SET CHECK | GRAPHIC SET CLIP | PATHSCAN | XPRINT GET CLIP |
| CONTROL SET CLIENT | GRAPHIC SET FIXED | PATHSCAN$ | XPRINT GET COLLATE |
| CONTROL SET FOCUS | GRAPHIC SET FONT | PEEK | XPRINT GET COLOR |
| CONTROL SET FONT | GRAPHIC SET MIX | PLAY | XPRINT GET COLORMODE |
| CONTROL SET LOC | GRAPHIC SET PIXEL | PLAY SOUND | XPRINT GET COPIES |
| CONTROL SET SIZE | GRAPHIC SET POS | POKE | XPRINT GET DC |
| CONTROL SET TEXT | GRAPHIC SET SIZE | PRINTER$ | XPRINT GET DUPLEX |
| CONTROL SET USER | GRAPHIC SET STRETCHMODE | PRINTERCOUNT | XPRINT GET LINES |
| CONTROL SHOW STATE | GRAPHIC SET TEXTALIGN | PROGRESSBAR GET POS | XPRINT GET MARGIN |
| COS | GRAPHIC SET VIEW | PROGRESSBAR GET RANGE | XPRINT GET MIX |
| COSH | GRAPHIC SET VIRTUAL | PROGRESSBAR SET POS | XPRINT GET ORIENTATION |
| COT | GRAPHIC SET WORDWRAP | PROGRESSBAR SET RANGE | XPRINT GET OVERLAP |
| COTH | GRAPHIC SET WRAP | PROGRESSBAR SET STEP | XPRINT GET PAGES |
| CQUAD | GRAPHIC STYLE | PROGRESSBAR STEP | XPRINT GET PAPER |
| CSC | GRAPHIC TEXT SIZE | PUT | XPRINT GET PAPERS |
| CSCH | GRAPHIC WIDTH | PUT STR | XPRINT GET PIXEL |
| CSET$ | HEADER GET COUNT | PUT WSTR | XPRINT GET POS |
| CSNG | HEADER GET ITEM | PUT$ | XPRINT GET PPI |
| CSTR | HEADER SEND | PUT$$ | XPRINT GET QUALITY |
| CULNG | HEADER SET ITEM | QUAD | XPRINT GET SCALE |
| CURDIR | HEX | RAISEEVENT | XPRINT GET SELECTION |
| CURDIR$ | HEX$ | READ | XPRINT GET SIZE |
| CVBYT | HI | READ$ | XPRINT GET STRETCHMODE |
| CVCUX | HIWRD | REDIM | XPRINT GET TEXTALIGN |
| CVDWD | HYPOT | REMAIN | XPRINT GET TRAY |
| CVL | IIF | REMAIN$ | XPRINT GET TRAYS |
| CVQ | IMAGELIST ADD BITMAP | REMOVE | XPRINT GET WORDWRAP |
| CVW | IMAGELIST ADD ICON | REMOVE$ | XPRINT GET WRAP |
| CWORD | IMAGELIST ADD MASKED | REPEAT | XPRINT IMAGELIST |
| DATACOUNT | IMAGELIST COUNT | REPEAT$ | XPRINT LINE |
| DAYNAME | IMAGELIST GET COUNT | RESOURCE SAVE FILE | XPRINT PIE |
| DAYNAME$ | IMAGELIST KILL | RESOURCE$ | XPRINT POLYGON |
| DEC | IMAGELIST NEW | RETAIN | XPRINT POLYLINE |
| DEC$ | IMAGELIST NEW BITMAP | RETAIN$ | XPRINT PREVIEW |
| DECLARE | IMAGELIST NEW ICON | RGB | XPRINT PRINT |
| DEF | IMAGELIST SET OVERLAY | RIGHT | XPRINT RENDER |
| DESKTOP GET PPI | IMP | RIGHT$ | XPRINT SCALE |
| DIALOG DEFAULT FONT | INPUT# | RND | XPRINT SET CLIP |
| DIALOG DISABLE | INSTANCE | ROUND | XPRINT SET COLLATE |
| DIALOG DOEVENTS | INSTR | RSET$ | XPRINT SET COLOR |
| DIALOG ENABLE | INT | RTRIM | XPRINT SET COLORMODE |
| DIALOG END | INTEGER | RTRIM$ | XPRINT SET COPIES |
| DIALOG GET CLIENT | ISEVEN | SCROLLBAR GET PAGESIZE | XPRINT SET DUPLEX |
| DIALOG GET LOC | ISFALSE | SCROLLBAR GET POS | XPRINT SET FONT |
| DIALOG GET SIZE | ISFILE | SCROLLBAR GET RANGE | XPRINT SET MIX |
| DIALOG GET TEXT | ISFOLDER | SCROLLBAR GET TRACKPOS | XPRINT SET ORIENTATION |
| DIALOG GET USER | ISINFINITE | SCROLLBAR SET PAGESIZE | XPRINT SET OVERLAP |
| DIALOG HIDE | ISNORMAL | SCROLLBAR SET POS | XPRINT SET PAGES |
| DIALOG MAXIMIZE | ISODD | SCROLLBAR SET RANGE | XPRINT SET PAPER |
| DIALOG MINIMIZE | ISTRUE | SEC | XPRINT SET PIXEL |
| DIALOG NEW | ISWIN | SECH | XPRINT SET POS |
| DIALOG NONSTABLE | JOIN$ | SEEK | XPRINT SET QUALITY |
| DIALOG NORMALIZE | LCASE | SETEOF | XPRINT SET STRETCHMODE |
| DIALOG PIXELS | LCASE$ | SGN | XPRINT SET TEXTALIGN |
| DIALOG POST | LEFT | SHRINK | XPRINT SET TRAY |
| DIALOG REDRAW | LEFT$ | SHRINK$ | XPRINT SET WORDWRAP |
| DIALOG SEND | LEN | SIN | XPRINT SET WRAP |
| DIALOG SET CLIENT | LET *(WITH OBJECTS)* | SINGLE | XPRINT SPLIT |
| DIALOG SET COLOR | LET *(WITH VARIANTS)* | SINH | XPRINT STRETCH |
| DIALOG SET ICON | LINE INPUT# | SIZEOF | XPRINT STYLE |
| DIALOG SET LOC | LISTBOX ADD | SPACE | XPRINT TEXT SIZE |
| DIALOG SET SIZE | LISTBOX DELETE | SPACE$ | XPRINT WIDTH |
| DIALOG SET TEXT | LISTBOX FIND | SQR |  |
