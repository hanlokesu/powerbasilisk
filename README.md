...
> Summary:
> - **795** official PowerBASIC statement/function keywords currently available for use
>   - **647** implemented or completed by this fork
...
> - **60** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 174 (v0.2.031). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 795 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DIALOG ENABLE | HEX | MKE | TCP OPEN |
| ACCEL ATTACH | DIALOG END | HEX$ | MKE$ | TCP PRINT |
| ACODE | DIALOG GET CLIENT | HI | MKI$ | TCP RECV |
| ACODE$ | DIALOG GET LOC | HIWRD | MKL$ | TCP SEND |
| ACOS | DIALOG GET SIZE | HOST ADDR | MKQ$ | THREAD CLOSE |
| ACOSH | DIALOG GET TEXT | HOST NAME | MKS | THREAD CREATE |
| AND | DIALOG GET USER | HYPOT | MKS$ | THREAD GET PRIORITY |
| ARRAY ADD | DIALOG HIDE | IF | MKWRD | THREAD RESUME |
| ARRAY ARRAYIX | DIALOG MAXIMIZE | IF/END IF | MKWRD$ | THREAD SET PRIORITY |
| ARRAY ASSIGN | DIALOG MINIMIZE | IIF | MOD | THREAD STATUS |
| ARRAY COPY | DIALOG NEW | IMAGELIST ADD BITMAP | MONTHNAME | THREAD SUSPEND |
| ARRAY DELETE | DIALOG NONSTABLE | IMAGELIST ADD ICON | MONTHNAME$ | THREADCOUNT |
| ARRAY INSERT | DIALOG NORMALIZE | IMAGELIST ADD MASKED | MOUSEPTR | THREADED |
| ARRAY REDIM DECR | DIALOG PIXELS | IMAGELIST COUNT | MSGBOX | THREADID |
| ARRAY REDIM INCR | DIALOG POST | IMAGELIST GET COUNT | NAME | TIMER |
| ARRAY REVERSE | DIALOG REDRAW | IMAGELIST KILL | NOT | TIX |
| ARRAY SCAN | DIALOG SEND | IMAGELIST NEW | NUL | TOOLBAR ADD BUTTON |
| ARRAY SHUFFLE | DIALOG SET CLIENT | IMAGELIST NEW BITMAP | NUL$ | TOOLBAR ADD SEPARATOR |
| ARRAY SORT | DIALOG SET COLOR | IMAGELIST NEW ICON | OBJECT | TOOLBAR DELETE BUTTON |
| ARRAY SWAP | DIALOG SET ICON | IMAGELIST SET OVERLAY | OCT | TOOLBAR GET COUNT |
| ARRAY TAGARRAY | DIALOG SET LOC | IMP | OCT$ | TOOLBAR GET STATE |
| ARRAY TAGARRAY ERASE | DIALOG SET SIZE | IMPORT | OEMTOCHR | TOOLBAR SET IMAGELIST |
| ARRAY UNIQUE | DIALOG SET TEXT | INCR | OEMTOCHR$ | TOOLBAR SET STATE |
| ASC | DIALOG SET USER | INPUT FLUSH | ON CALL | TRACE |
| ASIN | DIALOG SHOW MODAL | INPUT# | ON ERROR | TREEVIEW DELETE |
| ASINH | DIALOG SHOW MODELESS | INSTANCE | ON GOSUB | TREEVIEW GET BOLD |
| ASM | DIALOG SHOW STATE | INSTR | ON GOTO | TREEVIEW GET CHECK |
| ASMDATA / END ASMDATA | DIALOG STABILIZE | INT | OPEN | TREEVIEW GET CHILD |
| ATANH | DIALOG UNITS | INTEGER | OPTION EXPLICIT | TREEVIEW GET COUNT |
| ATN | DIM | INTERFACE / END INTERFACE (DIRECT) | OR | TREEVIEW GET EXPANDED |
| ATN2 | DIR | INTERFACE/END INTERFACE (IDBIND) | PARSE | TREEVIEW GET NEXT |
| BEEP | DIR CLOSE | ISEVEN | PARSE$ | TREEVIEW GET PARENT |
| BGR | DIR$ | ISFALSE | PARSECOUNT | TREEVIEW GET PREVIOUS |
| BIN | DISKFREE | ISFILE | PATHNAME | TREEVIEW GET ROOT |
| BIN$ | DISKSIZE | ISFOLDER | PATHNAME$ | TREEVIEW GET SELECT |
| BIT | DISPLAY BROWSE | ISINFINITE | PATHSCAN | TREEVIEW GET TEXT |
| BIT CALC | DISPLAY COLOR | ISNORMAL | PATHSCAN$ | TREEVIEW GET USER |
| BITS | DISPLAY FONT | ISODD | PEEK | TREEVIEW INSERT ITEM |
| BITS$ | DISPLAY OPENFILE | ISTRUE | PLAY | TREEVIEW RESET |
| BITSE | DISPLAY SAVEFILE | ISWIN | PLAY SOUND | TREEVIEW SELECT |
| BUILD | DOUBLE | ITERATE | PLAY WAVE | TREEVIEW SET BOLD |
| BUILD$ | END | JOIN$ | POKE | TREEVIEW SET CHECK |
| BYTE | ENVIRON | KILL | PREFIX | TREEVIEW SET EXPANDED |
| CALL | ENVIRON$ | LCASE | PRINT# | TREEVIEW SET IMAGELIST |
| CALL DWORD | EOF | LCASE$ | PRINTER$ | TREEVIEW SET TEXT |
| CALLSTK | EQV | LEFT | PRINTERCOUNT | TREEVIEW SET USER |
| CALLSTK$ | ERASE | LEFT$ | PROCESS GET PRIORITY | TREEVIEW UNSELECT |
| CALLSTKCOUNT | ERF | LEN | PROCESS SET PRIORITY | TRIM |
| CBOOL | ERL | LET | PROFILE | TRIM$ |
| CBRT | ERL$ | LET *(WITH OBJECTS)* | PROGRESSBAR GET POS | TRUNC |
| CBYTE | ERR | LET *(WITH TYPES)* | PROGRESSBAR GET RANGE | TRY/END TRY |
| CDBL | ERRCLEAR | LET *(WITH VARIANTS)* | PROGRESSBAR SET POS | TYPE SET |
| CDWORD | ERROR | LINE INPUT# | PROGRESSBAR SET RANGE | TYPE/END TYPE |
| CEIL | ERROR$ | LISTBOX ADD | PROGRESSBAR SET STEP | UCASE |
| CFLT | EVENT SOURCE | LISTBOX DELETE | PROGRESSBAR STEP | UCASE$ |
| CHDIR | EVENTS | LISTBOX FIND | PUT | UCODE$ |
| CHDRIVE | EXE | LISTBOX FIND EXACT | PUT STR | UCODEPAGE |
| CHOOSE | EXIST | LISTBOX GET COUNT | PUT WSTR | UDP CLOSE |
| CHR | EXIT | LISTBOX GET SELCOUNT | PUT$ | UDP NOTIFY |
| CHR$ | EXP | LISTBOX GET SELECT | PUT$$ | UDP OPEN |
| CHRBYTES | EXP10 | LISTBOX GET STATE | QUAD | UDP RECV |
| CHRTOOEM | EXP2 | LISTBOX GET TEXT | RAISEEVENT | UDP SEND |
| CHRTOOEM$ | EXPM1 | LISTBOX GET USER | RANDOMIZE | UNLOCK |
| CHRTOUTF8 | EXTRACT | LISTBOX INSERT | READ | UNWRAP |
| CHRTOUTF8$ | EXTRACT$ | LISTBOX RESET | READ$ | UNWRAP$ |
| CLASS/END CLASS | FIELD | LISTBOX SELECT | REDIM | USING |
| CLIP | FILEATTR | LISTBOX SET TEXT | REGEXPR | USING$ |
| CLIP$ | FILECOPY | LISTBOX SET USER | REGISTER | UTF8TOCHR |
| CLIPBOARD | FILENAME | LISTBOX UNSELECT | REGREPL | UTF8TOCHR$ |
| CLOSE | FILENAME$ | LISTVIEW DELETE COLUMN | REM | VAL |
| CLS | FILESCAN | LISTVIEW DELETE ITEM | REMAIN | VARPTR |
| CODEPTR | FIX | LISTVIEW FIND | REMAIN$ | VERIFY |
| COLOR | FLOOR | LISTVIEW FIND EXACT | REMOVE | WAITKEY |
| COMBOBOX ADD | FLUSH | LISTVIEW FIT CONTENT | REMOVE$ | WAITKEY$ |
| COMBOBOX DELETE | FONT END | LISTVIEW FIT HEADER | REPEAT | WINDOW GET |
| COMBOBOX FIND | FONT NEW | LISTVIEW GET COLUMN | REPEAT$ | WINDOW SET |
| COMBOBOX FIND EXACT | FOR / NEXT | LISTVIEW GET COUNT | REPLACE | WORD |
| COMBOBOX GET COUNT | FORMAT | LISTVIEW GET HEADER | RESET | WRAP |
| COMBOBOX GET SELCOUNT | FORMAT$ | LISTVIEW GET HEADERID | RESOURCE SAVE FILE | WRAP$ |
| COMBOBOX GET SELECT | FRAC | LISTVIEW GET MODE | RESOURCE$ | WRITE |
| COMBOBOX GET STATE | FRE | LISTVIEW GET SELCOUNT | RESUME | WRITE# |
| COMBOBOX GET TEXT | FREEFILE | LISTVIEW GET SELECT | RETAIN | XOR |
| COMBOBOX GET USER | FUNCNAME | LISTVIEW GET STATE | RETAIN$ | XPRINT ARC |
| COMBOBOX INSERT | FUNCNAME$ | LISTVIEW GET STYLEXX | RETURN | XPRINT ATTACH |
| COMBOBOX RESET | FUNCTION / END FUNCTION | LISTVIEW GET TEXT | RGB | XPRINT BOX |
| COMBOBOX SELECT | GET | LISTVIEW GET USER | RIGHT | XPRINT CANCEL |
| COMBOBOX SET TEXT | GET STR | LISTVIEW INSERT COLUMN | RIGHT$ | XPRINT CELL |
| COMBOBOX SET USER | GET WSTR | LISTVIEW INSERT ITEM | RMDIR | XPRINT CELL SIZE |
| COMBOBOX UNSELECT | GET$ | LISTVIEW RESET | RND | XPRINT CHR SIZE |
| COMM CLOSE | GET$$ | LISTVIEW SELECT | ROTATE | XPRINT CLOSE |
| COMM LINE | GETATTR | LISTVIEW SET COLUMN | ROUND | XPRINT COLOR |
| COMM LINE INPUT | GLOBAL | LISTVIEW SET HEADER | RSET | XPRINT COPY |
| COMM OPEN | GLOBALMEM | LISTVIEW SET IMAGE | RSET$ | XPRINT ELLIPSE |
| COMM PRINT | GRAPHIC ARC | LISTVIEW SET IMAGE2 | RTRIM | XPRINT FORMFEED |
| COMM RECV | GRAPHIC ATTACH | LISTVIEW SET IMAGELIST | RTRIM$ | XPRINT GET ATTACH |
| COMM RESET | GRAPHIC BITMAP END | LISTVIEW SET MODE | SCROLLBAR GET PAGESIZE | XPRINT GET CANVAS |
| COMM SEND | GRAPHIC BITMAP LOAD | LISTVIEW SET OVERLAY | SCROLLBAR GET POS | XPRINT GET CLIENT |
| COMM SET | GRAPHIC BITMAP NEW | LISTVIEW SET STYLEXX | SCROLLBAR GET RANGE | XPRINT GET CLIP |
| COMM TIMEOUT | GRAPHIC BOX | LISTVIEW SET TEXT | SCROLLBAR GET TRACKPOS | XPRINT GET COLLATE |
| COMMAND | GRAPHIC CELL | LISTVIEW SET USER | SCROLLBAR SET PAGESIZE | XPRINT GET COLOR |
| COMMAND$ | GRAPHIC CELL SIZE | LISTVIEW SORT | SCROLLBAR SET POS | XPRINT GET COLORMODE |
| CONTROL ADD | GRAPHIC CHR SIZE | LISTVIEW UNSELECT | SCROLLBAR SET RANGE | XPRINT GET COPIES |
| CONTROL ADD BUTTON | GRAPHIC CIRCLE | LISTVIEW VISIBLE | SEC | XPRINT GET DC |
| CONTROL ADD CHECKBOX | GRAPHIC CLEAR | LO | SECH | XPRINT GET DUPLEX |
| CONTROL ADD COMBOBOX | GRAPHIC COLOR | LOC | SEEK | XPRINT GET LINES |
| CONTROL ADD LABEL | GRAPHIC COPY | LOCAL | SELECT CASE/END SELECT | XPRINT GET MARGIN |
| CONTROL ADD LISTBOX | GRAPHIC DETACH | LOCK | SETATTR | XPRINT GET MIX |
| CONTROL ADD LISTVIEW | GRAPHIC ELLIPSE | LOF | SETEOF | XPRINT GET ORIENTATION |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET BITS | LOG | SGN | XPRINT GET OVERLAP |
| CONTROL ADD SCROLLBAR | GRAPHIC GET CANVAS | LOG10 | SHELL | XPRINT GET PAGES |
| CONTROL ADD STATUSBAR | GRAPHIC GET CAPTION | LOG1P | SHIFT | XPRINT GET PAPER |
| CONTROL ADD TAB | GRAPHIC GET CLIENT | LOG2 | SHRINK | XPRINT GET PAPERS |
| CONTROL ADD TOOLBAR | GRAPHIC GET CLIP | LONG | SHRINK$ | XPRINT GET PIXEL |
| CONTROL ADD TREEVIEW | GRAPHIC GET DC | LOWRD | SIN | XPRINT GET POS |
| CONTROL DISABLE | GRAPHIC GET LINES | LPRINT | SINGLE | XPRINT GET PPI |
| CONTROL ENABLE | GRAPHIC GET LOC | LPRINT ATTACH | SINH | XPRINT GET QUALITY |
| CONTROL GET CHECK | GRAPHIC GET MIX | LPRINT CLOSE | SIZEOF | XPRINT GET SCALE |
| CONTROL GET TEXT | GRAPHIC GET PIXEL | LPRINT FLUSH | SLEEP | XPRINT GET SELECTION |
| CONTROL HIDE | GRAPHIC GET POS | LPRINT FORMFEED | SPACE | XPRINT GET SIZE |
| CONTROL KILL | GRAPHIC GET PPI | LPRINT$ | SPACE$ | XPRINT GET STRETCHMODE |
| CONTROL SET CHECK | GRAPHIC GET SCALE | LSET | SPLIT | XPRINT GET TEXTALIGN |
| CONTROL SET TEXT | GRAPHIC GET SIZE | LSET$ | SQR | XPRINT GET TRAY |
| COS | GRAPHIC GET STRETCHMODE | LTRIM | STATIC | XPRINT GET TRAYS |
| COSH | GRAPHIC GET TEXTALIGN | LTRIM$ | STATUSBAR SET PARTS | XPRINT GET WORDWRAP |
| COT | GRAPHIC GET VIEW | MACRO/END MACRO | STATUSBAR SET TEXT | XPRINT GET WRAP |
| COTH | GRAPHIC GET WORDWRAP | MAK | STR | XPRINT IMAGELIST |
| CQUAD | GRAPHIC GET WRAP | MAT | STR$ | XPRINT LINE |
| CSC | GRAPHIC LINE | MAX | STRDELETE | XPRINT PIE |
| CSCH | GRAPHIC PAINT | MCASE | STRDELETE$ | XPRINT POLYGON |
| CSET | GRAPHIC PIE | MCASE$ | STRING | XPRINT POLYLINE |
| CSET$ | GRAPHIC POLYGON | MEMORY | STRINSERT | XPRINT PREVIEW |
| CSNG | GRAPHIC POLYLINE | MEMORY FILL | STRINSERT$ | XPRINT PRINT |
| CSTR | GRAPHIC PRINT | MEMORY FILLS | STRPTR | XPRINT RENDER |
| CULNG | GRAPHIC SAVE | MENU ADD POPUP | STRREVERSE | XPRINT SCALE |
| CURDIR | GRAPHIC SCALE | MENU ADD STRING | STRREVERSE$ | XPRINT SET CLIP |
| CURDIR$ | GRAPHIC SCALE PIXELS | MENU ATTACH | SWAP | XPRINT SET COLLATE |
| CVBYT | GRAPHIC SET AUTOSIZE | MENU CONTEXT | SWITCH | XPRINT SET COLOR |
| CVCUX | GRAPHIC SET BITS | MENU DELETE | SWITCH$ | XPRINT SET COLORMODE |
| CVDWD | GRAPHIC SET CAPTION | MENU DRAW BAR | TAB DELETE | XPRINT SET COPIES |
| CVL | GRAPHIC SET CLIP | MENU GET STATE | TAB GET COUNT | XPRINT SET DUPLEX |
| CVQ | GRAPHIC SET FIXED | MENU GET TEXT | TAB GET DIALOG | XPRINT SET FONT |
| CVW | GRAPHIC SET FONT | MENU NEW BAR | TAB GET IMAGE | XPRINT SET MIX |
| CWORD | GRAPHIC SET MIX | MENU NEW POPUP | TAB GET PAGE | XPRINT SET ORIENTATION |
| DATA | GRAPHIC SET PIXEL | MENU SET STATE | TAB GET SELECT | XPRINT SET OVERLAP |
| DATACOUNT | GRAPHIC SET POS | MENU SET TEXT | TAB GET TEXT | XPRINT SET PAGES |
| DAYNAME | GRAPHIC SET SIZE | METHOD / END METHOD | TAB INSERT PAGE | XPRINT SET PAPER |
| DAYNAME$ | GRAPHIC SET STRETCHMODE | METRICS | TAB RESET | XPRINT SET PIXEL |
| DEC | GRAPHIC SET TEXTALIGN | MID | TAB SELECT | XPRINT SET POS |
| DEC$ | GRAPHIC SET VIEW | MID$ | TAB SET IMAGE | XPRINT SET QUALITY |
| DECLARE | GRAPHIC SET VIRTUAL | MIN | TAB SET IMAGELIST | XPRINT SET STRETCHMODE |
| DECR | GRAPHIC SET WORDWRAP | MKBYT | TAB SET TEXT | XPRINT SET TEXTALIGN |
| DEF | GRAPHIC SET WRAP | MKBYT$ | TAB$ | XPRINT SET TRAY |
| DESKTOP GET CLIENT | GRAPHIC STYLE | MKCUR$ | TALLY | XPRINT SET WORDWRAP |
| DESKTOP GET LOC | GRAPHIC TEXT SIZE | MKCUX | TAN | XPRINT SET WRAP |
| DESKTOP GET PPI | GRAPHIC WIDTH | MKCUX$ | TANH | XPRINT SPLIT |
| DESKTOP GET SIZE | HEADER GET COUNT | MKD$ | TCP ACCEPT | XPRINT STRETCH |
| DIALOG DEFAULT FONT | HEADER GET ITEM | MKDIR | TCP CLOSE | XPRINT STYLE |
| DIALOG DISABLE | HEADER SEND | MKDWD | TCP LINE INPUT | XPRINT TEXT SIZE |
| DIALOG DOEVENTS | HEADER SET ITEM | MKDWD$ | TCP NOTIFY | XPRINT WIDTH |

## **Newly** implemented by this branch

> **647 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DISPLAY BROWSE | LISTBOX RESET | STRDELETE |
| ACCEL ATTACH | DISPLAY COLOR | LISTBOX SELECT | STRDELETE$ |
| ACODE | DISPLAY FONT | LISTBOX SET TEXT | STRING |
| ACODE$ | DISPLAY OPENFILE | LISTBOX SET USER | STRINSERT |
| ACOS | DISPLAY SAVEFILE | LISTBOX UNSELECT | STRINSERT$ |
| ACOSH | DOUBLE | LISTVIEW DELETE COLUMN | STRPTR |
| ARRAY ADD | ENVIRON$ | LISTVIEW DELETE ITEM | STRREVERSE |
| ARRAY ARRAYIX | EOF | LISTVIEW FIND | STRREVERSE$ |
| ARRAY ASSIGN | EQV | LISTVIEW FIND EXACT | SWITCH |
| ARRAY COPY | ERF | LISTVIEW FIT CONTENT | SWITCH$ |
| ARRAY DELETE | ERL | LISTVIEW FIT HEADER | TAB DELETE |
| ARRAY INSERT | ERL$ | LISTVIEW GET COLUMN | TAB GET COUNT |
| ARRAY REDIM DECR | ERR | LISTVIEW GET COUNT | TAB GET DIALOG |
| ARRAY REDIM INCR | ERRCLEAR | LISTVIEW GET HEADER | TAB GET IMAGE |
| ARRAY REVERSE | ERROR$ | LISTVIEW GET HEADERID | TAB GET PAGE |
| ARRAY SCAN | EVENT SOURCE | LISTVIEW GET MODE | TAB GET SELECT |
| ARRAY SHUFFLE | EVENTS | LISTVIEW GET SELCOUNT | TAB GET TEXT |
| ARRAY SWAP | EXE | LISTVIEW GET SELECT | TAB INSERT PAGE |
| ARRAY TAGARRAY | EXIST | LISTVIEW GET STATE | TAB RESET |
| ARRAY TAGARRAY ERASE | EXP | LISTVIEW GET STYLEXX | TAB SELECT |
| ARRAY UNIQUE | EXP10 | LISTVIEW GET TEXT | TAB SET IMAGE |
| ASIN | EXP2 | LISTVIEW GET USER | TAB SET IMAGELIST |
| ASINH | EXPM1 | LISTVIEW INSERT COLUMN | TAB SET TEXT |
| ATANH | EXTRACT | LISTVIEW INSERT ITEM | TAB$ |
| ATN | EXTRACT$ | LISTVIEW RESET | TALLY |
| ATN2 | FILEATTR | LISTVIEW SELECT | TAN |
| BGR | FILENAME | LISTVIEW SET COLUMN | TANH |
| BIN | FILENAME$ | LISTVIEW SET HEADER | TCP NOTIFY |
| BIN$ | FIX | LISTVIEW SET IMAGE | THREADCOUNT |
| BITS | FLOOR | LISTVIEW SET IMAGE2 | THREADID |
| BITS$ | FONT END | LISTVIEW SET IMAGELIST | TIMER |
| BITSE | FONT NEW | LISTVIEW SET MODE | TOOLBAR ADD BUTTON |
| BUILD | FORMAT | LISTVIEW SET OVERLAY | TOOLBAR ADD SEPARATOR |
| BUILD$ | FORMAT$ | LISTVIEW SET STYLEXX | TOOLBAR DELETE BUTTON |
| BYTE | FRAC | LISTVIEW SET TEXT | TOOLBAR GET COUNT |
| CALLSTK$ | FRE | LISTVIEW SET USER | TOOLBAR GET STATE |
| CALLSTKCOUNT | FREEFILE | LISTVIEW SORT | TOOLBAR SET IMAGELIST |
| CBOOL | FUNCNAME | LISTVIEW UNSELECT | TOOLBAR SET STATE |
| CBRT | FUNCNAME$ | LISTVIEW VISIBLE | TREEVIEW DELETE |
| CBYTE | GET | LO | TREEVIEW GET BOLD |
| CDBL | GET STR | LOC | TREEVIEW GET CHECK |
| CDWORD | GET WSTR | LOF | TREEVIEW GET CHILD |
| CEIL | GET$ | LOG | TREEVIEW GET COUNT |
| CFLT | GET$$ | LOG10 | TREEVIEW GET EXPANDED |
| CHOOSE | GETATTR | LOG1P | TREEVIEW GET NEXT |
| CHR | GRAPHIC ARC | LOG2 | TREEVIEW GET PARENT |
| CHR$ | GRAPHIC ATTACH | LONG | TREEVIEW GET PREVIOUS |
| CHRBYTES | GRAPHIC BITMAP END | LOWRD | TREEVIEW GET ROOT |
| CHRTOOEM | GRAPHIC BITMAP LOAD | LPRINT$ | TREEVIEW GET SELECT |
| CHRTOOEM$ | GRAPHIC BITMAP NEW | LSET$ | TREEVIEW GET TEXT |
| CHRTOUTF8 | GRAPHIC BOX | LTRIM | TREEVIEW GET USER |
| CHRTOUTF8$ | GRAPHIC CELL | LTRIM$ | TREEVIEW INSERT ITEM |
| CLIP | GRAPHIC CELL SIZE | MAK | TREEVIEW RESET |
| CLIP$ | GRAPHIC CHR SIZE | MAX | TREEVIEW SELECT |
| CLOSE | GRAPHIC CIRCLE | MCASE | TREEVIEW SET BOLD |
| CODEPTR | GRAPHIC CLEAR | MCASE$ | TREEVIEW SET CHECK |
| COMBOBOX ADD | GRAPHIC COLOR | MEMORY FILL | TREEVIEW SET EXPANDED |
| COMBOBOX DELETE | GRAPHIC COPY | MEMORY FILLS | TREEVIEW SET IMAGELIST |
| COMBOBOX FIND | GRAPHIC DETACH | MENU ADD POPUP | TREEVIEW SET TEXT |
| COMBOBOX FIND EXACT | GRAPHIC ELLIPSE | MENU ADD STRING | TREEVIEW SET USER |
| COMBOBOX GET COUNT | GRAPHIC GET BITS | MENU ATTACH | TREEVIEW UNSELECT |
| COMBOBOX GET SELCOUNT | GRAPHIC GET CANVAS | MENU CONTEXT | TRIM |
| COMBOBOX GET SELECT | GRAPHIC GET CAPTION | MENU DELETE | TRIM$ |
| COMBOBOX GET STATE | GRAPHIC GET CLIENT | MENU DRAW BAR | TRUNC |
| COMBOBOX GET TEXT | GRAPHIC GET CLIP | MENU GET STATE | UCASE |
| COMBOBOX GET USER | GRAPHIC GET DC | MENU GET TEXT | UCASE$ |
| COMBOBOX INSERT | GRAPHIC GET LINES | MENU NEW BAR | UCODE$ |
| COMBOBOX RESET | GRAPHIC GET LOC | MENU NEW POPUP | UCODEPAGE |
| COMBOBOX SELECT | GRAPHIC GET MIX | MENU SET STATE | UDP NOTIFY |
| COMBOBOX SET TEXT | GRAPHIC GET PIXEL | MENU SET TEXT | UNWRAP |
| COMBOBOX SET USER | GRAPHIC GET POS | METRICS | UNWRAP$ |
| COMBOBOX UNSELECT | GRAPHIC GET PPI | MID | USING |
| COMM LINE INPUT | GRAPHIC GET SCALE | MIN | USING$ |
| COMMAND | GRAPHIC GET SIZE | MKBYT | UTF8TOCHR |
| COMMAND$ | GRAPHIC GET STRETCHMODE | MKCUX | UTF8TOCHR$ |
| CONTROL ADD | GRAPHIC GET TEXTALIGN | MKDWD | VARPTR |
| CONTROL ADD BUTTON | GRAPHIC GET VIEW | MKE | VERIFY |
| CONTROL ADD CHECKBOX | GRAPHIC GET WORDWRAP | MKS | WAITKEY |
| CONTROL ADD COMBOBOX | GRAPHIC GET WRAP | MKWRD | WAITKEY$ |
| CONTROL ADD LABEL | GRAPHIC LINE | MOD | WORD |
| CONTROL ADD LISTBOX | GRAPHIC PAINT | MONTHNAME | WRAP |
| CONTROL ADD LISTVIEW | GRAPHIC PIE | MONTHNAME$ | WRAP$ |
| CONTROL ADD PROGRESSBAR | GRAPHIC POLYGON | NUL$ | WRITE |
| CONTROL ADD SCROLLBAR | GRAPHIC POLYLINE | OCT | WRITE# |
| CONTROL ADD STATUSBAR | GRAPHIC PRINT | OCT$ | XPRINT ARC |
| CONTROL ADD TAB | GRAPHIC SAVE | OEMTOCHR | XPRINT ATTACH |
| CONTROL ADD TOOLBAR | GRAPHIC SCALE | OEMTOCHR$ | XPRINT BOX |
| CONTROL ADD TREEVIEW | GRAPHIC SCALE PIXELS | ON CALL | XPRINT CANCEL |
| CONTROL DISABLE | GRAPHIC SET AUTOSIZE | ON GOSUB | XPRINT CELL |
| CONTROL ENABLE | GRAPHIC SET BITS | ON GOTO | XPRINT CELL SIZE |
| CONTROL GET CHECK | GRAPHIC SET CAPTION | OPEN | XPRINT CHR SIZE |
| CONTROL GET TEXT | GRAPHIC SET CLIP | PARSE$ | XPRINT CLOSE |
| CONTROL HIDE | GRAPHIC SET FIXED | PARSECOUNT | XPRINT COLOR |
| CONTROL KILL | GRAPHIC SET FONT | PATHNAME | XPRINT COPY |
| CONTROL SET CHECK | GRAPHIC SET MIX | PATHNAME$ | XPRINT ELLIPSE |
| CONTROL SET TEXT | GRAPHIC SET PIXEL | PATHSCAN | XPRINT FORMFEED |
| COS | GRAPHIC SET POS | PATHSCAN$ | XPRINT GET ATTACH |
| COSH | GRAPHIC SET SIZE | PEEK | XPRINT GET CANVAS |
| COT | GRAPHIC SET STRETCHMODE | PLAY | XPRINT GET CLIENT |
| COTH | GRAPHIC SET TEXTALIGN | PLAY SOUND | XPRINT GET CLIP |
| CQUAD | GRAPHIC SET VIEW | POKE | XPRINT GET COLLATE |
| CSC | GRAPHIC SET VIRTUAL | PRINTER$ | XPRINT GET COLOR |
| CSCH | GRAPHIC SET WORDWRAP | PRINTERCOUNT | XPRINT GET COLORMODE |
| CSET$ | GRAPHIC SET WRAP | PROGRESSBAR GET POS | XPRINT GET COPIES |
| CSNG | GRAPHIC STYLE | PROGRESSBAR GET RANGE | XPRINT GET DC |
| CSTR | GRAPHIC TEXT SIZE | PROGRESSBAR SET POS | XPRINT GET DUPLEX |
| CULNG | GRAPHIC WIDTH | PROGRESSBAR SET RANGE | XPRINT GET LINES |
| CURDIR | HEADER GET COUNT | PROGRESSBAR SET STEP | XPRINT GET MARGIN |
| CURDIR$ | HEADER GET ITEM | PROGRESSBAR STEP | XPRINT GET MIX |
| CVBYT | HEADER SEND | PUT | XPRINT GET ORIENTATION |
| CVCUX | HEADER SET ITEM | PUT STR | XPRINT GET OVERLAP |
| CVDWD | HEX | PUT WSTR | XPRINT GET PAGES |
| CVL | HEX$ | PUT$ | XPRINT GET PAPER |
| CVQ | HI | PUT$$ | XPRINT GET PAPERS |
| CVW | HIWRD | QUAD | XPRINT GET PIXEL |
| CWORD | HYPOT | RAISEEVENT | XPRINT GET POS |
| DATACOUNT | IIF | READ | XPRINT GET PPI |
| DAYNAME | IMAGELIST ADD BITMAP | READ$ | XPRINT GET QUALITY |
| DAYNAME$ | IMAGELIST ADD ICON | REDIM | XPRINT GET SCALE |
| DEC | IMAGELIST ADD MASKED | REMAIN | XPRINT GET SELECTION |
| DEC$ | IMAGELIST COUNT | REMAIN$ | XPRINT GET SIZE |
| DECLARE | IMAGELIST GET COUNT | REMOVE | XPRINT GET STRETCHMODE |
| DEF | IMAGELIST KILL | REMOVE$ | XPRINT GET TEXTALIGN |
| DESKTOP GET PPI | IMAGELIST NEW | REPEAT | XPRINT GET TRAY |
| DIALOG DEFAULT FONT | IMAGELIST NEW BITMAP | REPEAT$ | XPRINT GET TRAYS |
| DIALOG DISABLE | IMAGELIST NEW ICON | RESOURCE SAVE FILE | XPRINT GET WORDWRAP |
| DIALOG DOEVENTS | IMAGELIST SET OVERLAY | RESOURCE$ | XPRINT GET WRAP |
| DIALOG ENABLE | IMP | RETAIN | XPRINT IMAGELIST |
| DIALOG END | INPUT# | RETAIN$ | XPRINT LINE |
| DIALOG GET CLIENT | INSTANCE | RGB | XPRINT PIE |
| DIALOG GET LOC | INSTR | RIGHT | XPRINT POLYGON |
| DIALOG GET SIZE | INT | RIGHT$ | XPRINT POLYLINE |
| DIALOG GET TEXT | INTEGER | RND | XPRINT PREVIEW |
| DIALOG GET USER | ISEVEN | ROUND | XPRINT PRINT |
| DIALOG HIDE | ISFALSE | RSET$ | XPRINT RENDER |
| DIALOG MAXIMIZE | ISFILE | RTRIM | XPRINT SCALE |
| DIALOG MINIMIZE | ISFOLDER | RTRIM$ | XPRINT SET CLIP |
| DIALOG NEW | ISINFINITE | SCROLLBAR GET PAGESIZE | XPRINT SET COLLATE |
| DIALOG NONSTABLE | ISNORMAL | SCROLLBAR GET POS | XPRINT SET COLOR |
| DIALOG NORMALIZE | ISODD | SCROLLBAR GET RANGE | XPRINT SET COLORMODE |
| DIALOG PIXELS | ISTRUE | SCROLLBAR GET TRACKPOS | XPRINT SET COPIES |
| DIALOG POST | ISWIN | SCROLLBAR SET PAGESIZE | XPRINT SET DUPLEX |
| DIALOG REDRAW | JOIN$ | SCROLLBAR SET POS | XPRINT SET FONT |
| DIALOG SEND | LCASE | SCROLLBAR SET RANGE | XPRINT SET MIX |
| DIALOG SET CLIENT | LCASE$ | SEC | XPRINT SET ORIENTATION |
| DIALOG SET COLOR | LEFT | SECH | XPRINT SET OVERLAP |
| DIALOG SET ICON | LEFT$ | SEEK | XPRINT SET PAGES |
| DIALOG SET LOC | LEN | SETEOF | XPRINT SET PAPER |
| DIALOG SET SIZE | LET *(WITH OBJECTS)* | SGN | XPRINT SET PIXEL |
| DIALOG SET TEXT | LET *(WITH VARIANTS)* | SHRINK | XPRINT SET POS |
| DIALOG SET USER | LINE INPUT# | SHRINK$ | XPRINT SET QUALITY |
| DIALOG SHOW MODAL | LISTBOX ADD | SIN | XPRINT SET STRETCHMODE |
| DIALOG SHOW MODELESS | LISTBOX DELETE | SINGLE | XPRINT SET TEXTALIGN |
| DIALOG SHOW STATE | LISTBOX FIND | SINH | XPRINT SET TRAY |
| DIALOG STABILIZE | LISTBOX FIND EXACT | SIZEOF | XPRINT SET WORDWRAP |
| DIALOG UNITS | LISTBOX GET COUNT | SPACE | XPRINT SET WRAP |
| DIM | LISTBOX GET SELCOUNT | SPACE$ | XPRINT SPLIT |
| DIR | LISTBOX GET SELECT | SQR | XPRINT STRETCH |
| DIR CLOSE | LISTBOX GET STATE | STATUSBAR SET PARTS | XPRINT STYLE |
| DIR$ | LISTBOX GET TEXT | STATUSBAR SET TEXT | XPRINT TEXT SIZE |
| DISKFREE | LISTBOX GET USER | STR | XPRINT WIDTH |
| DISKSIZE | LISTBOX INSERT | STR$ |  |
