...
> Summary:
> - **828** official PowerBASIC statement/function keywords currently available for use
>   - **680** implemented or completed by this fork
...
> - **27** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 179 (v0.2.036). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 828 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | CULNG | GRAPHIC SET FIXED | MID | TANH |
| ACCEL ATTACH | CURDIR | GRAPHIC SET FONT | MID$ | TCP ACCEPT |
| ACODE | CURDIR$ | GRAPHIC SET MIX | MIN | TCP CLOSE |
| ACODE$ | CVBYT | GRAPHIC SET PIXEL | MKBYT | TCP LINE INPUT |
| ACOS | CVCUX | GRAPHIC SET POS | MKBYT$ | TCP NOTIFY |
| ACOSH | CVDWD | GRAPHIC SET SIZE | MKCUR$ | TCP OPEN |
| AND | CVL | GRAPHIC SET STRETCHMODE | MKCUX | TCP PRINT |
| ARRAY ADD | CVQ | GRAPHIC SET TEXTALIGN | MKCUX$ | TCP RECV |
| ARRAY ARRAYIX | CVW | GRAPHIC SET VIEW | MKD$ | TCP SEND |
| ARRAY ASSIGN | CWORD | GRAPHIC SET VIRTUAL | MKDIR | THREAD CLOSE |
| ARRAY COPY | DATA | GRAPHIC SET WORDWRAP | MKDWD | THREAD CREATE |
| ARRAY DELETE | DATACOUNT | GRAPHIC SET WRAP | MKDWD$ | THREAD GET PRIORITY |
| ARRAY INSERT | DAYNAME | GRAPHIC STYLE | MKE | THREAD RESUME |
| ARRAY REDIM DECR | DAYNAME$ | GRAPHIC TEXT SIZE | MKE$ | THREAD SET PRIORITY |
| ARRAY REDIM INCR | DEC | GRAPHIC WIDTH | MKI$ | THREAD STATUS |
| ARRAY REVERSE | DEC$ | HEADER GET COUNT | MKL$ | THREAD SUSPEND |
| ARRAY SCAN | DECLARE | HEADER GET ITEM | MKQ$ | THREADCOUNT |
| ARRAY SHUFFLE | DECR | HEADER SEND | MKS | THREADED |
| ARRAY SORT | DEF | HEADER SET ITEM | MKS$ | THREADID |
| ARRAY SWAP | DESKTOP GET CLIENT | HEX | MKWRD | TIMER |
| ARRAY TAGARRAY | DESKTOP GET LOC | HEX$ | MKWRD$ | TIX |
| ARRAY TAGARRAY ERASE | DESKTOP GET PPI | HI | MOD | TOOLBAR ADD BUTTON |
| ARRAY UNIQUE | DESKTOP GET SIZE | HIWRD | MONTHNAME | TOOLBAR ADD SEPARATOR |
| ASC | DIALOG DEFAULT FONT | HOST ADDR | MONTHNAME$ | TOOLBAR DELETE BUTTON |
| ASIN | DIALOG DISABLE | HOST NAME | MOUSEPTR | TOOLBAR GET COUNT |
| ASINH | DIALOG DOEVENTS | HYPOT | MSGBOX | TOOLBAR GET STATE |
| ASM | DIALOG ENABLE | IF | NAME | TOOLBAR SET IMAGELIST |
| ASMDATA / END ASMDATA | DIALOG END | IF/END IF | NOT | TOOLBAR SET STATE |
| ATANH | DIALOG GET CLIENT | IIF | NUL | TRACE |
| ATN | DIALOG GET LOC | IMAGELIST ADD BITMAP | NUL$ | TREEVIEW DELETE |
| ATN2 | DIALOG GET SIZE | IMAGELIST ADD ICON | OBJECT | TREEVIEW GET BOLD |
| BEEP | DIALOG GET TEXT | IMAGELIST ADD MASKED | OCT | TREEVIEW GET CHECK |
| BGR | DIALOG GET USER | IMAGELIST COUNT | OCT$ | TREEVIEW GET CHILD |
| BIN | DIALOG HIDE | IMAGELIST GET COUNT | OEMTOCHR | TREEVIEW GET COUNT |
| BIN$ | DIALOG MAXIMIZE | IMAGELIST KILL | OEMTOCHR$ | TREEVIEW GET EXPANDED |
| BIT | DIALOG MINIMIZE | IMAGELIST NEW | ON CALL | TREEVIEW GET NEXT |
| BIT CALC | DIALOG NEW | IMAGELIST NEW BITMAP | ON ERROR | TREEVIEW GET PARENT |
| BITS | DIALOG NONSTABLE | IMAGELIST NEW ICON | ON GOSUB | TREEVIEW GET PREVIOUS |
| BITS$ | DIALOG NORMALIZE | IMAGELIST SET OVERLAY | ON GOTO | TREEVIEW GET ROOT |
| BITSE | DIALOG PIXELS | IMP | OPEN | TREEVIEW GET SELECT |
| BUILD | DIALOG POST | IMPORT | OPTION EXPLICIT | TREEVIEW GET TEXT |
| BUILD$ | DIALOG REDRAW | INCR | OR | TREEVIEW GET USER |
| BYTE | DIALOG SEND | INPUT FLUSH | PARSE | TREEVIEW INSERT ITEM |
| CALL | DIALOG SET CLIENT | INPUT# | PARSE$ | TREEVIEW RESET |
| CALL DWORD | DIALOG SET COLOR | INSTANCE | PARSECOUNT | TREEVIEW SELECT |
| CALLSTK | DIALOG SET ICON | INSTR | PATHNAME | TREEVIEW SET BOLD |
| CALLSTK$ | DIALOG SET LOC | INT | PATHNAME$ | TREEVIEW SET CHECK |
| CALLSTKCOUNT | DIALOG SET SIZE | INTEGER | PATHSCAN | TREEVIEW SET EXPANDED |
| CBOOL | DIALOG SET TEXT | INTERFACE / END INTERFACE (DIRECT) | PATHSCAN$ | TREEVIEW SET IMAGELIST |
| CBRT | DIALOG SET USER | INTERFACE/END INTERFACE (IDBIND) | PEEK | TREEVIEW SET TEXT |
| CBYTE | DIALOG SHOW MODAL | ISEVEN | PLAY | TREEVIEW SET USER |
| CDBL | DIALOG SHOW MODELESS | ISFALSE | PLAY SOUND | TREEVIEW UNSELECT |
| CDWORD | DIALOG SHOW STATE | ISFILE | PLAY WAVE | TRIM |
| CEIL | DIALOG STABILIZE | ISFOLDER | POKE | TRIM$ |
| CFLT | DIALOG UNITS | ISINFINITE | PREFIX | TRUNC |
| CHDIR | DIM | ISNORMAL | PRINT# | TRY/END TRY |
| CHDRIVE | DIR | ISODD | PRINTER$ | TYPE SET |
| CHOOSE | DIR CLOSE | ISTRUE | PRINTERCOUNT | TYPE/END TYPE |
| CHR | DIR$ | ISWIN | PROCESS GET PRIORITY | UCASE |
| CHR$ | DISKFREE | ITERATE | PROCESS SET PRIORITY | UCASE$ |
| CHRBYTES | DISKSIZE | JOIN$ | PROFILE | UCODE$ |
| CHRTOOEM | DISPLAY BROWSE | KILL | PROGRESSBAR GET POS | UCODEPAGE |
| CHRTOOEM$ | DISPLAY COLOR | LCASE | PROGRESSBAR GET RANGE | UDP CLOSE |
| CHRTOUTF8 | DISPLAY FONT | LCASE$ | PROGRESSBAR SET POS | UDP NOTIFY |
| CHRTOUTF8$ | DISPLAY OPENFILE | LEFT | PROGRESSBAR SET RANGE | UDP OPEN |
| CLASS/END CLASS | DISPLAY SAVEFILE | LEFT$ | PROGRESSBAR SET STEP | UDP RECV |
| CLIP | DOUBLE | LEN | PROGRESSBAR STEP | UDP SEND |
| CLIP$ | END | LET | PUT | UNLOCK |
| CLIPBOARD | ENVIRON | LET *(WITH OBJECTS)* | PUT STR | UNWRAP |
| CLOSE | ENVIRON$ | LET *(WITH TYPES)* | PUT WSTR | UNWRAP$ |
| CLS | EOF | LET *(WITH VARIANTS)* | PUT$ | USING |
| CODEPTR | EQV | LINE INPUT# | PUT$$ | USING$ |
| COLOR | ERASE | LISTBOX ADD | QUAD | UTF8TOCHR |
| COMBOBOX ADD | ERF | LISTBOX DELETE | RAISEEVENT | UTF8TOCHR$ |
| COMBOBOX DELETE | ERL | LISTBOX FIND | RANDOMIZE | VAL |
| COMBOBOX FIND | ERL$ | LISTBOX FIND EXACT | READ | VARPTR |
| COMBOBOX FIND EXACT | ERR | LISTBOX GET COUNT | READ$ | VERIFY |
| COMBOBOX GET COUNT | ERRCLEAR | LISTBOX GET SELCOUNT | REDIM | WAITKEY |
| COMBOBOX GET SELCOUNT | ERROR | LISTBOX GET SELECT | REGEXPR | WAITKEY$ |
| COMBOBOX GET SELECT | ERROR$ | LISTBOX GET STATE | REGISTER | WINDOW GET |
| COMBOBOX GET STATE | EVENT SOURCE | LISTBOX GET TEXT | REGREPL | WINDOW SET |
| COMBOBOX GET TEXT | EVENTS | LISTBOX GET USER | REM | WORD |
| COMBOBOX GET USER | EXE | LISTBOX INSERT | REMAIN | WRAP |
| COMBOBOX INSERT | EXIST | LISTBOX RESET | REMAIN$ | WRAP$ |
| COMBOBOX RESET | EXIT | LISTBOX SELECT | REMOVE | WRITE |
| COMBOBOX SELECT | EXP | LISTBOX SET TEXT | REMOVE$ | WRITE# |
| COMBOBOX SET TEXT | EXP10 | LISTBOX SET USER | REPEAT | XOR |
| COMBOBOX SET USER | EXP2 | LISTBOX UNSELECT | REPEAT$ | XPRINT ARC |
| COMBOBOX UNSELECT | EXPM1 | LISTVIEW DELETE COLUMN | REPLACE | XPRINT ATTACH |
| COMM CLOSE | EXTRACT | LISTVIEW DELETE ITEM | RESET | XPRINT BOX |
| COMM LINE | EXTRACT$ | LISTVIEW FIND | RESOURCE SAVE FILE | XPRINT CANCEL |
| COMM LINE INPUT | FIELD | LISTVIEW FIND EXACT | RESOURCE$ | XPRINT CELL |
| COMM OPEN | FILEATTR | LISTVIEW FIT CONTENT | RESUME | XPRINT CELL SIZE |
| COMM PRINT | FILECOPY | LISTVIEW FIT HEADER | RETAIN | XPRINT CHR SIZE |
| COMM RECV | FILENAME | LISTVIEW GET COLUMN | RETAIN$ | XPRINT CLOSE |
| COMM RESET | FILENAME$ | LISTVIEW GET COUNT | RETURN | XPRINT COLOR |
| COMM SEND | FILESCAN | LISTVIEW GET HEADER | RGB | XPRINT COPY |
| COMM SET | FIX | LISTVIEW GET HEADERID | RIGHT | XPRINT ELLIPSE |
| COMM TIMEOUT | FLOOR | LISTVIEW GET MODE | RIGHT$ | XPRINT FORMFEED |
| COMMAND | FLUSH | LISTVIEW GET SELCOUNT | RMDIR | XPRINT GET ATTACH |
| COMMAND$ | FONT END | LISTVIEW GET SELECT | RND | XPRINT GET CANVAS |
| CONTROL ADD | FONT NEW | LISTVIEW GET STATE | ROTATE | XPRINT GET CLIENT |
| CONTROL ADD BUTTON | FOR / NEXT | LISTVIEW GET STYLEXX | ROUND | XPRINT GET CLIP |
| CONTROL ADD CHECK3STATE | FORMAT | LISTVIEW GET TEXT | RSET | XPRINT GET COLLATE |
| CONTROL ADD CHECKBOX | FORMAT$ | LISTVIEW GET USER | RSET$ | XPRINT GET COLOR |
| CONTROL ADD COMBOBOX | FRAC | LISTVIEW INSERT COLUMN | RTRIM | XPRINT GET COLORMODE |
| CONTROL ADD FRAME | FRE | LISTVIEW INSERT ITEM | RTRIM$ | XPRINT GET COPIES |
| CONTROL ADD GRAPHIC | FREEFILE | LISTVIEW RESET | SCROLLBAR GET PAGESIZE | XPRINT GET DC |
| CONTROL ADD HEADER | FUNCNAME | LISTVIEW SELECT | SCROLLBAR GET POS | XPRINT GET DUPLEX |
| CONTROL ADD IMAGE | FUNCNAME$ | LISTVIEW SET COLUMN | SCROLLBAR GET RANGE | XPRINT GET LINES |
| CONTROL ADD IMAGEX | FUNCTION / END FUNCTION | LISTVIEW SET HEADER | SCROLLBAR GET TRACKPOS | XPRINT GET MARGIN |
| CONTROL ADD IMGBUTTON | GET | LISTVIEW SET IMAGE | SCROLLBAR SET PAGESIZE | XPRINT GET MIX |
| CONTROL ADD IMGBUTTONX | GET STR | LISTVIEW SET IMAGE2 | SCROLLBAR SET POS | XPRINT GET ORIENTATION |
| CONTROL ADD LABEL | GET WSTR | LISTVIEW SET IMAGELIST | SCROLLBAR SET RANGE | XPRINT GET OVERLAP |
| CONTROL ADD LINE | GET$ | LISTVIEW SET MODE | SEC | XPRINT GET PAGES |
| CONTROL ADD LISTBOX | GET$$ | LISTVIEW SET OVERLAY | SECH | XPRINT GET PAPER |
| CONTROL ADD LISTVIEW | GETATTR | LISTVIEW SET STYLEXX | SEEK | XPRINT GET PAPERS |
| CONTROL ADD OPTION | GLOBAL | LISTVIEW SET TEXT | SELECT CASE/END SELECT | XPRINT GET PIXEL |
| CONTROL ADD PROGRESSBAR | GLOBALMEM | LISTVIEW SET USER | SETATTR | XPRINT GET POS |
| CONTROL ADD SCROLLBAR | GRAPHIC ARC | LISTVIEW SORT | SETEOF | XPRINT GET PPI |
| CONTROL ADD STATUSBAR | GRAPHIC ATTACH | LISTVIEW UNSELECT | SGN | XPRINT GET QUALITY |
| CONTROL ADD TAB | GRAPHIC BITMAP END | LISTVIEW VISIBLE | SHELL | XPRINT GET SCALE |
| CONTROL ADD TEXTBOX | GRAPHIC BITMAP LOAD | LO | SHIFT | XPRINT GET SELECTION |
| CONTROL ADD TOOLBAR | GRAPHIC BITMAP NEW | LOC | SHRINK | XPRINT GET SIZE |
| CONTROL ADD TREEVIEW | GRAPHIC BOX | LOCAL | SHRINK$ | XPRINT GET STRETCHMODE |
| CONTROL DISABLE | GRAPHIC CELL | LOCK | SIN | XPRINT GET TEXTALIGN |
| CONTROL ENABLE | GRAPHIC CELL SIZE | LOF | SINGLE | XPRINT GET TRAY |
| CONTROL GET CHECK | GRAPHIC CHR SIZE | LOG | SINH | XPRINT GET TRAYS |
| CONTROL GET CLIENT | GRAPHIC CIRCLE | LOG10 | SIZEOF | XPRINT GET WORDWRAP |
| CONTROL GET LOC | GRAPHIC CLEAR | LOG1P | SLEEP | XPRINT GET WRAP |
| CONTROL GET SIZE | GRAPHIC COLOR | LOG2 | SPACE | XPRINT IMAGELIST |
| CONTROL GET TEXT | GRAPHIC COPY | LONG | SPACE$ | XPRINT LINE |
| CONTROL GET USER | GRAPHIC DETACH | LOWRD | SPLIT | XPRINT PIE |
| CONTROL HANDLE | GRAPHIC ELLIPSE | LPRINT | SQR | XPRINT POLYGON |
| CONTROL HIDE | GRAPHIC GET BITS | LPRINT ATTACH | STATIC | XPRINT POLYLINE |
| CONTROL KILL | GRAPHIC GET CANVAS | LPRINT CLOSE | STATUSBAR SET PARTS | XPRINT PREVIEW |
| CONTROL NORMALIZE | GRAPHIC GET CAPTION | LPRINT FLUSH | STATUSBAR SET TEXT | XPRINT PRINT |
| CONTROL POST | GRAPHIC GET CLIENT | LPRINT FORMFEED | STR | XPRINT RENDER |
| CONTROL REDRAW | GRAPHIC GET CLIP | LPRINT$ | STR$ | XPRINT SCALE |
| CONTROL SEND | GRAPHIC GET DC | LSET | STRDELETE | XPRINT SET CLIP |
| CONTROL SET CHECK | GRAPHIC GET LINES | LSET$ | STRDELETE$ | XPRINT SET COLLATE |
| CONTROL SET CLIENT | GRAPHIC GET LOC | LTRIM | STRING | XPRINT SET COLOR |
| CONTROL SET COLOR | GRAPHIC GET MIX | LTRIM$ | STRINSERT | XPRINT SET COLORMODE |
| CONTROL SET FOCUS | GRAPHIC GET PIXEL | MACRO/END MACRO | STRINSERT$ | XPRINT SET COPIES |
| CONTROL SET FONT | GRAPHIC GET POS | MAK | STRPTR | XPRINT SET DUPLEX |
| CONTROL SET IMAGE | GRAPHIC GET PPI | MAT | STRREVERSE | XPRINT SET FONT |
| CONTROL SET IMAGEX | GRAPHIC GET SCALE | MAX | STRREVERSE$ | XPRINT SET MIX |
| CONTROL SET IMGBUTTON | GRAPHIC GET SIZE | MCASE | SWAP | XPRINT SET ORIENTATION |
| CONTROL SET IMGBUTTONX | GRAPHIC GET STRETCHMODE | MCASE$ | SWITCH | XPRINT SET OVERLAP |
| CONTROL SET LOC | GRAPHIC GET TEXTALIGN | MEMORY | SWITCH$ | XPRINT SET PAGES |
| CONTROL SET OPTION | GRAPHIC GET VIEW | MEMORY FILL | TAB DELETE | XPRINT SET PAPER |
| CONTROL SET SIZE | GRAPHIC GET WORDWRAP | MEMORY FILLS | TAB GET COUNT | XPRINT SET PIXEL |
| CONTROL SET TEXT | GRAPHIC GET WRAP | MENU ADD POPUP | TAB GET DIALOG | XPRINT SET POS |
| CONTROL SET USER | GRAPHIC LINE | MENU ADD STRING | TAB GET IMAGE | XPRINT SET QUALITY |
| CONTROL SHOW STATE | GRAPHIC PAINT | MENU ATTACH | TAB GET PAGE | XPRINT SET STRETCHMODE |
| COS | GRAPHIC PIE | MENU CONTEXT | TAB GET SELECT | XPRINT SET TEXTALIGN |
| COSH | GRAPHIC POLYGON | MENU DELETE | TAB GET TEXT | XPRINT SET TRAY |
| COT | GRAPHIC POLYLINE | MENU DRAW BAR | TAB INSERT PAGE | XPRINT SET WORDWRAP |
| COTH | GRAPHIC PRINT | MENU GET STATE | TAB RESET | XPRINT SET WRAP |
| CQUAD | GRAPHIC SAVE | MENU GET TEXT | TAB SELECT | XPRINT SPLIT |
| CSC | GRAPHIC SCALE | MENU NEW BAR | TAB SET IMAGE | XPRINT STRETCH |
| CSCH | GRAPHIC SCALE PIXELS | MENU NEW POPUP | TAB SET IMAGELIST | XPRINT STYLE |
| CSET | GRAPHIC SET AUTOSIZE | MENU SET STATE | TAB SET TEXT | XPRINT TEXT SIZE |
| CSET$ | GRAPHIC SET BITS | MENU SET TEXT | TAB$ | XPRINT WIDTH |
| CSNG | GRAPHIC SET CAPTION | METHOD / END METHOD | TALLY |  |
| CSTR | GRAPHIC SET CLIP | METRICS | TAN |  |

## **Newly** implemented by this branch

> **680 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG NEW | LEFT | SINH |
| ACCEL ATTACH | DIALOG NONSTABLE | LEFT$ | SIZEOF |
| ACODE | DIALOG NORMALIZE | LEN | SPACE |
| ACODE$ | DIALOG PIXELS | LET *(WITH OBJECTS)* | SPACE$ |
| ACOS | DIALOG POST | LET *(WITH VARIANTS)* | SQR |
| ACOSH | DIALOG REDRAW | LINE INPUT# | STATUSBAR SET PARTS |
| ARRAY ADD | DIALOG SEND | LISTBOX ADD | STATUSBAR SET TEXT |
| ARRAY ARRAYIX | DIALOG SET CLIENT | LISTBOX DELETE | STR |
| ARRAY ASSIGN | DIALOG SET COLOR | LISTBOX FIND | STR$ |
| ARRAY COPY | DIALOG SET ICON | LISTBOX FIND EXACT | STRDELETE |
| ARRAY DELETE | DIALOG SET LOC | LISTBOX GET COUNT | STRDELETE$ |
| ARRAY INSERT | DIALOG SET SIZE | LISTBOX GET SELCOUNT | STRING |
| ARRAY REDIM DECR | DIALOG SET TEXT | LISTBOX GET SELECT | STRINSERT |
| ARRAY REDIM INCR | DIALOG SET USER | LISTBOX GET STATE | STRINSERT$ |
| ARRAY REVERSE | DIALOG SHOW MODAL | LISTBOX GET TEXT | STRPTR |
| ARRAY SCAN | DIALOG SHOW MODELESS | LISTBOX GET USER | STRREVERSE |
| ARRAY SHUFFLE | DIALOG SHOW STATE | LISTBOX INSERT | STRREVERSE$ |
| ARRAY SWAP | DIALOG STABILIZE | LISTBOX RESET | SWITCH |
| ARRAY TAGARRAY | DIALOG UNITS | LISTBOX SELECT | SWITCH$ |
| ARRAY TAGARRAY ERASE | DIM | LISTBOX SET TEXT | TAB DELETE |
| ARRAY UNIQUE | DIR | LISTBOX SET USER | TAB GET COUNT |
| ASIN | DIR CLOSE | LISTBOX UNSELECT | TAB GET DIALOG |
| ASINH | DIR$ | LISTVIEW DELETE COLUMN | TAB GET IMAGE |
| ATANH | DISKFREE | LISTVIEW DELETE ITEM | TAB GET PAGE |
| ATN | DISKSIZE | LISTVIEW FIND | TAB GET SELECT |
| ATN2 | DISPLAY BROWSE | LISTVIEW FIND EXACT | TAB GET TEXT |
| BGR | DISPLAY COLOR | LISTVIEW FIT CONTENT | TAB INSERT PAGE |
| BIN | DISPLAY FONT | LISTVIEW FIT HEADER | TAB RESET |
| BIN$ | DISPLAY OPENFILE | LISTVIEW GET COLUMN | TAB SELECT |
| BITS | DISPLAY SAVEFILE | LISTVIEW GET COUNT | TAB SET IMAGE |
| BITS$ | DOUBLE | LISTVIEW GET HEADER | TAB SET IMAGELIST |
| BITSE | ENVIRON$ | LISTVIEW GET HEADERID | TAB SET TEXT |
| BUILD | EOF | LISTVIEW GET MODE | TAB$ |
| BUILD$ | EQV | LISTVIEW GET SELCOUNT | TALLY |
| BYTE | ERF | LISTVIEW GET SELECT | TAN |
| CALLSTK$ | ERL | LISTVIEW GET STATE | TANH |
| CALLSTKCOUNT | ERL$ | LISTVIEW GET STYLEXX | TCP NOTIFY |
| CBOOL | ERR | LISTVIEW GET TEXT | THREADCOUNT |
| CBRT | ERRCLEAR | LISTVIEW GET USER | THREADID |
| CBYTE | ERROR$ | LISTVIEW INSERT COLUMN | TIMER |
| CDBL | EVENT SOURCE | LISTVIEW INSERT ITEM | TOOLBAR ADD BUTTON |
| CDWORD | EVENTS | LISTVIEW RESET | TOOLBAR ADD SEPARATOR |
| CEIL | EXE | LISTVIEW SELECT | TOOLBAR DELETE BUTTON |
| CFLT | EXIST | LISTVIEW SET COLUMN | TOOLBAR GET COUNT |
| CHOOSE | EXP | LISTVIEW SET HEADER | TOOLBAR GET STATE |
| CHR | EXP10 | LISTVIEW SET IMAGE | TOOLBAR SET IMAGELIST |
| CHR$ | EXP2 | LISTVIEW SET IMAGE2 | TOOLBAR SET STATE |
| CHRBYTES | EXPM1 | LISTVIEW SET IMAGELIST | TREEVIEW DELETE |
| CHRTOOEM | EXTRACT | LISTVIEW SET MODE | TREEVIEW GET BOLD |
| CHRTOOEM$ | EXTRACT$ | LISTVIEW SET OVERLAY | TREEVIEW GET CHECK |
| CHRTOUTF8 | FILEATTR | LISTVIEW SET STYLEXX | TREEVIEW GET CHILD |
| CHRTOUTF8$ | FILENAME | LISTVIEW SET TEXT | TREEVIEW GET COUNT |
| CLIP | FILENAME$ | LISTVIEW SET USER | TREEVIEW GET EXPANDED |
| CLIP$ | FIX | LISTVIEW SORT | TREEVIEW GET NEXT |
| CLOSE | FLOOR | LISTVIEW UNSELECT | TREEVIEW GET PARENT |
| CODEPTR | FONT END | LISTVIEW VISIBLE | TREEVIEW GET PREVIOUS |
| COMBOBOX ADD | FONT NEW | LO | TREEVIEW GET ROOT |
| COMBOBOX DELETE | FORMAT | LOC | TREEVIEW GET SELECT |
| COMBOBOX FIND | FORMAT$ | LOF | TREEVIEW GET TEXT |
| COMBOBOX FIND EXACT | FRAC | LOG | TREEVIEW GET USER |
| COMBOBOX GET COUNT | FRE | LOG10 | TREEVIEW INSERT ITEM |
| COMBOBOX GET SELCOUNT | FREEFILE | LOG1P | TREEVIEW RESET |
| COMBOBOX GET SELECT | FUNCNAME | LOG2 | TREEVIEW SELECT |
| COMBOBOX GET STATE | FUNCNAME$ | LONG | TREEVIEW SET BOLD |
| COMBOBOX GET TEXT | GET | LOWRD | TREEVIEW SET CHECK |
| COMBOBOX GET USER | GET STR | LPRINT$ | TREEVIEW SET EXPANDED |
| COMBOBOX INSERT | GET WSTR | LSET$ | TREEVIEW SET IMAGELIST |
| COMBOBOX RESET | GET$ | LTRIM | TREEVIEW SET TEXT |
| COMBOBOX SELECT | GET$$ | LTRIM$ | TREEVIEW SET USER |
| COMBOBOX SET TEXT | GETATTR | MAK | TREEVIEW UNSELECT |
| COMBOBOX SET USER | GRAPHIC ARC | MAX | TRIM |
| COMBOBOX UNSELECT | GRAPHIC ATTACH | MCASE | TRIM$ |
| COMM LINE INPUT | GRAPHIC BITMAP END | MCASE$ | TRUNC |
| COMMAND | GRAPHIC BITMAP LOAD | MEMORY FILL | UCASE |
| COMMAND$ | GRAPHIC BITMAP NEW | MEMORY FILLS | UCASE$ |
| CONTROL ADD | GRAPHIC BOX | MENU ADD POPUP | UCODE$ |
| CONTROL ADD BUTTON | GRAPHIC CELL | MENU ADD STRING | UCODEPAGE |
| CONTROL ADD CHECK3STATE | GRAPHIC CELL SIZE | MENU ATTACH | UDP NOTIFY |
| CONTROL ADD CHECKBOX | GRAPHIC CHR SIZE | MENU CONTEXT | UNWRAP |
| CONTROL ADD COMBOBOX | GRAPHIC CIRCLE | MENU DELETE | UNWRAP$ |
| CONTROL ADD FRAME | GRAPHIC CLEAR | MENU DRAW BAR | USING |
| CONTROL ADD GRAPHIC | GRAPHIC COLOR | MENU GET STATE | USING$ |
| CONTROL ADD HEADER | GRAPHIC COPY | MENU GET TEXT | UTF8TOCHR |
| CONTROL ADD IMAGE | GRAPHIC DETACH | MENU NEW BAR | UTF8TOCHR$ |
| CONTROL ADD IMAGEX | GRAPHIC ELLIPSE | MENU NEW POPUP | VARPTR |
| CONTROL ADD IMGBUTTON | GRAPHIC GET BITS | MENU SET STATE | VERIFY |
| CONTROL ADD IMGBUTTONX | GRAPHIC GET CANVAS | MENU SET TEXT | WAITKEY |
| CONTROL ADD LABEL | GRAPHIC GET CAPTION | METRICS | WAITKEY$ |
| CONTROL ADD LINE | GRAPHIC GET CLIENT | MID | WORD |
| CONTROL ADD LISTBOX | GRAPHIC GET CLIP | MIN | WRAP |
| CONTROL ADD LISTVIEW | GRAPHIC GET DC | MKBYT | WRAP$ |
| CONTROL ADD OPTION | GRAPHIC GET LINES | MKCUX | WRITE |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET LOC | MKDWD | WRITE# |
| CONTROL ADD SCROLLBAR | GRAPHIC GET MIX | MKE | XPRINT ARC |
| CONTROL ADD STATUSBAR | GRAPHIC GET PIXEL | MKS | XPRINT ATTACH |
| CONTROL ADD TAB | GRAPHIC GET POS | MKWRD | XPRINT BOX |
| CONTROL ADD TEXTBOX | GRAPHIC GET PPI | MOD | XPRINT CANCEL |
| CONTROL ADD TOOLBAR | GRAPHIC GET SCALE | MONTHNAME | XPRINT CELL |
| CONTROL ADD TREEVIEW | GRAPHIC GET SIZE | MONTHNAME$ | XPRINT CELL SIZE |
| CONTROL DISABLE | GRAPHIC GET STRETCHMODE | NUL$ | XPRINT CHR SIZE |
| CONTROL ENABLE | GRAPHIC GET TEXTALIGN | OCT | XPRINT CLOSE |
| CONTROL GET CHECK | GRAPHIC GET VIEW | OCT$ | XPRINT COLOR |
| CONTROL GET CLIENT | GRAPHIC GET WORDWRAP | OEMTOCHR | XPRINT COPY |
| CONTROL GET LOC | GRAPHIC GET WRAP | OEMTOCHR$ | XPRINT ELLIPSE |
| CONTROL GET SIZE | GRAPHIC LINE | ON CALL | XPRINT FORMFEED |
| CONTROL GET TEXT | GRAPHIC PAINT | ON GOSUB | XPRINT GET ATTACH |
| CONTROL GET USER | GRAPHIC PIE | ON GOTO | XPRINT GET CANVAS |
| CONTROL HANDLE | GRAPHIC POLYGON | OPEN | XPRINT GET CLIENT |
| CONTROL HIDE | GRAPHIC POLYLINE | PARSE$ | XPRINT GET CLIP |
| CONTROL KILL | GRAPHIC PRINT | PARSECOUNT | XPRINT GET COLLATE |
| CONTROL NORMALIZE | GRAPHIC SAVE | PATHNAME | XPRINT GET COLOR |
| CONTROL POST | GRAPHIC SCALE | PATHNAME$ | XPRINT GET COLORMODE |
| CONTROL REDRAW | GRAPHIC SCALE PIXELS | PATHSCAN | XPRINT GET COPIES |
| CONTROL SEND | GRAPHIC SET AUTOSIZE | PATHSCAN$ | XPRINT GET DC |
| CONTROL SET CHECK | GRAPHIC SET BITS | PEEK | XPRINT GET DUPLEX |
| CONTROL SET CLIENT | GRAPHIC SET CAPTION | PLAY | XPRINT GET LINES |
| CONTROL SET COLOR | GRAPHIC SET CLIP | PLAY SOUND | XPRINT GET MARGIN |
| CONTROL SET FOCUS | GRAPHIC SET FIXED | POKE | XPRINT GET MIX |
| CONTROL SET FONT | GRAPHIC SET FONT | PRINTER$ | XPRINT GET ORIENTATION |
| CONTROL SET IMAGE | GRAPHIC SET MIX | PRINTERCOUNT | XPRINT GET OVERLAP |
| CONTROL SET IMAGEX | GRAPHIC SET PIXEL | PROGRESSBAR GET POS | XPRINT GET PAGES |
| CONTROL SET IMGBUTTON | GRAPHIC SET POS | PROGRESSBAR GET RANGE | XPRINT GET PAPER |
| CONTROL SET IMGBUTTONX | GRAPHIC SET SIZE | PROGRESSBAR SET POS | XPRINT GET PAPERS |
| CONTROL SET LOC | GRAPHIC SET STRETCHMODE | PROGRESSBAR SET RANGE | XPRINT GET PIXEL |
| CONTROL SET OPTION | GRAPHIC SET TEXTALIGN | PROGRESSBAR SET STEP | XPRINT GET POS |
| CONTROL SET SIZE | GRAPHIC SET VIEW | PROGRESSBAR STEP | XPRINT GET PPI |
| CONTROL SET TEXT | GRAPHIC SET VIRTUAL | PUT | XPRINT GET QUALITY |
| CONTROL SET USER | GRAPHIC SET WORDWRAP | PUT STR | XPRINT GET SCALE |
| CONTROL SHOW STATE | GRAPHIC SET WRAP | PUT WSTR | XPRINT GET SELECTION |
| COS | GRAPHIC STYLE | PUT$ | XPRINT GET SIZE |
| COSH | GRAPHIC TEXT SIZE | PUT$$ | XPRINT GET STRETCHMODE |
| COT | GRAPHIC WIDTH | QUAD | XPRINT GET TEXTALIGN |
| COTH | HEADER GET COUNT | RAISEEVENT | XPRINT GET TRAY |
| CQUAD | HEADER GET ITEM | READ | XPRINT GET TRAYS |
| CSC | HEADER SEND | READ$ | XPRINT GET WORDWRAP |
| CSCH | HEADER SET ITEM | REDIM | XPRINT GET WRAP |
| CSET$ | HEX | REMAIN | XPRINT IMAGELIST |
| CSNG | HEX$ | REMAIN$ | XPRINT LINE |
| CSTR | HI | REMOVE | XPRINT PIE |
| CULNG | HIWRD | REMOVE$ | XPRINT POLYGON |
| CURDIR | HYPOT | REPEAT | XPRINT POLYLINE |
| CURDIR$ | IIF | REPEAT$ | XPRINT PREVIEW |
| CVBYT | IMAGELIST ADD BITMAP | RESOURCE SAVE FILE | XPRINT PRINT |
| CVCUX | IMAGELIST ADD ICON | RESOURCE$ | XPRINT RENDER |
| CVDWD | IMAGELIST ADD MASKED | RETAIN | XPRINT SCALE |
| CVL | IMAGELIST COUNT | RETAIN$ | XPRINT SET CLIP |
| CVQ | IMAGELIST GET COUNT | RGB | XPRINT SET COLLATE |
| CVW | IMAGELIST KILL | RIGHT | XPRINT SET COLOR |
| CWORD | IMAGELIST NEW | RIGHT$ | XPRINT SET COLORMODE |
| DATACOUNT | IMAGELIST NEW BITMAP | RND | XPRINT SET COPIES |
| DAYNAME | IMAGELIST NEW ICON | ROUND | XPRINT SET DUPLEX |
| DAYNAME$ | IMAGELIST SET OVERLAY | RSET$ | XPRINT SET FONT |
| DEC | IMP | RTRIM | XPRINT SET MIX |
| DEC$ | INPUT# | RTRIM$ | XPRINT SET ORIENTATION |
| DECLARE | INSTANCE | SCROLLBAR GET PAGESIZE | XPRINT SET OVERLAP |
| DEF | INSTR | SCROLLBAR GET POS | XPRINT SET PAGES |
| DESKTOP GET PPI | INT | SCROLLBAR GET RANGE | XPRINT SET PAPER |
| DIALOG DEFAULT FONT | INTEGER | SCROLLBAR GET TRACKPOS | XPRINT SET PIXEL |
| DIALOG DISABLE | ISEVEN | SCROLLBAR SET PAGESIZE | XPRINT SET POS |
| DIALOG DOEVENTS | ISFALSE | SCROLLBAR SET POS | XPRINT SET QUALITY |
| DIALOG ENABLE | ISFILE | SCROLLBAR SET RANGE | XPRINT SET STRETCHMODE |
| DIALOG END | ISFOLDER | SEC | XPRINT SET TEXTALIGN |
| DIALOG GET CLIENT | ISINFINITE | SECH | XPRINT SET TRAY |
| DIALOG GET LOC | ISNORMAL | SEEK | XPRINT SET WORDWRAP |
| DIALOG GET SIZE | ISODD | SETEOF | XPRINT SET WRAP |
| DIALOG GET TEXT | ISTRUE | SGN | XPRINT SPLIT |
| DIALOG GET USER | ISWIN | SHRINK | XPRINT STRETCH |
| DIALOG HIDE | JOIN$ | SHRINK$ | XPRINT STYLE |
| DIALOG MAXIMIZE | LCASE | SIN | XPRINT TEXT SIZE |
| DIALOG MINIMIZE | LCASE$ | SINGLE | XPRINT WIDTH |
...
- **Counts**: 857 rows, **680** implemented by this fork (682 CSV Implemented rows, including 2 fork extensions), 148 established, 0 not implemented, **27** Tier-3, **830** available.
