...
> Summary:
> - **769** official PowerBASIC statement/function keywords currently available for use
>   - **621** implemented or completed by this fork
...
> - **86** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 170 (v0.2.027). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 769 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DESKTOP GET PPI | GRAPHIC SET VIRTUAL | MKCUR$ | TAB SELECT |
| ACCEL ATTACH | DESKTOP GET SIZE | GRAPHIC SET WORDWRAP | MKCUX | TAB SET IMAGE |
| ACODE | DIALOG DEFAULT FONT | GRAPHIC SET WRAP | MKCUX$ | TAB SET IMAGELIST |
| ACODE$ | DIALOG DISABLE | GRAPHIC STYLE | MKD$ | TAB SET TEXT |
| ACOS | DIALOG DOEVENTS | GRAPHIC TEXT SIZE | MKDIR | TAB$ |
| ACOSH | DIALOG ENABLE | GRAPHIC WIDTH | MKDWD | TALLY |
| AND | DIALOG END | HEADER GET COUNT | MKDWD$ | TAN |
| ARRAY ADD | DIALOG GET CLIENT | HEADER GET ITEM | MKE | TANH |
| ARRAY ARRAYIX | DIALOG GET LOC | HEADER SEND | MKE$ | TCP ACCEPT |
| ARRAY ASSIGN | DIALOG GET SIZE | HEADER SET ITEM | MKI$ | TCP CLOSE |
| ARRAY COPY | DIALOG GET TEXT | HEX | MKL$ | TCP LINE INPUT |
| ARRAY DELETE | DIALOG GET USER | HEX$ | MKQ$ | TCP NOTIFY |
| ARRAY INSERT | DIALOG HIDE | HI | MKS | TCP OPEN |
| ARRAY REDIM DECR | DIALOG MAXIMIZE | HIWRD | MKS$ | TCP PRINT |
| ARRAY REDIM INCR | DIALOG MINIMIZE | HOST ADDR | MKWRD | TCP RECV |
| ARRAY REVERSE | DIALOG NEW | HOST NAME | MKWRD$ | TCP SEND |
| ARRAY SCAN | DIALOG NONSTABLE | HYPOT | MOD | THREAD CLOSE |
| ARRAY SHUFFLE | DIALOG NORMALIZE | IF | MONTHNAME | THREAD CREATE |
| ARRAY SORT | DIALOG PIXELS | IF/END IF | MONTHNAME$ | THREAD GET PRIORITY |
| ARRAY SWAP | DIALOG POST | IIF | MOUSEPTR | THREAD RESUME |
| ARRAY TAGARRAY | DIALOG REDRAW | IMAGELIST COUNT | MSGBOX | THREAD SET PRIORITY |
| ARRAY TAGARRAY ERASE | DIALOG SEND | IMAGELIST GET COUNT | NAME | THREAD STATUS |
| ARRAY UNIQUE | DIALOG SET CLIENT | IMAGELIST KILL | NOT | THREAD SUSPEND |
| ASC | DIALOG SET COLOR | IMAGELIST NEW | NUL | THREADCOUNT |
| ASIN | DIALOG SET ICON | IMAGELIST NEW BITMAP | NUL$ | THREADED |
| ASINH | DIALOG SET LOC | IMP | OBJECT | THREADID |
| ASM | DIALOG SET SIZE | IMPORT | OCT | TIMER |
| ASMDATA / END ASMDATA | DIALOG SET TEXT | INCR | OCT$ | TIX |
| ATANH | DIALOG SET USER | INPUT FLUSH | OEMTOCHR | TOOLBAR ADD BUTTON |
| ATN | DIALOG SHOW MODAL | INPUT# | OEMTOCHR$ | TOOLBAR ADD SEPARATOR |
| ATN2 | DIALOG SHOW MODELESS | INSTANCE | ON CALL | TOOLBAR DELETE BUTTON |
| BEEP | DIALOG SHOW STATE | INSTR | ON ERROR | TOOLBAR GET COUNT |
| BGR | DIALOG STABILIZE | INT | ON GOSUB | TOOLBAR GET STATE |
| BIN | DIALOG UNITS | INTEGER | ON GOTO | TOOLBAR SET IMAGELIST |
| BIN$ | DIM | INTERFACE / END INTERFACE (DIRECT) | OPEN | TOOLBAR SET STATE |
| BIT | DIR | INTERFACE/END INTERFACE (IDBIND) | OPTION EXPLICIT | TRACE |
| BIT CALC | DIR CLOSE | ISEVEN | OR | TREEVIEW DELETE |
| BITS | DIR$ | ISFALSE | PARSE | TREEVIEW GET COUNT |
| BITS$ | DISKFREE | ISFILE | PARSE$ | TREEVIEW GET TEXT |
| BITSE | DISKSIZE | ISFOLDER | PARSECOUNT | TREEVIEW INSERT ITEM |
| BUILD | DISPLAY BROWSE | ISINFINITE | PATHNAME | TREEVIEW RESET |
| BUILD$ | DISPLAY COLOR | ISNORMAL | PATHNAME$ | TRIM |
| BYTE | DISPLAY FONT | ISODD | PATHSCAN | TRIM$ |
| CALL | DISPLAY OPENFILE | ISTRUE | PATHSCAN$ | TRUNC |
| CALL DWORD | DISPLAY SAVEFILE | ISWIN | PEEK | TRY/END TRY |
| CALLSTK | DOUBLE | ITERATE | PLAY | TYPE SET |
| CALLSTK$ | END | JOIN$ | PLAY SOUND | TYPE/END TYPE |
| CALLSTKCOUNT | ENVIRON | KILL | PLAY WAVE | UCASE |
| CBOOL | ENVIRON$ | LCASE | POKE | UCASE$ |
| CBRT | EOF | LCASE$ | PREFIX | UCODE$ |
| CBYTE | EQV | LEFT | PRINT# | UCODEPAGE |
| CDBL | ERASE | LEFT$ | PRINTER$ | UDP CLOSE |
| CDWORD | ERF | LEN | PRINTERCOUNT | UDP NOTIFY |
| CEIL | ERL | LET | PROCESS GET PRIORITY | UDP OPEN |
| CFLT | ERL$ | LET *(WITH OBJECTS)* | PROCESS SET PRIORITY | UDP RECV |
| CHDIR | ERR | LET *(WITH TYPES)* | PROFILE | UDP SEND |
| CHDRIVE | ERRCLEAR | LET *(WITH VARIANTS)* | PROGRESSBAR GET POS | UNLOCK |
| CHOOSE | ERROR | LINE INPUT# | PROGRESSBAR GET RANGE | UNWRAP |
| CHR | ERROR$ | LISTBOX ADD | PROGRESSBAR SET POS | UNWRAP$ |
| CHR$ | EVENT SOURCE | LISTBOX DELETE | PROGRESSBAR SET RANGE | USING |
| CHRBYTES | EVENTS | LISTBOX FIND | PROGRESSBAR SET STEP | USING$ |
| CHRTOOEM | EXE | LISTBOX FIND EXACT | PROGRESSBAR STEP | UTF8TOCHR |
| CHRTOOEM$ | EXIST | LISTBOX GET COUNT | PUT | UTF8TOCHR$ |
| CHRTOUTF8 | EXIT | LISTBOX GET SELCOUNT | PUT STR | VAL |
| CHRTOUTF8$ | EXP | LISTBOX GET SELECT | PUT WSTR | VARPTR |
| CLASS/END CLASS | EXP10 | LISTBOX GET STATE | PUT$ | VERIFY |
| CLIP | EXP2 | LISTBOX GET TEXT | PUT$$ | WAITKEY |
| CLIP$ | EXPM1 | LISTBOX GET USER | QUAD | WAITKEY$ |
| CLIPBOARD | EXTRACT | LISTBOX INSERT | RAISEEVENT | WINDOW GET |
| CLOSE | EXTRACT$ | LISTBOX RESET | RANDOMIZE | WINDOW SET |
| CLS | FIELD | LISTBOX SELECT | READ | WORD |
| CODEPTR | FILEATTR | LISTBOX SET TEXT | READ$ | WRAP |
| COLOR | FILECOPY | LISTBOX SET USER | REDIM | WRAP$ |
| COMBOBOX ADD | FILENAME | LISTBOX UNSELECT | REGEXPR | WRITE |
| COMBOBOX DELETE | FILENAME$ | LISTVIEW DELETE COLUMN | REGISTER | WRITE# |
| COMBOBOX FIND | FILESCAN | LISTVIEW DELETE ITEM | REGREPL | XOR |
| COMBOBOX FIND EXACT | FIX | LISTVIEW FIND | REM | XPRINT ARC |
| COMBOBOX GET COUNT | FLOOR | LISTVIEW FIND EXACT | REMAIN | XPRINT ATTACH |
| COMBOBOX GET SELCOUNT | FLUSH | LISTVIEW FIT CONTENT | REMAIN$ | XPRINT BOX |
| COMBOBOX GET SELECT | FONT END | LISTVIEW FIT HEADER | REMOVE | XPRINT CANCEL |
| COMBOBOX GET STATE | FONT NEW | LISTVIEW GET COLUMN | REMOVE$ | XPRINT CELL |
| COMBOBOX GET TEXT | FOR / NEXT | LISTVIEW GET COUNT | REPEAT | XPRINT CELL SIZE |
| COMBOBOX GET USER | FORMAT | LISTVIEW GET HEADER | REPEAT$ | XPRINT CHR SIZE |
| COMBOBOX INSERT | FORMAT$ | LISTVIEW GET HEADERID | REPLACE | XPRINT CLOSE |
| COMBOBOX RESET | FRAC | LISTVIEW GET MODE | RESET | XPRINT COLOR |
| COMBOBOX SELECT | FRE | LISTVIEW GET SELCOUNT | RESOURCE SAVE FILE | XPRINT COPY |
| COMBOBOX SET TEXT | FREEFILE | LISTVIEW GET SELECT | RESOURCE$ | XPRINT ELLIPSE |
| COMBOBOX SET USER | FUNCNAME | LISTVIEW GET STATE | RESUME | XPRINT FORMFEED |
| COMBOBOX UNSELECT | FUNCNAME$ | LISTVIEW GET STYLEXX | RETAIN | XPRINT GET ATTACH |
| COMM CLOSE | FUNCTION / END FUNCTION | LISTVIEW GET TEXT | RETAIN$ | XPRINT GET CANVAS |
| COMM LINE | GET | LISTVIEW GET USER | RETURN | XPRINT GET CLIENT |
| COMM LINE INPUT | GET STR | LISTVIEW INSERT COLUMN | RGB | XPRINT GET CLIP |
| COMM OPEN | GET WSTR | LISTVIEW INSERT ITEM | RIGHT | XPRINT GET COLLATE |
| COMM PRINT | GET$ | LISTVIEW RESET | RIGHT$ | XPRINT GET COLOR |
| COMM RECV | GET$$ | LISTVIEW SELECT | RMDIR | XPRINT GET COLORMODE |
| COMM RESET | GETATTR | LISTVIEW SET COLUMN | RND | XPRINT GET COPIES |
| COMM SEND | GLOBAL | LISTVIEW SET HEADER | ROTATE | XPRINT GET DC |
| COMM SET | GLOBALMEM | LISTVIEW SET IMAGE | ROUND | XPRINT GET DUPLEX |
| COMM TIMEOUT | GRAPHIC ARC | LISTVIEW SET IMAGE2 | RSET | XPRINT GET LINES |
| COMMAND | GRAPHIC ATTACH | LISTVIEW SET IMAGELIST | RSET$ | XPRINT GET MARGIN |
| COMMAND$ | GRAPHIC BITMAP END | LISTVIEW SET MODE | RTRIM | XPRINT GET MIX |
| CONTROL ADD | GRAPHIC BITMAP LOAD | LISTVIEW SET OVERLAY | RTRIM$ | XPRINT GET ORIENTATION |
| CONTROL ADD BUTTON | GRAPHIC BITMAP NEW | LISTVIEW SET STYLEXX | SCROLLBAR GET PAGESIZE | XPRINT GET OVERLAP |
| CONTROL ADD CHECKBOX | GRAPHIC BOX | LISTVIEW SET TEXT | SCROLLBAR GET POS | XPRINT GET PAGES |
| CONTROL ADD COMBOBOX | GRAPHIC CELL | LISTVIEW SET USER | SCROLLBAR GET RANGE | XPRINT GET PAPER |
| CONTROL ADD LABEL | GRAPHIC CELL SIZE | LISTVIEW SORT | SCROLLBAR GET TRACKPOS | XPRINT GET PAPERS |
| CONTROL ADD LISTBOX | GRAPHIC CHR SIZE | LISTVIEW UNSELECT | SCROLLBAR SET PAGESIZE | XPRINT GET PIXEL |
| CONTROL ADD LISTVIEW | GRAPHIC CIRCLE | LISTVIEW VISIBLE | SCROLLBAR SET POS | XPRINT GET POS |
| CONTROL ADD PROGRESSBAR | GRAPHIC CLEAR | LO | SCROLLBAR SET RANGE | XPRINT GET PPI |
| CONTROL ADD SCROLLBAR | GRAPHIC COLOR | LOC | SEC | XPRINT GET QUALITY |
| CONTROL ADD STATUSBAR | GRAPHIC COPY | LOCAL | SECH | XPRINT GET SCALE |
| CONTROL ADD TAB | GRAPHIC DETACH | LOCK | SEEK | XPRINT GET SELECTION |
| CONTROL ADD TOOLBAR | GRAPHIC ELLIPSE | LOF | SELECT CASE/END SELECT | XPRINT GET SIZE |
| CONTROL ADD TREEVIEW | GRAPHIC GET BITS | LOG | SETATTR | XPRINT GET STRETCHMODE |
| CONTROL DISABLE | GRAPHIC GET CANVAS | LOG10 | SETEOF | XPRINT GET TEXTALIGN |
| CONTROL ENABLE | GRAPHIC GET CAPTION | LOG1P | SGN | XPRINT GET TRAY |
| CONTROL GET CHECK | GRAPHIC GET CLIENT | LOG2 | SHELL | XPRINT GET TRAYS |
| CONTROL GET TEXT | GRAPHIC GET CLIP | LONG | SHIFT | XPRINT GET WORDWRAP |
| CONTROL HIDE | GRAPHIC GET DC | LOWRD | SHRINK | XPRINT GET WRAP |
| CONTROL KILL | GRAPHIC GET LINES | LPRINT | SHRINK$ | XPRINT IMAGELIST |
| CONTROL SET CHECK | GRAPHIC GET LOC | LPRINT ATTACH | SIN | XPRINT LINE |
| CONTROL SET TEXT | GRAPHIC GET MIX | LPRINT CLOSE | SINGLE | XPRINT PIE |
| COS | GRAPHIC GET PIXEL | LPRINT FLUSH | SINH | XPRINT POLYGON |
| COSH | GRAPHIC GET POS | LPRINT FORMFEED | SIZEOF | XPRINT POLYLINE |
| COT | GRAPHIC GET PPI | LPRINT$ | SLEEP | XPRINT PREVIEW |
| COTH | GRAPHIC GET SCALE | LSET | SPACE | XPRINT PRINT |
| CQUAD | GRAPHIC GET SIZE | LSET$ | SPACE$ | XPRINT RENDER |
| CSC | GRAPHIC GET STRETCHMODE | LTRIM | SPLIT | XPRINT SCALE |
| CSCH | GRAPHIC GET TEXTALIGN | LTRIM$ | SQR | XPRINT SET CLIP |
| CSET | GRAPHIC GET VIEW | MACRO/END MACRO | STATIC | XPRINT SET COLLATE |
| CSET$ | GRAPHIC GET WORDWRAP | MAK | STATUSBAR SET PARTS | XPRINT SET COLOR |
| CSNG | GRAPHIC GET WRAP | MAT | STATUSBAR SET TEXT | XPRINT SET COLORMODE |
| CSTR | GRAPHIC LINE | MAX | STR | XPRINT SET COPIES |
| CULNG | GRAPHIC PAINT | MCASE | STR$ | XPRINT SET DUPLEX |
| CURDIR | GRAPHIC PIE | MCASE$ | STRDELETE | XPRINT SET FONT |
| CURDIR$ | GRAPHIC POLYGON | MEMORY | STRDELETE$ | XPRINT SET MIX |
| CVBYT | GRAPHIC POLYLINE | MEMORY FILL | STRING | XPRINT SET ORIENTATION |
| CVCUX | GRAPHIC PRINT | MEMORY FILLS | STRINSERT | XPRINT SET OVERLAP |
| CVDWD | GRAPHIC SAVE | MENU ADD POPUP | STRINSERT$ | XPRINT SET PAGES |
| CVL | GRAPHIC SCALE | MENU ADD STRING | STRPTR | XPRINT SET PAPER |
| CVQ | GRAPHIC SCALE PIXELS | MENU DELETE | STRREVERSE | XPRINT SET PIXEL |
| CVW | GRAPHIC SET AUTOSIZE | MENU GET STATE | STRREVERSE$ | XPRINT SET POS |
| CWORD | GRAPHIC SET BITS | MENU GET TEXT | SWAP | XPRINT SET QUALITY |
| DATA | GRAPHIC SET CAPTION | MENU NEW BAR | SWITCH | XPRINT SET STRETCHMODE |
| DATACOUNT | GRAPHIC SET CLIP | MENU NEW POPUP | SWITCH$ | XPRINT SET TEXTALIGN |
| DAYNAME | GRAPHIC SET FIXED | MENU SET STATE | TAB DELETE | XPRINT SET TRAY |
| DAYNAME$ | GRAPHIC SET FONT | MENU SET TEXT | TAB GET COUNT | XPRINT SET WORDWRAP |
| DEC | GRAPHIC SET MIX | METHOD / END METHOD | TAB GET DIALOG | XPRINT SET WRAP |
| DEC$ | GRAPHIC SET PIXEL | METRICS | TAB GET IMAGE | XPRINT SPLIT |
| DECLARE | GRAPHIC SET POS | MID | TAB GET PAGE | XPRINT STRETCH |
| DECR | GRAPHIC SET SIZE | MID$ | TAB GET SELECT | XPRINT STYLE |
| DEF | GRAPHIC SET STRETCHMODE | MIN | TAB GET TEXT | XPRINT TEXT SIZE |
| DESKTOP GET CLIENT | GRAPHIC SET TEXTALIGN | MKBYT | TAB INSERT PAGE | XPRINT WIDTH |
| DESKTOP GET LOC | GRAPHIC SET VIEW | MKBYT$ | TAB RESET |  |

## **Newly** implemented by this branch

> **621 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIM | LISTBOX GET COUNT | SINGLE |
| ACCEL ATTACH | DIR | LISTBOX GET SELCOUNT | SINH |
| ACODE | DIR CLOSE | LISTBOX GET SELECT | SIZEOF |
| ACODE$ | DIR$ | LISTBOX GET STATE | SPACE |
| ACOS | DISKFREE | LISTBOX GET TEXT | SPACE$ |
| ACOSH | DISKSIZE | LISTBOX GET USER | SQR |
| ARRAY ADD | DISPLAY BROWSE | LISTBOX INSERT | STATUSBAR SET PARTS |
| ARRAY ARRAYIX | DISPLAY COLOR | LISTBOX RESET | STATUSBAR SET TEXT |
| ARRAY ASSIGN | DISPLAY FONT | LISTBOX SELECT | STR |
| ARRAY COPY | DISPLAY OPENFILE | LISTBOX SET TEXT | STR$ |
| ARRAY DELETE | DISPLAY SAVEFILE | LISTBOX SET USER | STRDELETE |
| ARRAY INSERT | DOUBLE | LISTBOX UNSELECT | STRDELETE$ |
| ARRAY REDIM DECR | ENVIRON$ | LISTVIEW DELETE COLUMN | STRING |
| ARRAY REDIM INCR | EOF | LISTVIEW DELETE ITEM | STRINSERT |
| ARRAY REVERSE | EQV | LISTVIEW FIND | STRINSERT$ |
| ARRAY SCAN | ERF | LISTVIEW FIND EXACT | STRPTR |
| ARRAY SHUFFLE | ERL | LISTVIEW FIT CONTENT | STRREVERSE |
| ARRAY SWAP | ERL$ | LISTVIEW FIT HEADER | STRREVERSE$ |
| ARRAY TAGARRAY | ERR | LISTVIEW GET COLUMN | SWITCH |
| ARRAY TAGARRAY ERASE | ERRCLEAR | LISTVIEW GET COUNT | SWITCH$ |
| ARRAY UNIQUE | ERROR$ | LISTVIEW GET HEADER | TAB DELETE |
| ASIN | EVENT SOURCE | LISTVIEW GET HEADERID | TAB GET COUNT |
| ASINH | EVENTS | LISTVIEW GET MODE | TAB GET DIALOG |
| ATANH | EXE | LISTVIEW GET SELCOUNT | TAB GET IMAGE |
| ATN | EXIST | LISTVIEW GET SELECT | TAB GET PAGE |
| ATN2 | EXP | LISTVIEW GET STATE | TAB GET SELECT |
| BGR | EXP10 | LISTVIEW GET STYLEXX | TAB GET TEXT |
| BIN | EXP2 | LISTVIEW GET TEXT | TAB INSERT PAGE |
| BIN$ | EXPM1 | LISTVIEW GET USER | TAB RESET |
| BITS | EXTRACT | LISTVIEW INSERT COLUMN | TAB SELECT |
| BITS$ | EXTRACT$ | LISTVIEW INSERT ITEM | TAB SET IMAGE |
| BITSE | FILEATTR | LISTVIEW RESET | TAB SET IMAGELIST |
| BUILD | FILENAME | LISTVIEW SELECT | TAB SET TEXT |
| BUILD$ | FILENAME$ | LISTVIEW SET COLUMN | TAB$ |
| BYTE | FIX | LISTVIEW SET HEADER | TALLY |
| CALLSTK$ | FLOOR | LISTVIEW SET IMAGE | TAN |
| CALLSTKCOUNT | FONT END | LISTVIEW SET IMAGE2 | TANH |
| CBOOL | FONT NEW | LISTVIEW SET IMAGELIST | TCP NOTIFY |
| CBRT | FORMAT | LISTVIEW SET MODE | THREADCOUNT |
| CBYTE | FORMAT$ | LISTVIEW SET OVERLAY | THREADID |
| CDBL | FRAC | LISTVIEW SET STYLEXX | TIMER |
| CDWORD | FRE | LISTVIEW SET TEXT | TOOLBAR ADD BUTTON |
| CEIL | FREEFILE | LISTVIEW SET USER | TOOLBAR ADD SEPARATOR |
| CFLT | FUNCNAME | LISTVIEW SORT | TOOLBAR DELETE BUTTON |
| CHOOSE | FUNCNAME$ | LISTVIEW UNSELECT | TOOLBAR GET COUNT |
| CHR | GET | LISTVIEW VISIBLE | TOOLBAR GET STATE |
| CHR$ | GET STR | LO | TOOLBAR SET IMAGELIST |
| CHRBYTES | GET WSTR | LOC | TOOLBAR SET STATE |
| CHRTOOEM | GET$ | LOF | TREEVIEW DELETE |
| CHRTOOEM$ | GET$$ | LOG | TREEVIEW GET COUNT |
| CHRTOUTF8 | GETATTR | LOG10 | TREEVIEW GET TEXT |
| CHRTOUTF8$ | GRAPHIC ARC | LOG1P | TREEVIEW INSERT ITEM |
| CLIP | GRAPHIC ATTACH | LOG2 | TREEVIEW RESET |
| CLIP$ | GRAPHIC BITMAP END | LONG | TRIM |
| CLOSE | GRAPHIC BITMAP LOAD | LOWRD | TRIM$ |
| CODEPTR | GRAPHIC BITMAP NEW | LPRINT$ | TRUNC |
| COMBOBOX ADD | GRAPHIC BOX | LSET$ | UCASE |
| COMBOBOX DELETE | GRAPHIC CELL | LTRIM | UCASE$ |
| COMBOBOX FIND | GRAPHIC CELL SIZE | LTRIM$ | UCODE$ |
| COMBOBOX FIND EXACT | GRAPHIC CHR SIZE | MAK | UCODEPAGE |
| COMBOBOX GET COUNT | GRAPHIC CIRCLE | MAX | UDP NOTIFY |
| COMBOBOX GET SELCOUNT | GRAPHIC CLEAR | MCASE | UNWRAP |
| COMBOBOX GET SELECT | GRAPHIC COLOR | MCASE$ | UNWRAP$ |
| COMBOBOX GET STATE | GRAPHIC COPY | MEMORY FILL | USING |
| COMBOBOX GET TEXT | GRAPHIC DETACH | MEMORY FILLS | USING$ |
| COMBOBOX GET USER | GRAPHIC ELLIPSE | MENU ADD POPUP | UTF8TOCHR |
| COMBOBOX INSERT | GRAPHIC GET BITS | MENU ADD STRING | UTF8TOCHR$ |
| COMBOBOX RESET | GRAPHIC GET CANVAS | MENU DELETE | VARPTR |
| COMBOBOX SELECT | GRAPHIC GET CAPTION | MENU GET STATE | VERIFY |
| COMBOBOX SET TEXT | GRAPHIC GET CLIENT | MENU GET TEXT | WAITKEY |
| COMBOBOX SET USER | GRAPHIC GET CLIP | MENU NEW BAR | WAITKEY$ |
| COMBOBOX UNSELECT | GRAPHIC GET DC | MENU NEW POPUP | WORD |
| COMM LINE INPUT | GRAPHIC GET LINES | MENU SET STATE | WRAP |
| COMMAND | GRAPHIC GET LOC | MENU SET TEXT | WRAP$ |
| COMMAND$ | GRAPHIC GET MIX | METRICS | WRITE |
| CONTROL ADD | GRAPHIC GET PIXEL | MID | WRITE# |
| CONTROL ADD BUTTON | GRAPHIC GET POS | MIN | XPRINT ARC |
| CONTROL ADD CHECKBOX | GRAPHIC GET PPI | MKBYT | XPRINT ATTACH |
| CONTROL ADD COMBOBOX | GRAPHIC GET SCALE | MKCUX | XPRINT BOX |
| CONTROL ADD LABEL | GRAPHIC GET SIZE | MKDWD | XPRINT CANCEL |
| CONTROL ADD LISTBOX | GRAPHIC GET STRETCHMODE | MKE | XPRINT CELL |
| CONTROL ADD LISTVIEW | GRAPHIC GET TEXTALIGN | MKS | XPRINT CELL SIZE |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET VIEW | MKWRD | XPRINT CHR SIZE |
| CONTROL ADD SCROLLBAR | GRAPHIC GET WORDWRAP | MOD | XPRINT CLOSE |
| CONTROL ADD STATUSBAR | GRAPHIC GET WRAP | MONTHNAME | XPRINT COLOR |
| CONTROL ADD TAB | GRAPHIC LINE | MONTHNAME$ | XPRINT COPY |
| CONTROL ADD TOOLBAR | GRAPHIC PAINT | NUL$ | XPRINT ELLIPSE |
| CONTROL ADD TREEVIEW | GRAPHIC PIE | OCT | XPRINT FORMFEED |
| CONTROL DISABLE | GRAPHIC POLYGON | OCT$ | XPRINT GET ATTACH |
| CONTROL ENABLE | GRAPHIC POLYLINE | OEMTOCHR | XPRINT GET CANVAS |
| CONTROL GET CHECK | GRAPHIC PRINT | OEMTOCHR$ | XPRINT GET CLIENT |
| CONTROL GET TEXT | GRAPHIC SAVE | ON CALL | XPRINT GET CLIP |
| CONTROL HIDE | GRAPHIC SCALE | ON GOSUB | XPRINT GET COLLATE |
| CONTROL KILL | GRAPHIC SCALE PIXELS | ON GOTO | XPRINT GET COLOR |
| CONTROL SET CHECK | GRAPHIC SET AUTOSIZE | OPEN | XPRINT GET COLORMODE |
| CONTROL SET TEXT | GRAPHIC SET BITS | PARSE$ | XPRINT GET COPIES |
| COS | GRAPHIC SET CAPTION | PARSECOUNT | XPRINT GET DC |
| COSH | GRAPHIC SET CLIP | PATHNAME | XPRINT GET DUPLEX |
| COT | GRAPHIC SET FIXED | PATHNAME$ | XPRINT GET LINES |
| COTH | GRAPHIC SET FONT | PATHSCAN | XPRINT GET MARGIN |
| CQUAD | GRAPHIC SET MIX | PATHSCAN$ | XPRINT GET MIX |
| CSC | GRAPHIC SET PIXEL | PEEK | XPRINT GET ORIENTATION |
| CSCH | GRAPHIC SET POS | PLAY | XPRINT GET OVERLAP |
| CSET$ | GRAPHIC SET SIZE | PLAY SOUND | XPRINT GET PAGES |
| CSNG | GRAPHIC SET STRETCHMODE | POKE | XPRINT GET PAPER |
| CSTR | GRAPHIC SET TEXTALIGN | PRINTER$ | XPRINT GET PAPERS |
| CULNG | GRAPHIC SET VIEW | PRINTERCOUNT | XPRINT GET PIXEL |
| CURDIR | GRAPHIC SET VIRTUAL | PROGRESSBAR GET POS | XPRINT GET POS |
| CURDIR$ | GRAPHIC SET WORDWRAP | PROGRESSBAR GET RANGE | XPRINT GET PPI |
| CVBYT | GRAPHIC SET WRAP | PROGRESSBAR SET POS | XPRINT GET QUALITY |
| CVCUX | GRAPHIC STYLE | PROGRESSBAR SET RANGE | XPRINT GET SCALE |
| CVDWD | GRAPHIC TEXT SIZE | PROGRESSBAR SET STEP | XPRINT GET SELECTION |
| CVL | GRAPHIC WIDTH | PROGRESSBAR STEP | XPRINT GET SIZE |
| CVQ | HEADER GET COUNT | PUT | XPRINT GET STRETCHMODE |
| CVW | HEADER GET ITEM | PUT STR | XPRINT GET TEXTALIGN |
| CWORD | HEADER SEND | PUT WSTR | XPRINT GET TRAY |
| DATACOUNT | HEADER SET ITEM | PUT$ | XPRINT GET TRAYS |
| DAYNAME | HEX | PUT$$ | XPRINT GET WORDWRAP |
| DAYNAME$ | HEX$ | QUAD | XPRINT GET WRAP |
| DEC | HI | RAISEEVENT | XPRINT IMAGELIST |
| DEC$ | HIWRD | READ | XPRINT LINE |
| DECLARE | HYPOT | READ$ | XPRINT PIE |
| DEF | IIF | REDIM | XPRINT POLYGON |
| DESKTOP GET PPI | IMAGELIST COUNT | REMAIN | XPRINT POLYLINE |
| DIALOG DEFAULT FONT | IMAGELIST GET COUNT | REMAIN$ | XPRINT PREVIEW |
| DIALOG DISABLE | IMAGELIST KILL | REMOVE | XPRINT PRINT |
| DIALOG DOEVENTS | IMAGELIST NEW | REMOVE$ | XPRINT RENDER |
| DIALOG ENABLE | IMAGELIST NEW BITMAP | REPEAT | XPRINT SCALE |
| DIALOG END | IMP | REPEAT$ | XPRINT SET CLIP |
| DIALOG GET CLIENT | INPUT# | RESOURCE SAVE FILE | XPRINT SET COLLATE |
| DIALOG GET LOC | INSTANCE | RESOURCE$ | XPRINT SET COLOR |
| DIALOG GET SIZE | INSTR | RETAIN | XPRINT SET COLORMODE |
| DIALOG GET TEXT | INT | RETAIN$ | XPRINT SET COPIES |
| DIALOG GET USER | INTEGER | RGB | XPRINT SET DUPLEX |
| DIALOG HIDE | ISEVEN | RIGHT | XPRINT SET FONT |
| DIALOG MAXIMIZE | ISFALSE | RIGHT$ | XPRINT SET MIX |
| DIALOG MINIMIZE | ISFILE | RND | XPRINT SET ORIENTATION |
| DIALOG NEW | ISFOLDER | ROUND | XPRINT SET OVERLAP |
| DIALOG NONSTABLE | ISINFINITE | RSET$ | XPRINT SET PAGES |
| DIALOG NORMALIZE | ISNORMAL | RTRIM | XPRINT SET PAPER |
| DIALOG PIXELS | ISODD | RTRIM$ | XPRINT SET PIXEL |
| DIALOG POST | ISTRUE | SCROLLBAR GET PAGESIZE | XPRINT SET POS |
| DIALOG REDRAW | ISWIN | SCROLLBAR GET POS | XPRINT SET QUALITY |
| DIALOG SEND | JOIN$ | SCROLLBAR GET RANGE | XPRINT SET STRETCHMODE |
| DIALOG SET CLIENT | LCASE | SCROLLBAR GET TRACKPOS | XPRINT SET TEXTALIGN |
| DIALOG SET COLOR | LCASE$ | SCROLLBAR SET PAGESIZE | XPRINT SET TRAY |
| DIALOG SET ICON | LEFT | SCROLLBAR SET POS | XPRINT SET WORDWRAP |
| DIALOG SET LOC | LEFT$ | SCROLLBAR SET RANGE | XPRINT SET WRAP |
| DIALOG SET SIZE | LEN | SEC | XPRINT SPLIT |
| DIALOG SET TEXT | LET *(WITH OBJECTS)* | SECH | XPRINT STRETCH |
| DIALOG SET USER | LET *(WITH VARIANTS)* | SEEK | XPRINT STYLE |
| DIALOG SHOW MODAL | LINE INPUT# | SETEOF | XPRINT TEXT SIZE |
| DIALOG SHOW MODELESS | LISTBOX ADD | SGN | XPRINT WIDTH |
| DIALOG SHOW STATE | LISTBOX DELETE | SHRINK |  |
| DIALOG STABILIZE | LISTBOX FIND | SHRINK$ |  |
| DIALOG UNITS | LISTBOX FIND EXACT | SIN |  |
