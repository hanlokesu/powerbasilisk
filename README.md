...
> Summary:
> - **854** official PowerBASIC statement/function keywords currently available for use
>   - **706** implemented or completed by this fork
...
**All 854 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | CVDWD | GRAPHIC SET CLIP | MENU CONTEXT | TAB SET IMAGE |
| ACCEL ATTACH | CVL | GRAPHIC SET FIXED | MENU DELETE | TAB SET IMAGELIST |
| ACODE | CVQ | GRAPHIC SET FOCUS | MENU DRAW BAR | TAB SET TEXT |
| ACODE$ | CVW | GRAPHIC SET FONT | MENU GET STATE | TAB$ |
| ACOS | CWORD | GRAPHIC SET LOC | MENU GET TEXT | TALLY |
| ACOSH | DATA | GRAPHIC SET MIX | MENU NEW BAR | TAN |
| AND | DATACOUNT | GRAPHIC SET OVERLAP | MENU NEW POPUP | TANH |
| ARRAY ADD | DAYNAME | GRAPHIC SET PIXEL | MENU SET STATE | TCP ACCEPT |
| ARRAY ARRAYIX | DAYNAME$ | GRAPHIC SET POS | MENU SET TEXT | TCP CLOSE |
| ARRAY ASSIGN | DEC | GRAPHIC SET SCROLLTEXT | METHOD / END METHOD | TCP LINE INPUT |
| ARRAY COPY | DEC$ | GRAPHIC SET SIZE | METRICS | TCP NOTIFY |
| ARRAY DELETE | DECLARE | GRAPHIC SET STRETCHMODE | MID | TCP OPEN |
| ARRAY INSERT | DECR | GRAPHIC SET TEXTALIGN | MID$ | TCP PRINT |
| ARRAY REDIM DECR | DEF | GRAPHIC SET VIEW | MIN | TCP RECV |
| ARRAY REDIM INCR | DESKTOP GET CLIENT | GRAPHIC SET VIRTUAL | MKBYT | TCP SEND |
| ARRAY REVERSE | DESKTOP GET LOC | GRAPHIC SET WORDWRAP | MKBYT$ | THREAD CLOSE |
| ARRAY SCAN | DESKTOP GET PPI | GRAPHIC SET WRAP | MKCUR$ | THREAD CREATE |
| ARRAY SHUFFLE | DESKTOP GET SIZE | GRAPHIC SPLIT | MKCUX | THREAD GET PRIORITY |
| ARRAY SORT | DIALOG DEFAULT FONT | GRAPHIC STRETCH | MKCUX$ | THREAD RESUME |
| ARRAY SWAP | DIALOG DISABLE | GRAPHIC STYLE | MKD$ | THREAD SET PRIORITY |
| ARRAY TAGARRAY | DIALOG DOEVENTS | GRAPHIC TEXT SIZE | MKDIR | THREAD STATUS |
| ARRAY TAGARRAY ERASE | DIALOG ENABLE | GRAPHIC WAITKEY$ | MKDWD | THREAD SUSPEND |
| ARRAY UNIQUE | DIALOG END | GRAPHIC WIDTH | MKDWD$ | THREADCOUNT |
| ASC | DIALOG GET CLIENT | GRAPHIC WINDOW | MKE | THREADED |
| ASIN | DIALOG GET LOC | GRAPHIC WINDOW CLICK | MKE$ | THREADID |
| ASINH | DIALOG GET SIZE | GRAPHIC WINDOW END | MKI$ | TIMER |
| ASM | DIALOG GET TEXT | GRAPHIC WINDOW HIDE | MKL$ | TIX |
| ASMDATA / END ASMDATA | DIALOG GET USER | GRAPHIC WINDOW MINIMIZE | MKQ$ | TOOLBAR ADD BUTTON |
| ATANH | DIALOG HIDE | GRAPHIC WINDOW NONSTABLE | MKS | TOOLBAR ADD SEPARATOR |
| ATN | DIALOG MAXIMIZE | GRAPHIC WINDOW NORMALIZE | MKS$ | TOOLBAR DELETE BUTTON |
| ATN2 | DIALOG MINIMIZE | GRAPHIC WINDOW STABILIZE | MKWRD | TOOLBAR GET COUNT |
| BEEP | DIALOG NEW | HEADER GET COUNT | MKWRD$ | TOOLBAR GET STATE |
| BGR | DIALOG NONSTABLE | HEADER GET ITEM | MOD | TOOLBAR SET IMAGELIST |
| BIN | DIALOG NORMALIZE | HEADER SEND | MONTHNAME | TOOLBAR SET STATE |
| BIN$ | DIALOG PIXELS | HEADER SET ITEM | MONTHNAME$ | TRACE |
| BIT | DIALOG POST | HEX | MOUSEPTR | TREEVIEW DELETE |
| BIT CALC | DIALOG REDRAW | HEX$ | MSGBOX | TREEVIEW GET BOLD |
| BITS | DIALOG SEND | HI | NAME | TREEVIEW GET CHECK |
| BITS$ | DIALOG SET CLIENT | HIWRD | NOT | TREEVIEW GET CHILD |
| BITSE | DIALOG SET COLOR | HOST ADDR | NUL | TREEVIEW GET COUNT |
| BUILD | DIALOG SET ICON | HOST NAME | NUL$ | TREEVIEW GET EXPANDED |
| BUILD$ | DIALOG SET LOC | HYPOT | OBJECT | TREEVIEW GET NEXT |
| BYTE | DIALOG SET SIZE | IF | OCT | TREEVIEW GET PARENT |
| CALL | DIALOG SET TEXT | IF/END IF | OCT$ | TREEVIEW GET PREVIOUS |
| CALL DWORD | DIALOG SET USER | IIF | OEMTOCHR | TREEVIEW GET ROOT |
| CALLSTK | DIALOG SHOW MODAL | IMAGELIST ADD BITMAP | OEMTOCHR$ | TREEVIEW GET SELECT |
| CALLSTK$ | DIALOG SHOW MODELESS | IMAGELIST ADD ICON | ON CALL | TREEVIEW GET TEXT |
| CALLSTKCOUNT | DIALOG SHOW STATE | IMAGELIST ADD MASKED | ON ERROR | TREEVIEW GET USER |
| CBOOL | DIALOG STABILIZE | IMAGELIST COUNT | ON GOSUB | TREEVIEW INSERT ITEM |
| CBRT | DIALOG UNITS | IMAGELIST GET COUNT | ON GOTO | TREEVIEW RESET |
| CBYTE | DIM | IMAGELIST KILL | OPEN | TREEVIEW SELECT |
| CDBL | DIR | IMAGELIST NEW | OPTION EXPLICIT | TREEVIEW SET BOLD |
| CDWORD | DIR CLOSE | IMAGELIST NEW BITMAP | OR | TREEVIEW SET CHECK |
| CEIL | DIR$ | IMAGELIST NEW ICON | PARSE | TREEVIEW SET EXPANDED |
| CFLT | DISKFREE | IMAGELIST SET OVERLAY | PARSE$ | TREEVIEW SET IMAGELIST |
| CHDIR | DISKSIZE | IMP | PARSECOUNT | TREEVIEW SET TEXT |
| CHDRIVE | DISPLAY BROWSE | IMPORT | PATHNAME | TREEVIEW SET USER |
| CHOOSE | DISPLAY COLOR | INCR | PATHNAME$ | TREEVIEW UNSELECT |
| CHR | DISPLAY FONT | INPUT FLUSH | PATHSCAN | TRIM |
| CHR$ | DISPLAY OPENFILE | INPUT# | PATHSCAN$ | TRIM$ |
| CHRBYTES | DISPLAY SAVEFILE | INSTANCE | PEEK | TRUNC |
| CHRTOOEM | DOUBLE | INSTR | PLAY | TRY/END TRY |
| CHRTOOEM$ | END | INT | PLAY SOUND | TYPE SET |
| CHRTOUTF8 | ENVIRON | INTEGER | PLAY WAVE | TYPE/END TYPE |
| CHRTOUTF8$ | ENVIRON$ | INTERFACE / END INTERFACE (DIRECT) | POKE | UCASE |
| CLASS/END CLASS | EOF | INTERFACE/END INTERFACE (IDBIND) | PREFIX | UCASE$ |
| CLIP | EQV | ISEVEN | PRINT# | UCODE$ |
| CLIP$ | ERASE | ISFALSE | PRINTER$ | UCODEPAGE |
| CLIPBOARD | ERF | ISFILE | PRINTERCOUNT | UDP CLOSE |
| CLOSE | ERL | ISFOLDER | PROCESS GET PRIORITY | UDP NOTIFY |
| CLS | ERL$ | ISINFINITE | PROCESS SET PRIORITY | UDP OPEN |
| CODEPTR | ERR | ISNORMAL | PROFILE | UDP RECV |
| COLOR | ERRCLEAR | ISODD | PROGRESSBAR GET POS | UDP SEND |
| COMBOBOX ADD | ERROR | ISTRUE | PROGRESSBAR GET RANGE | UNLOCK |
| COMBOBOX DELETE | ERROR$ | ISWIN | PROGRESSBAR SET POS | UNWRAP |
| COMBOBOX FIND | EVENT SOURCE | ITERATE | PROGRESSBAR SET RANGE | UNWRAP$ |
| COMBOBOX FIND EXACT | EVENTS | JOIN$ | PROGRESSBAR SET STEP | USING |
| COMBOBOX GET COUNT | EXE | KILL | PROGRESSBAR STEP | USING$ |
| COMBOBOX GET SELCOUNT | EXIST | LCASE | PUT | UTF8TOCHR |
| COMBOBOX GET SELECT | EXIT | LCASE$ | PUT STR | UTF8TOCHR$ |
| COMBOBOX GET STATE | EXP | LEFT | PUT WSTR | VAL |
| COMBOBOX GET TEXT | EXP10 | LEFT$ | PUT$ | VARPTR |
| COMBOBOX GET USER | EXP2 | LEN | PUT$$ | VERIFY |
| COMBOBOX INSERT | EXPM1 | LET | QUAD | WAITKEY |
| COMBOBOX RESET | EXTRACT | LET *(WITH OBJECTS)* | RAISEEVENT | WAITKEY$ |
| COMBOBOX SELECT | EXTRACT$ | LET *(WITH TYPES)* | RANDOMIZE | WINDOW GET |
| COMBOBOX SET TEXT | FIELD | LET *(WITH VARIANTS)* | READ | WINDOW SET |
| COMBOBOX SET USER | FILEATTR | LINE INPUT# | READ$ | WORD |
| COMBOBOX UNSELECT | FILECOPY | LISTBOX ADD | REDIM | WRAP |
| COMM CLOSE | FILENAME | LISTBOX DELETE | REGEXPR | WRAP$ |
| COMM LINE | FILENAME$ | LISTBOX FIND | REGISTER | WRITE |
| COMM LINE INPUT | FILESCAN | LISTBOX FIND EXACT | REGREPL | WRITE# |
| COMM OPEN | FIX | LISTBOX GET COUNT | REM | XOR |
| COMM PRINT | FLOOR | LISTBOX GET SELCOUNT | REMAIN | XPRINT ARC |
| COMM RECV | FLUSH | LISTBOX GET SELECT | REMAIN$ | XPRINT ATTACH |
| COMM RESET | FONT END | LISTBOX GET STATE | REMOVE | XPRINT BOX |
| COMM SEND | FONT NEW | LISTBOX GET TEXT | REMOVE$ | XPRINT CANCEL |
| COMM SET | FOR / NEXT | LISTBOX GET USER | REPEAT | XPRINT CELL |
| COMM TIMEOUT | FORMAT | LISTBOX INSERT | REPEAT$ | XPRINT CELL SIZE |
| COMMAND | FORMAT$ | LISTBOX RESET | REPLACE | XPRINT CHR SIZE |
| COMMAND$ | FRAC | LISTBOX SELECT | RESET | XPRINT CLOSE |
| CONTROL ADD | FRE | LISTBOX SET TEXT | RESOURCE SAVE FILE | XPRINT COLOR |
| CONTROL ADD BUTTON | FREEFILE | LISTBOX SET USER | RESOURCE$ | XPRINT COPY |
| CONTROL ADD CHECK3STATE | FUNCNAME | LISTBOX UNSELECT | RESUME | XPRINT ELLIPSE |
| CONTROL ADD CHECKBOX | FUNCNAME$ | LISTVIEW DELETE COLUMN | RETAIN | XPRINT FORMFEED |
| CONTROL ADD COMBOBOX | FUNCTION / END FUNCTION | LISTVIEW DELETE ITEM | RETAIN$ | XPRINT GET ATTACH |
| CONTROL ADD FRAME | GET | LISTVIEW FIND | RETURN | XPRINT GET CANVAS |
| CONTROL ADD GRAPHIC | GET STR | LISTVIEW FIND EXACT | RGB | XPRINT GET CLIENT |
| CONTROL ADD HEADER | GET WSTR | LISTVIEW FIT CONTENT | RIGHT | XPRINT GET CLIP |
| CONTROL ADD IMAGE | GET$ | LISTVIEW FIT HEADER | RIGHT$ | XPRINT GET COLLATE |
| CONTROL ADD IMAGEX | GET$$ | LISTVIEW GET COLUMN | RMDIR | XPRINT GET COLOR |
| CONTROL ADD IMGBUTTON | GETATTR | LISTVIEW GET COUNT | RND | XPRINT GET COLORMODE |
| CONTROL ADD IMGBUTTONX | GLOBAL | LISTVIEW GET HEADER | ROTATE | XPRINT GET COPIES |
| CONTROL ADD LABEL | GLOBALMEM | LISTVIEW GET HEADERID | ROUND | XPRINT GET DC |
| CONTROL ADD LINE | GRAPHIC ARC | LISTVIEW GET MODE | RSET | XPRINT GET DUPLEX |
| CONTROL ADD LISTBOX | GRAPHIC ATTACH | LISTVIEW GET SELCOUNT | RSET$ | XPRINT GET LINES |
| CONTROL ADD LISTVIEW | GRAPHIC BITMAP END | LISTVIEW GET SELECT | RTRIM | XPRINT GET MARGIN |
| CONTROL ADD OPTION | GRAPHIC BITMAP LOAD | LISTVIEW GET STATE | RTRIM$ | XPRINT GET MIX |
| CONTROL ADD PROGRESSBAR | GRAPHIC BITMAP NEW | LISTVIEW GET STYLEXX | SCROLLBAR GET PAGESIZE | XPRINT GET ORIENTATION |
| CONTROL ADD SCROLLBAR | GRAPHIC BOX | LISTVIEW GET TEXT | SCROLLBAR GET POS | XPRINT GET OVERLAP |
| CONTROL ADD STATUSBAR | GRAPHIC CELL | LISTVIEW GET USER | SCROLLBAR GET RANGE | XPRINT GET PAGES |
| CONTROL ADD TAB | GRAPHIC CELL SIZE | LISTVIEW INSERT COLUMN | SCROLLBAR GET TRACKPOS | XPRINT GET PAPER |
| CONTROL ADD TEXTBOX | GRAPHIC CHR SIZE | LISTVIEW INSERT ITEM | SCROLLBAR SET PAGESIZE | XPRINT GET PAPERS |
| CONTROL ADD TOOLBAR | GRAPHIC CIRCLE | LISTVIEW RESET | SCROLLBAR SET POS | XPRINT GET PIXEL |
| CONTROL ADD TREEVIEW | GRAPHIC CLEAR | LISTVIEW SELECT | SCROLLBAR SET RANGE | XPRINT GET POS |
| CONTROL DISABLE | GRAPHIC COLOR | LISTVIEW SET COLUMN | SEC | XPRINT GET PPI |
| CONTROL ENABLE | GRAPHIC COPY | LISTVIEW SET HEADER | SECH | XPRINT GET QUALITY |
| CONTROL GET CHECK | GRAPHIC DETACH | LISTVIEW SET IMAGE | SEEK | XPRINT GET SCALE |
| CONTROL GET CLIENT | GRAPHIC ELLIPSE | LISTVIEW SET IMAGE2 | SELECT CASE/END SELECT | XPRINT GET SELECTION |
| CONTROL GET LOC | GRAPHIC GET BITS | LISTVIEW SET IMAGELIST | SETATTR | XPRINT GET SIZE |
| CONTROL GET SIZE | GRAPHIC GET CANVAS | LISTVIEW SET MODE | SETEOF | XPRINT GET STRETCHMODE |
| CONTROL GET TEXT | GRAPHIC GET CAPTION | LISTVIEW SET OVERLAY | SGN | XPRINT GET TEXTALIGN |
| CONTROL GET USER | GRAPHIC GET CLIENT | LISTVIEW SET STYLEXX | SHELL | XPRINT GET TRAY |
| CONTROL HANDLE | GRAPHIC GET CLIP | LISTVIEW SET TEXT | SHIFT | XPRINT GET TRAYS |
| CONTROL HIDE | GRAPHIC GET DC | LISTVIEW SET USER | SHRINK | XPRINT GET WORDWRAP |
| CONTROL KILL | GRAPHIC GET LINES | LISTVIEW SORT | SHRINK$ | XPRINT GET WRAP |
| CONTROL NORMALIZE | GRAPHIC GET LOC | LISTVIEW UNSELECT | SIN | XPRINT IMAGELIST |
| CONTROL POST | GRAPHIC GET MIX | LISTVIEW VISIBLE | SINGLE | XPRINT LINE |
| CONTROL REDRAW | GRAPHIC GET OVERLAP | LO | SINH | XPRINT PIE |
| CONTROL SEND | GRAPHIC GET PIXEL | LOC | SIZEOF | XPRINT POLYGON |
| CONTROL SET CHECK | GRAPHIC GET POS | LOCAL | SLEEP | XPRINT POLYLINE |
| CONTROL SET CLIENT | GRAPHIC GET PPI | LOCK | SPACE | XPRINT PREVIEW |
| CONTROL SET COLOR | GRAPHIC GET SCALE | LOF | SPACE$ | XPRINT PRINT |
| CONTROL SET FOCUS | GRAPHIC GET SCROLLTEXT | LOG | SPLIT | XPRINT RENDER |
| CONTROL SET FONT | GRAPHIC GET SIZE | LOG10 | SQR | XPRINT SCALE |
| CONTROL SET IMAGE | GRAPHIC GET STRETCHMODE | LOG1P | STATIC | XPRINT SET CLIP |
| CONTROL SET IMAGEX | GRAPHIC GET TEXTALIGN | LOG2 | STATUSBAR SET PARTS | XPRINT SET COLLATE |
| CONTROL SET IMGBUTTON | GRAPHIC GET VIEW | LONG | STATUSBAR SET TEXT | XPRINT SET COLOR |
| CONTROL SET IMGBUTTONX | GRAPHIC GET WORDWRAP | LOWRD | STR | XPRINT SET COLORMODE |
| CONTROL SET LOC | GRAPHIC GET WRAP | LPRINT | STR$ | XPRINT SET COPIES |
| CONTROL SET OPTION | GRAPHIC IMAGELIST | LPRINT ATTACH | STRDELETE | XPRINT SET DUPLEX |
| CONTROL SET SIZE | GRAPHIC INKEY$ | LPRINT CLOSE | STRDELETE$ | XPRINT SET FONT |
| CONTROL SET TEXT | GRAPHIC INPUT | LPRINT FLUSH | STRING | XPRINT SET MIX |
| CONTROL SET USER | GRAPHIC INPUT FLUSH | LPRINT FORMFEED | STRINSERT | XPRINT SET ORIENTATION |
| CONTROL SHOW STATE | GRAPHIC INSTAT | LPRINT$ | STRINSERT$ | XPRINT SET OVERLAP |
| COS | GRAPHIC LINE | LSET | STRPTR | XPRINT SET PAGES |
| COSH | GRAPHIC LINE INPUT | LSET$ | STRREVERSE | XPRINT SET PAPER |
| COT | GRAPHIC PAINT | LTRIM | STRREVERSE$ | XPRINT SET PIXEL |
| COTH | GRAPHIC PIE | LTRIM$ | SWAP | XPRINT SET POS |
| CQUAD | GRAPHIC POLYGON | MACRO/END MACRO | SWITCH | XPRINT SET QUALITY |
| CSC | GRAPHIC POLYLINE | MAK | SWITCH$ | XPRINT SET STRETCHMODE |
| CSCH | GRAPHIC PRINT | MAT | TAB DELETE | XPRINT SET TEXTALIGN |
| CSET | GRAPHIC REDRAW | MAX | TAB GET COUNT | XPRINT SET TRAY |
| CSET$ | GRAPHIC RENDER | MCASE | TAB GET DIALOG | XPRINT SET WORDWRAP |
| CSNG | GRAPHIC SAVE | MCASE$ | TAB GET IMAGE | XPRINT SET WRAP |
| CSTR | GRAPHIC SCALE | MEMORY | TAB GET PAGE | XPRINT SPLIT |
| CULNG | GRAPHIC SCALE PIXELS | MEMORY FILL | TAB GET SELECT | XPRINT STRETCH |
| CURDIR | GRAPHIC SET AUTOSIZE | MEMORY FILLS | TAB GET TEXT | XPRINT STYLE |
| CURDIR$ | GRAPHIC SET BITS | MENU ADD POPUP | TAB INSERT PAGE | XPRINT TEXT SIZE |
| CVBYT | GRAPHIC SET CAPTION | MENU ADD STRING | TAB RESET | XPRINT WIDTH |
| CVCUX | GRAPHIC SET CLIENT | MENU ATTACH | TAB SELECT |  |

## **Newly** implemented by this branch

> **706 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG SET CLIENT | ISEVEN | SGN |
| ACCEL ATTACH | DIALOG SET COLOR | ISFALSE | SHRINK |
| ACODE | DIALOG SET ICON | ISFILE | SHRINK$ |
| ACODE$ | DIALOG SET LOC | ISFOLDER | SIN |
| ACOS | DIALOG SET SIZE | ISINFINITE | SINGLE |
| ACOSH | DIALOG SET TEXT | ISNORMAL | SINH |
| ARRAY ADD | DIALOG SET USER | ISODD | SIZEOF |
| ARRAY ARRAYIX | DIALOG SHOW MODAL | ISTRUE | SPACE |
| ARRAY ASSIGN | DIALOG SHOW MODELESS | ISWIN | SPACE$ |
| ARRAY COPY | DIALOG SHOW STATE | JOIN$ | SQR |
| ARRAY DELETE | DIALOG STABILIZE | LCASE | STATUSBAR SET PARTS |
| ARRAY INSERT | DIALOG UNITS | LCASE$ | STATUSBAR SET TEXT |
| ARRAY REDIM DECR | DIM | LEFT | STR |
| ARRAY REDIM INCR | DIR | LEFT$ | STR$ |
| ARRAY REVERSE | DIR CLOSE | LEN | STRDELETE |
| ARRAY SCAN | DIR$ | LET *(WITH OBJECTS)* | STRDELETE$ |
| ARRAY SHUFFLE | DISKFREE | LET *(WITH VARIANTS)* | STRING |
| ARRAY SWAP | DISKSIZE | LINE INPUT# | STRINSERT |
| ARRAY TAGARRAY | DISPLAY BROWSE | LISTBOX ADD | STRINSERT$ |
| ARRAY TAGARRAY ERASE | DISPLAY COLOR | LISTBOX DELETE | STRPTR |
| ARRAY UNIQUE | DISPLAY FONT | LISTBOX FIND | STRREVERSE |
| ASIN | DISPLAY OPENFILE | LISTBOX FIND EXACT | STRREVERSE$ |
| ASINH | DISPLAY SAVEFILE | LISTBOX GET COUNT | SWITCH |
| ATANH | DOUBLE | LISTBOX GET SELCOUNT | SWITCH$ |
| ATN | ENVIRON$ | LISTBOX GET SELECT | TAB DELETE |
| ATN2 | EOF | LISTBOX GET STATE | TAB GET COUNT |
| BGR | EQV | LISTBOX GET TEXT | TAB GET DIALOG |
| BIN | ERF | LISTBOX GET USER | TAB GET IMAGE |
| BIN$ | ERL | LISTBOX INSERT | TAB GET PAGE |
| BITS | ERL$ | LISTBOX RESET | TAB GET SELECT |
| BITS$ | ERR | LISTBOX SELECT | TAB GET TEXT |
| BITSE | ERRCLEAR | LISTBOX SET TEXT | TAB INSERT PAGE |
| BUILD | ERROR$ | LISTBOX SET USER | TAB RESET |
| BUILD$ | EVENT SOURCE | LISTBOX UNSELECT | TAB SELECT |
| BYTE | EVENTS | LISTVIEW DELETE COLUMN | TAB SET IMAGE |
| CALLSTK$ | EXE | LISTVIEW DELETE ITEM | TAB SET IMAGELIST |
| CALLSTKCOUNT | EXIST | LISTVIEW FIND | TAB SET TEXT |
| CBOOL | EXP | LISTVIEW FIND EXACT | TAB$ |
| CBRT | EXP10 | LISTVIEW FIT CONTENT | TALLY |
| CBYTE | EXP2 | LISTVIEW FIT HEADER | TAN |
| CDBL | EXPM1 | LISTVIEW GET COLUMN | TANH |
| CDWORD | EXTRACT | LISTVIEW GET COUNT | TCP NOTIFY |
| CEIL | EXTRACT$ | LISTVIEW GET HEADER | THREADCOUNT |
| CFLT | FILEATTR | LISTVIEW GET HEADERID | THREADID |
| CHOOSE | FILENAME | LISTVIEW GET MODE | TIMER |
| CHR | FILENAME$ | LISTVIEW GET SELCOUNT | TOOLBAR ADD BUTTON |
| CHR$ | FIX | LISTVIEW GET SELECT | TOOLBAR ADD SEPARATOR |
| CHRBYTES | FLOOR | LISTVIEW GET STATE | TOOLBAR DELETE BUTTON |
| CHRTOOEM | FONT END | LISTVIEW GET STYLEXX | TOOLBAR GET COUNT |
| CHRTOOEM$ | FONT NEW | LISTVIEW GET TEXT | TOOLBAR GET STATE |
| CHRTOUTF8 | FORMAT | LISTVIEW GET USER | TOOLBAR SET IMAGELIST |
| CHRTOUTF8$ | FORMAT$ | LISTVIEW INSERT COLUMN | TOOLBAR SET STATE |
| CLIP | FRAC | LISTVIEW INSERT ITEM | TREEVIEW DELETE |
| CLIP$ | FRE | LISTVIEW RESET | TREEVIEW GET BOLD |
| CLOSE | FREEFILE | LISTVIEW SELECT | TREEVIEW GET CHECK |
| CODEPTR | FUNCNAME | LISTVIEW SET COLUMN | TREEVIEW GET CHILD |
| COMBOBOX ADD | FUNCNAME$ | LISTVIEW SET HEADER | TREEVIEW GET COUNT |
| COMBOBOX DELETE | GET | LISTVIEW SET IMAGE | TREEVIEW GET EXPANDED |
| COMBOBOX FIND | GET STR | LISTVIEW SET IMAGE2 | TREEVIEW GET NEXT |
| COMBOBOX FIND EXACT | GET WSTR | LISTVIEW SET IMAGELIST | TREEVIEW GET PARENT |
| COMBOBOX GET COUNT | GET$ | LISTVIEW SET MODE | TREEVIEW GET PREVIOUS |
| COMBOBOX GET SELCOUNT | GET$$ | LISTVIEW SET OVERLAY | TREEVIEW GET ROOT |
| COMBOBOX GET SELECT | GETATTR | LISTVIEW SET STYLEXX | TREEVIEW GET SELECT |
| COMBOBOX GET STATE | GRAPHIC ARC | LISTVIEW SET TEXT | TREEVIEW GET TEXT |
| COMBOBOX GET TEXT | GRAPHIC ATTACH | LISTVIEW SET USER | TREEVIEW GET USER |
| COMBOBOX GET USER | GRAPHIC BITMAP END | LISTVIEW SORT | TREEVIEW INSERT ITEM |
| COMBOBOX INSERT | GRAPHIC BITMAP LOAD | LISTVIEW UNSELECT | TREEVIEW RESET |
| COMBOBOX RESET | GRAPHIC BITMAP NEW | LISTVIEW VISIBLE | TREEVIEW SELECT |
| COMBOBOX SELECT | GRAPHIC BOX | LO | TREEVIEW SET BOLD |
| COMBOBOX SET TEXT | GRAPHIC CELL | LOC | TREEVIEW SET CHECK |
| COMBOBOX SET USER | GRAPHIC CELL SIZE | LOF | TREEVIEW SET EXPANDED |
| COMBOBOX UNSELECT | GRAPHIC CHR SIZE | LOG | TREEVIEW SET IMAGELIST |
| COMM LINE INPUT | GRAPHIC CIRCLE | LOG10 | TREEVIEW SET TEXT |
| COMMAND | GRAPHIC CLEAR | LOG1P | TREEVIEW SET USER |
| COMMAND$ | GRAPHIC COLOR | LOG2 | TREEVIEW UNSELECT |
| CONTROL ADD | GRAPHIC COPY | LONG | TRIM |
| CONTROL ADD BUTTON | GRAPHIC DETACH | LOWRD | TRIM$ |
| CONTROL ADD CHECK3STATE | GRAPHIC ELLIPSE | LPRINT$ | TRUNC |
| CONTROL ADD CHECKBOX | GRAPHIC GET BITS | LSET$ | UCASE |
| CONTROL ADD COMBOBOX | GRAPHIC GET CANVAS | LTRIM | UCASE$ |
| CONTROL ADD FRAME | GRAPHIC GET CAPTION | LTRIM$ | UCODE$ |
| CONTROL ADD GRAPHIC | GRAPHIC GET CLIENT | MAK | UCODEPAGE |
| CONTROL ADD HEADER | GRAPHIC GET CLIP | MAX | UDP NOTIFY |
| CONTROL ADD IMAGE | GRAPHIC GET DC | MCASE | UNWRAP |
| CONTROL ADD IMAGEX | GRAPHIC GET LINES | MCASE$ | UNWRAP$ |
| CONTROL ADD IMGBUTTON | GRAPHIC GET LOC | MEMORY FILL | USING |
| CONTROL ADD IMGBUTTONX | GRAPHIC GET MIX | MEMORY FILLS | USING$ |
| CONTROL ADD LABEL | GRAPHIC GET OVERLAP | MENU ADD POPUP | UTF8TOCHR |
| CONTROL ADD LINE | GRAPHIC GET PIXEL | MENU ADD STRING | UTF8TOCHR$ |
| CONTROL ADD LISTBOX | GRAPHIC GET POS | MENU ATTACH | VARPTR |
| CONTROL ADD LISTVIEW | GRAPHIC GET PPI | MENU CONTEXT | VERIFY |
| CONTROL ADD OPTION | GRAPHIC GET SCALE | MENU DELETE | WAITKEY |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET SCROLLTEXT | MENU DRAW BAR | WAITKEY$ |
| CONTROL ADD SCROLLBAR | GRAPHIC GET SIZE | MENU GET STATE | WORD |
| CONTROL ADD STATUSBAR | GRAPHIC GET STRETCHMODE | MENU GET TEXT | WRAP |
| CONTROL ADD TAB | GRAPHIC GET TEXTALIGN | MENU NEW BAR | WRAP$ |
| CONTROL ADD TEXTBOX | GRAPHIC GET VIEW | MENU NEW POPUP | WRITE |
| CONTROL ADD TOOLBAR | GRAPHIC GET WORDWRAP | MENU SET STATE | WRITE# |
| CONTROL ADD TREEVIEW | GRAPHIC GET WRAP | MENU SET TEXT | XPRINT ARC |
| CONTROL DISABLE | GRAPHIC IMAGELIST | METRICS | XPRINT ATTACH |
| CONTROL ENABLE | GRAPHIC INKEY$ | MID | XPRINT BOX |
| CONTROL GET CHECK | GRAPHIC INPUT | MIN | XPRINT CANCEL |
| CONTROL GET CLIENT | GRAPHIC INPUT FLUSH | MKBYT | XPRINT CELL |
| CONTROL GET LOC | GRAPHIC INSTAT | MKCUX | XPRINT CELL SIZE |
| CONTROL GET SIZE | GRAPHIC LINE | MKDWD | XPRINT CHR SIZE |
| CONTROL GET TEXT | GRAPHIC LINE INPUT | MKE | XPRINT CLOSE |
| CONTROL GET USER | GRAPHIC PAINT | MKS | XPRINT COLOR |
| CONTROL HANDLE | GRAPHIC PIE | MKWRD | XPRINT COPY |
| CONTROL HIDE | GRAPHIC POLYGON | MOD | XPRINT ELLIPSE |
| CONTROL KILL | GRAPHIC POLYLINE | MONTHNAME | XPRINT FORMFEED |
| CONTROL NORMALIZE | GRAPHIC PRINT | MONTHNAME$ | XPRINT GET ATTACH |
| CONTROL POST | GRAPHIC REDRAW | NUL$ | XPRINT GET CANVAS |
| CONTROL REDRAW | GRAPHIC RENDER | OCT | XPRINT GET CLIENT |
| CONTROL SEND | GRAPHIC SAVE | OCT$ | XPRINT GET CLIP |
| CONTROL SET CHECK | GRAPHIC SCALE | OEMTOCHR | XPRINT GET COLLATE |
| CONTROL SET CLIENT | GRAPHIC SCALE PIXELS | OEMTOCHR$ | XPRINT GET COLOR |
| CONTROL SET COLOR | GRAPHIC SET AUTOSIZE | ON CALL | XPRINT GET COLORMODE |
| CONTROL SET FOCUS | GRAPHIC SET BITS | ON GOSUB | XPRINT GET COPIES |
| CONTROL SET FONT | GRAPHIC SET CAPTION | ON GOTO | XPRINT GET DC |
| CONTROL SET IMAGE | GRAPHIC SET CLIENT | OPEN | XPRINT GET DUPLEX |
| CONTROL SET IMAGEX | GRAPHIC SET CLIP | PARSE$ | XPRINT GET LINES |
| CONTROL SET IMGBUTTON | GRAPHIC SET FIXED | PARSECOUNT | XPRINT GET MARGIN |
| CONTROL SET IMGBUTTONX | GRAPHIC SET FOCUS | PATHNAME | XPRINT GET MIX |
| CONTROL SET LOC | GRAPHIC SET FONT | PATHNAME$ | XPRINT GET ORIENTATION |
| CONTROL SET OPTION | GRAPHIC SET LOC | PATHSCAN | XPRINT GET OVERLAP |
| CONTROL SET SIZE | GRAPHIC SET MIX | PATHSCAN$ | XPRINT GET PAGES |
| CONTROL SET TEXT | GRAPHIC SET OVERLAP | PEEK | XPRINT GET PAPER |
| CONTROL SET USER | GRAPHIC SET PIXEL | PLAY | XPRINT GET PAPERS |
| CONTROL SHOW STATE | GRAPHIC SET POS | PLAY SOUND | XPRINT GET PIXEL |
| COS | GRAPHIC SET SCROLLTEXT | POKE | XPRINT GET POS |
| COSH | GRAPHIC SET SIZE | PRINTER$ | XPRINT GET PPI |
| COT | GRAPHIC SET STRETCHMODE | PRINTERCOUNT | XPRINT GET QUALITY |
| COTH | GRAPHIC SET TEXTALIGN | PROGRESSBAR GET POS | XPRINT GET SCALE |
| CQUAD | GRAPHIC SET VIEW | PROGRESSBAR GET RANGE | XPRINT GET SELECTION |
| CSC | GRAPHIC SET VIRTUAL | PROGRESSBAR SET POS | XPRINT GET SIZE |
| CSCH | GRAPHIC SET WORDWRAP | PROGRESSBAR SET RANGE | XPRINT GET STRETCHMODE |
| CSET$ | GRAPHIC SET WRAP | PROGRESSBAR SET STEP | XPRINT GET TEXTALIGN |
| CSNG | GRAPHIC SPLIT | PROGRESSBAR STEP | XPRINT GET TRAY |
| CSTR | GRAPHIC STRETCH | PUT | XPRINT GET TRAYS |
| CULNG | GRAPHIC STYLE | PUT STR | XPRINT GET WORDWRAP |
| CURDIR | GRAPHIC TEXT SIZE | PUT WSTR | XPRINT GET WRAP |
| CURDIR$ | GRAPHIC WAITKEY$ | PUT$ | XPRINT IMAGELIST |
| CVBYT | GRAPHIC WIDTH | PUT$$ | XPRINT LINE |
| CVCUX | GRAPHIC WINDOW | QUAD | XPRINT PIE |
| CVDWD | GRAPHIC WINDOW CLICK | RAISEEVENT | XPRINT POLYGON |
| CVL | GRAPHIC WINDOW END | READ | XPRINT POLYLINE |
| CVQ | GRAPHIC WINDOW HIDE | READ$ | XPRINT PREVIEW |
| CVW | GRAPHIC WINDOW MINIMIZE | REDIM | XPRINT PRINT |
| CWORD | GRAPHIC WINDOW NONSTABLE | REMAIN | XPRINT RENDER |
| DATACOUNT | GRAPHIC WINDOW NORMALIZE | REMAIN$ | XPRINT SCALE |
| DAYNAME | GRAPHIC WINDOW STABILIZE | REMOVE | XPRINT SET CLIP |
| DAYNAME$ | HEADER GET COUNT | REMOVE$ | XPRINT SET COLLATE |
| DEC | HEADER GET ITEM | REPEAT | XPRINT SET COLOR |
| DEC$ | HEADER SEND | REPEAT$ | XPRINT SET COLORMODE |
| DECLARE | HEADER SET ITEM | RESOURCE SAVE FILE | XPRINT SET COPIES |
| DEF | HEX | RESOURCE$ | XPRINT SET DUPLEX |
| DESKTOP GET PPI | HEX$ | RETAIN | XPRINT SET FONT |
| DIALOG DEFAULT FONT | HI | RETAIN$ | XPRINT SET MIX |
| DIALOG DISABLE | HIWRD | RGB | XPRINT SET ORIENTATION |
| DIALOG DOEVENTS | HYPOT | RIGHT | XPRINT SET OVERLAP |
| DIALOG ENABLE | IIF | RIGHT$ | XPRINT SET PAGES |
| DIALOG END | IMAGELIST ADD BITMAP | RND | XPRINT SET PAPER |
| DIALOG GET CLIENT | IMAGELIST ADD ICON | ROUND | XPRINT SET PIXEL |
| DIALOG GET LOC | IMAGELIST ADD MASKED | RSET$ | XPRINT SET POS |
| DIALOG GET SIZE | IMAGELIST COUNT | RTRIM | XPRINT SET QUALITY |
| DIALOG GET TEXT | IMAGELIST GET COUNT | RTRIM$ | XPRINT SET STRETCHMODE |
| DIALOG GET USER | IMAGELIST KILL | SCROLLBAR GET PAGESIZE | XPRINT SET TEXTALIGN |
| DIALOG HIDE | IMAGELIST NEW | SCROLLBAR GET POS | XPRINT SET TRAY |
| DIALOG MAXIMIZE | IMAGELIST NEW BITMAP | SCROLLBAR GET RANGE | XPRINT SET WORDWRAP |
| DIALOG MINIMIZE | IMAGELIST NEW ICON | SCROLLBAR GET TRACKPOS | XPRINT SET WRAP |
| DIALOG NEW | IMAGELIST SET OVERLAY | SCROLLBAR SET PAGESIZE | XPRINT SPLIT |
| DIALOG NONSTABLE | IMP | SCROLLBAR SET POS | XPRINT STRETCH |
| DIALOG NORMALIZE | INPUT# | SCROLLBAR SET RANGE | XPRINT STYLE |
| DIALOG PIXELS | INSTANCE | SEC | XPRINT TEXT SIZE |
| DIALOG POST | INSTR | SECH | XPRINT WIDTH |
| DIALOG REDRAW | INT | SEEK |  |
| DIALOG SEND | INTEGER | SETEOF |  |
