...
> Summary: **212** statement-class keywords implemented · **190** DDT/GUI-class
...
| `FONT NEW fontname$ [, points!, style&, charset&, pitch&, escapement&] TO fhndl` | ✅ | 51 (v0.1.45) | pb_gdi_bitmap_new — CreateDIBSection (memory DIB, top-down 32bpp); pb_gdi_bitmap_end — DeleteObject (no-arg destroys last) |
