...
> Summary:
> - **825** official PowerBASIC statement/function keywords currently available for use
>   - **677** implemented or completed by this fork
...
> - **30** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 178 (v0.2.035). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 825 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | CURDIR$ | GRAPHIC SET FONT | MID | TAN |
| ACCEL ATTACH | CVBYT | GRAPHIC SET MIX | MID$ | TANH |
| ACODE | CVCUX | GRAPHIC SET PIXEL | MIN | TCP ACCEPT |
| ACODE$ | CVDWD | GRAPHIC SET POS | MKBYT | TCP CLOSE |
| ACOS | CVL | GRAPHIC SET SIZE | MKBYT$ | TCP LINE INPUT |
| ACOSH | CVQ | GRAPHIC SET STRETCHMODE | MKCUR$ | TCP NOTIFY |
| AND | CVW | GRAPHIC SET TEXTALIGN | MKCUX | TCP OPEN |
| ARRAY ADD | CWORD | GRAPHIC SET VIEW | MKCUX$ | TCP PRINT |
| ARRAY ARRAYIX | DATA | GRAPHIC SET VIRTUAL | MKD$ | TCP RECV |
| ARRAY ASSIGN | DATACOUNT | GRAPHIC SET WORDWRAP | MKDIR | TCP SEND |
| ARRAY COPY | DAYNAME | GRAPHIC SET WRAP | MKDWD | THREAD CLOSE |
| ARRAY DELETE | DAYNAME$ | GRAPHIC STYLE | MKDWD$ | THREAD CREATE |
| ARRAY INSERT | DEC | GRAPHIC TEXT SIZE | MKE | THREAD GET PRIORITY |
| ARRAY REDIM DECR | DEC$ | GRAPHIC WIDTH | MKE$ | THREAD RESUME |
| ARRAY REDIM INCR | DECLARE | HEADER GET COUNT | MKI$ | THREAD SET PRIORITY |
| ARRAY REVERSE | DECR | HEADER GET ITEM | MKL$ | THREAD STATUS |
| ARRAY SCAN | DEF | HEADER SEND | MKQ$ | THREAD SUSPEND |
| ARRAY SHUFFLE | DESKTOP GET CLIENT | HEADER SET ITEM | MKS | THREADCOUNT |
| ARRAY SORT | DESKTOP GET LOC | HEX | MKS$ | THREADED |
| ARRAY SWAP | DESKTOP GET PPI | HEX$ | MKWRD | THREADID |
| ARRAY TAGARRAY | DESKTOP GET SIZE | HI | MKWRD$ | TIMER |
| ARRAY TAGARRAY ERASE | DIALOG DEFAULT FONT | HIWRD | MOD | TIX |
| ARRAY UNIQUE | DIALOG DISABLE | HOST ADDR | MONTHNAME | TOOLBAR ADD BUTTON |
| ASC | DIALOG DOEVENTS | HOST NAME | MONTHNAME$ | TOOLBAR ADD SEPARATOR |
| ASIN | DIALOG ENABLE | HYPOT | MOUSEPTR | TOOLBAR DELETE BUTTON |
| ASINH | DIALOG END | IF | MSGBOX | TOOLBAR GET COUNT |
| ASM | DIALOG GET CLIENT | IF/END IF | NAME | TOOLBAR GET STATE |
| ASMDATA / END ASMDATA | DIALOG GET LOC | IIF | NOT | TOOLBAR SET IMAGELIST |
| ATANH | DIALOG GET SIZE | IMAGELIST ADD BITMAP | NUL | TOOLBAR SET STATE |
| ATN | DIALOG GET TEXT | IMAGELIST ADD ICON | NUL$ | TRACE |
| ATN2 | DIALOG GET USER | IMAGELIST ADD MASKED | OBJECT | TREEVIEW DELETE |
| BEEP | DIALOG HIDE | IMAGELIST COUNT | OCT | TREEVIEW GET BOLD |
| BGR | DIALOG MAXIMIZE | IMAGELIST GET COUNT | OCT$ | TREEVIEW GET CHECK |
| BIN | DIALOG MINIMIZE | IMAGELIST KILL | OEMTOCHR | TREEVIEW GET CHILD |
| BIN$ | DIALOG NEW | IMAGELIST NEW | OEMTOCHR$ | TREEVIEW GET COUNT |
| BIT | DIALOG NONSTABLE | IMAGELIST NEW BITMAP | ON CALL | TREEVIEW GET EXPANDED |
| BIT CALC | DIALOG NORMALIZE | IMAGELIST NEW ICON | ON ERROR | TREEVIEW GET NEXT |
| BITS | DIALOG PIXELS | IMAGELIST SET OVERLAY | ON GOSUB | TREEVIEW GET PARENT |
| BITS$ | DIALOG POST | IMP | ON GOTO | TREEVIEW GET PREVIOUS |
| BITSE | DIALOG REDRAW | IMPORT | OPEN | TREEVIEW GET ROOT |
| BUILD | DIALOG SEND | INCR | OPTION EXPLICIT | TREEVIEW GET SELECT |
| BUILD$ | DIALOG SET CLIENT | INPUT FLUSH | OR | TREEVIEW GET TEXT |
| BYTE | DIALOG SET COLOR | INPUT# | PARSE | TREEVIEW GET USER |
| CALL | DIALOG SET ICON | INSTANCE | PARSE$ | TREEVIEW INSERT ITEM |
| CALL DWORD | DIALOG SET LOC | INSTR | PARSECOUNT | TREEVIEW RESET |
| CALLSTK | DIALOG SET SIZE | INT | PATHNAME | TREEVIEW SELECT |
| CALLSTK$ | DIALOG SET TEXT | INTEGER | PATHNAME$ | TREEVIEW SET BOLD |
| CALLSTKCOUNT | DIALOG SET USER | INTERFACE / END INTERFACE (DIRECT) | PATHSCAN | TREEVIEW SET CHECK |
| CBOOL | DIALOG SHOW MODAL | INTERFACE/END INTERFACE (IDBIND) | PATHSCAN$ | TREEVIEW SET EXPANDED |
| CBRT | DIALOG SHOW MODELESS | ISEVEN | PEEK | TREEVIEW SET IMAGELIST |
| CBYTE | DIALOG SHOW STATE | ISFALSE | PLAY | TREEVIEW SET TEXT |
| CDBL | DIALOG STABILIZE | ISFILE | PLAY SOUND | TREEVIEW SET USER |
| CDWORD | DIALOG UNITS | ISFOLDER | PLAY WAVE | TREEVIEW UNSELECT |
| CEIL | DIM | ISINFINITE | POKE | TRIM |
| CFLT | DIR | ISNORMAL | PREFIX | TRIM$ |
| CHDIR | DIR CLOSE | ISODD | PRINT# | TRUNC |
| CHDRIVE | DIR$ | ISTRUE | PRINTER$ | TRY/END TRY |
| CHOOSE | DISKFREE | ISWIN | PRINTERCOUNT | TYPE SET |
| CHR | DISKSIZE | ITERATE | PROCESS GET PRIORITY | TYPE/END TYPE |
| CHR$ | DISPLAY BROWSE | JOIN$ | PROCESS SET PRIORITY | UCASE |
| CHRBYTES | DISPLAY COLOR | KILL | PROFILE | UCASE$ |
| CHRTOOEM | DISPLAY FONT | LCASE | PROGRESSBAR GET POS | UCODE$ |
| CHRTOOEM$ | DISPLAY OPENFILE | LCASE$ | PROGRESSBAR GET RANGE | UCODEPAGE |
| CHRTOUTF8 | DISPLAY SAVEFILE | LEFT | PROGRESSBAR SET POS | UDP CLOSE |
| CHRTOUTF8$ | DOUBLE | LEFT$ | PROGRESSBAR SET RANGE | UDP NOTIFY |
| CLASS/END CLASS | END | LEN | PROGRESSBAR SET STEP | UDP OPEN |
| CLIP | ENVIRON | LET | PROGRESSBAR STEP | UDP RECV |
| CLIP$ | ENVIRON$ | LET *(WITH OBJECTS)* | PUT | UDP SEND |
| CLIPBOARD | EOF | LET *(WITH TYPES)* | PUT STR | UNLOCK |
| CLOSE | EQV | LET *(WITH VARIANTS)* | PUT WSTR | UNWRAP |
| CLS | ERASE | LINE INPUT# | PUT$ | UNWRAP$ |
| CODEPTR | ERF | LISTBOX ADD | PUT$$ | USING |
| COLOR | ERL | LISTBOX DELETE | QUAD | USING$ |
| COMBOBOX ADD | ERL$ | LISTBOX FIND | RAISEEVENT | UTF8TOCHR |
| COMBOBOX DELETE | ERR | LISTBOX FIND EXACT | RANDOMIZE | UTF8TOCHR$ |
| COMBOBOX FIND | ERRCLEAR | LISTBOX GET COUNT | READ | VAL |
| COMBOBOX FIND EXACT | ERROR | LISTBOX GET SELCOUNT | READ$ | VARPTR |
| COMBOBOX GET COUNT | ERROR$ | LISTBOX GET SELECT | REDIM | VERIFY |
| COMBOBOX GET SELCOUNT | EVENT SOURCE | LISTBOX GET STATE | REGEXPR | WAITKEY |
| COMBOBOX GET SELECT | EVENTS | LISTBOX GET TEXT | REGISTER | WAITKEY$ |
| COMBOBOX GET STATE | EXE | LISTBOX GET USER | REGREPL | WINDOW GET |
| COMBOBOX GET TEXT | EXIST | LISTBOX INSERT | REM | WINDOW SET |
| COMBOBOX GET USER | EXIT | LISTBOX RESET | REMAIN | WORD |
| COMBOBOX INSERT | EXP | LISTBOX SELECT | REMAIN$ | WRAP |
| COMBOBOX RESET | EXP10 | LISTBOX SET TEXT | REMOVE | WRAP$ |
| COMBOBOX SELECT | EXP2 | LISTBOX SET USER | REMOVE$ | WRITE |
| COMBOBOX SET TEXT | EXPM1 | LISTBOX UNSELECT | REPEAT | WRITE# |
| COMBOBOX SET USER | EXTRACT | LISTVIEW DELETE COLUMN | REPEAT$ | XOR |
| COMBOBOX UNSELECT | EXTRACT$ | LISTVIEW DELETE ITEM | REPLACE | XPRINT ARC |
| COMM CLOSE | FIELD | LISTVIEW FIND | RESET | XPRINT ATTACH |
| COMM LINE | FILEATTR | LISTVIEW FIND EXACT | RESOURCE SAVE FILE | XPRINT BOX |
| COMM LINE INPUT | FILECOPY | LISTVIEW FIT CONTENT | RESOURCE$ | XPRINT CANCEL |
| COMM OPEN | FILENAME | LISTVIEW FIT HEADER | RESUME | XPRINT CELL |
| COMM PRINT | FILENAME$ | LISTVIEW GET COLUMN | RETAIN | XPRINT CELL SIZE |
| COMM RECV | FILESCAN | LISTVIEW GET COUNT | RETAIN$ | XPRINT CHR SIZE |
| COMM RESET | FIX | LISTVIEW GET HEADER | RETURN | XPRINT CLOSE |
| COMM SEND | FLOOR | LISTVIEW GET HEADERID | RGB | XPRINT COLOR |
| COMM SET | FLUSH | LISTVIEW GET MODE | RIGHT | XPRINT COPY |
| COMM TIMEOUT | FONT END | LISTVIEW GET SELCOUNT | RIGHT$ | XPRINT ELLIPSE |
| COMMAND | FONT NEW | LISTVIEW GET SELECT | RMDIR | XPRINT FORMFEED |
| COMMAND$ | FOR / NEXT | LISTVIEW GET STATE | RND | XPRINT GET ATTACH |
| CONTROL ADD | FORMAT | LISTVIEW GET STYLEXX | ROTATE | XPRINT GET CANVAS |
| CONTROL ADD BUTTON | FORMAT$ | LISTVIEW GET TEXT | ROUND | XPRINT GET CLIENT |
| CONTROL ADD CHECK3STATE | FRAC | LISTVIEW GET USER | RSET | XPRINT GET CLIP |
| CONTROL ADD CHECKBOX | FRE | LISTVIEW INSERT COLUMN | RSET$ | XPRINT GET COLLATE |
| CONTROL ADD COMBOBOX | FREEFILE | LISTVIEW INSERT ITEM | RTRIM | XPRINT GET COLOR |
| CONTROL ADD FRAME | FUNCNAME | LISTVIEW RESET | RTRIM$ | XPRINT GET COLORMODE |
| CONTROL ADD IMAGE | FUNCNAME$ | LISTVIEW SELECT | SCROLLBAR GET PAGESIZE | XPRINT GET COPIES |
| CONTROL ADD IMAGEX | FUNCTION / END FUNCTION | LISTVIEW SET COLUMN | SCROLLBAR GET POS | XPRINT GET DC |
| CONTROL ADD IMGBUTTON | GET | LISTVIEW SET HEADER | SCROLLBAR GET RANGE | XPRINT GET DUPLEX |
| CONTROL ADD IMGBUTTONX | GET STR | LISTVIEW SET IMAGE | SCROLLBAR GET TRACKPOS | XPRINT GET LINES |
| CONTROL ADD LABEL | GET WSTR | LISTVIEW SET IMAGE2 | SCROLLBAR SET PAGESIZE | XPRINT GET MARGIN |
| CONTROL ADD LINE | GET$ | LISTVIEW SET IMAGELIST | SCROLLBAR SET POS | XPRINT GET MIX |
| CONTROL ADD LISTBOX | GET$$ | LISTVIEW SET MODE | SCROLLBAR SET RANGE | XPRINT GET ORIENTATION |
| CONTROL ADD LISTVIEW | GETATTR | LISTVIEW SET OVERLAY | SEC | XPRINT GET OVERLAP |
| CONTROL ADD OPTION | GLOBAL | LISTVIEW SET STYLEXX | SECH | XPRINT GET PAGES |
| CONTROL ADD PROGRESSBAR | GLOBALMEM | LISTVIEW SET TEXT | SEEK | XPRINT GET PAPER |
| CONTROL ADD SCROLLBAR | GRAPHIC ARC | LISTVIEW SET USER | SELECT CASE/END SELECT | XPRINT GET PAPERS |
| CONTROL ADD STATUSBAR | GRAPHIC ATTACH | LISTVIEW SORT | SETATTR | XPRINT GET PIXEL |
| CONTROL ADD TAB | GRAPHIC BITMAP END | LISTVIEW UNSELECT | SETEOF | XPRINT GET POS |
| CONTROL ADD TEXTBOX | GRAPHIC BITMAP LOAD | LISTVIEW VISIBLE | SGN | XPRINT GET PPI |
| CONTROL ADD TOOLBAR | GRAPHIC BITMAP NEW | LO | SHELL | XPRINT GET QUALITY |
| CONTROL ADD TREEVIEW | GRAPHIC BOX | LOC | SHIFT | XPRINT GET SCALE |
| CONTROL DISABLE | GRAPHIC CELL | LOCAL | SHRINK | XPRINT GET SELECTION |
| CONTROL ENABLE | GRAPHIC CELL SIZE | LOCK | SHRINK$ | XPRINT GET SIZE |
| CONTROL GET CHECK | GRAPHIC CHR SIZE | LOF | SIN | XPRINT GET STRETCHMODE |
| CONTROL GET CLIENT | GRAPHIC CIRCLE | LOG | SINGLE | XPRINT GET TEXTALIGN |
| CONTROL GET LOC | GRAPHIC CLEAR | LOG10 | SINH | XPRINT GET TRAY |
| CONTROL GET SIZE | GRAPHIC COLOR | LOG1P | SIZEOF | XPRINT GET TRAYS |
| CONTROL GET TEXT | GRAPHIC COPY | LOG2 | SLEEP | XPRINT GET WORDWRAP |
| CONTROL GET USER | GRAPHIC DETACH | LONG | SPACE | XPRINT GET WRAP |
| CONTROL HANDLE | GRAPHIC ELLIPSE | LOWRD | SPACE$ | XPRINT IMAGELIST |
| CONTROL HIDE | GRAPHIC GET BITS | LPRINT | SPLIT | XPRINT LINE |
| CONTROL KILL | GRAPHIC GET CANVAS | LPRINT ATTACH | SQR | XPRINT PIE |
| CONTROL NORMALIZE | GRAPHIC GET CAPTION | LPRINT CLOSE | STATIC | XPRINT POLYGON |
| CONTROL POST | GRAPHIC GET CLIENT | LPRINT FLUSH | STATUSBAR SET PARTS | XPRINT POLYLINE |
| CONTROL REDRAW | GRAPHIC GET CLIP | LPRINT FORMFEED | STATUSBAR SET TEXT | XPRINT PREVIEW |
| CONTROL SEND | GRAPHIC GET DC | LPRINT$ | STR | XPRINT PRINT |
| CONTROL SET CHECK | GRAPHIC GET LINES | LSET | STR$ | XPRINT RENDER |
| CONTROL SET CLIENT | GRAPHIC GET LOC | LSET$ | STRDELETE | XPRINT SCALE |
| CONTROL SET FOCUS | GRAPHIC GET MIX | LTRIM | STRDELETE$ | XPRINT SET CLIP |
| CONTROL SET FONT | GRAPHIC GET PIXEL | LTRIM$ | STRING | XPRINT SET COLLATE |
| CONTROL SET IMAGE | GRAPHIC GET POS | MACRO/END MACRO | STRINSERT | XPRINT SET COLOR |
| CONTROL SET IMAGEX | GRAPHIC GET PPI | MAK | STRINSERT$ | XPRINT SET COLORMODE |
| CONTROL SET IMGBUTTON | GRAPHIC GET SCALE | MAT | STRPTR | XPRINT SET COPIES |
| CONTROL SET IMGBUTTONX | GRAPHIC GET SIZE | MAX | STRREVERSE | XPRINT SET DUPLEX |
| CONTROL SET LOC | GRAPHIC GET STRETCHMODE | MCASE | STRREVERSE$ | XPRINT SET FONT |
| CONTROL SET OPTION | GRAPHIC GET TEXTALIGN | MCASE$ | SWAP | XPRINT SET MIX |
| CONTROL SET SIZE | GRAPHIC GET VIEW | MEMORY | SWITCH | XPRINT SET ORIENTATION |
| CONTROL SET TEXT | GRAPHIC GET WORDWRAP | MEMORY FILL | SWITCH$ | XPRINT SET OVERLAP |
| CONTROL SET USER | GRAPHIC GET WRAP | MEMORY FILLS | TAB DELETE | XPRINT SET PAGES |
| CONTROL SHOW STATE | GRAPHIC LINE | MENU ADD POPUP | TAB GET COUNT | XPRINT SET PAPER |
| COS | GRAPHIC PAINT | MENU ADD STRING | TAB GET DIALOG | XPRINT SET PIXEL |
| COSH | GRAPHIC PIE | MENU ATTACH | TAB GET IMAGE | XPRINT SET POS |
| COT | GRAPHIC POLYGON | MENU CONTEXT | TAB GET PAGE | XPRINT SET QUALITY |
| COTH | GRAPHIC POLYLINE | MENU DELETE | TAB GET SELECT | XPRINT SET STRETCHMODE |
| CQUAD | GRAPHIC PRINT | MENU DRAW BAR | TAB GET TEXT | XPRINT SET TEXTALIGN |
| CSC | GRAPHIC SAVE | MENU GET STATE | TAB INSERT PAGE | XPRINT SET TRAY |
| CSCH | GRAPHIC SCALE | MENU GET TEXT | TAB RESET | XPRINT SET WORDWRAP |
| CSET | GRAPHIC SCALE PIXELS | MENU NEW BAR | TAB SELECT | XPRINT SET WRAP |
| CSET$ | GRAPHIC SET AUTOSIZE | MENU NEW POPUP | TAB SET IMAGE | XPRINT SPLIT |
| CSNG | GRAPHIC SET BITS | MENU SET STATE | TAB SET IMAGELIST | XPRINT STRETCH |
| CSTR | GRAPHIC SET CAPTION | MENU SET TEXT | TAB SET TEXT | XPRINT STYLE |
| CULNG | GRAPHIC SET CLIP | METHOD / END METHOD | TAB$ | XPRINT TEXT SIZE |
| CURDIR | GRAPHIC SET FIXED | METRICS | TALLY | XPRINT WIDTH |

## **Newly** implemented by this branch

> **677 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG PIXELS | LET *(WITH OBJECTS)* | SPACE$ |
| ACCEL ATTACH | DIALOG POST | LET *(WITH VARIANTS)* | SQR |
| ACODE | DIALOG REDRAW | LINE INPUT# | STATUSBAR SET PARTS |
| ACODE$ | DIALOG SEND | LISTBOX ADD | STATUSBAR SET TEXT |
| ACOS | DIALOG SET CLIENT | LISTBOX DELETE | STR |
| ACOSH | DIALOG SET COLOR | LISTBOX FIND | STR$ |
| ARRAY ADD | DIALOG SET ICON | LISTBOX FIND EXACT | STRDELETE |
| ARRAY ARRAYIX | DIALOG SET LOC | LISTBOX GET COUNT | STRDELETE$ |
| ARRAY ASSIGN | DIALOG SET SIZE | LISTBOX GET SELCOUNT | STRING |
| ARRAY COPY | DIALOG SET TEXT | LISTBOX GET SELECT | STRINSERT |
| ARRAY DELETE | DIALOG SET USER | LISTBOX GET STATE | STRINSERT$ |
| ARRAY INSERT | DIALOG SHOW MODAL | LISTBOX GET TEXT | STRPTR |
| ARRAY REDIM DECR | DIALOG SHOW MODELESS | LISTBOX GET USER | STRREVERSE |
| ARRAY REDIM INCR | DIALOG SHOW STATE | LISTBOX INSERT | STRREVERSE$ |
| ARRAY REVERSE | DIALOG STABILIZE | LISTBOX RESET | SWITCH |
| ARRAY SCAN | DIALOG UNITS | LISTBOX SELECT | SWITCH$ |
| ARRAY SHUFFLE | DIM | LISTBOX SET TEXT | TAB DELETE |
| ARRAY SWAP | DIR | LISTBOX SET USER | TAB GET COUNT |
| ARRAY TAGARRAY | DIR CLOSE | LISTBOX UNSELECT | TAB GET DIALOG |
| ARRAY TAGARRAY ERASE | DIR$ | LISTVIEW DELETE COLUMN | TAB GET IMAGE |
| ARRAY UNIQUE | DISKFREE | LISTVIEW DELETE ITEM | TAB GET PAGE |
| ASIN | DISKSIZE | LISTVIEW FIND | TAB GET SELECT |
| ASINH | DISPLAY BROWSE | LISTVIEW FIND EXACT | TAB GET TEXT |
| ATANH | DISPLAY COLOR | LISTVIEW FIT CONTENT | TAB INSERT PAGE |
| ATN | DISPLAY FONT | LISTVIEW FIT HEADER | TAB RESET |
| ATN2 | DISPLAY OPENFILE | LISTVIEW GET COLUMN | TAB SELECT |
| BGR | DISPLAY SAVEFILE | LISTVIEW GET COUNT | TAB SET IMAGE |
| BIN | DOUBLE | LISTVIEW GET HEADER | TAB SET IMAGELIST |
| BIN$ | ENVIRON$ | LISTVIEW GET HEADERID | TAB SET TEXT |
| BITS | EOF | LISTVIEW GET MODE | TAB$ |
| BITS$ | EQV | LISTVIEW GET SELCOUNT | TALLY |
| BITSE | ERF | LISTVIEW GET SELECT | TAN |
| BUILD | ERL | LISTVIEW GET STATE | TANH |
| BUILD$ | ERL$ | LISTVIEW GET STYLEXX | TCP NOTIFY |
| BYTE | ERR | LISTVIEW GET TEXT | THREADCOUNT |
| CALLSTK$ | ERRCLEAR | LISTVIEW GET USER | THREADID |
| CALLSTKCOUNT | ERROR$ | LISTVIEW INSERT COLUMN | TIMER |
| CBOOL | EVENT SOURCE | LISTVIEW INSERT ITEM | TOOLBAR ADD BUTTON |
| CBRT | EVENTS | LISTVIEW RESET | TOOLBAR ADD SEPARATOR |
| CBYTE | EXE | LISTVIEW SELECT | TOOLBAR DELETE BUTTON |
| CDBL | EXIST | LISTVIEW SET COLUMN | TOOLBAR GET COUNT |
| CDWORD | EXP | LISTVIEW SET HEADER | TOOLBAR GET STATE |
| CEIL | EXP10 | LISTVIEW SET IMAGE | TOOLBAR SET IMAGELIST |
| CFLT | EXP2 | LISTVIEW SET IMAGE2 | TOOLBAR SET STATE |
| CHOOSE | EXPM1 | LISTVIEW SET IMAGELIST | TREEVIEW DELETE |
| CHR | EXTRACT | LISTVIEW SET MODE | TREEVIEW GET BOLD |
| CHR$ | EXTRACT$ | LISTVIEW SET OVERLAY | TREEVIEW GET CHECK |
| CHRBYTES | FILEATTR | LISTVIEW SET STYLEXX | TREEVIEW GET CHILD |
| CHRTOOEM | FILENAME | LISTVIEW SET TEXT | TREEVIEW GET COUNT |
| CHRTOOEM$ | FILENAME$ | LISTVIEW SET USER | TREEVIEW GET EXPANDED |
| CHRTOUTF8 | FIX | LISTVIEW SORT | TREEVIEW GET NEXT |
| CHRTOUTF8$ | FLOOR | LISTVIEW UNSELECT | TREEVIEW GET PARENT |
| CLIP | FONT END | LISTVIEW VISIBLE | TREEVIEW GET PREVIOUS |
| CLIP$ | FONT NEW | LO | TREEVIEW GET ROOT |
| CLOSE | FORMAT | LOC | TREEVIEW GET SELECT |
| CODEPTR | FORMAT$ | LOF | TREEVIEW GET TEXT |
| COMBOBOX ADD | FRAC | LOG | TREEVIEW GET USER |
| COMBOBOX DELETE | FRE | LOG10 | TREEVIEW INSERT ITEM |
| COMBOBOX FIND | FREEFILE | LOG1P | TREEVIEW RESET |
| COMBOBOX FIND EXACT | FUNCNAME | LOG2 | TREEVIEW SELECT |
| COMBOBOX GET COUNT | FUNCNAME$ | LONG | TREEVIEW SET BOLD |
| COMBOBOX GET SELCOUNT | GET | LOWRD | TREEVIEW SET CHECK |
| COMBOBOX GET SELECT | GET STR | LPRINT$ | TREEVIEW SET EXPANDED |
| COMBOBOX GET STATE | GET WSTR | LSET$ | TREEVIEW SET IMAGELIST |
| COMBOBOX GET TEXT | GET$ | LTRIM | TREEVIEW SET TEXT |
| COMBOBOX GET USER | GET$$ | LTRIM$ | TREEVIEW SET USER |
| COMBOBOX INSERT | GETATTR | MAK | TREEVIEW UNSELECT |
| COMBOBOX RESET | GRAPHIC ARC | MAX | TRIM |
| COMBOBOX SELECT | GRAPHIC ATTACH | MCASE | TRIM$ |
| COMBOBOX SET TEXT | GRAPHIC BITMAP END | MCASE$ | TRUNC |
| COMBOBOX SET USER | GRAPHIC BITMAP LOAD | MEMORY FILL | UCASE |
| COMBOBOX UNSELECT | GRAPHIC BITMAP NEW | MEMORY FILLS | UCASE$ |
| COMM LINE INPUT | GRAPHIC BOX | MENU ADD POPUP | UCODE$ |
| COMMAND | GRAPHIC CELL | MENU ADD STRING | UCODEPAGE |
| COMMAND$ | GRAPHIC CELL SIZE | MENU ATTACH | UDP NOTIFY |
| CONTROL ADD | GRAPHIC CHR SIZE | MENU CONTEXT | UNWRAP |
| CONTROL ADD BUTTON | GRAPHIC CIRCLE | MENU DELETE | UNWRAP$ |
| CONTROL ADD CHECK3STATE | GRAPHIC CLEAR | MENU DRAW BAR | USING |
| CONTROL ADD CHECKBOX | GRAPHIC COLOR | MENU GET STATE | USING$ |
| CONTROL ADD COMBOBOX | GRAPHIC COPY | MENU GET TEXT | UTF8TOCHR |
| CONTROL ADD FRAME | GRAPHIC DETACH | MENU NEW BAR | UTF8TOCHR$ |
| CONTROL ADD IMAGE | GRAPHIC ELLIPSE | MENU NEW POPUP | VARPTR |
| CONTROL ADD IMAGEX | GRAPHIC GET BITS | MENU SET STATE | VERIFY |
| CONTROL ADD IMGBUTTON | GRAPHIC GET CANVAS | MENU SET TEXT | WAITKEY |
| CONTROL ADD IMGBUTTONX | GRAPHIC GET CAPTION | METRICS | WAITKEY$ |
| CONTROL ADD LABEL | GRAPHIC GET CLIENT | MID | WORD |
| CONTROL ADD LINE | GRAPHIC GET CLIP | MIN | WRAP |
| CONTROL ADD LISTBOX | GRAPHIC GET DC | MKBYT | WRAP$ |
| CONTROL ADD LISTVIEW | GRAPHIC GET LINES | MKCUX | WRITE |
| CONTROL ADD OPTION | GRAPHIC GET LOC | MKDWD | WRITE# |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET MIX | MKE | XPRINT ARC |
| CONTROL ADD SCROLLBAR | GRAPHIC GET PIXEL | MKS | XPRINT ATTACH |
| CONTROL ADD STATUSBAR | GRAPHIC GET POS | MKWRD | XPRINT BOX |
| CONTROL ADD TAB | GRAPHIC GET PPI | MOD | XPRINT CANCEL |
| CONTROL ADD TEXTBOX | GRAPHIC GET SCALE | MONTHNAME | XPRINT CELL |
| CONTROL ADD TOOLBAR | GRAPHIC GET SIZE | MONTHNAME$ | XPRINT CELL SIZE |
| CONTROL ADD TREEVIEW | GRAPHIC GET STRETCHMODE | NUL$ | XPRINT CHR SIZE |
| CONTROL DISABLE | GRAPHIC GET TEXTALIGN | OCT | XPRINT CLOSE |
| CONTROL ENABLE | GRAPHIC GET VIEW | OCT$ | XPRINT COLOR |
| CONTROL GET CHECK | GRAPHIC GET WORDWRAP | OEMTOCHR | XPRINT COPY |
| CONTROL GET CLIENT | GRAPHIC GET WRAP | OEMTOCHR$ | XPRINT ELLIPSE |
| CONTROL GET LOC | GRAPHIC LINE | ON CALL | XPRINT FORMFEED |
| CONTROL GET SIZE | GRAPHIC PAINT | ON GOSUB | XPRINT GET ATTACH |
| CONTROL GET TEXT | GRAPHIC PIE | ON GOTO | XPRINT GET CANVAS |
| CONTROL GET USER | GRAPHIC POLYGON | OPEN | XPRINT GET CLIENT |
| CONTROL HANDLE | GRAPHIC POLYLINE | PARSE$ | XPRINT GET CLIP |
| CONTROL HIDE | GRAPHIC PRINT | PARSECOUNT | XPRINT GET COLLATE |
| CONTROL KILL | GRAPHIC SAVE | PATHNAME | XPRINT GET COLOR |
| CONTROL NORMALIZE | GRAPHIC SCALE | PATHNAME$ | XPRINT GET COLORMODE |
| CONTROL POST | GRAPHIC SCALE PIXELS | PATHSCAN | XPRINT GET COPIES |
| CONTROL REDRAW | GRAPHIC SET AUTOSIZE | PATHSCAN$ | XPRINT GET DC |
| CONTROL SEND | GRAPHIC SET BITS | PEEK | XPRINT GET DUPLEX |
| CONTROL SET CHECK | GRAPHIC SET CAPTION | PLAY | XPRINT GET LINES |
| CONTROL SET CLIENT | GRAPHIC SET CLIP | PLAY SOUND | XPRINT GET MARGIN |
...
| DIALOG NEW | LEFT | SINH |  |
| DIALOG NONSTABLE | LEFT$ | SIZEOF |  |
| DIALOG NORMALIZE | LEN | SPACE |  |
