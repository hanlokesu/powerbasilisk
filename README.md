...
> Summary:
> - **451** statement/function keywords implemented
> - **429** DDT/GUI-class deferred (Tier 3)
> - **35** documented but not yet implemented.

**All 451 supported keywords (alphabetical):**
...
| ARRAY SCAN | ARRAY SELECT | ARRAY SHUFFLE | ARRAY SWAP | ARRAY TAGARRAY |
| ARRAY TAGARRAY ERASE | ARRAY UNIQUE | ARRAY_REDIM_DECR | ARRAY_REDIM_INCR | ARRAY_SELECT |
| ARRAY_TAGARRAY | ARRAY_TAGARRAY_ERASE | ASIN | ASINH | ATANH |
| ATN | ATN2 | BGR | BIN | BIN$ |
| BITS | BITS$ | BITSE | BUILD | BUILD$ |
| BYTE | CALLSTK$ | CALLSTKCOUNT | CBOOL | CBRT |
| CBYTE | CDBL | CDWORD | CEIL | CFLT |
| CHOOSE | CHR | CHR$ | CHRBYTES | CHRTOOEM |
| CHRTOOEM$ | CHRTOUTF8 | CHRTOUTF8$ | CLIP | CLIP$ |
| CLOSE | CODEPTR | COMM LINE INPUT | COMMAND | COMMAND$ |
| COS | COSH | COT | COTH | CQUAD |
| CSC | CSCH | CSET$ | CSNG | CSTR |
| CULNG | CURDIR | CURDIR$ | CVBYT | CVCUX |
| CVDWD | CVL | CVQ | CVW | CWORD |
| DATACOUNT | DAYNAME | DAYNAME$ | DEC | DEC$ |
| DECLARE | DESKTOP GET PPI | DIM | DIR | DIR CLOSE |
| DIR$ | DISKFREE | DISKSIZE | DISPLAY_BROWSE | DISPLAY_COLOR |
| DISPLAY_FONT | DISPLAY_OPENFILE | DISPLAY_SAVEFILE | DOUBLE | ENVIRON$ |
| EOF | EQV | ERF | ERL | ERL$ |
| ERR | ERRCLEAR | ERROR$ | EXE | EXIST |
| EXP | EXP10 | EXP2 | EXPM1 | EXTRACT |
| EXTRACT$ | FILEATTR | FILENAME | FILENAME$ | FIX |
| FLOOR | FONT_END | FONT_NEW | FORMAT | FORMAT$ |
| FRAC | FRE | FREEFILE | FUNCNAME | FUNCNAME$ |
| GET | GET$ | GET$$ | GET_STR | GET_WSTR |
| GETATTR | GRAPHIC_ARC | GRAPHIC_ATTACH | GRAPHIC_BITMAP_END | GRAPHIC_BITMAP_LOAD |
| GRAPHIC_BITMAP_NEW | GRAPHIC_CELL | GRAPHIC_CHR_SIZE | GRAPHIC_CIRCLE | GRAPHIC_CLEAR |
| GRAPHIC_COLOR | GRAPHIC_COPY | GRAPHIC_DETACH | GRAPHIC_ELLIPSE | GRAPHIC_GET_BITS |
| GRAPHIC_GET_CAPTION | GRAPHIC_GET_CLIP | GRAPHIC_GET_DC | GRAPHIC_GET_LINES | GRAPHIC_GET_LOC |
...
| GRAPHIC_STYLE | GRAPHIC_TEXT_SIZE | HEADER | HEX | HEX$ |
| HI | HIWRD | HYPOT | IIF | IMAGELIST_COUNT |
| IMAGELIST_KILL | IMAGELIST_NEW | IMP | INPUT# | INSTR |
| INT | INTEGER | ISEVEN | ISFALSE | ISFILE |
| ISFOLDER | ISINFINITE | ISNORMAL | ISODD | ISTRUE |
| ISWIN | JOIN$ | LCASE | LCASE$ | LEFT |
| LEFT$ | LEN | LINE INPUT# | LO | LOC |
| LOF | LOG | LOG10 | LOG1P | LOG2 |
| LONG | LOWRD | LPRINT$ | LSET$ | LTRIM |
| LTRIM$ | MAK | MAX | MCASE | MCASE$ |
| MEMORY_FILL | MEMORY_FILLS | MENU_ADD_POPUP | MENU_ADD_STRING | MENU_DELETE |
| MENU_GET_STATE | MENU_GET_TEXT | MENU_NEW_POPUP | MENU_SET_STATE | MENU_SET_TEXT |
| METRICS | MID | MIN | MKBYT | MKCUX |
| MKDWD | MKE | MKS | MKWRD | MOD |
| MONTHNAME | MONTHNAME$ | NUL$ | OCT | OCT$ |
| OEMTOCHR | OEMTOCHR$ | ON CALL | ON GOSUB | ON GOTO |
| OPEN | PARSE$ | PARSECOUNT | PATHNAME | PATHNAME$ |
| PATHSCAN | PATHSCAN$ | PEEK | PLAY | PLAY SOUND |
| POKE | PRINTER$ | PRINTERCOUNT | PROGRESSBAR | PUT |
| PUT$ | PUT$$ | PUT_STR | PUT_WSTR | QUAD |
| READ | READ$ | REDIM | REMAIN | REMAIN$ |
| REMOVE | REMOVE$ | REPEAT | REPEAT$ | RESOURCE SAVE FILE |
| RESOURCE$ | RETAIN | RETAIN$ | RGB | RIGHT |
| RIGHT$ | RND | ROUND | RSET$ | RTRIM |
| RTRIM$ | SEC | SECH | SEEK | SETEOF |
| SGN | SHRINK | SHRINK$ | SIN | SINGLE |
| SINH | SIZEOF | SPACE | SPACE$ | SQR |
| STR | STR$ | STRDELETE | STRDELETE$ | STRING |
| STRINSERT | STRINSERT$ | STRPTR | STRREVERSE | STRREVERSE$ |
| SWITCH | SWITCH$ | TAB$ | TALLY | TAN |
| TANH | TCP_NOTIFY | THREADCOUNT | THREADID | TIMER |
| TRIM | TRIM$ | TRUNC | UCASE | UCASE$ |
| UCODE$ | UDP_NOTIFY | UNWRAP | UNWRAP$ | USING |
| USING$ | UTF8TOCHR | UTF8TOCHR$ | VARPTR | VERIFY |
| WAITKEY | WORD | WRAP | WRAP$ | WRITE |
| WRITE# | XPRINT_ARC | XPRINT_ATTACH | XPRINT_BOX | XPRINT_CANCEL |
...
| XPRINT_SET_WORDWRAP | XPRINT_SET_WRAP | XPRINT_SPLIT | XPRINT_STYLE | XPRINT_TEXT_SIZE |
| XPRINT_WIDTH |  |  |  |  |
...
| DIR | DIR$ | DIR CLOSE | DIR NEXT | DISKFREE |
