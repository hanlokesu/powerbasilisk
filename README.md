...
> Summary:
> - **817** official PowerBASIC statement/function keywords currently available for use
>   - **669** implemented or completed by this fork
...
> - **38** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 177 (v0.2.034). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 817 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | CWORD | GRAPHIC SET TEXTALIGN | MKCUR$ | TCP LINE INPUT |
| ACCEL ATTACH | DATA | GRAPHIC SET VIEW | MKCUX | TCP NOTIFY |
| ACODE | DATACOUNT | GRAPHIC SET VIRTUAL | MKCUX$ | TCP OPEN |
| ACODE$ | DAYNAME | GRAPHIC SET WORDWRAP | MKD$ | TCP PRINT |
| ACOS | DAYNAME$ | GRAPHIC SET WRAP | MKDIR | TCP RECV |
| ACOSH | DEC | GRAPHIC STYLE | MKDWD | TCP SEND |
| AND | DEC$ | GRAPHIC TEXT SIZE | MKDWD$ | THREAD CLOSE |
| ARRAY ADD | DECLARE | GRAPHIC WIDTH | MKE | THREAD CREATE |
| ARRAY ARRAYIX | DECR | HEADER GET COUNT | MKE$ | THREAD GET PRIORITY |
| ARRAY ASSIGN | DEF | HEADER GET ITEM | MKI$ | THREAD RESUME |
| ARRAY COPY | DESKTOP GET CLIENT | HEADER SEND | MKL$ | THREAD SET PRIORITY |
| ARRAY DELETE | DESKTOP GET LOC | HEADER SET ITEM | MKQ$ | THREAD STATUS |
| ARRAY INSERT | DESKTOP GET PPI | HEX | MKS | THREAD SUSPEND |
| ARRAY REDIM DECR | DESKTOP GET SIZE | HEX$ | MKS$ | THREADCOUNT |
| ARRAY REDIM INCR | DIALOG DEFAULT FONT | HI | MKWRD | THREADED |
| ARRAY REVERSE | DIALOG DISABLE | HIWRD | MKWRD$ | THREADID |
| ARRAY SCAN | DIALOG DOEVENTS | HOST ADDR | MOD | TIMER |
| ARRAY SHUFFLE | DIALOG ENABLE | HOST NAME | MONTHNAME | TIX |
| ARRAY SORT | DIALOG END | HYPOT | MONTHNAME$ | TOOLBAR ADD BUTTON |
| ARRAY SWAP | DIALOG GET CLIENT | IF | MOUSEPTR | TOOLBAR ADD SEPARATOR |
| ARRAY TAGARRAY | DIALOG GET LOC | IF/END IF | MSGBOX | TOOLBAR DELETE BUTTON |
| ARRAY TAGARRAY ERASE | DIALOG GET SIZE | IIF | NAME | TOOLBAR GET COUNT |
| ARRAY UNIQUE | DIALOG GET TEXT | IMAGELIST ADD BITMAP | NOT | TOOLBAR GET STATE |
| ASC | DIALOG GET USER | IMAGELIST ADD ICON | NUL | TOOLBAR SET IMAGELIST |
| ASIN | DIALOG HIDE | IMAGELIST ADD MASKED | NUL$ | TOOLBAR SET STATE |
| ASINH | DIALOG MAXIMIZE | IMAGELIST COUNT | OBJECT | TRACE |
| ASM | DIALOG MINIMIZE | IMAGELIST GET COUNT | OCT | TREEVIEW DELETE |
| ASMDATA / END ASMDATA | DIALOG NEW | IMAGELIST KILL | OCT$ | TREEVIEW GET BOLD |
| ATANH | DIALOG NONSTABLE | IMAGELIST NEW | OEMTOCHR | TREEVIEW GET CHECK |
| ATN | DIALOG NORMALIZE | IMAGELIST NEW BITMAP | OEMTOCHR$ | TREEVIEW GET CHILD |
| ATN2 | DIALOG PIXELS | IMAGELIST NEW ICON | ON CALL | TREEVIEW GET COUNT |
| BEEP | DIALOG POST | IMAGELIST SET OVERLAY | ON ERROR | TREEVIEW GET EXPANDED |
| BGR | DIALOG REDRAW | IMP | ON GOSUB | TREEVIEW GET NEXT |
| BIN | DIALOG SEND | IMPORT | ON GOTO | TREEVIEW GET PARENT |
| BIN$ | DIALOG SET CLIENT | INCR | OPEN | TREEVIEW GET PREVIOUS |
| BIT | DIALOG SET COLOR | INPUT FLUSH | OPTION EXPLICIT | TREEVIEW GET ROOT |
| BIT CALC | DIALOG SET ICON | INPUT# | OR | TREEVIEW GET SELECT |
| BITS | DIALOG SET LOC | INSTANCE | PARSE | TREEVIEW GET TEXT |
| BITS$ | DIALOG SET SIZE | INSTR | PARSE$ | TREEVIEW GET USER |
| BITSE | DIALOG SET TEXT | INT | PARSECOUNT | TREEVIEW INSERT ITEM |
| BUILD | DIALOG SET USER | INTEGER | PATHNAME | TREEVIEW RESET |
| BUILD$ | DIALOG SHOW MODAL | INTERFACE / END INTERFACE (DIRECT) | PATHNAME$ | TREEVIEW SELECT |
| BYTE | DIALOG SHOW MODELESS | INTERFACE/END INTERFACE (IDBIND) | PATHSCAN | TREEVIEW SET BOLD |
| CALL | DIALOG SHOW STATE | ISEVEN | PATHSCAN$ | TREEVIEW SET CHECK |
| CALL DWORD | DIALOG STABILIZE | ISFALSE | PEEK | TREEVIEW SET EXPANDED |
| CALLSTK | DIALOG UNITS | ISFILE | PLAY | TREEVIEW SET IMAGELIST |
| CALLSTK$ | DIM | ISFOLDER | PLAY SOUND | TREEVIEW SET TEXT |
| CALLSTKCOUNT | DIR | ISINFINITE | PLAY WAVE | TREEVIEW SET USER |
| CBOOL | DIR CLOSE | ISNORMAL | POKE | TREEVIEW UNSELECT |
| CBRT | DIR$ | ISODD | PREFIX | TRIM |
| CBYTE | DISKFREE | ISTRUE | PRINT# | TRIM$ |
| CDBL | DISKSIZE | ISWIN | PRINTER$ | TRUNC |
| CDWORD | DISPLAY BROWSE | ITERATE | PRINTERCOUNT | TRY/END TRY |
| CEIL | DISPLAY COLOR | JOIN$ | PROCESS GET PRIORITY | TYPE SET |
| CFLT | DISPLAY FONT | KILL | PROCESS SET PRIORITY | TYPE/END TYPE |
| CHDIR | DISPLAY OPENFILE | LCASE | PROFILE | UCASE |
| CHDRIVE | DISPLAY SAVEFILE | LCASE$ | PROGRESSBAR GET POS | UCASE$ |
| CHOOSE | DOUBLE | LEFT | PROGRESSBAR GET RANGE | UCODE$ |
| CHR | END | LEFT$ | PROGRESSBAR SET POS | UCODEPAGE |
| CHR$ | ENVIRON | LEN | PROGRESSBAR SET RANGE | UDP CLOSE |
| CHRBYTES | ENVIRON$ | LET | PROGRESSBAR SET STEP | UDP NOTIFY |
| CHRTOOEM | EOF | LET *(WITH OBJECTS)* | PROGRESSBAR STEP | UDP OPEN |
| CHRTOOEM$ | EQV | LET *(WITH TYPES)* | PUT | UDP RECV |
| CHRTOUTF8 | ERASE | LET *(WITH VARIANTS)* | PUT STR | UDP SEND |
| CHRTOUTF8$ | ERF | LINE INPUT# | PUT WSTR | UNLOCK |
| CLASS/END CLASS | ERL | LISTBOX ADD | PUT$ | UNWRAP |
| CLIP | ERL$ | LISTBOX DELETE | PUT$$ | UNWRAP$ |
| CLIP$ | ERR | LISTBOX FIND | QUAD | USING |
| CLIPBOARD | ERRCLEAR | LISTBOX FIND EXACT | RAISEEVENT | USING$ |
| CLOSE | ERROR | LISTBOX GET COUNT | RANDOMIZE | UTF8TOCHR |
| CLS | ERROR$ | LISTBOX GET SELCOUNT | READ | UTF8TOCHR$ |
| CODEPTR | EVENT SOURCE | LISTBOX GET SELECT | READ$ | VAL |
| COLOR | EVENTS | LISTBOX GET STATE | REDIM | VARPTR |
| COMBOBOX ADD | EXE | LISTBOX GET TEXT | REGEXPR | VERIFY |
| COMBOBOX DELETE | EXIST | LISTBOX GET USER | REGISTER | WAITKEY |
| COMBOBOX FIND | EXIT | LISTBOX INSERT | REGREPL | WAITKEY$ |
| COMBOBOX FIND EXACT | EXP | LISTBOX RESET | REM | WINDOW GET |
| COMBOBOX GET COUNT | EXP10 | LISTBOX SELECT | REMAIN | WINDOW SET |
| COMBOBOX GET SELCOUNT | EXP2 | LISTBOX SET TEXT | REMAIN$ | WORD |
| COMBOBOX GET SELECT | EXPM1 | LISTBOX SET USER | REMOVE | WRAP |
| COMBOBOX GET STATE | EXTRACT | LISTBOX UNSELECT | REMOVE$ | WRAP$ |
| COMBOBOX GET TEXT | EXTRACT$ | LISTVIEW DELETE COLUMN | REPEAT | WRITE |
| COMBOBOX GET USER | FIELD | LISTVIEW DELETE ITEM | REPEAT$ | WRITE# |
| COMBOBOX INSERT | FILEATTR | LISTVIEW FIND | REPLACE | XOR |
| COMBOBOX RESET | FILECOPY | LISTVIEW FIND EXACT | RESET | XPRINT ARC |
| COMBOBOX SELECT | FILENAME | LISTVIEW FIT CONTENT | RESOURCE SAVE FILE | XPRINT ATTACH |
| COMBOBOX SET TEXT | FILENAME$ | LISTVIEW FIT HEADER | RESOURCE$ | XPRINT BOX |
| COMBOBOX SET USER | FILESCAN | LISTVIEW GET COLUMN | RESUME | XPRINT CANCEL |
| COMBOBOX UNSELECT | FIX | LISTVIEW GET COUNT | RETAIN | XPRINT CELL |
| COMM CLOSE | FLOOR | LISTVIEW GET HEADER | RETAIN$ | XPRINT CELL SIZE |
| COMM LINE | FLUSH | LISTVIEW GET HEADERID | RETURN | XPRINT CHR SIZE |
| COMM LINE INPUT | FONT END | LISTVIEW GET MODE | RGB | XPRINT CLOSE |
| COMM OPEN | FONT NEW | LISTVIEW GET SELCOUNT | RIGHT | XPRINT COLOR |
| COMM PRINT | FOR / NEXT | LISTVIEW GET SELECT | RIGHT$ | XPRINT COPY |
| COMM RECV | FORMAT | LISTVIEW GET STATE | RMDIR | XPRINT ELLIPSE |
| COMM RESET | FORMAT$ | LISTVIEW GET STYLEXX | RND | XPRINT FORMFEED |
| COMM SEND | FRAC | LISTVIEW GET TEXT | ROTATE | XPRINT GET ATTACH |
| COMM SET | FRE | LISTVIEW GET USER | ROUND | XPRINT GET CANVAS |
| COMM TIMEOUT | FREEFILE | LISTVIEW INSERT COLUMN | RSET | XPRINT GET CLIENT |
| COMMAND | FUNCNAME | LISTVIEW INSERT ITEM | RSET$ | XPRINT GET CLIP |
| COMMAND$ | FUNCNAME$ | LISTVIEW RESET | RTRIM | XPRINT GET COLLATE |
| CONTROL ADD | FUNCTION / END FUNCTION | LISTVIEW SELECT | RTRIM$ | XPRINT GET COLOR |
| CONTROL ADD BUTTON | GET | LISTVIEW SET COLUMN | SCROLLBAR GET PAGESIZE | XPRINT GET COLORMODE |
| CONTROL ADD CHECK3STATE | GET STR | LISTVIEW SET HEADER | SCROLLBAR GET POS | XPRINT GET COPIES |
| CONTROL ADD CHECKBOX | GET WSTR | LISTVIEW SET IMAGE | SCROLLBAR GET RANGE | XPRINT GET DC |
| CONTROL ADD COMBOBOX | GET$ | LISTVIEW SET IMAGE2 | SCROLLBAR GET TRACKPOS | XPRINT GET DUPLEX |
| CONTROL ADD FRAME | GET$$ | LISTVIEW SET IMAGELIST | SCROLLBAR SET PAGESIZE | XPRINT GET LINES |
| CONTROL ADD LABEL | GETATTR | LISTVIEW SET MODE | SCROLLBAR SET POS | XPRINT GET MARGIN |
| CONTROL ADD LINE | GLOBAL | LISTVIEW SET OVERLAY | SCROLLBAR SET RANGE | XPRINT GET MIX |
| CONTROL ADD LISTBOX | GLOBALMEM | LISTVIEW SET STYLEXX | SEC | XPRINT GET ORIENTATION |
| CONTROL ADD LISTVIEW | GRAPHIC ARC | LISTVIEW SET TEXT | SECH | XPRINT GET OVERLAP |
| CONTROL ADD OPTION | GRAPHIC ATTACH | LISTVIEW SET USER | SEEK | XPRINT GET PAGES |
| CONTROL ADD PROGRESSBAR | GRAPHIC BITMAP END | LISTVIEW SORT | SELECT CASE/END SELECT | XPRINT GET PAPER |
| CONTROL ADD SCROLLBAR | GRAPHIC BITMAP LOAD | LISTVIEW UNSELECT | SETATTR | XPRINT GET PAPERS |
| CONTROL ADD STATUSBAR | GRAPHIC BITMAP NEW | LISTVIEW VISIBLE | SETEOF | XPRINT GET PIXEL |
| CONTROL ADD TAB | GRAPHIC BOX | LO | SGN | XPRINT GET POS |
| CONTROL ADD TEXTBOX | GRAPHIC CELL | LOC | SHELL | XPRINT GET PPI |
| CONTROL ADD TOOLBAR | GRAPHIC CELL SIZE | LOCAL | SHIFT | XPRINT GET QUALITY |
| CONTROL ADD TREEVIEW | GRAPHIC CHR SIZE | LOCK | SHRINK | XPRINT GET SCALE |
| CONTROL DISABLE | GRAPHIC CIRCLE | LOF | SHRINK$ | XPRINT GET SELECTION |
| CONTROL ENABLE | GRAPHIC CLEAR | LOG | SIN | XPRINT GET SIZE |
| CONTROL GET CHECK | GRAPHIC COLOR | LOG10 | SINGLE | XPRINT GET STRETCHMODE |
| CONTROL GET CLIENT | GRAPHIC COPY | LOG1P | SINH | XPRINT GET TEXTALIGN |
| CONTROL GET LOC | GRAPHIC DETACH | LOG2 | SIZEOF | XPRINT GET TRAY |
| CONTROL GET SIZE | GRAPHIC ELLIPSE | LONG | SLEEP | XPRINT GET TRAYS |
| CONTROL GET TEXT | GRAPHIC GET BITS | LOWRD | SPACE | XPRINT GET WORDWRAP |
| CONTROL GET USER | GRAPHIC GET CANVAS | LPRINT | SPACE$ | XPRINT GET WRAP |
| CONTROL HANDLE | GRAPHIC GET CAPTION | LPRINT ATTACH | SPLIT | XPRINT IMAGELIST |
| CONTROL HIDE | GRAPHIC GET CLIENT | LPRINT CLOSE | SQR | XPRINT LINE |
| CONTROL KILL | GRAPHIC GET CLIP | LPRINT FLUSH | STATIC | XPRINT PIE |
| CONTROL NORMALIZE | GRAPHIC GET DC | LPRINT FORMFEED | STATUSBAR SET PARTS | XPRINT POLYGON |
| CONTROL POST | GRAPHIC GET LINES | LPRINT$ | STATUSBAR SET TEXT | XPRINT POLYLINE |
| CONTROL REDRAW | GRAPHIC GET LOC | LSET | STR | XPRINT PREVIEW |
| CONTROL SEND | GRAPHIC GET MIX | LSET$ | STR$ | XPRINT PRINT |
| CONTROL SET CHECK | GRAPHIC GET PIXEL | LTRIM | STRDELETE | XPRINT RENDER |
| CONTROL SET CLIENT | GRAPHIC GET POS | LTRIM$ | STRDELETE$ | XPRINT SCALE |
| CONTROL SET FOCUS | GRAPHIC GET PPI | MACRO/END MACRO | STRING | XPRINT SET CLIP |
| CONTROL SET FONT | GRAPHIC GET SCALE | MAK | STRINSERT | XPRINT SET COLLATE |
| CONTROL SET LOC | GRAPHIC GET SIZE | MAT | STRINSERT$ | XPRINT SET COLOR |
| CONTROL SET OPTION | GRAPHIC GET STRETCHMODE | MAX | STRPTR | XPRINT SET COLORMODE |
| CONTROL SET SIZE | GRAPHIC GET TEXTALIGN | MCASE | STRREVERSE | XPRINT SET COPIES |
| CONTROL SET TEXT | GRAPHIC GET VIEW | MCASE$ | STRREVERSE$ | XPRINT SET DUPLEX |
| CONTROL SET USER | GRAPHIC GET WORDWRAP | MEMORY | SWAP | XPRINT SET FONT |
| CONTROL SHOW STATE | GRAPHIC GET WRAP | MEMORY FILL | SWITCH | XPRINT SET MIX |
| COS | GRAPHIC LINE | MEMORY FILLS | SWITCH$ | XPRINT SET ORIENTATION |
| COSH | GRAPHIC PAINT | MENU ADD POPUP | TAB DELETE | XPRINT SET OVERLAP |
| COT | GRAPHIC PIE | MENU ADD STRING | TAB GET COUNT | XPRINT SET PAGES |
| COTH | GRAPHIC POLYGON | MENU ATTACH | TAB GET DIALOG | XPRINT SET PAPER |
| CQUAD | GRAPHIC POLYLINE | MENU CONTEXT | TAB GET IMAGE | XPRINT SET PIXEL |
| CSC | GRAPHIC PRINT | MENU DELETE | TAB GET PAGE | XPRINT SET POS |
| CSCH | GRAPHIC SAVE | MENU DRAW BAR | TAB GET SELECT | XPRINT SET QUALITY |
| CSET | GRAPHIC SCALE | MENU GET STATE | TAB GET TEXT | XPRINT SET STRETCHMODE |
| CSET$ | GRAPHIC SCALE PIXELS | MENU GET TEXT | TAB INSERT PAGE | XPRINT SET TEXTALIGN |
| CSNG | GRAPHIC SET AUTOSIZE | MENU NEW BAR | TAB RESET | XPRINT SET TRAY |
| CSTR | GRAPHIC SET BITS | MENU NEW POPUP | TAB SELECT | XPRINT SET WORDWRAP |
| CULNG | GRAPHIC SET CAPTION | MENU SET STATE | TAB SET IMAGE | XPRINT SET WRAP |
| CURDIR | GRAPHIC SET CLIP | MENU SET TEXT | TAB SET IMAGELIST | XPRINT SPLIT |
| CURDIR$ | GRAPHIC SET FIXED | METHOD / END METHOD | TAB SET TEXT | XPRINT STRETCH |
| CVBYT | GRAPHIC SET FONT | METRICS | TAB$ | XPRINT STYLE |
| CVCUX | GRAPHIC SET MIX | MID | TALLY | XPRINT TEXT SIZE |
| CVDWD | GRAPHIC SET PIXEL | MID$ | TAN | XPRINT WIDTH |
| CVL | GRAPHIC SET POS | MIN | TANH |  |
| CVQ | GRAPHIC SET SIZE | MKBYT | TCP ACCEPT |  |
| CVW | GRAPHIC SET STRETCHMODE | MKBYT$ | TCP CLOSE |  |

## **Newly** implemented by this branch

> **669 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG SET ICON | LISTBOX DELETE | STATUSBAR SET PARTS |
| ACCEL ATTACH | DIALOG SET LOC | LISTBOX FIND | STATUSBAR SET TEXT |
| ACODE | DIALOG SET SIZE | LISTBOX FIND EXACT | STR |
| ACODE$ | DIALOG SET TEXT | LISTBOX GET COUNT | STR$ |
| ACOS | DIALOG SET USER | LISTBOX GET SELCOUNT | STRDELETE |
| ACOSH | DIALOG SHOW MODAL | LISTBOX GET SELECT | STRDELETE$ |
| ARRAY ADD | DIALOG SHOW MODELESS | LISTBOX GET STATE | STRING |
| ARRAY ARRAYIX | DIALOG SHOW STATE | LISTBOX GET TEXT | STRINSERT |
| ARRAY ASSIGN | DIALOG STABILIZE | LISTBOX GET USER | STRINSERT$ |
| ARRAY COPY | DIALOG UNITS | LISTBOX INSERT | STRPTR |
| ARRAY DELETE | DIM | LISTBOX RESET | STRREVERSE |
| ARRAY INSERT | DIR | LISTBOX SELECT | STRREVERSE$ |
| ARRAY REDIM DECR | DIR CLOSE | LISTBOX SET TEXT | SWITCH |
| ARRAY REDIM INCR | DIR$ | LISTBOX SET USER | SWITCH$ |
| ARRAY REVERSE | DISKFREE | LISTBOX UNSELECT | TAB DELETE |
| ARRAY SCAN | DISKSIZE | LISTVIEW DELETE COLUMN | TAB GET COUNT |
| ARRAY SHUFFLE | DISPLAY BROWSE | LISTVIEW DELETE ITEM | TAB GET DIALOG |
| ARRAY SWAP | DISPLAY COLOR | LISTVIEW FIND | TAB GET IMAGE |
| ARRAY TAGARRAY | DISPLAY FONT | LISTVIEW FIND EXACT | TAB GET PAGE |
| ARRAY TAGARRAY ERASE | DISPLAY OPENFILE | LISTVIEW FIT CONTENT | TAB GET SELECT |
| ARRAY UNIQUE | DISPLAY SAVEFILE | LISTVIEW FIT HEADER | TAB GET TEXT |
| ASIN | DOUBLE | LISTVIEW GET COLUMN | TAB INSERT PAGE |
| ASINH | ENVIRON$ | LISTVIEW GET COUNT | TAB RESET |
| ATANH | EOF | LISTVIEW GET HEADER | TAB SELECT |
| ATN | EQV | LISTVIEW GET HEADERID | TAB SET IMAGE |
| ATN2 | ERF | LISTVIEW GET MODE | TAB SET IMAGELIST |
| BGR | ERL | LISTVIEW GET SELCOUNT | TAB SET TEXT |
| BIN | ERL$ | LISTVIEW GET SELECT | TAB$ |
| BIN$ | ERR | LISTVIEW GET STATE | TALLY |
| BITS | ERRCLEAR | LISTVIEW GET STYLEXX | TAN |
| BITS$ | ERROR$ | LISTVIEW GET TEXT | TANH |
| BITSE | EVENT SOURCE | LISTVIEW GET USER | TCP NOTIFY |
| BUILD | EVENTS | LISTVIEW INSERT COLUMN | THREADCOUNT |
| BUILD$ | EXE | LISTVIEW INSERT ITEM | THREADID |
| BYTE | EXIST | LISTVIEW RESET | TIMER |
| CALLSTK$ | EXP | LISTVIEW SELECT | TOOLBAR ADD BUTTON |
| CALLSTKCOUNT | EXP10 | LISTVIEW SET COLUMN | TOOLBAR ADD SEPARATOR |
| CBOOL | EXP2 | LISTVIEW SET HEADER | TOOLBAR DELETE BUTTON |
| CBRT | EXPM1 | LISTVIEW SET IMAGE | TOOLBAR GET COUNT |
| CBYTE | EXTRACT | LISTVIEW SET IMAGE2 | TOOLBAR GET STATE |
| CDBL | EXTRACT$ | LISTVIEW SET IMAGELIST | TOOLBAR SET IMAGELIST |
| CDWORD | FILEATTR | LISTVIEW SET MODE | TOOLBAR SET STATE |
| CEIL | FILENAME | LISTVIEW SET OVERLAY | TREEVIEW DELETE |
| CFLT | FILENAME$ | LISTVIEW SET STYLEXX | TREEVIEW GET BOLD |
| CHOOSE | FIX | LISTVIEW SET TEXT | TREEVIEW GET CHECK |
| CHR | FLOOR | LISTVIEW SET USER | TREEVIEW GET CHILD |
| CHR$ | FONT END | LISTVIEW SORT | TREEVIEW GET COUNT |
| CHRBYTES | FONT NEW | LISTVIEW UNSELECT | TREEVIEW GET EXPANDED |
| CHRTOOEM | FORMAT | LISTVIEW VISIBLE | TREEVIEW GET NEXT |
| CHRTOOEM$ | FORMAT$ | LO | TREEVIEW GET PARENT |
| CHRTOUTF8 | FRAC | LOC | TREEVIEW GET PREVIOUS |
| CHRTOUTF8$ | FRE | LOF | TREEVIEW GET ROOT |
| CLIP | FREEFILE | LOG | TREEVIEW GET SELECT |
| CLIP$ | FUNCNAME | LOG10 | TREEVIEW GET TEXT |
| CLOSE | FUNCNAME$ | LOG1P | TREEVIEW GET USER |
| CODEPTR | GET | LOG2 | TREEVIEW INSERT ITEM |
| COMBOBOX ADD | GET STR | LONG | TREEVIEW RESET |
| COMBOBOX DELETE | GET WSTR | LOWRD | TREEVIEW SELECT |
| COMBOBOX FIND | GET$ | LPRINT$ | TREEVIEW SET BOLD |
| COMBOBOX FIND EXACT | GET$$ | LSET$ | TREEVIEW SET CHECK |
| COMBOBOX GET COUNT | GETATTR | LTRIM | TREEVIEW SET EXPANDED |
| COMBOBOX GET SELCOUNT | GRAPHIC ARC | LTRIM$ | TREEVIEW SET IMAGELIST |
| COMBOBOX GET SELECT | GRAPHIC ATTACH | MAK | TREEVIEW SET TEXT |
| COMBOBOX GET STATE | GRAPHIC BITMAP END | MAX | TREEVIEW SET USER |
| COMBOBOX GET TEXT | GRAPHIC BITMAP LOAD | MCASE | TREEVIEW UNSELECT |
| COMBOBOX GET USER | GRAPHIC BITMAP NEW | MCASE$ | TRIM |
| COMBOBOX INSERT | GRAPHIC BOX | MEMORY FILL | TRIM$ |
| COMBOBOX RESET | GRAPHIC CELL | MEMORY FILLS | TRUNC |
| COMBOBOX SELECT | GRAPHIC CELL SIZE | MENU ADD POPUP | UCASE |
| COMBOBOX SET TEXT | GRAPHIC CHR SIZE | MENU ADD STRING | UCASE$ |
| COMBOBOX SET USER | GRAPHIC CIRCLE | MENU ATTACH | UCODE$ |
| COMBOBOX UNSELECT | GRAPHIC CLEAR | MENU CONTEXT | UCODEPAGE |
| COMM LINE INPUT | GRAPHIC COLOR | MENU DELETE | UDP NOTIFY |
| COMMAND | GRAPHIC COPY | MENU DRAW BAR | UNWRAP |
| COMMAND$ | GRAPHIC DETACH | MENU GET STATE | UNWRAP$ |
| CONTROL ADD | GRAPHIC ELLIPSE | MENU GET TEXT | USING |
| CONTROL ADD BUTTON | GRAPHIC GET BITS | MENU NEW BAR | USING$ |
| CONTROL ADD CHECK3STATE | GRAPHIC GET CANVAS | MENU NEW POPUP | UTF8TOCHR |
| CONTROL ADD CHECKBOX | GRAPHIC GET CAPTION | MENU SET STATE | UTF8TOCHR$ |
| CONTROL ADD COMBOBOX | GRAPHIC GET CLIENT | MENU SET TEXT | VARPTR |
| CONTROL ADD FRAME | GRAPHIC GET CLIP | METRICS | VERIFY |
| CONTROL ADD LABEL | GRAPHIC GET DC | MID | WAITKEY |
| CONTROL ADD LINE | GRAPHIC GET LINES | MIN | WAITKEY$ |
| CONTROL ADD LISTBOX | GRAPHIC GET LOC | MKBYT | WORD |
| CONTROL ADD LISTVIEW | GRAPHIC GET MIX | MKCUX | WRAP |
| CONTROL ADD OPTION | GRAPHIC GET PIXEL | MKDWD | WRAP$ |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET POS | MKE | WRITE |
| CONTROL ADD SCROLLBAR | GRAPHIC GET PPI | MKS | WRITE# |
| CONTROL ADD STATUSBAR | GRAPHIC GET SCALE | MKWRD | XPRINT ARC |
| CONTROL ADD TAB | GRAPHIC GET SIZE | MOD | XPRINT ATTACH |
| CONTROL ADD TEXTBOX | GRAPHIC GET STRETCHMODE | MONTHNAME | XPRINT BOX |
| CONTROL ADD TOOLBAR | GRAPHIC GET TEXTALIGN | MONTHNAME$ | XPRINT CANCEL |
| CONTROL ADD TREEVIEW | GRAPHIC GET VIEW | NUL$ | XPRINT CELL |
| CONTROL DISABLE | GRAPHIC GET WORDWRAP | OCT | XPRINT CELL SIZE |
| CONTROL ENABLE | GRAPHIC GET WRAP | OCT$ | XPRINT CHR SIZE |
| CONTROL GET CHECK | GRAPHIC LINE | OEMTOCHR | XPRINT CLOSE |
| CONTROL GET CLIENT | GRAPHIC PAINT | OEMTOCHR$ | XPRINT COLOR |
| CONTROL GET LOC | GRAPHIC PIE | ON CALL | XPRINT COPY |
| CONTROL GET SIZE | GRAPHIC POLYGON | ON GOSUB | XPRINT ELLIPSE |
| CONTROL GET TEXT | GRAPHIC POLYLINE | ON GOTO | XPRINT FORMFEED |
| CONTROL GET USER | GRAPHIC PRINT | OPEN | XPRINT GET ATTACH |
| CONTROL HANDLE | GRAPHIC SAVE | PARSE$ | XPRINT GET CANVAS |
| CONTROL HIDE | GRAPHIC SCALE | PARSECOUNT | XPRINT GET CLIENT |
| CONTROL KILL | GRAPHIC SCALE PIXELS | PATHNAME | XPRINT GET CLIP |
| CONTROL NORMALIZE | GRAPHIC SET AUTOSIZE | PATHNAME$ | XPRINT GET COLLATE |
| CONTROL POST | GRAPHIC SET BITS | PATHSCAN | XPRINT GET COLOR |
| CONTROL REDRAW | GRAPHIC SET CAPTION | PATHSCAN$ | XPRINT GET COLORMODE |
| CONTROL SEND | GRAPHIC SET CLIP | PEEK | XPRINT GET COPIES |
| CONTROL SET CHECK | GRAPHIC SET FIXED | PLAY | XPRINT GET DC |
| CONTROL SET CLIENT | GRAPHIC SET FONT | PLAY SOUND | XPRINT GET DUPLEX |
| CONTROL SET FOCUS | GRAPHIC SET MIX | POKE | XPRINT GET LINES |
| CONTROL SET FONT | GRAPHIC SET PIXEL | PRINTER$ | XPRINT GET MARGIN |
| CONTROL SET LOC | GRAPHIC SET POS | PRINTERCOUNT | XPRINT GET MIX |
| CONTROL SET OPTION | GRAPHIC SET SIZE | PROGRESSBAR GET POS | XPRINT GET ORIENTATION |
| CONTROL SET SIZE | GRAPHIC SET STRETCHMODE | PROGRESSBAR GET RANGE | XPRINT GET OVERLAP |
| CONTROL SET TEXT | GRAPHIC SET TEXTALIGN | PROGRESSBAR SET POS | XPRINT GET PAGES |
| CONTROL SET USER | GRAPHIC SET VIEW | PROGRESSBAR SET RANGE | XPRINT GET PAPER |
| CONTROL SHOW STATE | GRAPHIC SET VIRTUAL | PROGRESSBAR SET STEP | XPRINT GET PAPERS |
| COS | GRAPHIC SET WORDWRAP | PROGRESSBAR STEP | XPRINT GET PIXEL |
| COSH | GRAPHIC SET WRAP | PUT | XPRINT GET POS |
| COT | GRAPHIC STYLE | PUT STR | XPRINT GET PPI |
| COTH | GRAPHIC TEXT SIZE | PUT WSTR | XPRINT GET QUALITY |
| CQUAD | GRAPHIC WIDTH | PUT$ | XPRINT GET SCALE |
| CSC | HEADER GET COUNT | PUT$$ | XPRINT GET SELECTION |
| CSCH | HEADER GET ITEM | QUAD | XPRINT GET SIZE |
| CSET$ | HEADER SEND | RAISEEVENT | XPRINT GET STRETCHMODE |
| CSNG | HEADER SET ITEM | READ | XPRINT GET TEXTALIGN |
| CSTR | HEX | READ$ | XPRINT GET TRAY |
| CULNG | HEX$ | REDIM | XPRINT GET TRAYS |
| CURDIR | HI | REMAIN | XPRINT GET WORDWRAP |
| CURDIR$ | HIWRD | REMAIN$ | XPRINT GET WRAP |
| CVBYT | HYPOT | REMOVE | XPRINT IMAGELIST |
| CVCUX | IIF | REMOVE$ | XPRINT LINE |
| CVDWD | IMAGELIST ADD BITMAP | REPEAT | XPRINT PIE |
| CVL | IMAGELIST ADD ICON | REPEAT$ | XPRINT POLYGON |
| CVQ | IMAGELIST ADD MASKED | RESOURCE SAVE FILE | XPRINT POLYLINE |
| CVW | IMAGELIST COUNT | RESOURCE$ | XPRINT PREVIEW |
| CWORD | IMAGELIST GET COUNT | RETAIN | XPRINT PRINT |
| DATACOUNT | IMAGELIST KILL | RETAIN$ | XPRINT RENDER |
| DAYNAME | IMAGELIST NEW | RGB | XPRINT SCALE |
| DAYNAME$ | IMAGELIST NEW BITMAP | RIGHT | XPRINT SET CLIP |
| DEC | IMAGELIST NEW ICON | RIGHT$ | XPRINT SET COLLATE |
| DEC$ | IMAGELIST SET OVERLAY | RND | XPRINT SET COLOR |
| DECLARE | IMP | ROUND | XPRINT SET COLORMODE |
| DEF | INPUT# | RSET$ | XPRINT SET COPIES |
| DESKTOP GET PPI | INSTANCE | RTRIM | XPRINT SET DUPLEX |
| DIALOG DEFAULT FONT | INSTR | RTRIM$ | XPRINT SET FONT |
| DIALOG DISABLE | INT | SCROLLBAR GET PAGESIZE | XPRINT SET MIX |
| DIALOG DOEVENTS | INTEGER | SCROLLBAR GET POS | XPRINT SET ORIENTATION |
| DIALOG ENABLE | ISEVEN | SCROLLBAR GET RANGE | XPRINT SET OVERLAP |
| DIALOG END | ISFALSE | SCROLLBAR GET TRACKPOS | XPRINT SET PAGES |
| DIALOG GET CLIENT | ISFILE | SCROLLBAR SET PAGESIZE | XPRINT SET PAPER |
| DIALOG GET LOC | ISFOLDER | SCROLLBAR SET POS | XPRINT SET PIXEL |
| DIALOG GET SIZE | ISINFINITE | SCROLLBAR SET RANGE | XPRINT SET POS |
| DIALOG GET TEXT | ISNORMAL | SEC | XPRINT SET QUALITY |
| DIALOG GET USER | ISODD | SECH | XPRINT SET STRETCHMODE |
| DIALOG HIDE | ISTRUE | SEEK | XPRINT SET TEXTALIGN |
| DIALOG MAXIMIZE | ISWIN | SETEOF | XPRINT SET TRAY |
| DIALOG MINIMIZE | JOIN$ | SGN | XPRINT SET WORDWRAP |
| DIALOG NEW | LCASE | SHRINK | XPRINT SET WRAP |
| DIALOG NONSTABLE | LCASE$ | SHRINK$ | XPRINT SPLIT |
| DIALOG NORMALIZE | LEFT | SIN | XPRINT STRETCH |
| DIALOG PIXELS | LEFT$ | SINGLE | XPRINT STYLE |
| DIALOG POST | LEN | SINH | XPRINT TEXT SIZE |
| DIALOG REDRAW | LET *(WITH OBJECTS)* | SIZEOF | XPRINT WIDTH |
| DIALOG SEND | LET *(WITH VARIANTS)* | SPACE |  |
| DIALOG SET CLIENT | LINE INPUT# | SPACE$ |  |
| DIALOG SET COLOR | LISTBOX ADD | SQR |  |
