...
**All 662 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DECR | GRAPHIC GET VIEW | MKE$ | TCP PRINT |
| ACCEL ATTACH | DEF | GRAPHIC GET WORDWRAP | MKI$ | TCP RECV |
| ACODE | DESKTOP GET CLIENT | GRAPHIC GET WRAP | MKL$ | TCP SEND |
| ACODE$ | DESKTOP GET LOC | GRAPHIC LINE | MKQ$ | THREAD CLOSE |
| ACOS | DESKTOP GET PPI | GRAPHIC PAINT | MKS | THREAD CREATE |
| ACOSH | DESKTOP GET SIZE | GRAPHIC PIE | MKS$ | THREAD GET PRIORITY |
| AND | DIALOG DEFAULT FONT | GRAPHIC POLYGON | MKWRD | THREAD RESUME |
| ARRAY ADD | DIALOG DISABLE | GRAPHIC POLYLINE | MKWRD$ | THREAD SET PRIORITY |
| ARRAY ARRAYIX | DIALOG DOEVENTS | GRAPHIC PRINT | MOD | THREAD STATUS |
| ARRAY ASSIGN | DIALOG ENABLE | GRAPHIC SAVE | MONTHNAME | THREAD SUSPEND |
| ARRAY COPY | DIALOG END | GRAPHIC SCALE | MONTHNAME$ | THREADCOUNT |
| ARRAY DELETE | DIALOG GET CLIENT | GRAPHIC SCALE PIXELS | MOUSEPTR | THREADED |
| ARRAY INSERT | DIALOG GET LOC | GRAPHIC SET AUTOSIZE | MSGBOX | THREADID |
| ARRAY REDIM DECR | DIALOG GET SIZE | GRAPHIC SET BITS | NAME | TIMER |
| ARRAY REDIM INCR | DIALOG GET TEXT | GRAPHIC SET CAPTION | NOT | TIX |
| ARRAY REVERSE | DIALOG GET USER | GRAPHIC SET CLIP | NUL | TOOLBAR |
| ARRAY SCAN | DIALOG HIDE | GRAPHIC SET FIXED | NUL$ | TRACE |
| ARRAY SHUFFLE | DIALOG MAXIMIZE | GRAPHIC SET FONT | OBJECT | TREEVIEW |
| ARRAY SORT | DIALOG MINIMIZE | GRAPHIC SET MIX | OCT | TRIM |
| ARRAY SWAP | DIALOG NEW | GRAPHIC SET PIXEL | OCT$ | TRIM$ |
| ARRAY TAGARRAY | DIALOG NONSTABLE | GRAPHIC SET POS | OEMTOCHR | TRUNC |
| ARRAY TAGARRAY ERASE | DIALOG NORMALIZE | GRAPHIC SET SIZE | OEMTOCHR$ | TRY/END TRY |
| ARRAY UNIQUE | DIALOG PIXELS | GRAPHIC SET STRETCHMODE | ON CALL | TYPE SET |
| ASC | DIALOG POST | GRAPHIC SET TEXTALIGN | ON ERROR | TYPE/END TYPE |
| ASIN | DIALOG REDRAW | GRAPHIC SET VIEW | ON GOSUB | UCASE |
| ASINH | DIALOG SEND | GRAPHIC SET VIRTUAL | ON GOTO | UCASE$ |
| ASM | DIALOG SET CLIENT | GRAPHIC SET WORDWRAP | OPEN | UCODE$ |
| ASMDATA / END ASMDATA | DIALOG SET COLOR | GRAPHIC SET WRAP | OPTION EXPLICIT | UCODEPAGE |
| ATANH | DIALOG SET ICON | GRAPHIC STYLE | OR | UDP CLOSE |
| ATN | DIALOG SET LOC | GRAPHIC TEXT SIZE | PARSE | UDP NOTIFY |
| ATN2 | DIALOG SET SIZE | GRAPHIC WIDTH | PARSE$ | UDP OPEN |
| BEEP | DIALOG SET TEXT | HEADER | PARSECOUNT | UDP RECV |
| BGR | DIALOG SET USER | HEX | PATHNAME | UDP SEND |
| BIN | DIALOG SHOW MODAL | HEX$ | PATHNAME$ | UNLOCK |
| BIN$ | DIALOG SHOW MODELESS | HI | PATHSCAN | UNWRAP |
| BIT | DIALOG SHOW STATE | HIWRD | PATHSCAN$ | UNWRAP$ |
| BIT CALC | DIALOG STABILIZE | HOST ADDR | PEEK | USING |
| BITS | DIALOG UNITS | HOST NAME | PLAY | USING$ |
| BITS$ | DIM | HYPOT | PLAY SOUND | UTF8TOCHR |
| BITSE | DIR | IF | PLAY WAVE | UTF8TOCHR$ |
| BUILD | DIR CLOSE | IF/END IF | POKE | VAL |
| BUILD$ | DIR$ | IIF | PREFIX | VARPTR |
| BYTE | DISKFREE | IMAGELIST COUNT | PRINT# | VERIFY |
| CALL | DISKSIZE | IMAGELIST KILL | PRINTER$ | WAITKEY |
| CALL DWORD | DISPLAY BROWSE | IMAGELIST NEW | PRINTERCOUNT | WAITKEY$ |
| CALLSTK | DISPLAY COLOR | IMP | PROCESS GET PRIORITY | WINDOW GET |
| CALLSTK$ | DISPLAY FONT | IMPORT | PROCESS SET PRIORITY | WINDOW SET |
| CALLSTKCOUNT | DISPLAY OPENFILE | INCR | PROFILE | WORD |
| CBOOL | DISPLAY SAVEFILE | INPUT FLUSH | PROGRESSBAR | WRAP |
| CBRT | DOUBLE | INPUT# | PUT | WRAP$ |
| CBYTE | END | INSTANCE | PUT STR | WRITE |
| CDBL | ENVIRON | INSTR | PUT WSTR | WRITE# |
| CDWORD | ENVIRON$ | INT | PUT$ | XOR |
| CEIL | EOF | INTEGER | PUT$$ | XPRINT ARC |
| CFLT | EQV | INTERFACE / END INTERFACE (DIRECT) | QUAD | XPRINT ATTACH |
| CHDIR | ERASE | INTERFACE/END INTERFACE (IDBIND) | RAISEEVENT | XPRINT BOX |
| CHDRIVE | ERF | ISEVEN | RANDOMIZE | XPRINT CANCEL |
| CHOOSE | ERL | ISFALSE | READ | XPRINT CELL |
| CHR | ERL$ | ISFILE | READ$ | XPRINT CELL SIZE |
| CHR$ | ERR | ISFOLDER | REDIM | XPRINT CHR SIZE |
| CHRBYTES | ERRCLEAR | ISINFINITE | REGEXPR | XPRINT CLOSE |
| CHRTOOEM | ERROR | ISNORMAL | REGISTER | XPRINT COLOR |
| CHRTOOEM$ | ERROR$ | ISODD | REGREPL | XPRINT COPY |
| CHRTOUTF8 | EVENT SOURCE | ISTRUE | REM | XPRINT ELLIPSE |
| CHRTOUTF8$ | EVENTS | ISWIN | REMAIN | XPRINT FORMFEED |
| CLASS/END CLASS | EXE | ITERATE | REMAIN$ | XPRINT GET ATTACH |
| CLIP | EXIST | JOIN$ | REMOVE | XPRINT GET CANVAS |
| CLIP$ | EXIT | KILL | REMOVE$ | XPRINT GET CLIENT |
| CLIPBOARD | EXP | LCASE | REPEAT | XPRINT GET CLIP |
| CLOSE | EXP10 | LCASE$ | REPEAT$ | XPRINT GET COLLATE |
| CLS | EXP2 | LEFT | REPLACE | XPRINT GET COLOR |
| CODEPTR | EXPM1 | LEFT$ | RESET | XPRINT GET COLORMODE |
| COLOR | EXTRACT | LEN | RESOURCE SAVE FILE | XPRINT GET COPIES |
| COMM CLOSE | EXTRACT$ | LET | RESOURCE$ | XPRINT GET DC |
| COMM LINE | FIELD | LET *(WITH OBJECTS)* | RESUME | XPRINT GET DUPLEX |
| COMM LINE INPUT | FILEATTR | LET *(WITH TYPES)* | RETAIN | XPRINT GET LINES |
| COMM OPEN | FILECOPY | LET *(WITH VARIANTS)* | RETAIN$ | XPRINT GET MARGIN |
| COMM PRINT | FILENAME | LINE INPUT# | RETURN | XPRINT GET MIX |
| COMM RECV | FILENAME$ | LISTVIEW | RGB | XPRINT GET ORIENTATION |
| COMM RESET | FILESCAN | LO | RIGHT | XPRINT GET OVERLAP |
| COMM SEND | FIX | LOC | RIGHT$ | XPRINT GET PAGES |
| COMM SET | FLOOR | LOCAL | RMDIR | XPRINT GET PAPER |
...
| CONTROL GET TEXT | GLOBAL | MACRO/END MACRO | SIN | XPRINT POLYLINE |
| CONTROL HIDE | GLOBALMEM | MAK | SINGLE | XPRINT PREVIEW |
| CONTROL KILL | GRAPHIC ARC | MAT | SINH | XPRINT PRINT |
| CONTROL SET CHECK | GRAPHIC ATTACH | MAX | SIZEOF | XPRINT RENDER |
| CONTROL SET TEXT | GRAPHIC BITMAP END | MCASE | SLEEP | XPRINT SCALE |
| COS | GRAPHIC BITMAP LOAD | MCASE$ | SPACE | XPRINT SET CLIP |
| COSH | GRAPHIC BITMAP NEW | MEMORY | SPACE$ | XPRINT SET COLLATE |
| COT | GRAPHIC BOX | MEMORY FILL | SPLIT | XPRINT SET COLOR |
| COTH | GRAPHIC CELL | MEMORY FILLS | SQR | XPRINT SET COLORMODE |
| CQUAD | GRAPHIC CELL SIZE | MENU ADD POPUP | STATIC | XPRINT SET COPIES |
| CSC | GRAPHIC CHR SIZE | MENU ADD STRING | STATUSBAR | XPRINT SET DUPLEX |
| CSCH | GRAPHIC CIRCLE | MENU DELETE | STR | XPRINT SET FONT |
| CSET | GRAPHIC CLEAR | MENU GET STATE | STR$ | XPRINT SET MIX |
| CSET$ | GRAPHIC COLOR | MENU GET TEXT | STRDELETE | XPRINT SET ORIENTATION |
| CSNG | GRAPHIC COPY | MENU NEW BAR | STRDELETE$ | XPRINT SET OVERLAP |
| CSTR | GRAPHIC DETACH | MENU NEW POPUP | STRING | XPRINT SET PAGES |
| CULNG | GRAPHIC ELLIPSE | MENU SET STATE | STRINSERT | XPRINT SET PAPER |
| CURDIR | GRAPHIC GET BITS | MENU SET TEXT | STRINSERT$ | XPRINT SET PIXEL |
| CURDIR$ | GRAPHIC GET CANVAS | METHOD / END METHOD | STRPTR | XPRINT SET POS |
| CVBYT | GRAPHIC GET CAPTION | METRICS | STRREVERSE | XPRINT SET QUALITY |
| CVCUX | GRAPHIC GET CLIENT | MID | STRREVERSE$ | XPRINT SET STRETCHMODE |
| CVDWD | GRAPHIC GET CLIP | MID$ | SWAP | XPRINT SET TEXTALIGN |
| CVL | GRAPHIC GET DC | MIN | SWITCH | XPRINT SET TRAY |
| CVQ | GRAPHIC GET LINES | MKBYT | SWITCH$ | XPRINT SET WORDWRAP |
| CVW | GRAPHIC GET LOC | MKBYT$ | TAB$ | XPRINT SET WRAP |
| CWORD | GRAPHIC GET MIX | MKCUR$ | TALLY | XPRINT SPLIT |
| DATA | GRAPHIC GET PIXEL | MKCUX | TAN | XPRINT STRETCH |
| DATACOUNT | GRAPHIC GET POS | MKCUX$ | TANH | XPRINT STYLE |
| DAYNAME | GRAPHIC GET PPI | MKD$ | TCP ACCEPT | XPRINT TEXT SIZE |
| DAYNAME$ | GRAPHIC GET SCALE | MKDIR | TCP CLOSE | XPRINT WIDTH |
| DEC | GRAPHIC GET SIZE | MKDWD | TCP LINE INPUT |  |
| DEC$ | GRAPHIC GET STRETCHMODE | MKDWD$ | TCP NOTIFY |  |
| DECLARE | GRAPHIC GET TEXTALIGN | MKE | TCP OPEN |  |

## **Newly** implemented by this branch

> **514 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG SET ICON | IIF | SIZEOF |
| ACCEL ATTACH | DIALOG SET LOC | IMAGELIST COUNT | SPACE |
| ACODE | DIALOG SET SIZE | IMAGELIST KILL | SPACE$ |
| ACODE$ | DIALOG SET TEXT | IMAGELIST NEW | SQR |
| ACOS | DIALOG SET USER | IMP | STATUSBAR |
| ACOSH | DIALOG SHOW MODAL | INPUT# | STR |
| ARRAY ADD | DIALOG SHOW MODELESS | INSTANCE | STR$ |
| ARRAY ARRAYIX | DIALOG SHOW STATE | INSTR | STRDELETE |
| ARRAY ASSIGN | DIALOG STABILIZE | INT | STRDELETE$ |
| ARRAY COPY | DIALOG UNITS | INTEGER | STRING |
| ARRAY DELETE | DIM | ISEVEN | STRINSERT |
| ARRAY INSERT | DIR | ISFALSE | STRINSERT$ |
| ARRAY REDIM DECR | DIR CLOSE | ISFILE | STRPTR |
| ARRAY REDIM INCR | DIR$ | ISFOLDER | STRREVERSE |
| ARRAY REVERSE | DISKFREE | ISINFINITE | STRREVERSE$ |
| ARRAY SCAN | DISKSIZE | ISNORMAL | SWITCH |
| ARRAY SHUFFLE | DISPLAY BROWSE | ISODD | SWITCH$ |
| ARRAY SWAP | DISPLAY COLOR | ISTRUE | TAB$ |
| ARRAY TAGARRAY | DISPLAY FONT | ISWIN | TALLY |
| ARRAY TAGARRAY ERASE | DISPLAY OPENFILE | JOIN$ | TAN |
| ARRAY UNIQUE | DISPLAY SAVEFILE | LCASE | TANH |
| ASIN | DOUBLE | LCASE$ | TCP NOTIFY |
| ASINH | ENVIRON$ | LEFT | THREADCOUNT |
| ATANH | EOF | LEFT$ | THREADID |
| ATN | EQV | LEN | TIMER |
| ATN2 | ERF | LET *(WITH OBJECTS)* | TOOLBAR |
| BGR | ERL | LET *(WITH VARIANTS)* | TREEVIEW |
| BIN | ERL$ | LINE INPUT# | TRIM |
| BIN$ | ERR | LISTVIEW | TRIM$ |
| BITS | ERRCLEAR | LO | TRUNC |
| BITS$ | ERROR$ | LOC | UCASE |
| BITSE | EVENT SOURCE | LOF | UCASE$ |
| BUILD | EVENTS | LOG | UCODE$ |
| BUILD$ | EXE | LOG10 | UCODEPAGE |
| BYTE | EXIST | LOG1P | UDP NOTIFY |
| CALLSTK$ | EXP | LOG2 | UNWRAP |
| CALLSTKCOUNT | EXP10 | LONG | UNWRAP$ |
| CBOOL | EXP2 | LOWRD | USING |
| CBRT | EXPM1 | LPRINT$ | USING$ |
| CBYTE | EXTRACT | LSET$ | UTF8TOCHR |
| CDBL | EXTRACT$ | LTRIM | UTF8TOCHR$ |
| CDWORD | FILEATTR | LTRIM$ | VARPTR |
| CEIL | FILENAME | MAK | VERIFY |
| CFLT | FILENAME$ | MAX | WAITKEY |
| CHOOSE | FIX | MCASE | WAITKEY$ |
| CHR | FLOOR | MCASE$ | WORD |
| CHR$ | FONT END | MEMORY FILL | WRAP |
| CHRBYTES | FONT NEW | MEMORY FILLS | WRAP$ |
| CHRTOOEM | FORMAT | MENU ADD POPUP | WRITE |
| CHRTOOEM$ | FORMAT$ | MENU ADD STRING | WRITE# |
| CHRTOUTF8 | FRAC | MENU DELETE | XPRINT ARC |
| CHRTOUTF8$ | FRE | MENU GET STATE | XPRINT ATTACH |
| CLIP | FREEFILE | MENU GET TEXT | XPRINT BOX |
| CLIP$ | FUNCNAME | MENU NEW BAR | XPRINT CANCEL |
| CLOSE | FUNCNAME$ | MENU NEW POPUP | XPRINT CELL |
| CODEPTR | GET | MENU SET STATE | XPRINT CELL SIZE |
...
| CONTROL GET TEXT | GRAPHIC DETACH | ON CALL | XPRINT GET MIX |
| CONTROL HIDE | GRAPHIC ELLIPSE | ON GOSUB | XPRINT GET ORIENTATION |
| CONTROL KILL | GRAPHIC GET BITS | ON GOTO | XPRINT GET OVERLAP |
| CONTROL SET CHECK | GRAPHIC GET CANVAS | OPEN | XPRINT GET PAGES |
| CONTROL SET TEXT | GRAPHIC GET CAPTION | PARSE$ | XPRINT GET PAPER |
| COS | GRAPHIC GET CLIENT | PARSECOUNT | XPRINT GET PAPERS |
| COSH | GRAPHIC GET CLIP | PATHNAME | XPRINT GET PIXEL |
| COT | GRAPHIC GET DC | PATHNAME$ | XPRINT GET POS |
| COTH | GRAPHIC GET LINES | PATHSCAN | XPRINT GET PPI |
| CQUAD | GRAPHIC GET LOC | PATHSCAN$ | XPRINT GET QUALITY |
| CSC | GRAPHIC GET MIX | PEEK | XPRINT GET SCALE |
| CSCH | GRAPHIC GET PIXEL | PLAY | XPRINT GET SELECTION |
| CSET$ | GRAPHIC GET POS | PLAY SOUND | XPRINT GET SIZE |
| CSNG | GRAPHIC GET PPI | POKE | XPRINT GET STRETCHMODE |
| CSTR | GRAPHIC GET SCALE | PRINTER$ | XPRINT GET TEXTALIGN |
| CULNG | GRAPHIC GET SIZE | PRINTERCOUNT | XPRINT GET TRAY |
| CURDIR | GRAPHIC GET STRETCHMODE | PROGRESSBAR | XPRINT GET TRAYS |
| CURDIR$ | GRAPHIC GET TEXTALIGN | PUT | XPRINT GET WORDWRAP |
| CVBYT | GRAPHIC GET VIEW | PUT STR | XPRINT GET WRAP |
| CVCUX | GRAPHIC GET WORDWRAP | PUT WSTR | XPRINT IMAGELIST |
| CVDWD | GRAPHIC GET WRAP | PUT$ | XPRINT LINE |
| CVL | GRAPHIC LINE | PUT$$ | XPRINT PIE |
| CVQ | GRAPHIC PAINT | QUAD | XPRINT POLYGON |
| CVW | GRAPHIC PIE | RAISEEVENT | XPRINT POLYLINE |
| CWORD | GRAPHIC POLYGON | READ | XPRINT PREVIEW |
| DATACOUNT | GRAPHIC POLYLINE | READ$ | XPRINT PRINT |
| DAYNAME | GRAPHIC PRINT | REDIM | XPRINT RENDER |
| DAYNAME$ | GRAPHIC SAVE | REMAIN | XPRINT SCALE |
| DEC | GRAPHIC SCALE | REMAIN$ | XPRINT SET CLIP |
| DEC$ | GRAPHIC SCALE PIXELS | REMOVE | XPRINT SET COLLATE |
| DECLARE | GRAPHIC SET AUTOSIZE | REMOVE$ | XPRINT SET COLOR |
| DEF | GRAPHIC SET BITS | REPEAT | XPRINT SET COLORMODE |
| DESKTOP GET PPI | GRAPHIC SET CAPTION | REPEAT$ | XPRINT SET COPIES |
| DIALOG DEFAULT FONT | GRAPHIC SET CLIP | RESOURCE SAVE FILE | XPRINT SET DUPLEX |
| DIALOG DISABLE | GRAPHIC SET FIXED | RESOURCE$ | XPRINT SET FONT |
| DIALOG DOEVENTS | GRAPHIC SET FONT | RETAIN | XPRINT SET MIX |
| DIALOG ENABLE | GRAPHIC SET MIX | RETAIN$ | XPRINT SET ORIENTATION |
| DIALOG END | GRAPHIC SET PIXEL | RGB | XPRINT SET OVERLAP |
| DIALOG GET CLIENT | GRAPHIC SET POS | RIGHT | XPRINT SET PAGES |
| DIALOG GET LOC | GRAPHIC SET SIZE | RIGHT$ | XPRINT SET PAPER |
| DIALOG GET SIZE | GRAPHIC SET STRETCHMODE | RND | XPRINT SET PIXEL |
| DIALOG GET TEXT | GRAPHIC SET TEXTALIGN | ROUND | XPRINT SET POS |
| DIALOG GET USER | GRAPHIC SET VIEW | RSET$ | XPRINT SET QUALITY |
| DIALOG HIDE | GRAPHIC SET VIRTUAL | RTRIM | XPRINT SET STRETCHMODE |
| DIALOG MAXIMIZE | GRAPHIC SET WORDWRAP | RTRIM$ | XPRINT SET TEXTALIGN |
| DIALOG MINIMIZE | GRAPHIC SET WRAP | SEC | XPRINT SET TRAY |
| DIALOG NEW | GRAPHIC STYLE | SECH | XPRINT SET WORDWRAP |
| DIALOG NONSTABLE | GRAPHIC TEXT SIZE | SEEK | XPRINT SET WRAP |
| DIALOG NORMALIZE | GRAPHIC WIDTH | SETEOF | XPRINT SPLIT |
| DIALOG PIXELS | HEADER | SGN | XPRINT STRETCH |
| DIALOG POST | HEX | SHRINK | XPRINT STYLE |
| DIALOG REDRAW | HEX$ | SHRINK$ | XPRINT TEXT SIZE |
| DIALOG SEND | HI | SIN | XPRINT WIDTH |
| DIALOG SET CLIENT | HIWRD | SINGLE |  |
| DIALOG SET COLOR | HYPOT | SINH |  |
