...
> Summary:
> - **801** official PowerBASIC statement/function keywords currently available for use
>   - **653** implemented or completed by this fork
...
> - **54** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 175 (v0.2.032). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 801 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DESKTOP GET SIZE | HEADER SEND | MKE | TCP RECV |
| ACCEL ATTACH | DIALOG DEFAULT FONT | HEADER SET ITEM | MKE$ | TCP SEND |
| ACODE | DIALOG DISABLE | HEX | MKI$ | THREAD CLOSE |
| ACODE$ | DIALOG DOEVENTS | HEX$ | MKL$ | THREAD CREATE |
| ACOS | DIALOG ENABLE | HI | MKQ$ | THREAD GET PRIORITY |
| ACOSH | DIALOG END | HIWRD | MKS | THREAD RESUME |
| AND | DIALOG GET CLIENT | HOST ADDR | MKS$ | THREAD SET PRIORITY |
| ARRAY ADD | DIALOG GET LOC | HOST NAME | MKWRD | THREAD STATUS |
| ARRAY ARRAYIX | DIALOG GET SIZE | HYPOT | MKWRD$ | THREAD SUSPEND |
| ARRAY ASSIGN | DIALOG GET TEXT | IF | MOD | THREADCOUNT |
| ARRAY COPY | DIALOG GET USER | IF/END IF | MONTHNAME | THREADED |
| ARRAY DELETE | DIALOG HIDE | IIF | MONTHNAME$ | THREADID |
| ARRAY INSERT | DIALOG MAXIMIZE | IMAGELIST ADD BITMAP | MOUSEPTR | TIMER |
| ARRAY REDIM DECR | DIALOG MINIMIZE | IMAGELIST ADD ICON | MSGBOX | TIX |
| ARRAY REDIM INCR | DIALOG NEW | IMAGELIST ADD MASKED | NAME | TOOLBAR ADD BUTTON |
| ARRAY REVERSE | DIALOG NONSTABLE | IMAGELIST COUNT | NOT | TOOLBAR ADD SEPARATOR |
| ARRAY SCAN | DIALOG NORMALIZE | IMAGELIST GET COUNT | NUL | TOOLBAR DELETE BUTTON |
| ARRAY SHUFFLE | DIALOG PIXELS | IMAGELIST KILL | NUL$ | TOOLBAR GET COUNT |
| ARRAY SORT | DIALOG POST | IMAGELIST NEW | OBJECT | TOOLBAR GET STATE |
| ARRAY SWAP | DIALOG REDRAW | IMAGELIST NEW BITMAP | OCT | TOOLBAR SET IMAGELIST |
| ARRAY TAGARRAY | DIALOG SEND | IMAGELIST NEW ICON | OCT$ | TOOLBAR SET STATE |
| ARRAY TAGARRAY ERASE | DIALOG SET CLIENT | IMAGELIST SET OVERLAY | OEMTOCHR | TRACE |
| ARRAY UNIQUE | DIALOG SET COLOR | IMP | OEMTOCHR$ | TREEVIEW DELETE |
| ASC | DIALOG SET ICON | IMPORT | ON CALL | TREEVIEW GET BOLD |
| ASIN | DIALOG SET LOC | INCR | ON ERROR | TREEVIEW GET CHECK |
| ASINH | DIALOG SET SIZE | INPUT FLUSH | ON GOSUB | TREEVIEW GET CHILD |
| ASM | DIALOG SET TEXT | INPUT# | ON GOTO | TREEVIEW GET COUNT |
| ASMDATA / END ASMDATA | DIALOG SET USER | INSTANCE | OPEN | TREEVIEW GET EXPANDED |
| ATANH | DIALOG SHOW MODAL | INSTR | OPTION EXPLICIT | TREEVIEW GET NEXT |
| ATN | DIALOG SHOW MODELESS | INT | OR | TREEVIEW GET PARENT |
| ATN2 | DIALOG SHOW STATE | INTEGER | PARSE | TREEVIEW GET PREVIOUS |
| BEEP | DIALOG STABILIZE | INTERFACE / END INTERFACE (DIRECT) | PARSE$ | TREEVIEW GET ROOT |
| BGR | DIALOG UNITS | INTERFACE/END INTERFACE (IDBIND) | PARSECOUNT | TREEVIEW GET SELECT |
| BIN | DIM | ISEVEN | PATHNAME | TREEVIEW GET TEXT |
| BIN$ | DIR | ISFALSE | PATHNAME$ | TREEVIEW GET USER |
| BIT | DIR CLOSE | ISFILE | PATHSCAN | TREEVIEW INSERT ITEM |
| BIT CALC | DIR$ | ISFOLDER | PATHSCAN$ | TREEVIEW RESET |
| BITS | DISKFREE | ISINFINITE | PEEK | TREEVIEW SELECT |
| BITS$ | DISKSIZE | ISNORMAL | PLAY | TREEVIEW SET BOLD |
| BITSE | DISPLAY BROWSE | ISODD | PLAY SOUND | TREEVIEW SET CHECK |
| BUILD | DISPLAY COLOR | ISTRUE | PLAY WAVE | TREEVIEW SET EXPANDED |
| BUILD$ | DISPLAY FONT | ISWIN | POKE | TREEVIEW SET IMAGELIST |
| BYTE | DISPLAY OPENFILE | ITERATE | PREFIX | TREEVIEW SET TEXT |
| CALL | DISPLAY SAVEFILE | JOIN$ | PRINT# | TREEVIEW SET USER |
| CALL DWORD | DOUBLE | KILL | PRINTER$ | TREEVIEW UNSELECT |
| CALLSTK | END | LCASE | PRINTERCOUNT | TRIM |
| CALLSTK$ | ENVIRON | LCASE$ | PROCESS GET PRIORITY | TRIM$ |
| CALLSTKCOUNT | ENVIRON$ | LEFT | PROCESS SET PRIORITY | TRUNC |
| CBOOL | EOF | LEFT$ | PROFILE | TRY/END TRY |
| CBRT | EQV | LEN | PROGRESSBAR GET POS | TYPE SET |
| CBYTE | ERASE | LET | PROGRESSBAR GET RANGE | TYPE/END TYPE |
| CDBL | ERF | LET *(WITH OBJECTS)* | PROGRESSBAR SET POS | UCASE |
| CDWORD | ERL | LET *(WITH TYPES)* | PROGRESSBAR SET RANGE | UCASE$ |
| CEIL | ERL$ | LET *(WITH VARIANTS)* | PROGRESSBAR SET STEP | UCODE$ |
| CFLT | ERR | LINE INPUT# | PROGRESSBAR STEP | UCODEPAGE |
| CHDIR | ERRCLEAR | LISTBOX ADD | PUT | UDP CLOSE |
| CHDRIVE | ERROR | LISTBOX DELETE | PUT STR | UDP NOTIFY |
| CHOOSE | ERROR$ | LISTBOX FIND | PUT WSTR | UDP OPEN |
| CHR | EVENT SOURCE | LISTBOX FIND EXACT | PUT$ | UDP RECV |
| CHR$ | EVENTS | LISTBOX GET COUNT | PUT$$ | UDP SEND |
| CHRBYTES | EXE | LISTBOX GET SELCOUNT | QUAD | UNLOCK |
| CHRTOOEM | EXIST | LISTBOX GET SELECT | RAISEEVENT | UNWRAP |
| CHRTOOEM$ | EXIT | LISTBOX GET STATE | RANDOMIZE | UNWRAP$ |
| CHRTOUTF8 | EXP | LISTBOX GET TEXT | READ | USING |
| CHRTOUTF8$ | EXP10 | LISTBOX GET USER | READ$ | USING$ |
| CLASS/END CLASS | EXP2 | LISTBOX INSERT | REDIM | UTF8TOCHR |
| CLIP | EXPM1 | LISTBOX RESET | REGEXPR | UTF8TOCHR$ |
| CLIP$ | EXTRACT | LISTBOX SELECT | REGISTER | VAL |
| CLIPBOARD | EXTRACT$ | LISTBOX SET TEXT | REGREPL | VARPTR |
| CLOSE | FIELD | LISTBOX SET USER | REM | VERIFY |
| CLS | FILEATTR | LISTBOX UNSELECT | REMAIN | WAITKEY |
| CODEPTR | FILECOPY | LISTVIEW DELETE COLUMN | REMAIN$ | WAITKEY$ |
| COLOR | FILENAME | LISTVIEW DELETE ITEM | REMOVE | WINDOW GET |
| COMBOBOX ADD | FILENAME$ | LISTVIEW FIND | REMOVE$ | WINDOW SET |
| COMBOBOX DELETE | FILESCAN | LISTVIEW FIND EXACT | REPEAT | WORD |
| COMBOBOX FIND | FIX | LISTVIEW FIT CONTENT | REPEAT$ | WRAP |
| COMBOBOX FIND EXACT | FLOOR | LISTVIEW FIT HEADER | REPLACE | WRAP$ |
| COMBOBOX GET COUNT | FLUSH | LISTVIEW GET COLUMN | RESET | WRITE |
| COMBOBOX GET SELCOUNT | FONT END | LISTVIEW GET COUNT | RESOURCE SAVE FILE | WRITE# |
| COMBOBOX GET SELECT | FONT NEW | LISTVIEW GET HEADER | RESOURCE$ | XOR |
| COMBOBOX GET STATE | FOR / NEXT | LISTVIEW GET HEADERID | RESUME | XPRINT ARC |
| COMBOBOX GET TEXT | FORMAT | LISTVIEW GET MODE | RETAIN | XPRINT ATTACH |
| COMBOBOX GET USER | FORMAT$ | LISTVIEW GET SELCOUNT | RETAIN$ | XPRINT BOX |
| COMBOBOX INSERT | FRAC | LISTVIEW GET SELECT | RETURN | XPRINT CANCEL |
| COMBOBOX RESET | FRE | LISTVIEW GET STATE | RGB | XPRINT CELL |
| COMBOBOX SELECT | FREEFILE | LISTVIEW GET STYLEXX | RIGHT | XPRINT CELL SIZE |
| COMBOBOX SET TEXT | FUNCNAME | LISTVIEW GET TEXT | RIGHT$ | XPRINT CHR SIZE |
| COMBOBOX SET USER | FUNCNAME$ | LISTVIEW GET USER | RMDIR | XPRINT CLOSE |
| COMBOBOX UNSELECT | FUNCTION / END FUNCTION | LISTVIEW INSERT COLUMN | RND | XPRINT COLOR |
| COMM CLOSE | GET | LISTVIEW INSERT ITEM | ROTATE | XPRINT COPY |
| COMM LINE | GET STR | LISTVIEW RESET | ROUND | XPRINT ELLIPSE |
| COMM LINE INPUT | GET WSTR | LISTVIEW SELECT | RSET | XPRINT FORMFEED |
| COMM OPEN | GET$ | LISTVIEW SET COLUMN | RSET$ | XPRINT GET ATTACH |
| COMM PRINT | GET$$ | LISTVIEW SET HEADER | RTRIM | XPRINT GET CANVAS |
| COMM RECV | GETATTR | LISTVIEW SET IMAGE | RTRIM$ | XPRINT GET CLIENT |
| COMM RESET | GLOBAL | LISTVIEW SET IMAGE2 | SCROLLBAR GET PAGESIZE | XPRINT GET CLIP |
| COMM SEND | GLOBALMEM | LISTVIEW SET IMAGELIST | SCROLLBAR GET POS | XPRINT GET COLLATE |
| COMM SET | GRAPHIC ARC | LISTVIEW SET MODE | SCROLLBAR GET RANGE | XPRINT GET COLOR |
| COMM TIMEOUT | GRAPHIC ATTACH | LISTVIEW SET OVERLAY | SCROLLBAR GET TRACKPOS | XPRINT GET COLORMODE |
| COMMAND | GRAPHIC BITMAP END | LISTVIEW SET STYLEXX | SCROLLBAR SET PAGESIZE | XPRINT GET COPIES |
| COMMAND$ | GRAPHIC BITMAP LOAD | LISTVIEW SET TEXT | SCROLLBAR SET POS | XPRINT GET DC |
| CONTROL ADD | GRAPHIC BITMAP NEW | LISTVIEW SET USER | SCROLLBAR SET RANGE | XPRINT GET DUPLEX |
| CONTROL ADD BUTTON | GRAPHIC BOX | LISTVIEW SORT | SEC | XPRINT GET LINES |
| CONTROL ADD CHECKBOX | GRAPHIC CELL | LISTVIEW UNSELECT | SECH | XPRINT GET MARGIN |
| CONTROL ADD COMBOBOX | GRAPHIC CELL SIZE | LISTVIEW VISIBLE | SEEK | XPRINT GET MIX |
| CONTROL ADD LABEL | GRAPHIC CHR SIZE | LO | SELECT CASE/END SELECT | XPRINT GET ORIENTATION |
| CONTROL ADD LISTBOX | GRAPHIC CIRCLE | LOC | SETATTR | XPRINT GET OVERLAP |
| CONTROL ADD LISTVIEW | GRAPHIC CLEAR | LOCAL | SETEOF | XPRINT GET PAGES |
| CONTROL ADD PROGRESSBAR | GRAPHIC COLOR | LOCK | SGN | XPRINT GET PAPER |
| CONTROL ADD SCROLLBAR | GRAPHIC COPY | LOF | SHELL | XPRINT GET PAPERS |
| CONTROL ADD STATUSBAR | GRAPHIC DETACH | LOG | SHIFT | XPRINT GET PIXEL |
| CONTROL ADD TAB | GRAPHIC ELLIPSE | LOG10 | SHRINK | XPRINT GET POS |
| CONTROL ADD TOOLBAR | GRAPHIC GET BITS | LOG1P | SHRINK$ | XPRINT GET PPI |
| CONTROL ADD TREEVIEW | GRAPHIC GET CANVAS | LOG2 | SIN | XPRINT GET QUALITY |
| CONTROL DISABLE | GRAPHIC GET CAPTION | LONG | SINGLE | XPRINT GET SCALE |
| CONTROL ENABLE | GRAPHIC GET CLIENT | LOWRD | SINH | XPRINT GET SELECTION |
| CONTROL GET CHECK | GRAPHIC GET CLIP | LPRINT | SIZEOF | XPRINT GET SIZE |
| CONTROL GET CLIENT | GRAPHIC GET DC | LPRINT ATTACH | SLEEP | XPRINT GET STRETCHMODE |
| CONTROL GET LOC | GRAPHIC GET LINES | LPRINT CLOSE | SPACE | XPRINT GET TEXTALIGN |
| CONTROL GET SIZE | GRAPHIC GET LOC | LPRINT FLUSH | SPACE$ | XPRINT GET TRAY |
| CONTROL GET TEXT | GRAPHIC GET MIX | LPRINT FORMFEED | SPLIT | XPRINT GET TRAYS |
| CONTROL HIDE | GRAPHIC GET PIXEL | LPRINT$ | SQR | XPRINT GET WORDWRAP |
| CONTROL KILL | GRAPHIC GET POS | LSET | STATIC | XPRINT GET WRAP |
| CONTROL SET CHECK | GRAPHIC GET PPI | LSET$ | STATUSBAR SET PARTS | XPRINT IMAGELIST |
| CONTROL SET CLIENT | GRAPHIC GET SCALE | LTRIM | STATUSBAR SET TEXT | XPRINT LINE |
| CONTROL SET LOC | GRAPHIC GET SIZE | LTRIM$ | STR | XPRINT PIE |
| CONTROL SET SIZE | GRAPHIC GET STRETCHMODE | MACRO/END MACRO | STR$ | XPRINT POLYGON |
| CONTROL SET TEXT | GRAPHIC GET TEXTALIGN | MAK | STRDELETE | XPRINT POLYLINE |
| COS | GRAPHIC GET VIEW | MAT | STRDELETE$ | XPRINT PREVIEW |
| COSH | GRAPHIC GET WORDWRAP | MAX | STRING | XPRINT PRINT |
| COT | GRAPHIC GET WRAP | MCASE | STRINSERT | XPRINT RENDER |
| COTH | GRAPHIC LINE | MCASE$ | STRINSERT$ | XPRINT SCALE |
| CQUAD | GRAPHIC PAINT | MEMORY | STRPTR | XPRINT SET CLIP |
| CSC | GRAPHIC PIE | MEMORY FILL | STRREVERSE | XPRINT SET COLLATE |
| CSCH | GRAPHIC POLYGON | MEMORY FILLS | STRREVERSE$ | XPRINT SET COLOR |
| CSET | GRAPHIC POLYLINE | MENU ADD POPUP | SWAP | XPRINT SET COLORMODE |
| CSET$ | GRAPHIC PRINT | MENU ADD STRING | SWITCH | XPRINT SET COPIES |
| CSNG | GRAPHIC SAVE | MENU ATTACH | SWITCH$ | XPRINT SET DUPLEX |
| CSTR | GRAPHIC SCALE | MENU CONTEXT | TAB DELETE | XPRINT SET FONT |
| CULNG | GRAPHIC SCALE PIXELS | MENU DELETE | TAB GET COUNT | XPRINT SET MIX |
| CURDIR | GRAPHIC SET AUTOSIZE | MENU DRAW BAR | TAB GET DIALOG | XPRINT SET ORIENTATION |
| CURDIR$ | GRAPHIC SET BITS | MENU GET STATE | TAB GET IMAGE | XPRINT SET OVERLAP |
| CVBYT | GRAPHIC SET CAPTION | MENU GET TEXT | TAB GET PAGE | XPRINT SET PAGES |
| CVCUX | GRAPHIC SET CLIP | MENU NEW BAR | TAB GET SELECT | XPRINT SET PAPER |
| CVDWD | GRAPHIC SET FIXED | MENU NEW POPUP | TAB GET TEXT | XPRINT SET PIXEL |
| CVL | GRAPHIC SET FONT | MENU SET STATE | TAB INSERT PAGE | XPRINT SET POS |
| CVQ | GRAPHIC SET MIX | MENU SET TEXT | TAB RESET | XPRINT SET QUALITY |
| CVW | GRAPHIC SET PIXEL | METHOD / END METHOD | TAB SELECT | XPRINT SET STRETCHMODE |
| CWORD | GRAPHIC SET POS | METRICS | TAB SET IMAGE | XPRINT SET TEXTALIGN |
| DATA | GRAPHIC SET SIZE | MID | TAB SET IMAGELIST | XPRINT SET TRAY |
| DATACOUNT | GRAPHIC SET STRETCHMODE | MID$ | TAB SET TEXT | XPRINT SET WORDWRAP |
| DAYNAME | GRAPHIC SET TEXTALIGN | MIN | TAB$ | XPRINT SET WRAP |
| DAYNAME$ | GRAPHIC SET VIEW | MKBYT | TALLY | XPRINT SPLIT |
| DEC | GRAPHIC SET VIRTUAL | MKBYT$ | TAN | XPRINT STRETCH |
| DEC$ | GRAPHIC SET WORDWRAP | MKCUR$ | TANH | XPRINT STYLE |
| DECLARE | GRAPHIC SET WRAP | MKCUX | TCP ACCEPT | XPRINT TEXT SIZE |
| DECR | GRAPHIC STYLE | MKCUX$ | TCP CLOSE | XPRINT WIDTH |
| DEF | GRAPHIC TEXT SIZE | MKD$ | TCP LINE INPUT |  |
| DESKTOP GET CLIENT | GRAPHIC WIDTH | MKDIR | TCP NOTIFY |  |
| DESKTOP GET LOC | HEADER GET COUNT | MKDWD | TCP OPEN |  |
| DESKTOP GET PPI | HEADER GET ITEM | MKDWD$ | TCP PRINT |  |

## **Newly** implemented by this branch

> **653 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIR CLOSE | LISTBOX GET USER | STRDELETE |
| ACCEL ATTACH | DIR$ | LISTBOX INSERT | STRDELETE$ |
| ACODE | DISKFREE | LISTBOX RESET | STRING |
| ACODE$ | DISKSIZE | LISTBOX SELECT | STRINSERT |
| ACOS | DISPLAY BROWSE | LISTBOX SET TEXT | STRINSERT$ |
| ACOSH | DISPLAY COLOR | LISTBOX SET USER | STRPTR |
| ARRAY ADD | DISPLAY FONT | LISTBOX UNSELECT | STRREVERSE |
| ARRAY ARRAYIX | DISPLAY OPENFILE | LISTVIEW DELETE COLUMN | STRREVERSE$ |
| ARRAY ASSIGN | DISPLAY SAVEFILE | LISTVIEW DELETE ITEM | SWITCH |
| ARRAY COPY | DOUBLE | LISTVIEW FIND | SWITCH$ |
| ARRAY DELETE | ENVIRON$ | LISTVIEW FIND EXACT | TAB DELETE |
| ARRAY INSERT | EOF | LISTVIEW FIT CONTENT | TAB GET COUNT |
| ARRAY REDIM DECR | EQV | LISTVIEW FIT HEADER | TAB GET DIALOG |
| ARRAY REDIM INCR | ERF | LISTVIEW GET COLUMN | TAB GET IMAGE |
| ARRAY REVERSE | ERL | LISTVIEW GET COUNT | TAB GET PAGE |
| ARRAY SCAN | ERL$ | LISTVIEW GET HEADER | TAB GET SELECT |
| ARRAY SHUFFLE | ERR | LISTVIEW GET HEADERID | TAB GET TEXT |
| ARRAY SWAP | ERRCLEAR | LISTVIEW GET MODE | TAB INSERT PAGE |
| ARRAY TAGARRAY | ERROR$ | LISTVIEW GET SELCOUNT | TAB RESET |
| ARRAY TAGARRAY ERASE | EVENT SOURCE | LISTVIEW GET SELECT | TAB SELECT |
| ARRAY UNIQUE | EVENTS | LISTVIEW GET STATE | TAB SET IMAGE |
| ASIN | EXE | LISTVIEW GET STYLEXX | TAB SET IMAGELIST |
| ASINH | EXIST | LISTVIEW GET TEXT | TAB SET TEXT |
| ATANH | EXP | LISTVIEW GET USER | TAB$ |
| ATN | EXP10 | LISTVIEW INSERT COLUMN | TALLY |
| ATN2 | EXP2 | LISTVIEW INSERT ITEM | TAN |
| BGR | EXPM1 | LISTVIEW RESET | TANH |
| BIN | EXTRACT | LISTVIEW SELECT | TCP NOTIFY |
| BIN$ | EXTRACT$ | LISTVIEW SET COLUMN | THREADCOUNT |
| BITS | FILEATTR | LISTVIEW SET HEADER | THREADID |
| BITS$ | FILENAME | LISTVIEW SET IMAGE | TIMER |
| BITSE | FILENAME$ | LISTVIEW SET IMAGE2 | TOOLBAR ADD BUTTON |
| BUILD | FIX | LISTVIEW SET IMAGELIST | TOOLBAR ADD SEPARATOR |
| BUILD$ | FLOOR | LISTVIEW SET MODE | TOOLBAR DELETE BUTTON |
| BYTE | FONT END | LISTVIEW SET OVERLAY | TOOLBAR GET COUNT |
| CALLSTK$ | FONT NEW | LISTVIEW SET STYLEXX | TOOLBAR GET STATE |
| CALLSTKCOUNT | FORMAT | LISTVIEW SET TEXT | TOOLBAR SET IMAGELIST |
| CBOOL | FORMAT$ | LISTVIEW SET USER | TOOLBAR SET STATE |
| CBRT | FRAC | LISTVIEW SORT | TREEVIEW DELETE |
| CBYTE | FRE | LISTVIEW UNSELECT | TREEVIEW GET BOLD |
| CDBL | FREEFILE | LISTVIEW VISIBLE | TREEVIEW GET CHECK |
| CDWORD | FUNCNAME | LO | TREEVIEW GET CHILD |
| CEIL | FUNCNAME$ | LOC | TREEVIEW GET COUNT |
| CFLT | GET | LOF | TREEVIEW GET EXPANDED |
| CHOOSE | GET STR | LOG | TREEVIEW GET NEXT |
| CHR | GET WSTR | LOG10 | TREEVIEW GET PARENT |
| CHR$ | GET$ | LOG1P | TREEVIEW GET PREVIOUS |
| CHRBYTES | GET$$ | LOG2 | TREEVIEW GET ROOT |
| CHRTOOEM | GETATTR | LONG | TREEVIEW GET SELECT |
| CHRTOOEM$ | GRAPHIC ARC | LOWRD | TREEVIEW GET TEXT |
| CHRTOUTF8 | GRAPHIC ATTACH | LPRINT$ | TREEVIEW GET USER |
| CHRTOUTF8$ | GRAPHIC BITMAP END | LSET$ | TREEVIEW INSERT ITEM |
| CLIP | GRAPHIC BITMAP LOAD | LTRIM | TREEVIEW RESET |
| CLIP$ | GRAPHIC BITMAP NEW | LTRIM$ | TREEVIEW SELECT |
| CLOSE | GRAPHIC BOX | MAK | TREEVIEW SET BOLD |
| CODEPTR | GRAPHIC CELL | MAX | TREEVIEW SET CHECK |
| COMBOBOX ADD | GRAPHIC CELL SIZE | MCASE | TREEVIEW SET EXPANDED |
| COMBOBOX DELETE | GRAPHIC CHR SIZE | MCASE$ | TREEVIEW SET IMAGELIST |
| COMBOBOX FIND | GRAPHIC CIRCLE | MEMORY FILL | TREEVIEW SET TEXT |
| COMBOBOX FIND EXACT | GRAPHIC CLEAR | MEMORY FILLS | TREEVIEW SET USER |
| COMBOBOX GET COUNT | GRAPHIC COLOR | MENU ADD POPUP | TREEVIEW UNSELECT |
| COMBOBOX GET SELCOUNT | GRAPHIC COPY | MENU ADD STRING | TRIM |
| COMBOBOX GET SELECT | GRAPHIC DETACH | MENU ATTACH | TRIM$ |
| COMBOBOX GET STATE | GRAPHIC ELLIPSE | MENU CONTEXT | TRUNC |
| COMBOBOX GET TEXT | GRAPHIC GET BITS | MENU DELETE | UCASE |
| COMBOBOX GET USER | GRAPHIC GET CANVAS | MENU DRAW BAR | UCASE$ |
| COMBOBOX INSERT | GRAPHIC GET CAPTION | MENU GET STATE | UCODE$ |
| COMBOBOX RESET | GRAPHIC GET CLIENT | MENU GET TEXT | UCODEPAGE |
| COMBOBOX SELECT | GRAPHIC GET CLIP | MENU NEW BAR | UDP NOTIFY |
| COMBOBOX SET TEXT | GRAPHIC GET DC | MENU NEW POPUP | UNWRAP |
| COMBOBOX SET USER | GRAPHIC GET LINES | MENU SET STATE | UNWRAP$ |
| COMBOBOX UNSELECT | GRAPHIC GET LOC | MENU SET TEXT | USING |
| COMM LINE INPUT | GRAPHIC GET MIX | METRICS | USING$ |
| COMMAND | GRAPHIC GET PIXEL | MID | UTF8TOCHR |
| COMMAND$ | GRAPHIC GET POS | MIN | UTF8TOCHR$ |
| CONTROL ADD | GRAPHIC GET PPI | MKBYT | VARPTR |
| CONTROL ADD BUTTON | GRAPHIC GET SCALE | MKCUX | VERIFY |
| CONTROL ADD CHECKBOX | GRAPHIC GET SIZE | MKDWD | WAITKEY |
| CONTROL ADD COMBOBOX | GRAPHIC GET STRETCHMODE | MKE | WAITKEY$ |
| CONTROL ADD LABEL | GRAPHIC GET TEXTALIGN | MKS | WORD |
| CONTROL ADD LISTBOX | GRAPHIC GET VIEW | MKWRD | WRAP |
| CONTROL ADD LISTVIEW | GRAPHIC GET WORDWRAP | MOD | WRAP$ |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET WRAP | MONTHNAME | WRITE |
| CONTROL ADD SCROLLBAR | GRAPHIC LINE | MONTHNAME$ | WRITE# |
| CONTROL ADD STATUSBAR | GRAPHIC PAINT | NUL$ | XPRINT ARC |
| CONTROL ADD TAB | GRAPHIC PIE | OCT | XPRINT ATTACH |
| CONTROL ADD TOOLBAR | GRAPHIC POLYGON | OCT$ | XPRINT BOX |
| CONTROL ADD TREEVIEW | GRAPHIC POLYLINE | OEMTOCHR | XPRINT CANCEL |
| CONTROL DISABLE | GRAPHIC PRINT | OEMTOCHR$ | XPRINT CELL |
| CONTROL ENABLE | GRAPHIC SAVE | ON CALL | XPRINT CELL SIZE |
| CONTROL GET CHECK | GRAPHIC SCALE | ON GOSUB | XPRINT CHR SIZE |
| CONTROL GET CLIENT | GRAPHIC SCALE PIXELS | ON GOTO | XPRINT CLOSE |
| CONTROL GET LOC | GRAPHIC SET AUTOSIZE | OPEN | XPRINT COLOR |
| CONTROL GET SIZE | GRAPHIC SET BITS | PARSE$ | XPRINT COPY |
| CONTROL GET TEXT | GRAPHIC SET CAPTION | PARSECOUNT | XPRINT ELLIPSE |
| CONTROL HIDE | GRAPHIC SET CLIP | PATHNAME | XPRINT FORMFEED |
| CONTROL KILL | GRAPHIC SET FIXED | PATHNAME$ | XPRINT GET ATTACH |
| CONTROL SET CHECK | GRAPHIC SET FONT | PATHSCAN | XPRINT GET CANVAS |
| CONTROL SET CLIENT | GRAPHIC SET MIX | PATHSCAN$ | XPRINT GET CLIENT |
| CONTROL SET LOC | GRAPHIC SET PIXEL | PEEK | XPRINT GET CLIP |
| CONTROL SET SIZE | GRAPHIC SET POS | PLAY | XPRINT GET COLLATE |
| CONTROL SET TEXT | GRAPHIC SET SIZE | PLAY SOUND | XPRINT GET COLOR |
| COS | GRAPHIC SET STRETCHMODE | POKE | XPRINT GET COLORMODE |
| COSH | GRAPHIC SET TEXTALIGN | PRINTER$ | XPRINT GET COPIES |
| COT | GRAPHIC SET VIEW | PRINTERCOUNT | XPRINT GET DC |
| COTH | GRAPHIC SET VIRTUAL | PROGRESSBAR GET POS | XPRINT GET DUPLEX |
| CQUAD | GRAPHIC SET WORDWRAP | PROGRESSBAR GET RANGE | XPRINT GET LINES |
| CSC | GRAPHIC SET WRAP | PROGRESSBAR SET POS | XPRINT GET MARGIN |
| CSCH | GRAPHIC STYLE | PROGRESSBAR SET RANGE | XPRINT GET MIX |
| CSET$ | GRAPHIC TEXT SIZE | PROGRESSBAR SET STEP | XPRINT GET ORIENTATION |
| CSNG | GRAPHIC WIDTH | PROGRESSBAR STEP | XPRINT GET OVERLAP |
| CSTR | HEADER GET COUNT | PUT | XPRINT GET PAGES |
| CULNG | HEADER GET ITEM | PUT STR | XPRINT GET PAPER |
| CURDIR | HEADER SEND | PUT WSTR | XPRINT GET PAPERS |
| CURDIR$ | HEADER SET ITEM | PUT$ | XPRINT GET PIXEL |
| CVBYT | HEX | PUT$$ | XPRINT GET POS |
| CVCUX | HEX$ | QUAD | XPRINT GET PPI |
| CVDWD | HI | RAISEEVENT | XPRINT GET QUALITY |
| CVL | HIWRD | READ | XPRINT GET SCALE |
| CVQ | HYPOT | READ$ | XPRINT GET SELECTION |
| CVW | IIF | REDIM | XPRINT GET SIZE |
| CWORD | IMAGELIST ADD BITMAP | REMAIN | XPRINT GET STRETCHMODE |
| DATACOUNT | IMAGELIST ADD ICON | REMAIN$ | XPRINT GET TEXTALIGN |
| DAYNAME | IMAGELIST ADD MASKED | REMOVE | XPRINT GET TRAY |
| DAYNAME$ | IMAGELIST COUNT | REMOVE$ | XPRINT GET TRAYS |
| DEC | IMAGELIST GET COUNT | REPEAT | XPRINT GET WORDWRAP |
| DEC$ | IMAGELIST KILL | REPEAT$ | XPRINT GET WRAP |
| DECLARE | IMAGELIST NEW | RESOURCE SAVE FILE | XPRINT IMAGELIST |
| DEF | IMAGELIST NEW BITMAP | RESOURCE$ | XPRINT LINE |
| DESKTOP GET PPI | IMAGELIST NEW ICON | RETAIN | XPRINT PIE |
| DIALOG DEFAULT FONT | IMAGELIST SET OVERLAY | RETAIN$ | XPRINT POLYGON |
| DIALOG DISABLE | IMP | RGB | XPRINT POLYLINE |
| DIALOG DOEVENTS | INPUT# | RIGHT | XPRINT PREVIEW |
| DIALOG ENABLE | INSTANCE | RIGHT$ | XPRINT PRINT |
| DIALOG END | INSTR | RND | XPRINT RENDER |
| DIALOG GET CLIENT | INT | ROUND | XPRINT SCALE |
| DIALOG GET LOC | INTEGER | RSET$ | XPRINT SET CLIP |
| DIALOG GET SIZE | ISEVEN | RTRIM | XPRINT SET COLLATE |
| DIALOG GET TEXT | ISFALSE | RTRIM$ | XPRINT SET COLOR |
| DIALOG GET USER | ISFILE | SCROLLBAR GET PAGESIZE | XPRINT SET COLORMODE |
| DIALOG HIDE | ISFOLDER | SCROLLBAR GET POS | XPRINT SET COPIES |
| DIALOG MAXIMIZE | ISINFINITE | SCROLLBAR GET RANGE | XPRINT SET DUPLEX |
| DIALOG MINIMIZE | ISNORMAL | SCROLLBAR GET TRACKPOS | XPRINT SET FONT |
| DIALOG NEW | ISODD | SCROLLBAR SET PAGESIZE | XPRINT SET MIX |
| DIALOG NONSTABLE | ISTRUE | SCROLLBAR SET POS | XPRINT SET ORIENTATION |
| DIALOG NORMALIZE | ISWIN | SCROLLBAR SET RANGE | XPRINT SET OVERLAP |
| DIALOG PIXELS | JOIN$ | SEC | XPRINT SET PAGES |
| DIALOG POST | LCASE | SECH | XPRINT SET PAPER |
| DIALOG REDRAW | LCASE$ | SEEK | XPRINT SET PIXEL |
| DIALOG SEND | LEFT | SETEOF | XPRINT SET POS |
| DIALOG SET CLIENT | LEFT$ | SGN | XPRINT SET QUALITY |
| DIALOG SET COLOR | LEN | SHRINK | XPRINT SET STRETCHMODE |
| DIALOG SET ICON | LET *(WITH OBJECTS)* | SHRINK$ | XPRINT SET TEXTALIGN |
| DIALOG SET LOC | LET *(WITH VARIANTS)* | SIN | XPRINT SET TRAY |
| DIALOG SET SIZE | LINE INPUT# | SINGLE | XPRINT SET WORDWRAP |
| DIALOG SET TEXT | LISTBOX ADD | SINH | XPRINT SET WRAP |
| DIALOG SET USER | LISTBOX DELETE | SIZEOF | XPRINT SPLIT |
| DIALOG SHOW MODAL | LISTBOX FIND | SPACE | XPRINT STRETCH |
| DIALOG SHOW MODELESS | LISTBOX FIND EXACT | SPACE$ | XPRINT STYLE |
| DIALOG SHOW STATE | LISTBOX GET COUNT | SQR | XPRINT TEXT SIZE |
| DIALOG STABILIZE | LISTBOX GET SELCOUNT | STATUSBAR SET PARTS | XPRINT WIDTH |
| DIALOG UNITS | LISTBOX GET SELECT | STATUSBAR SET TEXT |  |
| DIM | LISTBOX GET STATE | STR |  |
| DIR | LISTBOX GET TEXT | STR$ |  |
