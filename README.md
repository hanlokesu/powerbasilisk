...
> Summary:
> - **787** official PowerBASIC statement/function keywords currently available for use
>   - **639** implemented or completed by this fork
...
> - **68** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 172 (v0.2.029). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 787 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DIALOG DOEVENTS | HEADER SEND | MKS | THREAD CLOSE |
| ACCEL ATTACH | DIALOG ENABLE | HEADER SET ITEM | MKS$ | THREAD CREATE |
| ACODE | DIALOG END | HEX | MKWRD | THREAD GET PRIORITY |
| ACODE$ | DIALOG GET CLIENT | HEX$ | MKWRD$ | THREAD RESUME |
| ACOS | DIALOG GET LOC | HI | MOD | THREAD SET PRIORITY |
| ACOSH | DIALOG GET SIZE | HIWRD | MONTHNAME | THREAD STATUS |
| AND | DIALOG GET TEXT | HOST ADDR | MONTHNAME$ | THREAD SUSPEND |
| ARRAY ADD | DIALOG GET USER | HOST NAME | MOUSEPTR | THREADCOUNT |
| ARRAY ARRAYIX | DIALOG HIDE | HYPOT | MSGBOX | THREADED |
| ARRAY ASSIGN | DIALOG MAXIMIZE | IF | NAME | THREADID |
| ARRAY COPY | DIALOG MINIMIZE | IF/END IF | NOT | TIMER |
| ARRAY DELETE | DIALOG NEW | IIF | NUL | TIX |
| ARRAY INSERT | DIALOG NONSTABLE | IMAGELIST COUNT | NUL$ | TOOLBAR ADD BUTTON |
| ARRAY REDIM DECR | DIALOG NORMALIZE | IMAGELIST GET COUNT | OBJECT | TOOLBAR ADD SEPARATOR |
| ARRAY REDIM INCR | DIALOG PIXELS | IMAGELIST KILL | OCT | TOOLBAR DELETE BUTTON |
| ARRAY REVERSE | DIALOG POST | IMAGELIST NEW | OCT$ | TOOLBAR GET COUNT |
| ARRAY SCAN | DIALOG REDRAW | IMAGELIST NEW BITMAP | OEMTOCHR | TOOLBAR GET STATE |
| ARRAY SHUFFLE | DIALOG SEND | IMP | OEMTOCHR$ | TOOLBAR SET IMAGELIST |
| ARRAY SORT | DIALOG SET CLIENT | IMPORT | ON CALL | TOOLBAR SET STATE |
| ARRAY SWAP | DIALOG SET COLOR | INCR | ON ERROR | TRACE |
| ARRAY TAGARRAY | DIALOG SET ICON | INPUT FLUSH | ON GOSUB | TREEVIEW DELETE |
| ARRAY TAGARRAY ERASE | DIALOG SET LOC | INPUT# | ON GOTO | TREEVIEW GET BOLD |
| ARRAY UNIQUE | DIALOG SET SIZE | INSTANCE | OPEN | TREEVIEW GET CHECK |
| ASC | DIALOG SET TEXT | INSTR | OPTION EXPLICIT | TREEVIEW GET CHILD |
| ASIN | DIALOG SET USER | INT | OR | TREEVIEW GET COUNT |
| ASINH | DIALOG SHOW MODAL | INTEGER | PARSE | TREEVIEW GET EXPANDED |
| ASM | DIALOG SHOW MODELESS | INTERFACE / END INTERFACE (DIRECT) | PARSE$ | TREEVIEW GET NEXT |
| ASMDATA / END ASMDATA | DIALOG SHOW STATE | INTERFACE/END INTERFACE (IDBIND) | PARSECOUNT | TREEVIEW GET PARENT |
| ATANH | DIALOG STABILIZE | ISEVEN | PATHNAME | TREEVIEW GET PREVIOUS |
| ATN | DIALOG UNITS | ISFALSE | PATHNAME$ | TREEVIEW GET ROOT |
| ATN2 | DIM | ISFILE | PATHSCAN | TREEVIEW GET SELECT |
| BEEP | DIR | ISFOLDER | PATHSCAN$ | TREEVIEW GET TEXT |
| BGR | DIR CLOSE | ISINFINITE | PEEK | TREEVIEW GET USER |
| BIN | DIR$ | ISNORMAL | PLAY | TREEVIEW INSERT ITEM |
| BIN$ | DISKFREE | ISODD | PLAY SOUND | TREEVIEW RESET |
| BIT | DISKSIZE | ISTRUE | PLAY WAVE | TREEVIEW SELECT |
| BIT CALC | DISPLAY BROWSE | ISWIN | POKE | TREEVIEW SET BOLD |
| BITS | DISPLAY COLOR | ITERATE | PREFIX | TREEVIEW SET CHECK |
| BITS$ | DISPLAY FONT | JOIN$ | PRINT# | TREEVIEW SET EXPANDED |
| BITSE | DISPLAY OPENFILE | KILL | PRINTER$ | TREEVIEW SET IMAGELIST |
| BUILD | DISPLAY SAVEFILE | LCASE | PRINTERCOUNT | TREEVIEW SET TEXT |
| BUILD$ | DOUBLE | LCASE$ | PROCESS GET PRIORITY | TREEVIEW SET USER |
| BYTE | END | LEFT | PROCESS SET PRIORITY | TREEVIEW UNSELECT |
| CALL | ENVIRON | LEFT$ | PROFILE | TRIM |
| CALL DWORD | ENVIRON$ | LEN | PROGRESSBAR GET POS | TRIM$ |
| CALLSTK | EOF | LET | PROGRESSBAR GET RANGE | TRUNC |
| CALLSTK$ | EQV | LET *(WITH OBJECTS)* | PROGRESSBAR SET POS | TRY/END TRY |
| CALLSTKCOUNT | ERASE | LET *(WITH TYPES)* | PROGRESSBAR SET RANGE | TYPE SET |
| CBOOL | ERF | LET *(WITH VARIANTS)* | PROGRESSBAR SET STEP | TYPE/END TYPE |
| CBRT | ERL | LINE INPUT# | PROGRESSBAR STEP | UCASE |
| CBYTE | ERL$ | LISTBOX ADD | PUT | UCASE$ |
| CDBL | ERR | LISTBOX DELETE | PUT STR | UCODE$ |
| CDWORD | ERRCLEAR | LISTBOX FIND | PUT WSTR | UCODEPAGE |
| CEIL | ERROR | LISTBOX FIND EXACT | PUT$ | UDP CLOSE |
| CFLT | ERROR$ | LISTBOX GET COUNT | PUT$$ | UDP NOTIFY |
| CHDIR | EVENT SOURCE | LISTBOX GET SELCOUNT | QUAD | UDP OPEN |
| CHDRIVE | EVENTS | LISTBOX GET SELECT | RAISEEVENT | UDP RECV |
| CHOOSE | EXE | LISTBOX GET STATE | RANDOMIZE | UDP SEND |
| CHR | EXIST | LISTBOX GET TEXT | READ | UNLOCK |
| CHR$ | EXIT | LISTBOX GET USER | READ$ | UNWRAP |
| CHRBYTES | EXP | LISTBOX INSERT | REDIM | UNWRAP$ |
| CHRTOOEM | EXP10 | LISTBOX RESET | REGEXPR | USING |
| CHRTOOEM$ | EXP2 | LISTBOX SELECT | REGISTER | USING$ |
| CHRTOUTF8 | EXPM1 | LISTBOX SET TEXT | REGREPL | UTF8TOCHR |
| CHRTOUTF8$ | EXTRACT | LISTBOX SET USER | REM | UTF8TOCHR$ |
| CLASS/END CLASS | EXTRACT$ | LISTBOX UNSELECT | REMAIN | VAL |
| CLIP | FIELD | LISTVIEW DELETE COLUMN | REMAIN$ | VARPTR |
| CLIP$ | FILEATTR | LISTVIEW DELETE ITEM | REMOVE | VERIFY |
| CLIPBOARD | FILECOPY | LISTVIEW FIND | REMOVE$ | WAITKEY |
| CLOSE | FILENAME | LISTVIEW FIND EXACT | REPEAT | WAITKEY$ |
| CLS | FILENAME$ | LISTVIEW FIT CONTENT | REPEAT$ | WINDOW GET |
| CODEPTR | FILESCAN | LISTVIEW FIT HEADER | REPLACE | WINDOW SET |
| COLOR | FIX | LISTVIEW GET COLUMN | RESET | WORD |
| COMBOBOX ADD | FLOOR | LISTVIEW GET COUNT | RESOURCE SAVE FILE | WRAP |
| COMBOBOX DELETE | FLUSH | LISTVIEW GET HEADER | RESOURCE$ | WRAP$ |
| COMBOBOX FIND | FONT END | LISTVIEW GET HEADERID | RESUME | WRITE |
| COMBOBOX FIND EXACT | FONT NEW | LISTVIEW GET MODE | RETAIN | WRITE# |
| COMBOBOX GET COUNT | FOR / NEXT | LISTVIEW GET SELCOUNT | RETAIN$ | XOR |
| COMBOBOX GET SELCOUNT | FORMAT | LISTVIEW GET SELECT | RETURN | XPRINT ARC |
| COMBOBOX GET SELECT | FORMAT$ | LISTVIEW GET STATE | RGB | XPRINT ATTACH |
| COMBOBOX GET STATE | FRAC | LISTVIEW GET STYLEXX | RIGHT | XPRINT BOX |
| COMBOBOX GET TEXT | FRE | LISTVIEW GET TEXT | RIGHT$ | XPRINT CANCEL |
| COMBOBOX GET USER | FREEFILE | LISTVIEW GET USER | RMDIR | XPRINT CELL |
| COMBOBOX INSERT | FUNCNAME | LISTVIEW INSERT COLUMN | RND | XPRINT CELL SIZE |
| COMBOBOX RESET | FUNCNAME$ | LISTVIEW INSERT ITEM | ROTATE | XPRINT CHR SIZE |
| COMBOBOX SELECT | FUNCTION / END FUNCTION | LISTVIEW RESET | ROUND | XPRINT CLOSE |
| COMBOBOX SET TEXT | GET | LISTVIEW SELECT | RSET | XPRINT COLOR |
| COMBOBOX SET USER | GET STR | LISTVIEW SET COLUMN | RSET$ | XPRINT COPY |
| COMBOBOX UNSELECT | GET WSTR | LISTVIEW SET HEADER | RTRIM | XPRINT ELLIPSE |
| COMM CLOSE | GET$ | LISTVIEW SET IMAGE | RTRIM$ | XPRINT FORMFEED |
| COMM LINE | GET$$ | LISTVIEW SET IMAGE2 | SCROLLBAR GET PAGESIZE | XPRINT GET ATTACH |
| COMM LINE INPUT | GETATTR | LISTVIEW SET IMAGELIST | SCROLLBAR GET POS | XPRINT GET CANVAS |
| COMM OPEN | GLOBAL | LISTVIEW SET MODE | SCROLLBAR GET RANGE | XPRINT GET CLIENT |
| COMM PRINT | GLOBALMEM | LISTVIEW SET OVERLAY | SCROLLBAR GET TRACKPOS | XPRINT GET CLIP |
| COMM RECV | GRAPHIC ARC | LISTVIEW SET STYLEXX | SCROLLBAR SET PAGESIZE | XPRINT GET COLLATE |
| COMM RESET | GRAPHIC ATTACH | LISTVIEW SET TEXT | SCROLLBAR SET POS | XPRINT GET COLOR |
| COMM SEND | GRAPHIC BITMAP END | LISTVIEW SET USER | SCROLLBAR SET RANGE | XPRINT GET COLORMODE |
| COMM SET | GRAPHIC BITMAP LOAD | LISTVIEW SORT | SEC | XPRINT GET COPIES |
| COMM TIMEOUT | GRAPHIC BITMAP NEW | LISTVIEW UNSELECT | SECH | XPRINT GET DC |
| COMMAND | GRAPHIC BOX | LISTVIEW VISIBLE | SEEK | XPRINT GET DUPLEX |
| COMMAND$ | GRAPHIC CELL | LO | SELECT CASE/END SELECT | XPRINT GET LINES |
| CONTROL ADD | GRAPHIC CELL SIZE | LOC | SETATTR | XPRINT GET MARGIN |
| CONTROL ADD BUTTON | GRAPHIC CHR SIZE | LOCAL | SETEOF | XPRINT GET MIX |
| CONTROL ADD CHECKBOX | GRAPHIC CIRCLE | LOCK | SGN | XPRINT GET ORIENTATION |
| CONTROL ADD COMBOBOX | GRAPHIC CLEAR | LOF | SHELL | XPRINT GET OVERLAP |
| CONTROL ADD LABEL | GRAPHIC COLOR | LOG | SHIFT | XPRINT GET PAGES |
| CONTROL ADD LISTBOX | GRAPHIC COPY | LOG10 | SHRINK | XPRINT GET PAPER |
| CONTROL ADD LISTVIEW | GRAPHIC DETACH | LOG1P | SHRINK$ | XPRINT GET PAPERS |
| CONTROL ADD PROGRESSBAR | GRAPHIC ELLIPSE | LOG2 | SIN | XPRINT GET PIXEL |
| CONTROL ADD SCROLLBAR | GRAPHIC GET BITS | LONG | SINGLE | XPRINT GET POS |
| CONTROL ADD STATUSBAR | GRAPHIC GET CANVAS | LOWRD | SINH | XPRINT GET PPI |
| CONTROL ADD TAB | GRAPHIC GET CAPTION | LPRINT | SIZEOF | XPRINT GET QUALITY |
| CONTROL ADD TOOLBAR | GRAPHIC GET CLIENT | LPRINT ATTACH | SLEEP | XPRINT GET SCALE |
| CONTROL ADD TREEVIEW | GRAPHIC GET CLIP | LPRINT CLOSE | SPACE | XPRINT GET SELECTION |
| CONTROL DISABLE | GRAPHIC GET DC | LPRINT FLUSH | SPACE$ | XPRINT GET SIZE |
| CONTROL ENABLE | GRAPHIC GET LINES | LPRINT FORMFEED | SPLIT | XPRINT GET STRETCHMODE |
| CONTROL GET CHECK | GRAPHIC GET LOC | LPRINT$ | SQR | XPRINT GET TEXTALIGN |
| CONTROL GET TEXT | GRAPHIC GET MIX | LSET | STATIC | XPRINT GET TRAY |
| CONTROL HIDE | GRAPHIC GET PIXEL | LSET$ | STATUSBAR SET PARTS | XPRINT GET TRAYS |
| CONTROL KILL | GRAPHIC GET POS | LTRIM | STATUSBAR SET TEXT | XPRINT GET WORDWRAP |
| CONTROL SET CHECK | GRAPHIC GET PPI | LTRIM$ | STR | XPRINT GET WRAP |
| CONTROL SET TEXT | GRAPHIC GET SCALE | MACRO/END MACRO | STR$ | XPRINT IMAGELIST |
| COS | GRAPHIC GET SIZE | MAK | STRDELETE | XPRINT LINE |
| COSH | GRAPHIC GET STRETCHMODE | MAT | STRDELETE$ | XPRINT PIE |
| COT | GRAPHIC GET TEXTALIGN | MAX | STRING | XPRINT POLYGON |
| COTH | GRAPHIC GET VIEW | MCASE | STRINSERT | XPRINT POLYLINE |
| CQUAD | GRAPHIC GET WORDWRAP | MCASE$ | STRINSERT$ | XPRINT PREVIEW |
| CSC | GRAPHIC GET WRAP | MEMORY | STRPTR | XPRINT PRINT |
| CSCH | GRAPHIC LINE | MEMORY FILL | STRREVERSE | XPRINT RENDER |
| CSET | GRAPHIC PAINT | MEMORY FILLS | STRREVERSE$ | XPRINT SCALE |
| CSET$ | GRAPHIC PIE | MENU ADD POPUP | SWAP | XPRINT SET CLIP |
| CSNG | GRAPHIC POLYGON | MENU ADD STRING | SWITCH | XPRINT SET COLLATE |
| CSTR | GRAPHIC POLYLINE | MENU DELETE | SWITCH$ | XPRINT SET COLOR |
| CULNG | GRAPHIC PRINT | MENU GET STATE | TAB DELETE | XPRINT SET COLORMODE |
| CURDIR | GRAPHIC SAVE | MENU GET TEXT | TAB GET COUNT | XPRINT SET COPIES |
| CURDIR$ | GRAPHIC SCALE | MENU NEW BAR | TAB GET DIALOG | XPRINT SET DUPLEX |
| CVBYT | GRAPHIC SCALE PIXELS | MENU NEW POPUP | TAB GET IMAGE | XPRINT SET FONT |
| CVCUX | GRAPHIC SET AUTOSIZE | MENU SET STATE | TAB GET PAGE | XPRINT SET MIX |
| CVDWD | GRAPHIC SET BITS | MENU SET TEXT | TAB GET SELECT | XPRINT SET ORIENTATION |
| CVL | GRAPHIC SET CAPTION | METHOD / END METHOD | TAB GET TEXT | XPRINT SET OVERLAP |
| CVQ | GRAPHIC SET CLIP | METRICS | TAB INSERT PAGE | XPRINT SET PAGES |
| CVW | GRAPHIC SET FIXED | MID | TAB RESET | XPRINT SET PAPER |
| CWORD | GRAPHIC SET FONT | MID$ | TAB SELECT | XPRINT SET PIXEL |
| DATA | GRAPHIC SET MIX | MIN | TAB SET IMAGE | XPRINT SET POS |
| DATACOUNT | GRAPHIC SET PIXEL | MKBYT | TAB SET IMAGELIST | XPRINT SET QUALITY |
| DAYNAME | GRAPHIC SET POS | MKBYT$ | TAB SET TEXT | XPRINT SET STRETCHMODE |
| DAYNAME$ | GRAPHIC SET SIZE | MKCUR$ | TAB$ | XPRINT SET TEXTALIGN |
| DEC | GRAPHIC SET STRETCHMODE | MKCUX | TALLY | XPRINT SET TRAY |
| DEC$ | GRAPHIC SET TEXTALIGN | MKCUX$ | TAN | XPRINT SET WORDWRAP |
| DECLARE | GRAPHIC SET VIEW | MKD$ | TANH | XPRINT SET WRAP |
| DECR | GRAPHIC SET VIRTUAL | MKDIR | TCP ACCEPT | XPRINT SPLIT |
| DEF | GRAPHIC SET WORDWRAP | MKDWD | TCP CLOSE | XPRINT STRETCH |
| DESKTOP GET CLIENT | GRAPHIC SET WRAP | MKDWD$ | TCP LINE INPUT | XPRINT STYLE |
| DESKTOP GET LOC | GRAPHIC STYLE | MKE | TCP NOTIFY | XPRINT TEXT SIZE |
| DESKTOP GET PPI | GRAPHIC TEXT SIZE | MKE$ | TCP OPEN | XPRINT WIDTH |
| DESKTOP GET SIZE | GRAPHIC WIDTH | MKI$ | TCP PRINT |  |
| DIALOG DEFAULT FONT | HEADER GET COUNT | MKL$ | TCP RECV |  |
| DIALOG DISABLE | HEADER GET ITEM | MKQ$ | TCP SEND |  |

## **Newly** implemented by this branch

> **639 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DISKFREE | LISTBOX SELECT | STRING |
| ACCEL ATTACH | DISKSIZE | LISTBOX SET TEXT | STRINSERT |
| ACODE | DISPLAY BROWSE | LISTBOX SET USER | STRINSERT$ |
| ACODE$ | DISPLAY COLOR | LISTBOX UNSELECT | STRPTR |
| ACOS | DISPLAY FONT | LISTVIEW DELETE COLUMN | STRREVERSE |
| ACOSH | DISPLAY OPENFILE | LISTVIEW DELETE ITEM | STRREVERSE$ |
| ARRAY ADD | DISPLAY SAVEFILE | LISTVIEW FIND | SWITCH |
| ARRAY ARRAYIX | DOUBLE | LISTVIEW FIND EXACT | SWITCH$ |
| ARRAY ASSIGN | ENVIRON$ | LISTVIEW FIT CONTENT | TAB DELETE |
| ARRAY COPY | EOF | LISTVIEW FIT HEADER | TAB GET COUNT |
| ARRAY DELETE | EQV | LISTVIEW GET COLUMN | TAB GET DIALOG |
| ARRAY INSERT | ERF | LISTVIEW GET COUNT | TAB GET IMAGE |
| ARRAY REDIM DECR | ERL | LISTVIEW GET HEADER | TAB GET PAGE |
| ARRAY REDIM INCR | ERL$ | LISTVIEW GET HEADERID | TAB GET SELECT |
| ARRAY REVERSE | ERR | LISTVIEW GET MODE | TAB GET TEXT |
| ARRAY SCAN | ERRCLEAR | LISTVIEW GET SELCOUNT | TAB INSERT PAGE |
| ARRAY SHUFFLE | ERROR$ | LISTVIEW GET SELECT | TAB RESET |
| ARRAY SWAP | EVENT SOURCE | LISTVIEW GET STATE | TAB SELECT |
| ARRAY TAGARRAY | EVENTS | LISTVIEW GET STYLEXX | TAB SET IMAGE |
| ARRAY TAGARRAY ERASE | EXE | LISTVIEW GET TEXT | TAB SET IMAGELIST |
| ARRAY UNIQUE | EXIST | LISTVIEW GET USER | TAB SET TEXT |
| ASIN | EXP | LISTVIEW INSERT COLUMN | TAB$ |
| ASINH | EXP10 | LISTVIEW INSERT ITEM | TALLY |
| ATANH | EXP2 | LISTVIEW RESET | TAN |
| ATN | EXPM1 | LISTVIEW SELECT | TANH |
| ATN2 | EXTRACT | LISTVIEW SET COLUMN | TCP NOTIFY |
| BGR | EXTRACT$ | LISTVIEW SET HEADER | THREADCOUNT |
| BIN | FILEATTR | LISTVIEW SET IMAGE | THREADID |
| BIN$ | FILENAME | LISTVIEW SET IMAGE2 | TIMER |
| BITS | FILENAME$ | LISTVIEW SET IMAGELIST | TOOLBAR ADD BUTTON |
| BITS$ | FIX | LISTVIEW SET MODE | TOOLBAR ADD SEPARATOR |
| BITSE | FLOOR | LISTVIEW SET OVERLAY | TOOLBAR DELETE BUTTON |
| BUILD | FONT END | LISTVIEW SET STYLEXX | TOOLBAR GET COUNT |
| BUILD$ | FONT NEW | LISTVIEW SET TEXT | TOOLBAR GET STATE |
| BYTE | FORMAT | LISTVIEW SET USER | TOOLBAR SET IMAGELIST |
| CALLSTK$ | FORMAT$ | LISTVIEW SORT | TOOLBAR SET STATE |
| CALLSTKCOUNT | FRAC | LISTVIEW UNSELECT | TREEVIEW DELETE |
| CBOOL | FRE | LISTVIEW VISIBLE | TREEVIEW GET BOLD |
| CBRT | FREEFILE | LO | TREEVIEW GET CHECK |
| CBYTE | FUNCNAME | LOC | TREEVIEW GET CHILD |
| CDBL | FUNCNAME$ | LOF | TREEVIEW GET COUNT |
| CDWORD | GET | LOG | TREEVIEW GET EXPANDED |
| CEIL | GET STR | LOG10 | TREEVIEW GET NEXT |
| CFLT | GET WSTR | LOG1P | TREEVIEW GET PARENT |
| CHOOSE | GET$ | LOG2 | TREEVIEW GET PREVIOUS |
| CHR | GET$$ | LONG | TREEVIEW GET ROOT |
| CHR$ | GETATTR | LOWRD | TREEVIEW GET SELECT |
| CHRBYTES | GRAPHIC ARC | LPRINT$ | TREEVIEW GET TEXT |
| CHRTOOEM | GRAPHIC ATTACH | LSET$ | TREEVIEW GET USER |
| CHRTOOEM$ | GRAPHIC BITMAP END | LTRIM | TREEVIEW INSERT ITEM |
| CHRTOUTF8 | GRAPHIC BITMAP LOAD | LTRIM$ | TREEVIEW RESET |
| CHRTOUTF8$ | GRAPHIC BITMAP NEW | MAK | TREEVIEW SELECT |
| CLIP | GRAPHIC BOX | MAX | TREEVIEW SET BOLD |
| CLIP$ | GRAPHIC CELL | MCASE | TREEVIEW SET CHECK |
| CLOSE | GRAPHIC CELL SIZE | MCASE$ | TREEVIEW SET EXPANDED |
| CODEPTR | GRAPHIC CHR SIZE | MEMORY FILL | TREEVIEW SET IMAGELIST |
| COMBOBOX ADD | GRAPHIC CIRCLE | MEMORY FILLS | TREEVIEW SET TEXT |
| COMBOBOX DELETE | GRAPHIC CLEAR | MENU ADD POPUP | TREEVIEW SET USER |
| COMBOBOX FIND | GRAPHIC COLOR | MENU ADD STRING | TREEVIEW UNSELECT |
| COMBOBOX FIND EXACT | GRAPHIC COPY | MENU DELETE | TRIM |
| COMBOBOX GET COUNT | GRAPHIC DETACH | MENU GET STATE | TRIM$ |
| COMBOBOX GET SELCOUNT | GRAPHIC ELLIPSE | MENU GET TEXT | TRUNC |
| COMBOBOX GET SELECT | GRAPHIC GET BITS | MENU NEW BAR | UCASE |
| COMBOBOX GET STATE | GRAPHIC GET CANVAS | MENU NEW POPUP | UCASE$ |
| COMBOBOX GET TEXT | GRAPHIC GET CAPTION | MENU SET STATE | UCODE$ |
| COMBOBOX GET USER | GRAPHIC GET CLIENT | MENU SET TEXT | UCODEPAGE |
| COMBOBOX INSERT | GRAPHIC GET CLIP | METRICS | UDP NOTIFY |
| COMBOBOX RESET | GRAPHIC GET DC | MID | UNWRAP |
| COMBOBOX SELECT | GRAPHIC GET LINES | MIN | UNWRAP$ |
| COMBOBOX SET TEXT | GRAPHIC GET LOC | MKBYT | USING |
| COMBOBOX SET USER | GRAPHIC GET MIX | MKCUX | USING$ |
| COMBOBOX UNSELECT | GRAPHIC GET PIXEL | MKDWD | UTF8TOCHR |
| COMM LINE INPUT | GRAPHIC GET POS | MKE | UTF8TOCHR$ |
| COMMAND | GRAPHIC GET PPI | MKS | VARPTR |
| COMMAND$ | GRAPHIC GET SCALE | MKWRD | VERIFY |
| CONTROL ADD | GRAPHIC GET SIZE | MOD | WAITKEY |
| CONTROL ADD BUTTON | GRAPHIC GET STRETCHMODE | MONTHNAME | WAITKEY$ |
| CONTROL ADD CHECKBOX | GRAPHIC GET TEXTALIGN | MONTHNAME$ | WORD |
| CONTROL ADD COMBOBOX | GRAPHIC GET VIEW | NUL$ | WRAP |
| CONTROL ADD LABEL | GRAPHIC GET WORDWRAP | OCT | WRAP$ |
| CONTROL ADD LISTBOX | GRAPHIC GET WRAP | OCT$ | WRITE |
| CONTROL ADD LISTVIEW | GRAPHIC LINE | OEMTOCHR | WRITE# |
| CONTROL ADD PROGRESSBAR | GRAPHIC PAINT | OEMTOCHR$ | XPRINT ARC |
| CONTROL ADD SCROLLBAR | GRAPHIC PIE | ON CALL | XPRINT ATTACH |
| CONTROL ADD STATUSBAR | GRAPHIC POLYGON | ON GOSUB | XPRINT BOX |
| CONTROL ADD TAB | GRAPHIC POLYLINE | ON GOTO | XPRINT CANCEL |
| CONTROL ADD TOOLBAR | GRAPHIC PRINT | OPEN | XPRINT CELL |
| CONTROL ADD TREEVIEW | GRAPHIC SAVE | PARSE$ | XPRINT CELL SIZE |
| CONTROL DISABLE | GRAPHIC SCALE | PARSECOUNT | XPRINT CHR SIZE |
| CONTROL ENABLE | GRAPHIC SCALE PIXELS | PATHNAME | XPRINT CLOSE |
| CONTROL GET CHECK | GRAPHIC SET AUTOSIZE | PATHNAME$ | XPRINT COLOR |
| CONTROL GET TEXT | GRAPHIC SET BITS | PATHSCAN | XPRINT COPY |
| CONTROL HIDE | GRAPHIC SET CAPTION | PATHSCAN$ | XPRINT ELLIPSE |
| CONTROL KILL | GRAPHIC SET CLIP | PEEK | XPRINT FORMFEED |
| CONTROL SET CHECK | GRAPHIC SET FIXED | PLAY | XPRINT GET ATTACH |
| CONTROL SET TEXT | GRAPHIC SET FONT | PLAY SOUND | XPRINT GET CANVAS |
| COS | GRAPHIC SET MIX | POKE | XPRINT GET CLIENT |
| COSH | GRAPHIC SET PIXEL | PRINTER$ | XPRINT GET CLIP |
| COT | GRAPHIC SET POS | PRINTERCOUNT | XPRINT GET COLLATE |
| COTH | GRAPHIC SET SIZE | PROGRESSBAR GET POS | XPRINT GET COLOR |
| CQUAD | GRAPHIC SET STRETCHMODE | PROGRESSBAR GET RANGE | XPRINT GET COLORMODE |
| CSC | GRAPHIC SET TEXTALIGN | PROGRESSBAR SET POS | XPRINT GET COPIES |
| CSCH | GRAPHIC SET VIEW | PROGRESSBAR SET RANGE | XPRINT GET DC |
| CSET$ | GRAPHIC SET VIRTUAL | PROGRESSBAR SET STEP | XPRINT GET DUPLEX |
| CSNG | GRAPHIC SET WORDWRAP | PROGRESSBAR STEP | XPRINT GET LINES |
| CSTR | GRAPHIC SET WRAP | PUT | XPRINT GET MARGIN |
| CULNG | GRAPHIC STYLE | PUT STR | XPRINT GET MIX |
| CURDIR | GRAPHIC TEXT SIZE | PUT WSTR | XPRINT GET ORIENTATION |
| CURDIR$ | GRAPHIC WIDTH | PUT$ | XPRINT GET OVERLAP |
| CVBYT | HEADER GET COUNT | PUT$$ | XPRINT GET PAGES |
| CVCUX | HEADER GET ITEM | QUAD | XPRINT GET PAPER |
| CVDWD | HEADER SEND | RAISEEVENT | XPRINT GET PAPERS |
| CVL | HEADER SET ITEM | READ | XPRINT GET PIXEL |
| CVQ | HEX | READ$ | XPRINT GET POS |
| CVW | HEX$ | REDIM | XPRINT GET PPI |
| CWORD | HI | REMAIN | XPRINT GET QUALITY |
| DATACOUNT | HIWRD | REMAIN$ | XPRINT GET SCALE |
| DAYNAME | HYPOT | REMOVE | XPRINT GET SELECTION |
| DAYNAME$ | IIF | REMOVE$ | XPRINT GET SIZE |
| DEC | IMAGELIST COUNT | REPEAT | XPRINT GET STRETCHMODE |
| DEC$ | IMAGELIST GET COUNT | REPEAT$ | XPRINT GET TEXTALIGN |
| DECLARE | IMAGELIST KILL | RESOURCE SAVE FILE | XPRINT GET TRAY |
| DEF | IMAGELIST NEW | RESOURCE$ | XPRINT GET TRAYS |
| DESKTOP GET PPI | IMAGELIST NEW BITMAP | RETAIN | XPRINT GET WORDWRAP |
| DIALOG DEFAULT FONT | IMP | RETAIN$ | XPRINT GET WRAP |
| DIALOG DISABLE | INPUT# | RGB | XPRINT IMAGELIST |
| DIALOG DOEVENTS | INSTANCE | RIGHT | XPRINT LINE |
| DIALOG ENABLE | INSTR | RIGHT$ | XPRINT PIE |
| DIALOG END | INT | RND | XPRINT POLYGON |
| DIALOG GET CLIENT | INTEGER | ROUND | XPRINT POLYLINE |
| DIALOG GET LOC | ISEVEN | RSET$ | XPRINT PREVIEW |
| DIALOG GET SIZE | ISFALSE | RTRIM | XPRINT PRINT |
| DIALOG GET TEXT | ISFILE | RTRIM$ | XPRINT RENDER |
| DIALOG GET USER | ISFOLDER | SCROLLBAR GET PAGESIZE | XPRINT SCALE |
| DIALOG HIDE | ISINFINITE | SCROLLBAR GET POS | XPRINT SET CLIP |
| DIALOG MAXIMIZE | ISNORMAL | SCROLLBAR GET RANGE | XPRINT SET COLLATE |
| DIALOG MINIMIZE | ISODD | SCROLLBAR GET TRACKPOS | XPRINT SET COLOR |
| DIALOG NEW | ISTRUE | SCROLLBAR SET PAGESIZE | XPRINT SET COLORMODE |
| DIALOG NONSTABLE | ISWIN | SCROLLBAR SET POS | XPRINT SET COPIES |
| DIALOG NORMALIZE | JOIN$ | SCROLLBAR SET RANGE | XPRINT SET DUPLEX |
| DIALOG PIXELS | LCASE | SEC | XPRINT SET FONT |
| DIALOG POST | LCASE$ | SECH | XPRINT SET MIX |
| DIALOG REDRAW | LEFT | SEEK | XPRINT SET ORIENTATION |
| DIALOG SEND | LEFT$ | SETEOF | XPRINT SET OVERLAP |
| DIALOG SET CLIENT | LEN | SGN | XPRINT SET PAGES |
| DIALOG SET COLOR | LET *(WITH OBJECTS)* | SHRINK | XPRINT SET PAPER |
| DIALOG SET ICON | LET *(WITH VARIANTS)* | SHRINK$ | XPRINT SET PIXEL |
| DIALOG SET LOC | LINE INPUT# | SIN | XPRINT SET POS |
| DIALOG SET SIZE | LISTBOX ADD | SINGLE | XPRINT SET QUALITY |
| DIALOG SET TEXT | LISTBOX DELETE | SINH | XPRINT SET STRETCHMODE |
| DIALOG SET USER | LISTBOX FIND | SIZEOF | XPRINT SET TEXTALIGN |
| DIALOG SHOW MODAL | LISTBOX FIND EXACT | SPACE | XPRINT SET TRAY |
| DIALOG SHOW MODELESS | LISTBOX GET COUNT | SPACE$ | XPRINT SET WORDWRAP |
| DIALOG SHOW STATE | LISTBOX GET SELCOUNT | SQR | XPRINT SET WRAP |
| DIALOG STABILIZE | LISTBOX GET SELECT | STATUSBAR SET PARTS | XPRINT SPLIT |
| DIALOG UNITS | LISTBOX GET STATE | STATUSBAR SET TEXT | XPRINT STRETCH |
| DIM | LISTBOX GET TEXT | STR | XPRINT STYLE |
| DIR | LISTBOX GET USER | STR$ | XPRINT TEXT SIZE |
| DIR CLOSE | LISTBOX INSERT | STRDELETE | XPRINT WIDTH |
| DIR$ | LISTBOX RESET | STRDELETE$ |  |
