...
> Summary:
> - **847** official PowerBASIC statement/function keywords currently available for use
>   - **699** implemented or completed by this fork
...
> - **7** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 182 (v0.2.039). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 847 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | CVCUX | GRAPHIC SET FONT | MENU GET TEXT | TAB$ |
| ACCEL ATTACH | CVDWD | GRAPHIC SET LOC | MENU NEW BAR | TALLY |
| ACODE | CVL | GRAPHIC SET MIX | MENU NEW POPUP | TAN |
| ACODE$ | CVQ | GRAPHIC SET OVERLAP | MENU SET STATE | TANH |
| ACOS | CVW | GRAPHIC SET PIXEL | MENU SET TEXT | TCP ACCEPT |
| ACOSH | CWORD | GRAPHIC SET POS | METHOD / END METHOD | TCP CLOSE |
| AND | DATA | GRAPHIC SET SCROLLTEXT | METRICS | TCP LINE INPUT |
| ARRAY ADD | DATACOUNT | GRAPHIC SET SIZE | MID | TCP NOTIFY |
| ARRAY ARRAYIX | DAYNAME | GRAPHIC SET STRETCHMODE | MID$ | TCP OPEN |
| ARRAY ASSIGN | DAYNAME$ | GRAPHIC SET TEXTALIGN | MIN | TCP PRINT |
| ARRAY COPY | DEC | GRAPHIC SET VIEW | MKBYT | TCP RECV |
| ARRAY DELETE | DEC$ | GRAPHIC SET VIRTUAL | MKBYT$ | TCP SEND |
| ARRAY INSERT | DECLARE | GRAPHIC SET WORDWRAP | MKCUR$ | THREAD CLOSE |
| ARRAY REDIM DECR | DECR | GRAPHIC SET WRAP | MKCUX | THREAD CREATE |
| ARRAY REDIM INCR | DEF | GRAPHIC STRETCH | MKCUX$ | THREAD GET PRIORITY |
| ARRAY REVERSE | DESKTOP GET CLIENT | GRAPHIC STYLE | MKD$ | THREAD RESUME |
| ARRAY SCAN | DESKTOP GET LOC | GRAPHIC TEXT SIZE | MKDIR | THREAD SET PRIORITY |
| ARRAY SHUFFLE | DESKTOP GET PPI | GRAPHIC WIDTH | MKDWD | THREAD STATUS |
| ARRAY SORT | DESKTOP GET SIZE | GRAPHIC WINDOW | MKDWD$ | THREAD SUSPEND |
| ARRAY SWAP | DIALOG DEFAULT FONT | GRAPHIC WINDOW CLICK | MKE | THREADCOUNT |
| ARRAY TAGARRAY | DIALOG DISABLE | GRAPHIC WINDOW END | MKE$ | THREADED |
| ARRAY TAGARRAY ERASE | DIALOG DOEVENTS | GRAPHIC WINDOW HIDE | MKI$ | THREADID |
| ARRAY UNIQUE | DIALOG ENABLE | GRAPHIC WINDOW MINIMIZE | MKL$ | TIMER |
| ASC | DIALOG END | GRAPHIC WINDOW NONSTABLE | MKQ$ | TIX |
| ASIN | DIALOG GET CLIENT | GRAPHIC WINDOW NORMALIZE | MKS | TOOLBAR ADD BUTTON |
| ASINH | DIALOG GET LOC | GRAPHIC WINDOW STABILIZE | MKS$ | TOOLBAR ADD SEPARATOR |
| ASM | DIALOG GET SIZE | HEADER GET COUNT | MKWRD | TOOLBAR DELETE BUTTON |
| ASMDATA / END ASMDATA | DIALOG GET TEXT | HEADER GET ITEM | MKWRD$ | TOOLBAR GET COUNT |
| ATANH | DIALOG GET USER | HEADER SEND | MOD | TOOLBAR GET STATE |
| ATN | DIALOG HIDE | HEADER SET ITEM | MONTHNAME | TOOLBAR SET IMAGELIST |
| ATN2 | DIALOG MAXIMIZE | HEX | MONTHNAME$ | TOOLBAR SET STATE |
| BEEP | DIALOG MINIMIZE | HEX$ | MOUSEPTR | TRACE |
| BGR | DIALOG NEW | HI | MSGBOX | TREEVIEW DELETE |
| BIN | DIALOG NONSTABLE | HIWRD | NAME | TREEVIEW GET BOLD |
| BIN$ | DIALOG NORMALIZE | HOST ADDR | NOT | TREEVIEW GET CHECK |
| BIT | DIALOG PIXELS | HOST NAME | NUL | TREEVIEW GET CHILD |
| BIT CALC | DIALOG POST | HYPOT | NUL$ | TREEVIEW GET COUNT |
| BITS | DIALOG REDRAW | IF | OBJECT | TREEVIEW GET EXPANDED |
| BITS$ | DIALOG SEND | IF/END IF | OCT | TREEVIEW GET NEXT |
| BITSE | DIALOG SET CLIENT | IIF | OCT$ | TREEVIEW GET PARENT |
| BUILD | DIALOG SET COLOR | IMAGELIST ADD BITMAP | OEMTOCHR | TREEVIEW GET PREVIOUS |
| BUILD$ | DIALOG SET ICON | IMAGELIST ADD ICON | OEMTOCHR$ | TREEVIEW GET ROOT |
| BYTE | DIALOG SET LOC | IMAGELIST ADD MASKED | ON CALL | TREEVIEW GET SELECT |
| CALL | DIALOG SET SIZE | IMAGELIST COUNT | ON ERROR | TREEVIEW GET TEXT |
| CALL DWORD | DIALOG SET TEXT | IMAGELIST GET COUNT | ON GOSUB | TREEVIEW GET USER |
| CALLSTK | DIALOG SET USER | IMAGELIST KILL | ON GOTO | TREEVIEW INSERT ITEM |
| CALLSTK$ | DIALOG SHOW MODAL | IMAGELIST NEW | OPEN | TREEVIEW RESET |
| CALLSTKCOUNT | DIALOG SHOW MODELESS | IMAGELIST NEW BITMAP | OPTION EXPLICIT | TREEVIEW SELECT |
| CBOOL | DIALOG SHOW STATE | IMAGELIST NEW ICON | OR | TREEVIEW SET BOLD |
| CBRT | DIALOG STABILIZE | IMAGELIST SET OVERLAY | PARSE | TREEVIEW SET CHECK |
| CBYTE | DIALOG UNITS | IMP | PARSE$ | TREEVIEW SET EXPANDED |
| CDBL | DIM | IMPORT | PARSECOUNT | TREEVIEW SET IMAGELIST |
| CDWORD | DIR | INCR | PATHNAME | TREEVIEW SET TEXT |
| CEIL | DIR CLOSE | INPUT FLUSH | PATHNAME$ | TREEVIEW SET USER |
| CFLT | DIR$ | INPUT# | PATHSCAN | TREEVIEW UNSELECT |
| CHDIR | DISKFREE | INSTANCE | PATHSCAN$ | TRIM |
| CHDRIVE | DISKSIZE | INSTR | PEEK | TRIM$ |
| CHOOSE | DISPLAY BROWSE | INT | PLAY | TRUNC |
| CHR | DISPLAY COLOR | INTEGER | PLAY SOUND | TRY/END TRY |
| CHR$ | DISPLAY FONT | INTERFACE / END INTERFACE (DIRECT) | PLAY WAVE | TYPE SET |
| CHRBYTES | DISPLAY OPENFILE | INTERFACE/END INTERFACE (IDBIND) | POKE | TYPE/END TYPE |
| CHRTOOEM | DISPLAY SAVEFILE | ISEVEN | PREFIX | UCASE |
| CHRTOOEM$ | DOUBLE | ISFALSE | PRINT# | UCASE$ |
| CHRTOUTF8 | END | ISFILE | PRINTER$ | UCODE$ |
| CHRTOUTF8$ | ENVIRON | ISFOLDER | PRINTERCOUNT | UCODEPAGE |
| CLASS/END CLASS | ENVIRON$ | ISINFINITE | PROCESS GET PRIORITY | UDP CLOSE |
| CLIP | EOF | ISNORMAL | PROCESS SET PRIORITY | UDP NOTIFY |
| CLIP$ | EQV | ISODD | PROFILE | UDP OPEN |
| CLIPBOARD | ERASE | ISTRUE | PROGRESSBAR GET POS | UDP RECV |
| CLOSE | ERF | ISWIN | PROGRESSBAR GET RANGE | UDP SEND |
| CLS | ERL | ITERATE | PROGRESSBAR SET POS | UNLOCK |
| CODEPTR | ERL$ | JOIN$ | PROGRESSBAR SET RANGE | UNWRAP |
| COLOR | ERR | KILL | PROGRESSBAR SET STEP | UNWRAP$ |
| COMBOBOX ADD | ERRCLEAR | LCASE | PROGRESSBAR STEP | USING |
| COMBOBOX DELETE | ERROR | LCASE$ | PUT | USING$ |
| COMBOBOX FIND | ERROR$ | LEFT | PUT STR | UTF8TOCHR |
| COMBOBOX FIND EXACT | EVENT SOURCE | LEFT$ | PUT WSTR | UTF8TOCHR$ |
| COMBOBOX GET COUNT | EVENTS | LEN | PUT$ | VAL |
| COMBOBOX GET SELCOUNT | EXE | LET | PUT$$ | VARPTR |
| COMBOBOX GET SELECT | EXIST | LET *(WITH OBJECTS)* | QUAD | VERIFY |
| COMBOBOX GET STATE | EXIT | LET *(WITH TYPES)* | RAISEEVENT | WAITKEY |
| COMBOBOX GET TEXT | EXP | LET *(WITH VARIANTS)* | RANDOMIZE | WAITKEY$ |
| COMBOBOX GET USER | EXP10 | LINE INPUT# | READ | WINDOW GET |
| COMBOBOX INSERT | EXP2 | LISTBOX ADD | READ$ | WINDOW SET |
| COMBOBOX RESET | EXPM1 | LISTBOX DELETE | REDIM | WORD |
| COMBOBOX SELECT | EXTRACT | LISTBOX FIND | REGEXPR | WRAP |
| COMBOBOX SET TEXT | EXTRACT$ | LISTBOX FIND EXACT | REGISTER | WRAP$ |
| COMBOBOX SET USER | FIELD | LISTBOX GET COUNT | REGREPL | WRITE |
| COMBOBOX UNSELECT | FILEATTR | LISTBOX GET SELCOUNT | REM | WRITE# |
| COMM CLOSE | FILECOPY | LISTBOX GET SELECT | REMAIN | XOR |
| COMM LINE | FILENAME | LISTBOX GET STATE | REMAIN$ | XPRINT ARC |
| COMM LINE INPUT | FILENAME$ | LISTBOX GET TEXT | REMOVE | XPRINT ATTACH |
| COMM OPEN | FILESCAN | LISTBOX GET USER | REMOVE$ | XPRINT BOX |
| COMM PRINT | FIX | LISTBOX INSERT | REPEAT | XPRINT CANCEL |
| COMM RECV | FLOOR | LISTBOX RESET | REPEAT$ | XPRINT CELL |
| COMM RESET | FLUSH | LISTBOX SELECT | REPLACE | XPRINT CELL SIZE |
| COMM SEND | FONT END | LISTBOX SET TEXT | RESET | XPRINT CHR SIZE |
| COMM SET | FONT NEW | LISTBOX SET USER | RESOURCE SAVE FILE | XPRINT CLOSE |
| COMM TIMEOUT | FOR / NEXT | LISTBOX UNSELECT | RESOURCE$ | XPRINT COLOR |
| COMMAND | FORMAT | LISTVIEW DELETE COLUMN | RESUME | XPRINT COPY |
| COMMAND$ | FORMAT$ | LISTVIEW DELETE ITEM | RETAIN | XPRINT ELLIPSE |
| CONTROL ADD | FRAC | LISTVIEW FIND | RETAIN$ | XPRINT FORMFEED |
| CONTROL ADD BUTTON | FRE | LISTVIEW FIND EXACT | RETURN | XPRINT GET ATTACH |
| CONTROL ADD CHECK3STATE | FREEFILE | LISTVIEW FIT CONTENT | RGB | XPRINT GET CANVAS |
| CONTROL ADD CHECKBOX | FUNCNAME | LISTVIEW FIT HEADER | RIGHT | XPRINT GET CLIENT |
| CONTROL ADD COMBOBOX | FUNCNAME$ | LISTVIEW GET COLUMN | RIGHT$ | XPRINT GET CLIP |
| CONTROL ADD FRAME | FUNCTION / END FUNCTION | LISTVIEW GET COUNT | RMDIR | XPRINT GET COLLATE |
| CONTROL ADD GRAPHIC | GET | LISTVIEW GET HEADER | RND | XPRINT GET COLOR |
| CONTROL ADD HEADER | GET STR | LISTVIEW GET HEADERID | ROTATE | XPRINT GET COLORMODE |
| CONTROL ADD IMAGE | GET WSTR | LISTVIEW GET MODE | ROUND | XPRINT GET COPIES |
| CONTROL ADD IMAGEX | GET$ | LISTVIEW GET SELCOUNT | RSET | XPRINT GET DC |
| CONTROL ADD IMGBUTTON | GET$$ | LISTVIEW GET SELECT | RSET$ | XPRINT GET DUPLEX |
| CONTROL ADD IMGBUTTONX | GETATTR | LISTVIEW GET STATE | RTRIM | XPRINT GET LINES |
| CONTROL ADD LABEL | GLOBAL | LISTVIEW GET STYLEXX | RTRIM$ | XPRINT GET MARGIN |
| CONTROL ADD LINE | GLOBALMEM | LISTVIEW GET TEXT | SCROLLBAR GET PAGESIZE | XPRINT GET MIX |
| CONTROL ADD LISTBOX | GRAPHIC ARC | LISTVIEW GET USER | SCROLLBAR GET POS | XPRINT GET ORIENTATION |
| CONTROL ADD LISTVIEW | GRAPHIC ATTACH | LISTVIEW INSERT COLUMN | SCROLLBAR GET RANGE | XPRINT GET OVERLAP |
| CONTROL ADD OPTION | GRAPHIC BITMAP END | LISTVIEW INSERT ITEM | SCROLLBAR GET TRACKPOS | XPRINT GET PAGES |
| CONTROL ADD PROGRESSBAR | GRAPHIC BITMAP LOAD | LISTVIEW RESET | SCROLLBAR SET PAGESIZE | XPRINT GET PAPER |
| CONTROL ADD SCROLLBAR | GRAPHIC BITMAP NEW | LISTVIEW SELECT | SCROLLBAR SET POS | XPRINT GET PAPERS |
| CONTROL ADD STATUSBAR | GRAPHIC BOX | LISTVIEW SET COLUMN | SCROLLBAR SET RANGE | XPRINT GET PIXEL |
| CONTROL ADD TAB | GRAPHIC CELL | LISTVIEW SET HEADER | SEC | XPRINT GET POS |
| CONTROL ADD TEXTBOX | GRAPHIC CELL SIZE | LISTVIEW SET IMAGE | SECH | XPRINT GET PPI |
| CONTROL ADD TOOLBAR | GRAPHIC CHR SIZE | LISTVIEW SET IMAGE2 | SEEK | XPRINT GET QUALITY |
| CONTROL ADD TREEVIEW | GRAPHIC CIRCLE | LISTVIEW SET IMAGELIST | SELECT CASE/END SELECT | XPRINT GET SCALE |
| CONTROL DISABLE | GRAPHIC CLEAR | LISTVIEW SET MODE | SETATTR | XPRINT GET SELECTION |
| CONTROL ENABLE | GRAPHIC COLOR | LISTVIEW SET OVERLAY | SETEOF | XPRINT GET SIZE |
| CONTROL GET CHECK | GRAPHIC COPY | LISTVIEW SET STYLEXX | SGN | XPRINT GET STRETCHMODE |
| CONTROL GET CLIENT | GRAPHIC DETACH | LISTVIEW SET TEXT | SHELL | XPRINT GET TEXTALIGN |
| CONTROL GET LOC | GRAPHIC ELLIPSE | LISTVIEW SET USER | SHIFT | XPRINT GET TRAY |
| CONTROL GET SIZE | GRAPHIC GET BITS | LISTVIEW SORT | SHRINK | XPRINT GET TRAYS |
| CONTROL GET TEXT | GRAPHIC GET CANVAS | LISTVIEW UNSELECT | SHRINK$ | XPRINT GET WORDWRAP |
| CONTROL GET USER | GRAPHIC GET CAPTION | LISTVIEW VISIBLE | SIN | XPRINT GET WRAP |
| CONTROL HANDLE | GRAPHIC GET CLIENT | LO | SINGLE | XPRINT IMAGELIST |
| CONTROL HIDE | GRAPHIC GET CLIP | LOC | SINH | XPRINT LINE |
| CONTROL KILL | GRAPHIC GET DC | LOCAL | SIZEOF | XPRINT PIE |
| CONTROL NORMALIZE | GRAPHIC GET LINES | LOCK | SLEEP | XPRINT POLYGON |
| CONTROL POST | GRAPHIC GET LOC | LOF | SPACE | XPRINT POLYLINE |
| CONTROL REDRAW | GRAPHIC GET MIX | LOG | SPACE$ | XPRINT PREVIEW |
| CONTROL SEND | GRAPHIC GET OVERLAP | LOG10 | SPLIT | XPRINT PRINT |
| CONTROL SET CHECK | GRAPHIC GET PIXEL | LOG1P | SQR | XPRINT RENDER |
| CONTROL SET CLIENT | GRAPHIC GET POS | LOG2 | STATIC | XPRINT SCALE |
| CONTROL SET COLOR | GRAPHIC GET PPI | LONG | STATUSBAR SET PARTS | XPRINT SET CLIP |
| CONTROL SET FOCUS | GRAPHIC GET SCALE | LOWRD | STATUSBAR SET TEXT | XPRINT SET COLLATE |
| CONTROL SET FONT | GRAPHIC GET SCROLLTEXT | LPRINT | STR | XPRINT SET COLOR |
| CONTROL SET IMAGE | GRAPHIC GET SIZE | LPRINT ATTACH | STR$ | XPRINT SET COLORMODE |
| CONTROL SET IMAGEX | GRAPHIC GET STRETCHMODE | LPRINT CLOSE | STRDELETE | XPRINT SET COPIES |
| CONTROL SET IMGBUTTON | GRAPHIC GET TEXTALIGN | LPRINT FLUSH | STRDELETE$ | XPRINT SET DUPLEX |
| CONTROL SET IMGBUTTONX | GRAPHIC GET VIEW | LPRINT FORMFEED | STRING | XPRINT SET FONT |
| CONTROL SET LOC | GRAPHIC GET WORDWRAP | LPRINT$ | STRINSERT | XPRINT SET MIX |
| CONTROL SET OPTION | GRAPHIC GET WRAP | LSET | STRINSERT$ | XPRINT SET ORIENTATION |
| CONTROL SET SIZE | GRAPHIC IMAGELIST | LSET$ | STRPTR | XPRINT SET OVERLAP |
| CONTROL SET TEXT | GRAPHIC LINE | LTRIM | STRREVERSE | XPRINT SET PAGES |
| CONTROL SET USER | GRAPHIC PAINT | LTRIM$ | STRREVERSE$ | XPRINT SET PAPER |
| CONTROL SHOW STATE | GRAPHIC PIE | MACRO/END MACRO | SWAP | XPRINT SET PIXEL |
| COS | GRAPHIC POLYGON | MAK | SWITCH | XPRINT SET POS |
| COSH | GRAPHIC POLYLINE | MAT | SWITCH$ | XPRINT SET QUALITY |
| COT | GRAPHIC PRINT | MAX | TAB DELETE | XPRINT SET STRETCHMODE |
| COTH | GRAPHIC REDRAW | MCASE | TAB GET COUNT | XPRINT SET TEXTALIGN |
| CQUAD | GRAPHIC RENDER | MCASE$ | TAB GET DIALOG | XPRINT SET TRAY |
| CSC | GRAPHIC SAVE | MEMORY | TAB GET IMAGE | XPRINT SET WORDWRAP |
| CSCH | GRAPHIC SCALE | MEMORY FILL | TAB GET PAGE | XPRINT SET WRAP |
| CSET | GRAPHIC SCALE PIXELS | MEMORY FILLS | TAB GET SELECT | XPRINT SPLIT |
| CSET$ | GRAPHIC SET AUTOSIZE | MENU ADD POPUP | TAB GET TEXT | XPRINT STRETCH |
| CSNG | GRAPHIC SET BITS | MENU ADD STRING | TAB INSERT PAGE | XPRINT STYLE |
| CSTR | GRAPHIC SET CAPTION | MENU ATTACH | TAB RESET | XPRINT TEXT SIZE |
| CULNG | GRAPHIC SET CLIENT | MENU CONTEXT | TAB SELECT | XPRINT WIDTH |
| CURDIR | GRAPHIC SET CLIP | MENU DELETE | TAB SET IMAGE |  |
| CURDIR$ | GRAPHIC SET FIXED | MENU DRAW BAR | TAB SET IMAGELIST |  |
| CVBYT | GRAPHIC SET FOCUS | MENU GET STATE | TAB SET TEXT |  |

## **Newly** implemented by this branch

> **699 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG REDRAW | ISFOLDER | SHRINK |
| ACCEL ATTACH | DIALOG SEND | ISINFINITE | SHRINK$ |
| ACODE | DIALOG SET CLIENT | ISNORMAL | SIN |
| ACODE$ | DIALOG SET COLOR | ISODD | SINGLE |
| ACOS | DIALOG SET ICON | ISTRUE | SINH |
| ACOSH | DIALOG SET LOC | ISWIN | SIZEOF |
| ARRAY ADD | DIALOG SET SIZE | JOIN$ | SPACE |
| ARRAY ARRAYIX | DIALOG SET TEXT | LCASE | SPACE$ |
| ARRAY ASSIGN | DIALOG SET USER | LCASE$ | SQR |
| ARRAY COPY | DIALOG SHOW MODAL | LEFT | STATUSBAR SET PARTS |
| ARRAY DELETE | DIALOG SHOW MODELESS | LEFT$ | STATUSBAR SET TEXT |
| ARRAY INSERT | DIALOG SHOW STATE | LEN | STR |
| ARRAY REDIM DECR | DIALOG STABILIZE | LET *(WITH OBJECTS)* | STR$ |
| ARRAY REDIM INCR | DIALOG UNITS | LET *(WITH VARIANTS)* | STRDELETE |
| ARRAY REVERSE | DIM | LINE INPUT# | STRDELETE$ |
| ARRAY SCAN | DIR | LISTBOX ADD | STRING |
| ARRAY SHUFFLE | DIR CLOSE | LISTBOX DELETE | STRINSERT |
| ARRAY SWAP | DIR$ | LISTBOX FIND | STRINSERT$ |
| ARRAY TAGARRAY | DISKFREE | LISTBOX FIND EXACT | STRPTR |
| ARRAY TAGARRAY ERASE | DISKSIZE | LISTBOX GET COUNT | STRREVERSE |
| ARRAY UNIQUE | DISPLAY BROWSE | LISTBOX GET SELCOUNT | STRREVERSE$ |
| ASIN | DISPLAY COLOR | LISTBOX GET SELECT | SWITCH |
| ASINH | DISPLAY FONT | LISTBOX GET STATE | SWITCH$ |
| ATANH | DISPLAY OPENFILE | LISTBOX GET TEXT | TAB DELETE |
| ATN | DISPLAY SAVEFILE | LISTBOX GET USER | TAB GET COUNT |
| ATN2 | DOUBLE | LISTBOX INSERT | TAB GET DIALOG |
| BGR | ENVIRON$ | LISTBOX RESET | TAB GET IMAGE |
| BIN | EOF | LISTBOX SELECT | TAB GET PAGE |
| BIN$ | EQV | LISTBOX SET TEXT | TAB GET SELECT |
| BITS | ERF | LISTBOX SET USER | TAB GET TEXT |
| BITS$ | ERL | LISTBOX UNSELECT | TAB INSERT PAGE |
| BITSE | ERL$ | LISTVIEW DELETE COLUMN | TAB RESET |
| BUILD | ERR | LISTVIEW DELETE ITEM | TAB SELECT |
| BUILD$ | ERRCLEAR | LISTVIEW FIND | TAB SET IMAGE |
| BYTE | ERROR$ | LISTVIEW FIND EXACT | TAB SET IMAGELIST |
| CALLSTK$ | EVENT SOURCE | LISTVIEW FIT CONTENT | TAB SET TEXT |
| CALLSTKCOUNT | EVENTS | LISTVIEW FIT HEADER | TAB$ |
| CBOOL | EXE | LISTVIEW GET COLUMN | TALLY |
| CBRT | EXIST | LISTVIEW GET COUNT | TAN |
| CBYTE | EXP | LISTVIEW GET HEADER | TANH |
| CDBL | EXP10 | LISTVIEW GET HEADERID | TCP NOTIFY |
| CDWORD | EXP2 | LISTVIEW GET MODE | THREADCOUNT |
| CEIL | EXPM1 | LISTVIEW GET SELCOUNT | THREADID |
| CFLT | EXTRACT | LISTVIEW GET SELECT | TIMER |
| CHOOSE | EXTRACT$ | LISTVIEW GET STATE | TOOLBAR ADD BUTTON |
| CHR | FILEATTR | LISTVIEW GET STYLEXX | TOOLBAR ADD SEPARATOR |
| CHR$ | FILENAME | LISTVIEW GET TEXT | TOOLBAR DELETE BUTTON |
| CHRBYTES | FILENAME$ | LISTVIEW GET USER | TOOLBAR GET COUNT |
| CHRTOOEM | FIX | LISTVIEW INSERT COLUMN | TOOLBAR GET STATE |
| CHRTOOEM$ | FLOOR | LISTVIEW INSERT ITEM | TOOLBAR SET IMAGELIST |
| CHRTOUTF8 | FONT END | LISTVIEW RESET | TOOLBAR SET STATE |
| CHRTOUTF8$ | FONT NEW | LISTVIEW SELECT | TREEVIEW DELETE |
| CLIP | FORMAT | LISTVIEW SET COLUMN | TREEVIEW GET BOLD |
| CLIP$ | FORMAT$ | LISTVIEW SET HEADER | TREEVIEW GET CHECK |
| CLOSE | FRAC | LISTVIEW SET IMAGE | TREEVIEW GET CHILD |
| CODEPTR | FRE | LISTVIEW SET IMAGE2 | TREEVIEW GET COUNT |
| COMBOBOX ADD | FREEFILE | LISTVIEW SET IMAGELIST | TREEVIEW GET EXPANDED |
| COMBOBOX DELETE | FUNCNAME | LISTVIEW SET MODE | TREEVIEW GET NEXT |
| COMBOBOX FIND | FUNCNAME$ | LISTVIEW SET OVERLAY | TREEVIEW GET PARENT |
| COMBOBOX FIND EXACT | GET | LISTVIEW SET STYLEXX | TREEVIEW GET PREVIOUS |
| COMBOBOX GET COUNT | GET STR | LISTVIEW SET TEXT | TREEVIEW GET ROOT |
| COMBOBOX GET SELCOUNT | GET WSTR | LISTVIEW SET USER | TREEVIEW GET SELECT |
| COMBOBOX GET SELECT | GET$ | LISTVIEW SORT | TREEVIEW GET TEXT |
| COMBOBOX GET STATE | GET$$ | LISTVIEW UNSELECT | TREEVIEW GET USER |
| COMBOBOX GET TEXT | GETATTR | LISTVIEW VISIBLE | TREEVIEW INSERT ITEM |
| COMBOBOX GET USER | GRAPHIC ARC | LO | TREEVIEW RESET |
| COMBOBOX INSERT | GRAPHIC ATTACH | LOC | TREEVIEW SELECT |
| COMBOBOX RESET | GRAPHIC BITMAP END | LOF | TREEVIEW SET BOLD |
| COMBOBOX SELECT | GRAPHIC BITMAP LOAD | LOG | TREEVIEW SET CHECK |
| COMBOBOX SET TEXT | GRAPHIC BITMAP NEW | LOG10 | TREEVIEW SET EXPANDED |
| COMBOBOX SET USER | GRAPHIC BOX | LOG1P | TREEVIEW SET IMAGELIST |
| COMBOBOX UNSELECT | GRAPHIC CELL | LOG2 | TREEVIEW SET TEXT |
| COMM LINE INPUT | GRAPHIC CELL SIZE | LONG | TREEVIEW SET USER |
| COMMAND | GRAPHIC CHR SIZE | LOWRD | TREEVIEW UNSELECT |
| COMMAND$ | GRAPHIC CIRCLE | LPRINT$ | TRIM |
| CONTROL ADD | GRAPHIC CLEAR | LSET$ | TRIM$ |
| CONTROL ADD BUTTON | GRAPHIC COLOR | LTRIM | TRUNC |
| CONTROL ADD CHECK3STATE | GRAPHIC COPY | LTRIM$ | UCASE |
| CONTROL ADD CHECKBOX | GRAPHIC DETACH | MAK | UCASE$ |
| CONTROL ADD COMBOBOX | GRAPHIC ELLIPSE | MAX | UCODE$ |
| CONTROL ADD FRAME | GRAPHIC GET BITS | MCASE | UCODEPAGE |
| CONTROL ADD GRAPHIC | GRAPHIC GET CANVAS | MCASE$ | UDP NOTIFY |
| CONTROL ADD HEADER | GRAPHIC GET CAPTION | MEMORY FILL | UNWRAP |
| CONTROL ADD IMAGE | GRAPHIC GET CLIENT | MEMORY FILLS | UNWRAP$ |
| CONTROL ADD IMAGEX | GRAPHIC GET CLIP | MENU ADD POPUP | USING |
| CONTROL ADD IMGBUTTON | GRAPHIC GET DC | MENU ADD STRING | USING$ |
| CONTROL ADD IMGBUTTONX | GRAPHIC GET LINES | MENU ATTACH | UTF8TOCHR |
| CONTROL ADD LABEL | GRAPHIC GET LOC | MENU CONTEXT | UTF8TOCHR$ |
| CONTROL ADD LINE | GRAPHIC GET MIX | MENU DELETE | VARPTR |
| CONTROL ADD LISTBOX | GRAPHIC GET OVERLAP | MENU DRAW BAR | VERIFY |
| CONTROL ADD LISTVIEW | GRAPHIC GET PIXEL | MENU GET STATE | WAITKEY |
| CONTROL ADD OPTION | GRAPHIC GET POS | MENU GET TEXT | WAITKEY$ |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET PPI | MENU NEW BAR | WORD |
| CONTROL ADD SCROLLBAR | GRAPHIC GET SCALE | MENU NEW POPUP | WRAP |
| CONTROL ADD STATUSBAR | GRAPHIC GET SCROLLTEXT | MENU SET STATE | WRAP$ |
| CONTROL ADD TAB | GRAPHIC GET SIZE | MENU SET TEXT | WRITE |
| CONTROL ADD TEXTBOX | GRAPHIC GET STRETCHMODE | METRICS | WRITE# |
| CONTROL ADD TOOLBAR | GRAPHIC GET TEXTALIGN | MID | XPRINT ARC |
| CONTROL ADD TREEVIEW | GRAPHIC GET VIEW | MIN | XPRINT ATTACH |
| CONTROL DISABLE | GRAPHIC GET WORDWRAP | MKBYT | XPRINT BOX |
| CONTROL ENABLE | GRAPHIC GET WRAP | MKCUX | XPRINT CANCEL |
| CONTROL GET CHECK | GRAPHIC IMAGELIST | MKDWD | XPRINT CELL |
| CONTROL GET CLIENT | GRAPHIC LINE | MKE | XPRINT CELL SIZE |
| CONTROL GET LOC | GRAPHIC PAINT | MKS | XPRINT CHR SIZE |
| CONTROL GET SIZE | GRAPHIC PIE | MKWRD | XPRINT CLOSE |
| CONTROL GET TEXT | GRAPHIC POLYGON | MOD | XPRINT COLOR |
| CONTROL GET USER | GRAPHIC POLYLINE | MONTHNAME | XPRINT COPY |
| CONTROL HANDLE | GRAPHIC PRINT | MONTHNAME$ | XPRINT ELLIPSE |
| CONTROL HIDE | GRAPHIC REDRAW | NUL$ | XPRINT FORMFEED |
| CONTROL KILL | GRAPHIC RENDER | OCT | XPRINT GET ATTACH |
| CONTROL NORMALIZE | GRAPHIC SAVE | OCT$ | XPRINT GET CANVAS |
| CONTROL POST | GRAPHIC SCALE | OEMTOCHR | XPRINT GET CLIENT |
| CONTROL REDRAW | GRAPHIC SCALE PIXELS | OEMTOCHR$ | XPRINT GET CLIP |
| CONTROL SEND | GRAPHIC SET AUTOSIZE | ON CALL | XPRINT GET COLLATE |
| CONTROL SET CHECK | GRAPHIC SET BITS | ON GOSUB | XPRINT GET COLOR |
| CONTROL SET CLIENT | GRAPHIC SET CAPTION | ON GOTO | XPRINT GET COLORMODE |
| CONTROL SET COLOR | GRAPHIC SET CLIENT | OPEN | XPRINT GET COPIES |
| CONTROL SET FOCUS | GRAPHIC SET CLIP | PARSE$ | XPRINT GET DC |
| CONTROL SET FONT | GRAPHIC SET FIXED | PARSECOUNT | XPRINT GET DUPLEX |
| CONTROL SET IMAGE | GRAPHIC SET FOCUS | PATHNAME | XPRINT GET LINES |
| CONTROL SET IMAGEX | GRAPHIC SET FONT | PATHNAME$ | XPRINT GET MARGIN |
| CONTROL SET IMGBUTTON | GRAPHIC SET LOC | PATHSCAN | XPRINT GET MIX |
| CONTROL SET IMGBUTTONX | GRAPHIC SET MIX | PATHSCAN$ | XPRINT GET ORIENTATION |
| CONTROL SET LOC | GRAPHIC SET OVERLAP | PEEK | XPRINT GET OVERLAP |
| CONTROL SET OPTION | GRAPHIC SET PIXEL | PLAY | XPRINT GET PAGES |
| CONTROL SET SIZE | GRAPHIC SET POS | PLAY SOUND | XPRINT GET PAPER |
| CONTROL SET TEXT | GRAPHIC SET SCROLLTEXT | POKE | XPRINT GET PAPERS |
| CONTROL SET USER | GRAPHIC SET SIZE | PRINTER$ | XPRINT GET PIXEL |
| CONTROL SHOW STATE | GRAPHIC SET STRETCHMODE | PRINTERCOUNT | XPRINT GET POS |
| COS | GRAPHIC SET TEXTALIGN | PROGRESSBAR GET POS | XPRINT GET PPI |
| COSH | GRAPHIC SET VIEW | PROGRESSBAR GET RANGE | XPRINT GET QUALITY |
| COT | GRAPHIC SET VIRTUAL | PROGRESSBAR SET POS | XPRINT GET SCALE |
| COTH | GRAPHIC SET WORDWRAP | PROGRESSBAR SET RANGE | XPRINT GET SELECTION |
| CQUAD | GRAPHIC SET WRAP | PROGRESSBAR SET STEP | XPRINT GET SIZE |
| CSC | GRAPHIC STRETCH | PROGRESSBAR STEP | XPRINT GET STRETCHMODE |
| CSCH | GRAPHIC STYLE | PUT | XPRINT GET TEXTALIGN |
| CSET$ | GRAPHIC TEXT SIZE | PUT STR | XPRINT GET TRAY |
| CSNG | GRAPHIC WIDTH | PUT WSTR | XPRINT GET TRAYS |
| CSTR | GRAPHIC WINDOW | PUT$ | XPRINT GET WORDWRAP |
| CULNG | GRAPHIC WINDOW CLICK | PUT$$ | XPRINT GET WRAP |
| CURDIR | GRAPHIC WINDOW END | QUAD | XPRINT IMAGELIST |
| CURDIR$ | GRAPHIC WINDOW HIDE | RAISEEVENT | XPRINT LINE |
| CVBYT | GRAPHIC WINDOW MINIMIZE | READ | XPRINT PIE |
| CVCUX | GRAPHIC WINDOW NONSTABLE | READ$ | XPRINT POLYGON |
| CVDWD | GRAPHIC WINDOW NORMALIZE | REDIM | XPRINT POLYLINE |
| CVL | GRAPHIC WINDOW STABILIZE | REMAIN | XPRINT PREVIEW |
| CVQ | HEADER GET COUNT | REMAIN$ | XPRINT PRINT |
| CVW | HEADER GET ITEM | REMOVE | XPRINT RENDER |
| CWORD | HEADER SEND | REMOVE$ | XPRINT SCALE |
| DATACOUNT | HEADER SET ITEM | REPEAT | XPRINT SET CLIP |
| DAYNAME | HEX | REPEAT$ | XPRINT SET COLLATE |
| DAYNAME$ | HEX$ | RESOURCE SAVE FILE | XPRINT SET COLOR |
| DEC | HI | RESOURCE$ | XPRINT SET COLORMODE |
| DEC$ | HIWRD | RETAIN | XPRINT SET COPIES |
| DECLARE | HYPOT | RETAIN$ | XPRINT SET DUPLEX |
| DEF | IIF | RGB | XPRINT SET FONT |
| DESKTOP GET PPI | IMAGELIST ADD BITMAP | RIGHT | XPRINT SET MIX |
| DIALOG DEFAULT FONT | IMAGELIST ADD ICON | RIGHT$ | XPRINT SET ORIENTATION |
| DIALOG DISABLE | IMAGELIST ADD MASKED | RND | XPRINT SET OVERLAP |
| DIALOG DOEVENTS | IMAGELIST COUNT | ROUND | XPRINT SET PAGES |
| DIALOG ENABLE | IMAGELIST GET COUNT | RSET$ | XPRINT SET PAPER |
| DIALOG END | IMAGELIST KILL | RTRIM | XPRINT SET PIXEL |
| DIALOG GET CLIENT | IMAGELIST NEW | RTRIM$ | XPRINT SET POS |
| DIALOG GET LOC | IMAGELIST NEW BITMAP | SCROLLBAR GET PAGESIZE | XPRINT SET QUALITY |
| DIALOG GET SIZE | IMAGELIST NEW ICON | SCROLLBAR GET POS | XPRINT SET STRETCHMODE |
| DIALOG GET TEXT | IMAGELIST SET OVERLAY | SCROLLBAR GET RANGE | XPRINT SET TEXTALIGN |
| DIALOG GET USER | IMP | SCROLLBAR GET TRACKPOS | XPRINT SET TRAY |
| DIALOG HIDE | INPUT# | SCROLLBAR SET PAGESIZE | XPRINT SET WORDWRAP |
| DIALOG MAXIMIZE | INSTANCE | SCROLLBAR SET POS | XPRINT SET WRAP |
| DIALOG MINIMIZE | INSTR | SCROLLBAR SET RANGE | XPRINT SPLIT |
| DIALOG NEW | INT | SEC | XPRINT STRETCH |
| DIALOG NONSTABLE | INTEGER | SECH | XPRINT STYLE |
| DIALOG NORMALIZE | ISEVEN | SEEK | XPRINT TEXT SIZE |
| DIALOG PIXELS | ISFALSE | SETEOF | XPRINT WIDTH |
| DIALOG POST | ISFILE | SGN |  |
