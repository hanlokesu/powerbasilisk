...
| CONTROL ADD BUTTON | CONTROL ADD CHECKBOX | CONTROL ADD COMBOBOX | CONTROL ADD EDITBOX | CONTROL ADD GROUPBOX |
| CONTROL ADD LISTBOX | CONTROL ADD RADIOBUTTON | CONTROL GET TEXT | CONTROL SET TEXT | COSH |
| COT | COTH | CSC | CSCH | CSET |
| CSET$ | CURDIR$ | DAYNAME$ | DEC$ | DECR |
| DESKTOP GET CLIENT | DESKTOP GET LOC | DESKTOP GET PPI | DESKTOP GET SIZE | DIR CLOSE |
| DIR$ | DISPLAY BROWSE | DISPLAY COLOR | DISPLAY FONT | DISPLAY OPENFILE |
| DISPLAY SAVEFILE | ENVIRON | ENVIRON$ | EQV | ERASE |
| ERF | ERL$ | ERROR | ERROR$ | EXP10 |
| EXP2 | EXPM1 | EXTRACT$ | FIELD | FILECOPY |
| FILENAME$ | FILESCAN | FLOOR | FLUSH | FONT END |
| FONT NEW | FUNCNAME | FUNCNAME$ | GET | GET$ |
...
| HOST NAME | HYPOT | IF/END IF | IMP | IMPORT |
...
| KILL | LET *(WITH TYPES)* | LINE INPUT# | LOCK | LOG10 |
| LOG1P | LOG2 | LPRINT | LPRINT ATTACH | LPRINT CLOSE |
| LPRINT FLUSH | LPRINT FORMFEED | LPRINT$ | LSET | LSET$ |
...
| MSGBOX | NAME | NUL | NUL$ | OBJECT |
| OCT$ | OEMTOCHR$ | ON CALL | ON ERROR | ON GOSUB |
| ON GOTO | OPTION EXPLICIT | PARSE$ | PATHNAME$ | PATHSCAN$ |
...
| REGREPL | REM | REMAIN$ | REPEAT$ | REPLACE |
| RESET | RESOURCE SAVE FILE | RESOURCE$ | RESUME | RETAIN$ |
| RGB | RMDIR | ROTATE | RSET | RSET$ |
| SEC | SECH | SEEK | SETATTR | SETEOF |
| SHELL | SHIFT | SHRINK$ | SINH | SLEEP |
| SPLIT | STATIC | STRDELETE$ | STRINSERT$ | STRREVERSE$ |
...
| THREADID | TIX | TRACE | TRUNC | TRY/END TRY |
| TYPE SET | UCODE$ | UCODEPAGE | UDP CLOSE | UDP OPEN |
| UDP RECV | UDP SEND | UNLOCK | UNWRAP$ | USING$ |
| UTF8TOCHR$ | WAITKEY$ | WINDOW | WINDOW GET | WINDOW SET |
