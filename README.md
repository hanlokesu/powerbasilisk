...
> Summary:
> - **729** official PowerBASIC statement/function keywords currently available for use
>   - **581** implemented or completed by this fork
...
> - **127** DDT/GUI-class keywords deferred (Tier 3)
...
> Updated through batch 168 (v0.2.025). **No official keyword remains unimplemented - every non-Tier-3 official keyword is implemented.**
...
**All 729 official keywords currently available for use (alphabetical):**

| Keyword | Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|---------|
| ABS | DEC | GRAPHIC SCALE | MKDIR | TCP CLOSE |
| ACCEL ATTACH | DEC$ | GRAPHIC SCALE PIXELS | MKDWD | TCP LINE INPUT |
| ACODE | DECLARE | GRAPHIC SET AUTOSIZE | MKDWD$ | TCP NOTIFY |
| ACODE$ | DECR | GRAPHIC SET BITS | MKE | TCP OPEN |
| ACOS | DEF | GRAPHIC SET CAPTION | MKE$ | TCP PRINT |
| ACOSH | DESKTOP GET CLIENT | GRAPHIC SET CLIP | MKI$ | TCP RECV |
| AND | DESKTOP GET LOC | GRAPHIC SET FIXED | MKL$ | TCP SEND |
| ARRAY ADD | DESKTOP GET PPI | GRAPHIC SET FONT | MKQ$ | THREAD CLOSE |
| ARRAY ARRAYIX | DESKTOP GET SIZE | GRAPHIC SET MIX | MKS | THREAD CREATE |
| ARRAY ASSIGN | DIALOG DEFAULT FONT | GRAPHIC SET PIXEL | MKS$ | THREAD GET PRIORITY |
| ARRAY COPY | DIALOG DISABLE | GRAPHIC SET POS | MKWRD | THREAD RESUME |
| ARRAY DELETE | DIALOG DOEVENTS | GRAPHIC SET SIZE | MKWRD$ | THREAD SET PRIORITY |
| ARRAY INSERT | DIALOG ENABLE | GRAPHIC SET STRETCHMODE | MOD | THREAD STATUS |
| ARRAY REDIM DECR | DIALOG END | GRAPHIC SET TEXTALIGN | MONTHNAME | THREAD SUSPEND |
| ARRAY REDIM INCR | DIALOG GET CLIENT | GRAPHIC SET VIEW | MONTHNAME$ | THREADCOUNT |
| ARRAY REVERSE | DIALOG GET LOC | GRAPHIC SET VIRTUAL | MOUSEPTR | THREADED |
| ARRAY SCAN | DIALOG GET SIZE | GRAPHIC SET WORDWRAP | MSGBOX | THREADID |
| ARRAY SHUFFLE | DIALOG GET TEXT | GRAPHIC SET WRAP | NAME | TIMER |
| ARRAY SORT | DIALOG GET USER | GRAPHIC STYLE | NOT | TIX |
| ARRAY SWAP | DIALOG HIDE | GRAPHIC TEXT SIZE | NUL | TOOLBAR ADD BUTTON |
| ARRAY TAGARRAY | DIALOG MAXIMIZE | GRAPHIC WIDTH | NUL$ | TOOLBAR ADD SEPARATOR |
| ARRAY TAGARRAY ERASE | DIALOG MINIMIZE | HEADER GET COUNT | OBJECT | TOOLBAR DELETE BUTTON |
| ARRAY UNIQUE | DIALOG NEW | HEADER GET ITEM | OCT | TOOLBAR GET COUNT |
| ASC | DIALOG NONSTABLE | HEADER SEND | OCT$ | TOOLBAR GET STATE |
| ASIN | DIALOG NORMALIZE | HEADER SET ITEM | OEMTOCHR | TOOLBAR SET IMAGELIST |
| ASINH | DIALOG PIXELS | HEX | OEMTOCHR$ | TOOLBAR SET STATE |
| ASM | DIALOG POST | HEX$ | ON CALL | TRACE |
| ASMDATA / END ASMDATA | DIALOG REDRAW | HI | ON ERROR | TREEVIEW DELETE |
| ATANH | DIALOG SEND | HIWRD | ON GOSUB | TREEVIEW GET COUNT |
| ATN | DIALOG SET CLIENT | HOST ADDR | ON GOTO | TREEVIEW GET TEXT |
| ATN2 | DIALOG SET COLOR | HOST NAME | OPEN | TREEVIEW INSERT ITEM |
| BEEP | DIALOG SET ICON | HYPOT | OPTION EXPLICIT | TREEVIEW RESET |
| BGR | DIALOG SET LOC | IF | OR | TRIM |
| BIN | DIALOG SET SIZE | IF/END IF | PARSE | TRIM$ |
| BIN$ | DIALOG SET TEXT | IIF | PARSE$ | TRUNC |
| BIT | DIALOG SET USER | IMAGELIST COUNT | PARSECOUNT | TRY/END TRY |
| BIT CALC | DIALOG SHOW MODAL | IMAGELIST GET COUNT | PATHNAME | TYPE SET |
| BITS | DIALOG SHOW MODELESS | IMAGELIST KILL | PATHNAME$ | TYPE/END TYPE |
| BITS$ | DIALOG SHOW STATE | IMAGELIST NEW | PATHSCAN | UCASE |
| BITSE | DIALOG STABILIZE | IMAGELIST NEW BITMAP | PATHSCAN$ | UCASE$ |
| BUILD | DIALOG UNITS | IMP | PEEK | UCODE$ |
| BUILD$ | DIM | IMPORT | PLAY | UCODEPAGE |
| BYTE | DIR | INCR | PLAY SOUND | UDP CLOSE |
| CALL | DIR CLOSE | INPUT FLUSH | PLAY WAVE | UDP NOTIFY |
| CALL DWORD | DIR$ | INPUT# | POKE | UDP OPEN |
| CALLSTK | DISKFREE | INSTANCE | PREFIX | UDP RECV |
| CALLSTK$ | DISKSIZE | INSTR | PRINT# | UDP SEND |
| CALLSTKCOUNT | DISPLAY BROWSE | INT | PRINTER$ | UNLOCK |
| CBOOL | DISPLAY COLOR | INTEGER | PRINTERCOUNT | UNWRAP |
| CBRT | DISPLAY FONT | INTERFACE / END INTERFACE (DIRECT) | PROCESS GET PRIORITY | UNWRAP$ |
| CBYTE | DISPLAY OPENFILE | INTERFACE/END INTERFACE (IDBIND) | PROCESS SET PRIORITY | USING |
| CDBL | DISPLAY SAVEFILE | ISEVEN | PROFILE | USING$ |
| CDWORD | DOUBLE | ISFALSE | PROGRESSBAR GET POS | UTF8TOCHR |
| CEIL | END | ISFILE | PROGRESSBAR GET RANGE | UTF8TOCHR$ |
| CFLT | ENVIRON | ISFOLDER | PROGRESSBAR SET POS | VAL |
| CHDIR | ENVIRON$ | ISINFINITE | PROGRESSBAR SET RANGE | VARPTR |
| CHDRIVE | EOF | ISNORMAL | PROGRESSBAR SET STEP | VERIFY |
| CHOOSE | EQV | ISODD | PROGRESSBAR STEP | WAITKEY |
| CHR | ERASE | ISTRUE | PUT | WAITKEY$ |
| CHR$ | ERF | ISWIN | PUT STR | WINDOW GET |
| CHRBYTES | ERL | ITERATE | PUT WSTR | WINDOW SET |
| CHRTOOEM | ERL$ | JOIN$ | PUT$ | WORD |
| CHRTOOEM$ | ERR | KILL | PUT$$ | WRAP |
| CHRTOUTF8 | ERRCLEAR | LCASE | QUAD | WRAP$ |
| CHRTOUTF8$ | ERROR | LCASE$ | RAISEEVENT | WRITE |
| CLASS/END CLASS | ERROR$ | LEFT | RANDOMIZE | WRITE# |
| CLIP | EVENT SOURCE | LEFT$ | READ | XOR |
| CLIP$ | EVENTS | LEN | READ$ | XPRINT ARC |
| CLIPBOARD | EXE | LET | REDIM | XPRINT ATTACH |
| CLOSE | EXIST | LET *(WITH OBJECTS)* | REGEXPR | XPRINT BOX |
| CLS | EXIT | LET *(WITH TYPES)* | REGISTER | XPRINT CANCEL |
| CODEPTR | EXP | LET *(WITH VARIANTS)* | REGREPL | XPRINT CELL |
| COLOR | EXP10 | LINE INPUT# | REM | XPRINT CELL SIZE |
| COMBOBOX ADD | EXP2 | LISTBOX ADD | REMAIN | XPRINT CHR SIZE |
| COMBOBOX DELETE | EXPM1 | LISTBOX DELETE | REMAIN$ | XPRINT CLOSE |
| COMBOBOX FIND | EXTRACT | LISTBOX FIND | REMOVE | XPRINT COLOR |
| COMBOBOX FIND EXACT | EXTRACT$ | LISTBOX FIND EXACT | REMOVE$ | XPRINT COPY |
| COMBOBOX GET COUNT | FIELD | LISTBOX GET COUNT | REPEAT | XPRINT ELLIPSE |
| COMBOBOX GET SELCOUNT | FILEATTR | LISTBOX GET SELCOUNT | REPEAT$ | XPRINT FORMFEED |
| COMBOBOX GET SELECT | FILECOPY | LISTBOX GET SELECT | REPLACE | XPRINT GET ATTACH |
| COMBOBOX GET STATE | FILENAME | LISTBOX GET STATE | RESET | XPRINT GET CANVAS |
| COMBOBOX GET TEXT | FILENAME$ | LISTBOX GET TEXT | RESOURCE SAVE FILE | XPRINT GET CLIENT |
| COMBOBOX GET USER | FILESCAN | LISTBOX GET USER | RESOURCE$ | XPRINT GET CLIP |
| COMBOBOX INSERT | FIX | LISTBOX INSERT | RESUME | XPRINT GET COLLATE |
| COMBOBOX RESET | FLOOR | LISTBOX RESET | RETAIN | XPRINT GET COLOR |
| COMBOBOX SELECT | FLUSH | LISTBOX SELECT | RETAIN$ | XPRINT GET COLORMODE |
| COMBOBOX SET TEXT | FONT END | LISTBOX SET TEXT | RETURN | XPRINT GET COPIES |
| COMBOBOX SET USER | FONT NEW | LISTBOX SET USER | RGB | XPRINT GET DC |
| COMBOBOX UNSELECT | FOR / NEXT | LISTBOX UNSELECT | RIGHT | XPRINT GET DUPLEX |
| COMM CLOSE | FORMAT | LISTVIEW DELETE ITEM | RIGHT$ | XPRINT GET LINES |
| COMM LINE | FORMAT$ | LISTVIEW GET COUNT | RMDIR | XPRINT GET MARGIN |
| COMM LINE INPUT | FRAC | LISTVIEW GET TEXT | RND | XPRINT GET MIX |
| COMM OPEN | FRE | LISTVIEW INSERT COLUMN | ROTATE | XPRINT GET ORIENTATION |
| COMM PRINT | FREEFILE | LISTVIEW INSERT ITEM | ROUND | XPRINT GET OVERLAP |
| COMM RECV | FUNCNAME | LISTVIEW RESET | RSET | XPRINT GET PAGES |
| COMM RESET | FUNCNAME$ | LISTVIEW SET TEXT | RSET$ | XPRINT GET PAPER |
| COMM SEND | FUNCTION / END FUNCTION | LO | RTRIM | XPRINT GET PAPERS |
| COMM SET | GET | LOC | RTRIM$ | XPRINT GET PIXEL |
| COMM TIMEOUT | GET STR | LOCAL | SCROLLBAR GET PAGESIZE | XPRINT GET POS |
| COMMAND | GET WSTR | LOCK | SCROLLBAR GET POS | XPRINT GET PPI |
| COMMAND$ | GET$ | LOF | SCROLLBAR GET RANGE | XPRINT GET QUALITY |
| CONTROL ADD | GET$$ | LOG | SCROLLBAR GET TRACKPOS | XPRINT GET SCALE |
| CONTROL ADD BUTTON | GETATTR | LOG10 | SCROLLBAR SET PAGESIZE | XPRINT GET SELECTION |
| CONTROL ADD CHECKBOX | GLOBAL | LOG1P | SCROLLBAR SET POS | XPRINT GET SIZE |
| CONTROL ADD COMBOBOX | GLOBALMEM | LOG2 | SCROLLBAR SET RANGE | XPRINT GET STRETCHMODE |
| CONTROL ADD LABEL | GRAPHIC ARC | LONG | SEC | XPRINT GET TEXTALIGN |
| CONTROL ADD LISTBOX | GRAPHIC ATTACH | LOWRD | SECH | XPRINT GET TRAY |
| CONTROL ADD LISTVIEW | GRAPHIC BITMAP END | LPRINT | SEEK | XPRINT GET TRAYS |
| CONTROL ADD PROGRESSBAR | GRAPHIC BITMAP LOAD | LPRINT ATTACH | SELECT CASE/END SELECT | XPRINT GET WORDWRAP |
| CONTROL ADD SCROLLBAR | GRAPHIC BITMAP NEW | LPRINT CLOSE | SETATTR | XPRINT GET WRAP |
| CONTROL ADD STATUSBAR | GRAPHIC BOX | LPRINT FLUSH | SETEOF | XPRINT IMAGELIST |
| CONTROL ADD TOOLBAR | GRAPHIC CELL | LPRINT FORMFEED | SGN | XPRINT LINE |
| CONTROL ADD TREEVIEW | GRAPHIC CELL SIZE | LPRINT$ | SHELL | XPRINT PIE |
| CONTROL DISABLE | GRAPHIC CHR SIZE | LSET | SHIFT | XPRINT POLYGON |
| CONTROL ENABLE | GRAPHIC CIRCLE | LSET$ | SHRINK | XPRINT POLYLINE |
| CONTROL GET CHECK | GRAPHIC CLEAR | LTRIM | SHRINK$ | XPRINT PREVIEW |
| CONTROL GET TEXT | GRAPHIC COLOR | LTRIM$ | SIN | XPRINT PRINT |
| CONTROL HIDE | GRAPHIC COPY | MACRO/END MACRO | SINGLE | XPRINT RENDER |
| CONTROL KILL | GRAPHIC DETACH | MAK | SINH | XPRINT SCALE |
| CONTROL SET CHECK | GRAPHIC ELLIPSE | MAT | SIZEOF | XPRINT SET CLIP |
| CONTROL SET TEXT | GRAPHIC GET BITS | MAX | SLEEP | XPRINT SET COLLATE |
| COS | GRAPHIC GET CANVAS | MCASE | SPACE | XPRINT SET COLOR |
| COSH | GRAPHIC GET CAPTION | MCASE$ | SPACE$ | XPRINT SET COLORMODE |
| COT | GRAPHIC GET CLIENT | MEMORY | SPLIT | XPRINT SET COPIES |
| COTH | GRAPHIC GET CLIP | MEMORY FILL | SQR | XPRINT SET DUPLEX |
| CQUAD | GRAPHIC GET DC | MEMORY FILLS | STATIC | XPRINT SET FONT |
| CSC | GRAPHIC GET LINES | MENU ADD POPUP | STATUSBAR SET PARTS | XPRINT SET MIX |
| CSCH | GRAPHIC GET LOC | MENU ADD STRING | STATUSBAR SET TEXT | XPRINT SET ORIENTATION |
| CSET | GRAPHIC GET MIX | MENU DELETE | STR | XPRINT SET OVERLAP |
| CSET$ | GRAPHIC GET PIXEL | MENU GET STATE | STR$ | XPRINT SET PAGES |
| CSNG | GRAPHIC GET POS | MENU GET TEXT | STRDELETE | XPRINT SET PAPER |
| CSTR | GRAPHIC GET PPI | MENU NEW BAR | STRDELETE$ | XPRINT SET PIXEL |
| CULNG | GRAPHIC GET SCALE | MENU NEW POPUP | STRING | XPRINT SET POS |
| CURDIR | GRAPHIC GET SIZE | MENU SET STATE | STRINSERT | XPRINT SET QUALITY |
| CURDIR$ | GRAPHIC GET STRETCHMODE | MENU SET TEXT | STRINSERT$ | XPRINT SET STRETCHMODE |
| CVBYT | GRAPHIC GET TEXTALIGN | METHOD / END METHOD | STRPTR | XPRINT SET TEXTALIGN |
| CVCUX | GRAPHIC GET VIEW | METRICS | STRREVERSE | XPRINT SET TRAY |
| CVDWD | GRAPHIC GET WORDWRAP | MID | STRREVERSE$ | XPRINT SET WORDWRAP |
| CVL | GRAPHIC GET WRAP | MID$ | SWAP | XPRINT SET WRAP |
| CVQ | GRAPHIC LINE | MIN | SWITCH | XPRINT SPLIT |
| CVW | GRAPHIC PAINT | MKBYT | SWITCH$ | XPRINT STRETCH |
| CWORD | GRAPHIC PIE | MKBYT$ | TAB$ | XPRINT STYLE |
| DATA | GRAPHIC POLYGON | MKCUR$ | TALLY | XPRINT TEXT SIZE |
| DATACOUNT | GRAPHIC POLYLINE | MKCUX | TAN | XPRINT WIDTH |
| DAYNAME | GRAPHIC PRINT | MKCUX$ | TANH |  |
| DAYNAME$ | GRAPHIC SAVE | MKD$ | TCP ACCEPT |  |

## **Newly** implemented by this branch

> **581 official keywords implemented by this fork** (every official keyword this fork added or completed). Verified via live compilation and testing. Listed alphabetically below.

**The keywords implemented by this fork (alphabetical):**

| Keyword | Keyword | Keyword | Keyword |
|---------|---------|---------|---------|
| ABS | DIALOG SET ICON | ISFALSE | SETEOF |
| ACCEL ATTACH | DIALOG SET LOC | ISFILE | SGN |
| ACODE | DIALOG SET SIZE | ISFOLDER | SHRINK |
| ACODE$ | DIALOG SET TEXT | ISINFINITE | SHRINK$ |
| ACOS | DIALOG SET USER | ISNORMAL | SIN |
| ACOSH | DIALOG SHOW MODAL | ISODD | SINGLE |
| ARRAY ADD | DIALOG SHOW MODELESS | ISTRUE | SINH |
| ARRAY ARRAYIX | DIALOG SHOW STATE | ISWIN | SIZEOF |
| ARRAY ASSIGN | DIALOG STABILIZE | JOIN$ | SPACE |
| ARRAY COPY | DIALOG UNITS | LCASE | SPACE$ |
| ARRAY DELETE | DIM | LCASE$ | SQR |
| ARRAY INSERT | DIR | LEFT | STATUSBAR SET PARTS |
| ARRAY REDIM DECR | DIR CLOSE | LEFT$ | STATUSBAR SET TEXT |
| ARRAY REDIM INCR | DIR$ | LEN | STR |
| ARRAY REVERSE | DISKFREE | LET *(WITH OBJECTS)* | STR$ |
| ARRAY SCAN | DISKSIZE | LET *(WITH VARIANTS)* | STRDELETE |
| ARRAY SHUFFLE | DISPLAY BROWSE | LINE INPUT# | STRDELETE$ |
| ARRAY SWAP | DISPLAY COLOR | LISTBOX ADD | STRING |
| ARRAY TAGARRAY | DISPLAY FONT | LISTBOX DELETE | STRINSERT |
| ARRAY TAGARRAY ERASE | DISPLAY OPENFILE | LISTBOX FIND | STRINSERT$ |
| ARRAY UNIQUE | DISPLAY SAVEFILE | LISTBOX FIND EXACT | STRPTR |
| ASIN | DOUBLE | LISTBOX GET COUNT | STRREVERSE |
| ASINH | ENVIRON$ | LISTBOX GET SELCOUNT | STRREVERSE$ |
| ATANH | EOF | LISTBOX GET SELECT | SWITCH |
| ATN | EQV | LISTBOX GET STATE | SWITCH$ |
| ATN2 | ERF | LISTBOX GET TEXT | TAB$ |
| BGR | ERL | LISTBOX GET USER | TALLY |
| BIN | ERL$ | LISTBOX INSERT | TAN |
| BIN$ | ERR | LISTBOX RESET | TANH |
| BITS | ERRCLEAR | LISTBOX SELECT | TCP NOTIFY |
| BITS$ | ERROR$ | LISTBOX SET TEXT | THREADCOUNT |
| BITSE | EVENT SOURCE | LISTBOX SET USER | THREADID |
| BUILD | EVENTS | LISTBOX UNSELECT | TIMER |
| BUILD$ | EXE | LISTVIEW DELETE ITEM | TOOLBAR ADD BUTTON |
| BYTE | EXIST | LISTVIEW GET COUNT | TOOLBAR ADD SEPARATOR |
| CALLSTK$ | EXP | LISTVIEW GET TEXT | TOOLBAR DELETE BUTTON |
| CALLSTKCOUNT | EXP10 | LISTVIEW INSERT COLUMN | TOOLBAR GET COUNT |
| CBOOL | EXP2 | LISTVIEW INSERT ITEM | TOOLBAR GET STATE |
| CBRT | EXPM1 | LISTVIEW RESET | TOOLBAR SET IMAGELIST |
| CBYTE | EXTRACT | LISTVIEW SET TEXT | TOOLBAR SET STATE |
| CDBL | EXTRACT$ | LO | TREEVIEW DELETE |
| CDWORD | FILEATTR | LOC | TREEVIEW GET COUNT |
| CEIL | FILENAME | LOF | TREEVIEW GET TEXT |
| CFLT | FILENAME$ | LOG | TREEVIEW INSERT ITEM |
| CHOOSE | FIX | LOG10 | TREEVIEW RESET |
| CHR | FLOOR | LOG1P | TRIM |
| CHR$ | FONT END | LOG2 | TRIM$ |
| CHRBYTES | FONT NEW | LONG | TRUNC |
| CHRTOOEM | FORMAT | LOWRD | UCASE |
| CHRTOOEM$ | FORMAT$ | LPRINT$ | UCASE$ |
| CHRTOUTF8 | FRAC | LSET$ | UCODE$ |
| CHRTOUTF8$ | FRE | LTRIM | UCODEPAGE |
| CLIP | FREEFILE | LTRIM$ | UDP NOTIFY |
| CLIP$ | FUNCNAME | MAK | UNWRAP |
| CLOSE | FUNCNAME$ | MAX | UNWRAP$ |
| CODEPTR | GET | MCASE | USING |
| COMBOBOX ADD | GET STR | MCASE$ | USING$ |
| COMBOBOX DELETE | GET WSTR | MEMORY FILL | UTF8TOCHR |
| COMBOBOX FIND | GET$ | MEMORY FILLS | UTF8TOCHR$ |
| COMBOBOX FIND EXACT | GET$$ | MENU ADD POPUP | VARPTR |
| COMBOBOX GET COUNT | GETATTR | MENU ADD STRING | VERIFY |
| COMBOBOX GET SELCOUNT | GRAPHIC ARC | MENU DELETE | WAITKEY |
| COMBOBOX GET SELECT | GRAPHIC ATTACH | MENU GET STATE | WAITKEY$ |
| COMBOBOX GET STATE | GRAPHIC BITMAP END | MENU GET TEXT | WORD |
| COMBOBOX GET TEXT | GRAPHIC BITMAP LOAD | MENU NEW BAR | WRAP |
| COMBOBOX GET USER | GRAPHIC BITMAP NEW | MENU NEW POPUP | WRAP$ |
| COMBOBOX INSERT | GRAPHIC BOX | MENU SET STATE | WRITE |
| COMBOBOX RESET | GRAPHIC CELL | MENU SET TEXT | WRITE# |
| COMBOBOX SELECT | GRAPHIC CELL SIZE | METRICS | XPRINT ARC |
| COMBOBOX SET TEXT | GRAPHIC CHR SIZE | MID | XPRINT ATTACH |
| COMBOBOX SET USER | GRAPHIC CIRCLE | MIN | XPRINT BOX |
| COMBOBOX UNSELECT | GRAPHIC CLEAR | MKBYT | XPRINT CANCEL |
| COMM LINE INPUT | GRAPHIC COLOR | MKCUX | XPRINT CELL |
| COMMAND | GRAPHIC COPY | MKDWD | XPRINT CELL SIZE |
| COMMAND$ | GRAPHIC DETACH | MKE | XPRINT CHR SIZE |
| CONTROL ADD | GRAPHIC ELLIPSE | MKS | XPRINT CLOSE |
| CONTROL ADD BUTTON | GRAPHIC GET BITS | MKWRD | XPRINT COLOR |
| CONTROL ADD CHECKBOX | GRAPHIC GET CANVAS | MOD | XPRINT COPY |
| CONTROL ADD COMBOBOX | GRAPHIC GET CAPTION | MONTHNAME | XPRINT ELLIPSE |
| CONTROL ADD LABEL | GRAPHIC GET CLIENT | MONTHNAME$ | XPRINT FORMFEED |
| CONTROL ADD LISTBOX | GRAPHIC GET CLIP | NUL$ | XPRINT GET ATTACH |
| CONTROL ADD LISTVIEW | GRAPHIC GET DC | OCT | XPRINT GET CANVAS |
| CONTROL ADD PROGRESSBAR | GRAPHIC GET LINES | OCT$ | XPRINT GET CLIENT |
| CONTROL ADD SCROLLBAR | GRAPHIC GET LOC | OEMTOCHR | XPRINT GET CLIP |
| CONTROL ADD STATUSBAR | GRAPHIC GET MIX | OEMTOCHR$ | XPRINT GET COLLATE |
| CONTROL ADD TOOLBAR | GRAPHIC GET PIXEL | ON CALL | XPRINT GET COLOR |
| CONTROL ADD TREEVIEW | GRAPHIC GET POS | ON GOSUB | XPRINT GET COLORMODE |
| CONTROL DISABLE | GRAPHIC GET PPI | ON GOTO | XPRINT GET COPIES |
| CONTROL ENABLE | GRAPHIC GET SCALE | OPEN | XPRINT GET DC |
| CONTROL GET CHECK | GRAPHIC GET SIZE | PARSE$ | XPRINT GET DUPLEX |
| CONTROL GET TEXT | GRAPHIC GET STRETCHMODE | PARSECOUNT | XPRINT GET LINES |
| CONTROL HIDE | GRAPHIC GET TEXTALIGN | PATHNAME | XPRINT GET MARGIN |
| CONTROL KILL | GRAPHIC GET VIEW | PATHNAME$ | XPRINT GET MIX |
| CONTROL SET CHECK | GRAPHIC GET WORDWRAP | PATHSCAN | XPRINT GET ORIENTATION |
| CONTROL SET TEXT | GRAPHIC GET WRAP | PATHSCAN$ | XPRINT GET OVERLAP |
| COS | GRAPHIC LINE | PEEK | XPRINT GET PAGES |
| COSH | GRAPHIC PAINT | PLAY | XPRINT GET PAPER |
| COT | GRAPHIC PIE | PLAY SOUND | XPRINT GET PAPERS |
| COTH | GRAPHIC POLYGON | POKE | XPRINT GET PIXEL |
| CQUAD | GRAPHIC POLYLINE | PRINTER$ | XPRINT GET POS |
| CSC | GRAPHIC PRINT | PRINTERCOUNT | XPRINT GET PPI |
| CSCH | GRAPHIC SAVE | PROGRESSBAR GET POS | XPRINT GET QUALITY |
| CSET$ | GRAPHIC SCALE | PROGRESSBAR GET RANGE | XPRINT GET SCALE |
| CSNG | GRAPHIC SCALE PIXELS | PROGRESSBAR SET POS | XPRINT GET SELECTION |
| CSTR | GRAPHIC SET AUTOSIZE | PROGRESSBAR SET RANGE | XPRINT GET SIZE |
| CULNG | GRAPHIC SET BITS | PROGRESSBAR SET STEP | XPRINT GET STRETCHMODE |
| CURDIR | GRAPHIC SET CAPTION | PROGRESSBAR STEP | XPRINT GET TEXTALIGN |
| CURDIR$ | GRAPHIC SET CLIP | PUT | XPRINT GET TRAY |
| CVBYT | GRAPHIC SET FIXED | PUT STR | XPRINT GET TRAYS |
| CVCUX | GRAPHIC SET FONT | PUT WSTR | XPRINT GET WORDWRAP |
| CVDWD | GRAPHIC SET MIX | PUT$ | XPRINT GET WRAP |
| CVL | GRAPHIC SET PIXEL | PUT$$ | XPRINT IMAGELIST |
| CVQ | GRAPHIC SET POS | QUAD | XPRINT LINE |
| CVW | GRAPHIC SET SIZE | RAISEEVENT | XPRINT PIE |
| CWORD | GRAPHIC SET STRETCHMODE | READ | XPRINT POLYGON |
| DATACOUNT | GRAPHIC SET TEXTALIGN | READ$ | XPRINT POLYLINE |
| DAYNAME | GRAPHIC SET VIEW | REDIM | XPRINT PREVIEW |
| DAYNAME$ | GRAPHIC SET VIRTUAL | REMAIN | XPRINT PRINT |
| DEC | GRAPHIC SET WORDWRAP | REMAIN$ | XPRINT RENDER |
| DEC$ | GRAPHIC SET WRAP | REMOVE | XPRINT SCALE |
| DECLARE | GRAPHIC STYLE | REMOVE$ | XPRINT SET CLIP |
| DEF | GRAPHIC TEXT SIZE | REPEAT | XPRINT SET COLLATE |
| DESKTOP GET PPI | GRAPHIC WIDTH | REPEAT$ | XPRINT SET COLOR |
| DIALOG DEFAULT FONT | HEADER GET COUNT | RESOURCE SAVE FILE | XPRINT SET COLORMODE |
| DIALOG DISABLE | HEADER GET ITEM | RESOURCE$ | XPRINT SET COPIES |
| DIALOG DOEVENTS | HEADER SEND | RETAIN | XPRINT SET DUPLEX |
| DIALOG ENABLE | HEADER SET ITEM | RETAIN$ | XPRINT SET FONT |
| DIALOG END | HEX | RGB | XPRINT SET MIX |
| DIALOG GET CLIENT | HEX$ | RIGHT | XPRINT SET ORIENTATION |
| DIALOG GET LOC | HI | RIGHT$ | XPRINT SET OVERLAP |
| DIALOG GET SIZE | HIWRD | RND | XPRINT SET PAGES |
| DIALOG GET TEXT | HYPOT | ROUND | XPRINT SET PAPER |
| DIALOG GET USER | IIF | RSET$ | XPRINT SET PIXEL |
| DIALOG HIDE | IMAGELIST COUNT | RTRIM | XPRINT SET POS |
| DIALOG MAXIMIZE | IMAGELIST GET COUNT | RTRIM$ | XPRINT SET QUALITY |
| DIALOG MINIMIZE | IMAGELIST KILL | SCROLLBAR GET PAGESIZE | XPRINT SET STRETCHMODE |
| DIALOG NEW | IMAGELIST NEW | SCROLLBAR GET POS | XPRINT SET TEXTALIGN |
| DIALOG NONSTABLE | IMAGELIST NEW BITMAP | SCROLLBAR GET RANGE | XPRINT SET TRAY |
| DIALOG NORMALIZE | IMP | SCROLLBAR GET TRACKPOS | XPRINT SET WORDWRAP |
| DIALOG PIXELS | INPUT# | SCROLLBAR SET PAGESIZE | XPRINT SET WRAP |
| DIALOG POST | INSTANCE | SCROLLBAR SET POS | XPRINT SPLIT |
| DIALOG REDRAW | INSTR | SCROLLBAR SET RANGE | XPRINT STRETCH |
| DIALOG SEND | INT | SEC | XPRINT STYLE |
| DIALOG SET CLIENT | INTEGER | SECH | XPRINT TEXT SIZE |
| DIALOG SET COLOR | ISEVEN | SEEK | XPRINT WIDTH |
